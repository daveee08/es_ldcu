...
function subjgroup_datatable() {
    ...
    $(label_text)[0].innerHTML =
        '<button class="btn btn-sm btn-primary" id="subjgroup_to_create_modal">Create Subject Group</button>';
}
...
var modal_html =
    '<div class="modal fade" id="subjgroup_modal" style="display: none; " aria-hidden="true" >' +
...
var modal_html =
    '<div class="modal fade" id="subjgroup_form_modal" style="display: none; " aria-hidden="true" >' +

...
class AccountsReceivableController extends Controller
{
    ...
    public function ar_getlevel(Request $request)
    {
                    ...
                    $html.='<table border="1" cellpadding="2" >
                        <thead>
                            <tr>
                                ...
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">ID</th>
                                <th style="font-size: 8px !important; font-weight: bold;" width="110" align="center">Student Name</th>
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">Academic Program</th>
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">Level</th>
                              
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">RECEIVABLES </th>

                                
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">PAYMENT </th>
                                <th style="font-size: 8px !important; font-weight: bold;" align="center">TOTAL<br/>RECEIVABLES</th>
                            </tr>
                        </thead>';
                            if(count($students)>0)
                            {

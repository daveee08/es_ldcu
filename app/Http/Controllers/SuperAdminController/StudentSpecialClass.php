...
class StudentSpecialClass extends \App\Http\Controllers\Controller
{
      ...
      public static function student_specialclas_delete(Request $request){
      ...
      public static function student_specialclas_update(Request $request){
            ...
            try{
                  ...
                  $checking = DB::table('student_specsubj')
                                    ->where('id','!=',$id)
                                    ->where('studid',$studid)
                                    ->where('syid',$syid)
                                    ->where('subjid',$subjid)
                  ...
                  if($levelid == 14 || $levelid == 15){
                        ...
                        $check_student_enrollment_record = DB::table('sh_enrolledstud')
                                                                  ->where('syid',$syid)
                                                                  ->where('semid',$semid)
                                                                  ->where('levelid',$levelid)
                                                                  ->where('studid',$studid)
                        ...
                        $check_student_enrollment_record = DB::table('enrolledstud')
                                                            ->where('syid',$syid)
                                                            ->where('levelid',$levelid)
                                                            ->where('studid',$studid)
                                                            ->where('sectionid',$sectionid)
                  ...
                  if( $check_student_enrollment_record > 0){
                        return array((object)[
                              'status'=>0,
                              'message'=>'Student is currently enrolled to this section!',
                        ]); 
                  }
      ...
      public static function student_specialclas_create(Request $request){
      ...
      public static function student_specialclas(Request $request){
            ...
            $students = DB::table('student_specsubj')
                        ...
                        ->join('subjects',function($join) use($syid){
                              $join->on('student_specsubj.subjid','=','subjects.id');
                              $join->where('subjects.deleted',0);
                        })  
                        ->leftJoin('sy',function($join) use($syid){
                              $join->on('student_specsubj.sytoapplygrade','=','sy.id');
                        }) 
                        ->leftJoin('semester',function($join) use($syid){
                              $join->on('student_specsubj.semtoapplygrade','=','semester.id');
                        }) 
                        ...
                        ->select(
                              ...
                              'sytoapplygrade',
                              'semtoapplygrade',
                              'student_specsubj.sectionid',
                              'student_specsubj.levelid',
                              'student_specsubj.subjid'
                        )
                        ->get();
            ...
            $students = DB::table('student_specsubj')
                        ...
                        ->join('sh_subjects',function($join) use($syid){
                              $join->on('student_specsubj.subjid','=','sh_subjects.id');
                              $join->where('sh_subjects.deleted',0);
                        })  
                        ->leftJoin('sy',function($join) use($syid){
                              $join->on('student_specsubj.sytoapplygrade','=','sy.id');

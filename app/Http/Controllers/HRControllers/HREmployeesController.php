...
class HREmployeesController extends Controller
{
    ...
    //old working code for adding new employee
    // public function addnewemployeesave(Request $request)
    // {
    //     $createdby = DB::table('teacher')
    //         ->where('userid', auth()->user()->id)
    ...
    {
        $inactiveemployees = DB::table('teacher')
            ->select(
                'teacher.id',
                'teacher.userid',
                'teacher.title',
            ...
            ->orderby('lastname', 'asc')
            ->where('teacher.deleted', '0')
            ->where('teacher.isactive', '0')
            ->get();

        return $inactiveemployees;
    }

    public function inactiveemployeepdf(Request $request)
    {
        $schoolinfo = DB::table('schoolinfo')
            ->leftJoin('refregion', 'schoolinfo.region', '=', 'refregion.regCode')
            ->leftJoin('refcitymun', 'schoolinfo.division', '=', 'refcitymun.citymunCode')
        ...
        $pdf = PDF::loadview('hr/employees/inactiveemployeelist_pdf', compact('employees', 'schoolinfo'))->setPaper('8.5x14', 'landscape');
        return $pdf->stream('Employee List');

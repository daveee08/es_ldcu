...
class HRBasicSalaryInfoController extends Controller
{
    ...
    $employeerateelevation = DB::table('hr_rateelevation')
        ...
        ->where('deleted','0')
        ->get();
        // return $employeebasicsalaryinfo;
    return view('hr.employeeprofile.basicsalary')
    ...
    public function employeebasicsalaryinfobasisselection(Request $request)
    {
        // return $request->all();
        if($request->get('typeid') == 4) //Monthly
        {
            
            return view('hr.employeeprofile.basicsalary_monthly')
                ->with('employeeid', $request->get('employeeid'));

        }elseif($request->get('typeid') == 5){ //Daily

            return view('hr.employeeprofile.basicsalary_daily')
                ->with('employeeid', $request->get('employeeid'));

        }elseif($request->get('typeid') == 6){ // Hourly

            return view('hr.employeeprofile.basicsalary_hourly')
                ->with('employeeid', $request->get('employeeid'));
        ...
        // }elseif($request->get('typeid') == 7){
            ...
            return view('hr.employeeprofile.basicsalary_project')
                ->with('employeeid', $request->get('employeeid'));
    ...
    public function employeebasicsalaryinfotimesched(Request $request)
    {
        date_default_timezone_set('Asia/Manila');
        // return $request->all();
        if($request->get('action') == 'get')
        {
            ...
            return view('hr.employeeprofile.basicsalary_hourlyschedule')
    ...
    public function employeerateelevation(Request $request)
    {
        ...
        // if($request->get('authorizedpassword') == )
        if($request->get('action') == 'request')
        {
            ...
            if(Hash::check($request->get('authorizedpassword'), auth()->user()->password))
            {
                ...
                //         ->insert([
                //             'employeeid'        => $request->get('employeeid'),
                //             'oldsalary'        => $request->get('oldsalary'),
                //             'newsalary'        => $request->get('newsalary'),
                //             'createddatetime'   => date('Y-m-d H:i:s')
                //         ]);

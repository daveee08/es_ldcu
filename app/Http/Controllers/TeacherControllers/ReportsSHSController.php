...
class ReportsSHSController extends Controller
{
    ...
    function form5a(Request $request)
    {
        ...
        $getStudents = collect($getStudents)->sortByDesc('firstname')->sortBy('lastname')->all();
        $getStudents = collect($getStudents)->unique('id')->all(); 
        ...
        foreach($getStudents as $student){
            ...
            foreach($grades1 as $filtergrades){
                ...
                if(isset($filtergrades->subjdesc))
                {
                    $filtergrades->backsubject = 0;
                    
                    $filtergrades->subjectcode = $filtergrades->subjdesc;
                        
                    if($filtergrades->finalrating < 75 && $filtergrades->finalrating > 0){
            ...
            if(($student->studstatus == 3 || $student->studstatus == 5) && count($backsubjects) == 0)
            {
                    $student->sem1status = 0;//incomplete
            }
        ...
        elseif($request->get('action') == 'export')
        {
            ...
            $students = collect($getStudents)->all();
            ...
            if($request->get('exporttype') == 'pdf')
            {
                ...
                $view = \View::make('teacher/pdf/pdf_shsf5a',compact('schoolinfo','sy','getSectionAndLevel','acadprogid','students','getTeacherName','getPrincipal','sem','strandinfo','divisionrep','principalname','courses'));
                $html = $view->render();
                
                if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'ndm' || strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'apmc')
                {
                    ...
                    $pdf->Image(base_path().'/public/'.$picurl, 8, 8, 15, 15, '', '', '', false, 300, '', false, false, 0);
                }
                if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'apmc')
                {
                    $pdf->Image(base_path().'/public/assets/images/department_of_Education.png', 265, 8, 22, 22, '', '', '', false, 300, '', false, false, 0);
                }else{
                    $pdf->Image(base_path().'/public/assets/images/department_of_Education.png', 185, 8, 15, 15, '', '', '', false, 300, '', false, false, 0);
                }
    ...
    function form5b(Request $request)
    {
        ...
        elseif($request->get('action') == 'export'){
            ...
            array_push($ncArray,(object)array(
                ...
                'nciiimale' => collect($getStudents)->where('gender','male')->where('certificationlevel','NC III')->count(),
                'nciiifemale' => collect($getStudents)->where('gender','female')->where('certificationlevel','NC III')->count(),
                'nciiitotal' => collect($getStudents)->where('certificationlevel','NC III')->count(),
                'nciimale' => collect($getStudents)->where('gender','male')->where('certificationlevel','NC II')->count(),
                'nciifemale' => collect($getStudents)->where('gender','female')->where('certificationlevel','NC II')->count(),
                'nciitotal' => collect($getStudents)->where('certificationlevel','NC II')->count(),
                'ncimale' => collect($getStudents)->where('gender','male')->where('certificationlevel','NC I')->count(),
                'ncifemale' => collect($getStudents)->where('gender','female')->where('certificationlevel','NC I')->count(),
                'ncitotal' => collect($getStudents)->where('certificationlevel','NC I')->count(),
                'nctotalmale' =>collect($getStudents)->where('gender','male')->where('certificationlevel','NC III')->count()+collect($getStudents)->where('gender','male')->where('certificationlevel','NC II')->count()+collect($getStudents)->where('gender','male')->where('certificationlevel','NC I')->count(),
                'nctotalfemale' => collect($getStudents)->where('gender','female')->where('certificationlevel','NC III')->count()+collect($getStudents)->where('gender','female')->where('certificationlevel','NC II')->count()+collect($getStudents)->where('gender','female')->where('certificationlevel','NC I')->count(),
                'nctotal' =>collect($getStudents)->where('gender','male')->where('certificationlevel','NC III')->count()+collect($getStudents)->where('gender','male')->where('certificationlevel','NC II')->count()+collect($getStudents)->where('gender','male')->where('certificationlevel','NC I')->count()+collect($getStudents)->where('gender','female')->where('certificationlevel','NC III')->count()+collect($getStudents)->where('gender','female')->where('certificationlevel','NC II')->count()+collect($getStudents)->where('gender','female')->where('certificationlevel','NC I')->count()
            ));
            ...
            if($request->get('exporttype') == 'pdf')
            {
                ...
                $sheet->setCellValue('X3', $getSchoolInfo->division ?? DB::table('schoolinfo')->first()->divisiontext);
                $sheet->setCellValue('Z3', $getSchoolInfo->region ?? DB::table('schoolinfo')->first()->regiontext);
                ...
                $sheet->getStyle('W41')->getAlignment()->setHorizontal('top');
                $sheet->setCellValue('W49', $getTeacherName->firstname.' '.$getTeacherName->middlename.' '.$getTeacherName->lastname.' '.$getTeacherName->suffix);
                ...
                // $sheet->setCellValue('W61', $divrepdesc);
                $startcellno = 15;
                $malecellcounts = 0; //29

...
class PromotionalReport extends Model
{
    ...
    public static function promotional_report(
        $syid = null,
        $semid = null,
        $courseid = null,
        $sectionid = null,
        ...
        foreach ($students as $enrolled_stud_item) {
            ...
            foreach ($student_sched as $sched) {
                ...
                $sched_array[] = (object)['data' => $final_grade]; 
            }
    ...
    public static function promotional_report_excel(
        ...
        for ($y = 17; $y <= 20; $y++) {
            $grades = self::promotional_report($syid, $semid, $courseid, $sectionid, $y, $students, $sched, $student_grades);

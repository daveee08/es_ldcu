...
<body style="margin: 0.25in 0.25in 0.25in 0.25in;"">
    ...
    {{-- <table width="100%"> 
                        <tr style="">
                        <td width="50%" style="text-align: center; font-size:16px;"><img src="{{base_path()}}/public/{{$schoolInfo->picurl}}" alt="school" width="120px">{{$schoolInfo->schoolname}}</td>
    ...
    <table width="100%" style="font-size:11px">
        <tbody style="border-bottom:solid 1px black; style:12px">
            <tr>
                <td width="75%">
                    <table width="100%">
                        <tbody>
                            ...
                            <tr style="vertical-align: top;">
                                ...
                                <td width="35%">NAME: {{ $studentInfo->lastname . ', ' . $studentInfo->firstname }}</td>
                                <td width="30%">CONTACT NO. {{ $studentInfo->contactno }}</td>
                            </tr>
                            <tr>
                                <td colspan="3">Course & Year: {{ $studentInfo->courseDesc }}
                                    {{ $studentInfo->levelname }}</td>
                            </tr>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td with="50%" style="text-align: right; font-size:11px">
                                    {{ \Carbon\Carbon::create($studentInfo->date_enrolled)->isoFormat('DD/MM/YYYY') }}
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right; font-size:11px">{{ $activeSem->semester }} SY
                                    {{ $activeSy->sydesc }}</td>
                            </tr>
                            <tr>
                                <td style="text-align: right; font-size:11px">Block Code:
    ...
    <table style="font-size:10px" width="100%" class="mb-1">
        <tbody>
            <tr>
                <td width="75%" valign="top">
                    <table width="100%" class="table table-bordered mb-0" style="font-size:.55rem !important">
                        @php
                            $totalUnits = 0.0;
                        @endphp
                        <tbody>
                            ...
                            @foreach ($schedules as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="p-1  text-center" width="22%">
                                        @foreach ($item as $timeitem)
                                            ...
                                            @if ($timeitem->stime != null && $timeitem->etime != null)
                                                <p class="mb-0">{{ $schedother }}
                                                    ...
                                                    -
                                                    {{ \Carbon\Carbon::create($item[0]->etime)->isoFormat('hh:mm A') }}
                                                </p>
                                            @else
                                                <p class="mb-0"></p>
                                            @endif
                                    ...
                                    <td class="p-1  text-center" width="12%">
                                    ...
                                    <td class="p-1  text-center" width="15%" style="font-size:.55rem !important">
                                        {{ $item[0]->teacher }}
                                    </td>
                                    @php
                ...
                <td width="25%" valign="top">
                    <table width="100%" style="font-size:.6rem !important" class="table-bordered">
                        <tbody>
                            @foreach ($ledger as $item)
                                <tr style="vertical-align: top; padding-top: 20px; padding-bottom: 20px;">
                                    <td style="padding-top: 3px; padding-bottom: 3px; padding-left: 4px !important; ">
                                        {{ $item->particulars }}
                                    </td>
                                    <td
                                        style="padding-top: 3px; padding-bottom: 3px; text-align: right;  padding-right: 4px !important;">
    ...
    <table style="font-size:10px" width="100%">
        <tbody>
            <tr>
                <td width="10%"></td>
                <td width="19%" style="text-align: center; ">TOTAL UNIT(S)</td>
                <td width="46%" style="font-size:13px"><b>{{ number_format($totalUnits, 1) }}<b></td>
                <td width="13%">TOTAL AMOUNT:</td>
                <td width="4%">Php</td>
                <td style="text-align: right; font-size:13px;" width="8%">
                    <b>{{ number_format(collect($ledger)->sum('amount'), 2) }}</b></td>
            </tr>
        </tbody>
    </table>
    <br>
    <p style="font-size:10px !important">This is your official certificate of registration. Please check and verify
        thoroughly the correctness of these data.
        If you have question or verification on the data found in this report, you may visit the RECORDS AND ADMISSION
        OFFICE.</p>
    <br>
    ...
    <table style="font-size:10px" width="100%">
        <tr>
            ...
            <td width="20%" style="text-align: center"><u>{{ $registrar_sig }}</u></td>
            <td width="10%" style="text-align: left">Checked by:</td>
            <td width="20%" style="text-align: center"> <u> {{ $regname }} </u></td>
            <td width="10%" style="text-align: left">Approved by:</td>
            <td width="30%" style="text-align: center"> <u>{{ $dean }}</u></td>
        </tr>
        <tr>
            <td></td>
            ...
            <td></td>
            <td style="text-align: center">
                <b>School Registrar</b>
            </td>
            <td></td>
            <td style="text-align: center">
                <b>College Chairperson</b>
            </td>
    ...
    <table width="100%" style="font-size:11px" class="mb-0">
        <tbody style="border-bottom:solid 1px black; style:12px">
            <tr>
                <td width="75%">
                    <table width="100%">
                        <tbody>
                            ...
                            <tr style="vertical-align: top;">
                                <td width="30%">ID no. {{ $studentInfo->sid }}</td>
                                <td width="40%">NAME: {{ $studentInfo->lastname . ', ' . $studentInfo->firstname }}
                                </td>
                                <td width="30%">CONTACT NO. {{ $studentInfo->contactno }}</td>
                            </tr>
                            <tr>

                    ...
                    <div class="row">
                        ...
                        <div class="form-group" id="not_found_holder" hidden>
                            <h5 class="pl-3 text-danger">Student Not Found. The information does not match our records.
                                ...
                                {{ DB::table('schoolinfo')->first()->scontactno }}.</h5>
                        </div>
                    </div>
                </div>
    ...
    <form id="regForm" action="preregistration/submit" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card">
            ...
            <div class="card-body" style="min-height: 400px">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8">
                            ...
                            <div class="form-group" id="lastschoolattfromgroup" hidden>
                                ...
                                <input name="lastschoolatt" id="lastschoolatt" class="form-control"
                                ...
                                <div class="form-group" id="lastschoolattfromgroup">
                                    ...
                                    @foreach (DB::table('grantee')->get() as $item)
                                        <div class="icheck-primary d-inline" dusk="withESC{{ $item->id }}">
                                            <input type="radio" name="withESC" id="withESC{{ $item->id }}"
                                                @if ($item->id == 1) checked @endif
                                                value="{{ $item->id }}">
                                            <label class="mr-5" for="withESC{{ $item->id }}">
                                                {{ $item->description }}
                                            </label>
                                        </div>
                                    @endforeach
                ...
                <div class="tab">
                    <div class="row">
                        <div class="col-md-12">
                            <label for="" id="dup_info" class="text-danger" hidden><b><i>Student name already
                                        exist please contact your school registar.</i></b></label>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-1">
                            ...
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control p-2"
                                placeholder="SU" id="suffix" name="suffix">
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select name="nationality" id="nationality" class="form-control select2" required>
                                ...
                                @foreach (DB::table('nationality')->where('deleted', 0)->orderBy('nationality')->get() as $item)
                                    @if ($item->id == 77)
                                        <option value="{{ $item->id }}" selected="selected">{{ $item->nationality }}
                                        </option>
                                    @else
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="street"
                                id="street" autocomplete="off" required>
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="barangay"
                                id="barangay" autocomplete="off" required>
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="city"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="province"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label class="form-control-label"><b>Email Address <span class="text-danger">*</span></b></label>
                ...
                <div class="tab">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                placeholder="(surname, full name, middle name)" name="guardian_name" id="guardian_name">
                            <div class="text-center" style="font-size: 1rem !important;">
                                ( surname, full name, middle name )
                            </div>
                            <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input class="form-control" id="guardian_contact_number" name="guardian_contact_number"
                                placeholder="09XX-XXXX-XXXX " minlength="13" maxlength="13">
                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <i><b>Note:</b>
                                        <ul>
                                            <li>Old/Continuing Students don’ t have to upload requirements ( unless
                                                specified
                                                and requested by the Registrar’s Office). You can skip this step by clicking
                                                next. </li>
                                            <li>For New/Transferee student please submit a hard copy of the requiremenst to
                                                the registars office.</li>
                                        </ul>
                                </td>
                            </tr>
                        </tfoot>
                ...
                <div class="tab">
                    <div class=" w-100" style="overflow: auto;max-height: 363px;" id="terms">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="icheck-success d-inline">
                                    <input class="form-control" type="checkbox" id="agree" name="agree"
                                        value="2" required>
                                    <label for="agree">I confirm that I have read, understand and agree to the above
                                        terms and agreement for enrollment of
        ...
        <div style="text-align:center;margin-top:40px;" class="stepHolder">
            <div class="float-right">
                ...
                <img class="schoollogo " style="max-height: 95px"
                    src="{{ asset(DB::table('schoolinfo')->first()->picurl) }}">
            </div>

    ...
    <div class="ckheader">
        <a href="#" class="brand-link sidehead">
            ...
            <span class="brand-text font-weight-light"
                style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>DEAN'S PORTAL</b></span>
        </a>
    </div>
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu"
                ...
                <li
                    class="nav-item has-treeview {{ Request::url() == url('/principalPortalSchoolCalendar') || Request::url() == url('/principal/calendar/setup') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview udernavs ">
                        <li class="nav-item">
                            <a href="/principalPortalSchoolCalendar"
                                class="nav-link {{ Request::url() == url('/principalPortalSchoolCalendar') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Calendar</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/principal/calendar/setup"
                                class="nav-link {{ Request::url() == url('/principal/calendar/setup') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Calendar Setup</p>
                            </a>
                        </li>
                ...
                @if (Session::get('isSeniorHighPrincipal'))
                    <li
                        class="nav-item has-treeview {{ Request::url() == url('/principalPortalSchedule') || Request::url() == url('/prinicipalblockinfo/') || Request::url() == url('/principalPortalBlocks') || Request::url() == url('/principalPortalSectionProfile/?') ? 'menu-open active' : '' }}">
                        <a href="#"
                            class="nav-link  {{ Request::url() == url('/principalPortalSchedule') || Request::url() == url('/prinicipalblockinfo/') || Request::url() == url('/principalPortalBlocks') || Request::url() == url('/principalPortalSectionProfile/?') ? 'active' : '' }}">
                        ...
                        top: 28%;"></i>
                                <span
                                    class="right badge badge-warning">{{ Session::get('blockCount') + Session::get('sectionCount') }}</span>
                            </p>
                        </a>
                        <ul class="nav nav-treeview udernavs">
                            <li class="nav-item">
                                <a href="/principalPortalSchedule"
                                    class="nav-link 
                                    {{ Request::url() == url('/principalPortalSchedule') || request()->is('principalPortalSectionProfile/*')
                                        ? 'active'
                                        : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Sections <span
                                            class="right badge badge-primary">{{ Session::get('sectionCount') }}</span>
                                    </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/principalPortalBlocks"
                                    class="nav-link {{ Request::url() == url('/principalPortalBlocks') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Blocks<span
                                            class="right badge badge-primary">{{ Session::get('blockCount') }}</span>
                                    </p>
                ...
                request()->is('principalviewSHSubjects/*')
                    ...
                    request()->is('viewsubjectInfo/*')
                        ...
                        top: 28%;"></i>
                            <span
                                class="right badge badge-warning">{{ Session::get('pssubjectcount') + Session::get('gssubjectcount') + Session::get('jhsubjectcount') + Session::get('shsubjectcount') }}</span>
                        </p>
                    </a>
                    @if (Session::get('isPreSchoolPrinicpal'))
                        <ul class="nav nav-treeview udernavs ">
                            <li class="nav-item">
                                <a href="/principalviewPSSubjects/{{ Crypt::encrypt('2') }}"
                                    class="nav-link {{ request()->is('principalviewPSSubjects/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Pre-School
                                        <span
                                            class="right badge badge-primary">{{ Session::get('pssubjectcount') }}</span>
                                    </p>
                    ...
                    @if (Session::get('isGradeSchoolPrinicpal'))
                        <ul class="nav nav-treeview udernavs ">
                            <li class="nav-item">
                                <a href="/principalviewGSSubjects/{{ Crypt::encrypt('3') }}"
                                    class="nav-link {{ request()->is('principalviewGSSubjects/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Grade School
                                        <span
                                            class="right badge badge-primary">{{ Session::get('gssubjectcount') }}</span>
                                    </p>
                    ...
                    @if (Session::get('isJuniorHighPrinicpal'))
                        <ul class="nav nav-treeview udernavs ">
                            <li class="nav-item">
                                <a href="/principalviewJHSubjects/{{ Crypt::encrypt('4') }}"
                                    class="nav-link {{ request()->is('principalviewJHSubjects/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Junior High School
                                        <span
                                            class="right badge badge-primary">{{ Session::get('jhsubjectcount') }}</span>
                                    </p>
                    ...
                    @if (Session::get('isSeniorHighPrincipal'))
                        <ul class="nav nav-treeview udernavs ">
                            <li class="nav-item">
                                <a href="/principalviewSHSubjects/{{ Crypt::encrypt('5') }}"
                                    class="nav-link {{ request()->is('principalviewSHSubjects/*') ? 'active' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Senior High School
                                        <span
                                            class="right badge badge-primary">{{ Session::get('shsubjectcount') }}</span>
                                    </p>

    ...
    <div class="ckheader">
      <a href="#" class="brand-link sidehead">
        ...
        @endif
          ...
          <span class="brand-text font-weight-light" style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>ENCODER</b></span>
      </a>
    </div>
    <div class="sidebar">
         @php
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu" data-accordion="false">
				...
				{{-- <li class="nav-item">
                    <a href="/student/permrecord/index" class="nav-link {{Request::url() == url('/student/permrecord/index') ? 'active' : ''}}">
                        <i class="nav-icon fa fa-user"></i>
                        <p>
                            Student Evaluation
                        </p>

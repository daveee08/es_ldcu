        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <label style="font-size: 13px !important" class="text-danger"><b>In case of emergency (
                                    Recipient for News, Announcement and School Info)</b></label>
                        </div>
                        <div class="col-md-4">
                            <div class="icheck-success d-inline">
                                <input class="form-control" type="radio" id="father" name="incase" value="1"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="icheck-success d-inline">
                                <input class="form-control" type="radio" id="mother" name="incase" value="2"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="icheck-success d-inline">
                                <input class="form-control" type="radio" id="guardian" name="incase" value="3"
                                    required>
                        ...
                        <div class="col-md-12">
                            <div class="info-box shadow-lg">
                                <div class="info-box-content">
                                    <div class="row">
                                        <div class="col-md-4 col-xl-2  form-group mb-0">
                                        ...
                                        <div class="col-md-4 col-xl-2 form-group mb-0 enrolled_holder">
                                            <label for="">School Year</label>
                                            <select class="form-control select2" id="filter_sy" style="width: 100%;">
                                                @foreach ($sy as $item)
                                                    @if ($item->isactive == 1)
                                        ...
                                        <div class="col-md-4 col-xl-2  form-group mb-0">
                                            ...
                                            <select class="form-control select2" id="filter_level" style="width: 100%;">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="font-size:14px">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-sm table-bordered" id="students_table"
                                            width="100%">
                                            <thead>
                                                <tr>
                                                    <th width="25%">Student</th>
                                                    <th width="15%">Mother Contact #</th>
                        ...
                        <div class="card-body" style="min-height: 587px">
                            <div class="row">
                                <div class="col-md-12" style="font-size:.7rem">
                                    <table class="table table-striped table-sm table-bordered" id="student_contact_info"
                                        width="100%">
                                        <thead>
                                            <tr>
                ...
                <div class="col-md-6">
                    <div class="card shadow" style="">
                        <div class="card-body" style="min-height: 587px">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="font-size:.7rem">
                                    <table class="table table-striped table-sm table-bordered " id="invalid_contact_info"
                                        width="100%">
                                        <thead>
                                            <tr>
                                                <th width="40%">Student</th>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#filter_status', function() {
                if ($(this).val() == "nsc") {
                    ...
                    var temp_students = all_students.filter(x => (x.ismothernum == 0 && x.isfathernum ==
                        0 && x.isguardannum == 0));
            ...
            $("#input_fcontact").inputmask({
                mask: "9999-999-9999"
            });
            $("#input_mcontact").inputmask({
                mask: "9999-999-9999"
            });
            $("#input_gcontact").inputmask({
                mask: "9999-999-9999"
            });
            $("#input_scontact").inputmask({
                mask: "9999-999-9999"
            });
            ...
            function update_contact() {
                ...
                if ($('#input_scontact').val() != "" && ($('#input_scontact').val()).toString().replace(/-|_/g, '')
                    .length != 11) {
                    Toast.fire({
                        type: 'warning',
                    ...
                    return false
                } else if ($('#input_fcontact').val() != "" && ($('#input_fcontact').val()).toString().replace(
                        /-|_/g, '').length != 11) {
                    Toast.fire({
                        type: 'warning',
                    ...
                    return false
                } else if ($('#input_mcontact').val() != "" && ($('#input_mcontact').val()).toString().replace(
                        /-|_/g, '').length != 11) {
                    Toast.fire({
                        type: 'warning',
                    ...
                    return false
                } else if ($('#input_gcontact').val() != "" && ($('#input_gcontact').val()).toString().replace(
                        /-|_/g, '').length != 11) {
                    Toast.fire({
                        type: 'warning',
                ...
                if (isfathernum == 1 && $('#input_fcontact').val() == "") {
                    ...
                    return false
                } else if (isguardiannum == 1 && ($('#input_gcontact').val()).toString().replace(/-|_/g, '')
                    .length != 11) {
                    Toast.fire({
                        type: 'warning',
                        title: "Mother contact # is invalid!"
                    ...
                    return false
                } else if (ismothernum == 1 && ($('#input_mcontact').val()).toString().replace(/-|_/g, '').length !=
                    11) {
                    Toast.fire({
                        type: 'warning',
                        title: "Mother contact # is invalid!"
                    ...
                    return false
                } else if (isfathernum == 1 && ($('#input_fcontact').val()).toString().replace(/-|_/g, '').length !=
                    11) {
                    Toast.fire({
                        type: 'warning',
                        title: "Mother contact # is invalid!"
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length == 0) {
                            ...
                            all_students[index].contactno = ($('#input_scontact').val()).toString()
                                .replace(/-/g, '')
                            all_students[index].fcontactno = ($('#input_fcontact').val()).toString()
                                .replace(/-/g, '')
                            all_students[index].mcontactno = ($('#input_mcontact').val()).toString()
                                .replace(/-/g, '')
                            all_students[index].gcontactno = ($('#input_gcontact').val()).toString()
                                .replace(/-/g, '')
                            ...
                            if ($('#filter_status').val() == "nsc") {
                                ...
                                var temp_students = all_students.filter(x => (x.ismothernum == 0 && x
                                    .isfathernum == 0 && x.isguardannum == 0) || (x
                                    .ismothernum == 1 && (x.mcontactno == null || x
                                        .mcontactno == "")) || (x.isfathernum == 1 && (x
                                    .fcontactno == null || x.fcontactno == "")) || (x
                                    .isguardannum == 1 && (x.gcontactno == null || x
                                        .gcontactno == "")));
                            } else {
                                var temp_students = null
                            }
            ...
            function loaddattable(temp_students = null) {
                ...
                $("#students_table").DataTable({
                    ...
                    autoWidth: false,
                    language: {
                        emptyTable: "Currently, there are no Student records to show."
                    },
                    columns: [{
                            "data": "student"
                        },
                    ...
                    columnDefs: [{
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                if (rowData.contactno != null && rowData.contactno != 'null') {
                                    ...
                                    contact =
                                        '<span class="badge badge-danger">No Student Contact #</span>'
                                }
                                var text = '<a class="mb-0">' + student + '</a>' +
                        ...
                        },
                        {
                            ...
                            'orderable': true,
                            'createdCell': function(td, cellData, rowData, row, col) {
                                // Use a single line to assign each value with a fallback to '&nbsp;' if null or undefined
                                var street = rowData.street || '&nbsp;';
                                var barangay = rowData.barangay || '&nbsp;';
                                var city = rowData.city || '&nbsp;';
                                var province = rowData.province || '&nbsp;';

                                // Construct the text content using template literals for readability
                                var text = `
                                                      <a class="mb-0">${street}</a>
                                                      <p class="text-muted mb-0" style="font-size:.7rem">
                                                      ${barangay}, ${city}, ${province}
                                                      </p>`;

                                // Set the innerHTML of the target cell
                                td.innerHTML = text;
                            }
                        },

                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var text = '<a class="mb-0">' + parent + '</a>' +
                                    '<p class="text-muted mb-0" style="font-size:.7rem">' +
                                    '<a href="javascript:void(0)" data-id="' + rowData.studid +
                                    '" class="update_contact_info ">Update Contact</a>' + '</p>';
                                $(td)[0].innerHTML = text
                            }
                        },
                    ]
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.print_contact', function() {
                window.open('/student/enrollment/report/contact/?datatype=' + $(this).attr('data-id') +

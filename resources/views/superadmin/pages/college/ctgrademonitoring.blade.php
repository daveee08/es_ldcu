...
<section class="content-header">
      <div class="container-fluid">
            <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1>Final Grading Status</h1>
                  </div>
                  <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item active">Final Grading Status</li>
                  </ol>
                  </div>
            </div>
      </div>
                              ...
                              <div class="card-body">
                                    <div class="row">
                                          <table class="table table-bordered table-sm"  style="font-size:.9rem !important">
                                                <tr>
                                                      <th width="60%">Status Final Grades</th>
...
<div class="modal fade" id="modal_final_grading" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
              <div class="modal-header pb-2 pt-2 border-0">
                  <h4 class="modal-title">Grade Submission -- <span style="font-size: 1.2rem" id="section_grades_title"></h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">×</span></button>
              </div>
              <div class="modal-body " style="font-size:.9rem">
                  <div class="row">
                      ...
                      <div class="col-md-6 row">
                              <div class="col-md-3 text-center px-1">
                                    <button class="btn btn-sm btn-primary w-100 status_button_final_grades" id="final_approve_button" data-id="2">Approve</button>
                              </div>
                              <div class="col-md-3 text-center px-1">
                                    <button class="btn btn-sm btn-info w-100 status_button_final_grades" id="final_post_button" data-id="5">Post</button>
                              </div>
                              <div class="col-md-3 text-center px-1">
                                    <button class="btn btn-sm btn-warning w-100  status_button_final_grades" id="final_pending_button" data-id="6">Pending</button>
                              </div>
                              <div class="col-md-3 text-center px-1">
                                    <button class="btn btn-sm btn-danger w-100  status_button_final_grades" id="final_unpost_button" data-id="2">Unpost</button>
                              </div>
                      </div>
                  </div>
                  <div class="row">
                      <div class="col-md-12 table-responsive" style="height: 422px;">
                          <table class="table table-sm table-striped table-bordered mb-0 table-head-fixed"
                              style="font-size:.9rem" width="100%" id="datatable_8">
                              <thead>
                                  <tr>
                                      <th width="5%"><input type="checkbox" checked="checked"
                                              class="select_all"> </th>
                                      <th width="80%">
                                          Name
                                      </th>
      ...
      <script>
             $(document).ready(function(){
                  ...
                  function filter_data(subjects){
                        ...
                        $.each(subjects,function (a,subject) {
                              ...
                              if(subject.prelim_status == 1  && subject.teacherid != null){ 
                                    ...
                                    if (!ws1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          ws1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 1  && subject.teacherid != null){ 
                                    ...
                                    if (!ws2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          ws2.push(subject);
                                    }
                              }
                              if(subject.prefinal_status == 1 && subject.teacherid != null ){ 
                                    ...
                                    if (!ws3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          ws3.push(subject);
                                    }
                              }
                              if(subject.final_status == 1 && subject.teacherid != null ){ 
                                    ...
                                    if (!ws4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          ws4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == 2  && subject.teacherid != null){ 
                                    ...
                                    if (!wa1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wa1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 2  && subject.teacherid != null){ 
                                    ...
                                    if (!wa2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wa2.push(subject);
                                    }
                              }
                              if(subject.prefinal_status == 2  && subject.teacherid != null){ 
                                    ...
                                    if (!wa3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wa3.push(subject);
                                    }
                              }
                              if(subject.final_status == 2  && subject.teacherid != null){ 
                                    ...
                                    if (!wa4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wa4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == 6 && subject.teacherid != null ){ 
                                    ...
                                    if (!wpe1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wpe1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 6 && subject.teacherid != null ){ 
                                    ...
                                    if (!wpe2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wpe2.push(subject);
                                    }
                              }
                              if(subject.prefinal_status == 6  && subject.teacherid != null){ 
                                    ...
                                    if (!wpe3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wpe3.push(subject);
                                    }
                              }
                              if(subject.final_status == 6  && subject.teacherid != null){ 
                                    ...
                                    if (!wpe4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wpe4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == 5 && subject.teacherid != null ){ 
                                    ...
                                    if (!wp1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wp1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 5  && subject.teacherid != null){ 
                                    ...
                                    if (!wp2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wp2.push(subject);
                              ...
                              if(subject.prefinal_status == 5  && subject.teacherid != null){ 
                                    ...
                                    if (!wp3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wp3.push(subject);
                                    }
                              }
                              if(subject.final_status == 5  && subject.teacherid != null){ 
                                    ...
                                    if (!wp4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wp4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == 7 && subject.teacherid != null ){ 
                                    ...
                                    if (!wi1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wi1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 7  && subject.teacherid != null){ 
                                    ...
                                    if (!wi2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wi2.push(subject);
                                    }
                              }
                              if(subject.prefinal_status == 7  && subject.teacherid != null){ 
                                    ...
                                    if (!wi3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wi3.push(subject);
                                    }
                              }
                              if(subject.final_status == 7  && subject.teacherid != null){ 
                                    ...
                                    if (!wi4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wi4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == 8 && subject.teacherid != null ){ 
                                    ...
                                    if (!wd1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wd1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == 8  && subject.teacherid != null){ 
                                    ...
                                    if (!wd2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wd2.push(subject);
                              ...
                              if(subject.prefinal_status == 8  && subject.teacherid != null){ 
                                    ...
                                    if (!wd3.some(s => s.subjDesc === subject.subjDesc && s.teacherid === subject.teacherid)) {
                                          wd3.push(subject);
                                    }
                              }
                              ...
                              if(subject.final_status == 8  && subject.teacherid != null ){ 
                                    ...
                                    if (!wd4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wd4.push(subject);
                                    }
                              }
                              ...
                              if(subject.prelim_status == null  && subject.teacherid != null ){ 
                                    ...
                                    if (!wu1.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wu1.push(subject);
                                    }
                              }
                              if(subject.midterm_status == null  && subject.teacherid != null ){ 
                                    ...
                                    if (!wu2.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wu2.push(subject);
                                    }
                              }
                              if(subject.prefinal_status == null  && subject.teacherid != null ){ 
                                    ...
                                    if (!wu3.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wu3.push(subject);
                                    }
                              }
                              if(subject.final_status == null  && subject.teacherid != null ){ 
                                    ...
                                    if (!wu4.some(s => s.subjDesc === subject.subjDesc && s.teacherid == subject.teacherid)) {
                                          wu4.push(subject);
                                    }
                              }
                        ...
                        datatable_var = $("#datatable_7").DataTable({
                              ...
                              columnDefs: [
                                    ...
                                    },
                                    {
                                          ...
                                          'orderable': false, 
                                          'createdCell':  function (td, cellData, rowData, row, col) {
                                                var text = '<p class="mb-0 final_subjDesc" >'+rowData.subjDesc+'</p><p class="text-muted mb-0 final_subjCode" style="font-size:.7rem ">'+rowData.subjCode+'</p>';
                                                $(td)[0].innerHTML =  text
                                          }
                                    },
                                    {
                                                ...
                                                if (rowData.grades && rowData.grades.length > 0) {
                                                      ...
                                                      switch (true) {
                                                            ...
                                                            case (temp_grade_1.length > 0):
                                                                  text = '<a href="#" class="text-success font-weight-bold showSubjectGrade" data-term="1" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Submitted <br> <span style="font-size:.7rem!important;"> ' + (temp_grade_1[0].prelim_updateddatetime ? temp_grade_1[0].prelim_updateddatetime : '')+' <br>' + (temp_grade_1[0].prelim_updateby ? temp_grade_1[0].prelim_updateby : '') + '</span></a>';
                                                                  break;
                                                            case (temp_grade_2.length > 0):
                                                                  text = '<a href="#" class="text-primary font-weight-bold showSubjectGrade" data-term="1" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Approved <br> <span style="font-size:.7rem!important;> ' + (temp_grade_2[0].prelim_updateddatetime ? temp_grade_2[0].prelim_updateddatetime : '')+' <br>' + (temp_grade_2[0].prelim_updateby ? temp_grade_2[0].prelim_updateby : '') + '</span></a>';
                                                                  break;
                                                            case (temp_grade_4.length > 0):
                                                            text = '<a href="#" class="text-info font-weight-bold showSubjectGrade" data-term="1" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Posted <br> <span style="font-size:.7rem!important;"> ' + (temp_grade_4[0].prelim_updateddatetime ? temp_grade_4[0].prelim_updateddatetime : '')+' <br>' + (temp_grade_4[0].prelim_updateby ? temp_grade_4[0].prelim_updateby : '') + '</span></a>';
                                                            break;
                                                            case (temp_grade_3.length > 0):
                                                                  text = '<a href="#" class="text-warning font-weight-bold showSubjectGrade" data-term="1" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Pending <br> <span style="font-size:.7rem!important;"> ' + (temp_grade_3[0].prelim_updateddatetime ? temp_grade_3[0].prelim_updateddatetime : '')+' <br>' + (temp_grade_3[0].prelim_updateby ? temp_grade_3[0].prelim_updateby : '') + '</span></a>';
                                                                  break;
                                                            default:
                                          ...
                                          'createdCell':  function (td, cellData, rowData, row, col) {
                                                ...
                                                if (rowData.grades && rowData.grades.length > 0) {
                                                      ...
                                                      switch (true) {
                                                            ...
                                                            case (temp_grade_1.length > 0):
                                                                  text = '<a href="#" class="text-success font-weight-bold showSubjectGrade" data-term="2" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Submitted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_1[0].midterm_updateddatetime ? temp_grade_1[0].midterm_updateddatetime : '')+' <br>' + (temp_grade_1[0].midterm_updateby ? temp_grade_1[0].midterm_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_2.length > 0):
                                                                  text = '<a href="#" class="text-primary font-weight-bold showSubjectGrade" data-term="2" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Approved <br> <span style="font-size:.7rem!important"> ' + (temp_grade_2[0].midterm_updateddatetime ? temp_grade_2[0].midterm_updateddatetime : '')+' <br>' + (temp_grade_2[0].midterm_updateby ? temp_grade_2[0].midterm_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_4.length > 0):
                                                            text = '<a href="#" class="text-info font-weight-bold showSubjectGrade" data-term="2" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Posted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_4[0].midterm_updateddatetime ? temp_grade_4[0].midterm_updateddatetime : '')+' <br>' + (temp_grade_4[0].midterm_updateby ? temp_grade_4[0].midterm_updateby : '') + '</a>';
                                                            break;
                                                            case (temp_grade_3.length > 0): 
                                                                  text = '<a href="#" class="text-warning font-weight-bold showSubjectGrade" data-term="2" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Pending <br> <span style="font-size:.7rem!important"> ' + (temp_grade_3[0].midterm_updateddatetime ? temp_grade_3[0].midterm_updateddatetime : '')+' <br>' + (temp_grade_3[0].midterm_updateby ? temp_grade_3[0].midterm_updateby : '') + '</a>';
                                                                  break;
                                                            default:
                                                                  text = '<p class="mb-0 text-secondary">Not Submitted</p>';
                                                      }
                                          ...
                                          'createdCell':  function (td, cellData, rowData, row, col) {
                                                ...
                                                if (rowData.grades && rowData.grades.length > 0) {
                                                      ...
                                                      switch (true) {
                                                            ...
                                                            case (temp_grade_1.length > 0):
                                                                  text = '<a href="#" class="text-success font-weight-bold showSubjectGrade" data-term="3" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Submitted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_1[0].prefinal_updateddatetime ? temp_grade_1[0].prefinal_updateddatetime : '')+' <br>' + (temp_grade_1[0].prefinal_updateby ? temp_grade_1[0].prefinal_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_2.length > 0):
                                                                  text = '<a href="#" class="text-primary font-weight-bold showSubjectGrade" data-term="3" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Approved <br> <span style="font-size:.7rem!important"> ' + (temp_grade_2[0].prefinal_updateddatetime ? temp_grade_2[0].prefinal_updateddatetime : '')+' <br>' + (temp_grade_2[0].prefinal_updateby ? temp_grade_2[0].prefinal_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_4.length > 0):
                                                            text = '<a href="#" class="text-info font-weight-bold showSubjectGrade" data-term="3" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Posted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_4[0].prefinal_updateddatetime ? temp_grade_4[0].prefinal_updateddatetime : '')+' <br>' + (temp_grade_4[0].prefinal_updateby ? temp_grade_4[0].prefinal_updateby : '') + '</a>';
                                                            break;
                                                            case (temp_grade_3.length > 0):
                                                                  text = '<a href="#" class="text-warning font-weight-bold showSubjectGrade" data-term="3" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Pending <br> <span style="font-size:.7rem!important"> ' + (temp_grade_3[0].prefinal_updateddatetime ? temp_grade_3[0].prefinal_updateddatetime : '')+' <br>' + (temp_grade_3[0].prefinal_updateby ? temp_grade_3[0].prefinal_updateby : '') + '</a>';
                                                                  break;
                                                            default:
                                                                  text = '<p class="mb-0 text-secondary">Not Submitted</p>';
                                                      }
                                    ...
                                    },
                                    {
                                          ...
                                          'createdCell':  function (td, cellData, rowData, row, col) {
                                                ...
                                                if (rowData.grades && rowData.grades.length > 0) {
                                                      ...
                                                      switch (true) {
                                                            case (temp_grade_1.length > 0):
                                                                  text = '<a href="#" class="text-success font-weight-bold showSubjectGrade" data-term="4" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Submitted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_1[0].final_updateddatetime ? temp_grade_1[0].final_updateddatetime : '')+' <br>' + (temp_grade_1[0].final_updateby ? temp_grade_1[0].final_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_2.length > 0):
                                                                  text = '<a href="#" class="text-primary font-weight-bold showSubjectGrade" data-term="4" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Approved <br> <span style="font-size:.7rem!important"> ' + (temp_grade_2[0].final_updateddatetime ? temp_grade_2[0].final_updateddatetime : '')+' <br>' + (temp_grade_2[0].final_updateby ? temp_grade_2[0].final_updateby : '') + '</a>';
                                                                  break;
                                                            case (temp_grade_4.length > 0):
                                                            text = '<a href="#" class="text-info font-weight-bold showSubjectGrade" data-term="4" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Posted <br> <span style="font-size:.7rem!important"> ' + (temp_grade_4[0].final_updateddatetime ? temp_grade_4[0].final_updateddatetime : '')+' <br>' + (temp_grade_4[0].final_updateby ? temp_grade_4[0].final_updateby : '') + '</a>';
                                                            break;
                                                            case (temp_grade_3.length > 0):
                                                                  text = '<a href="#" class="text-warning font-weight-bold showSubjectGrade" data-term="4" data-id="'+rowData.sectionid+'" data-subjectid="'+rowData.prospectusID+'">Pending <br> <span style="font-size:.7rem!important"> ' + (temp_grade_3[0].final_updateddatetime ? temp_grade_3[0].final_updateddatetime : '')+' <br>' + (temp_grade_3[0].final_updateby ? temp_grade_3[0].final_updateby : '') + '</a>';
                                                                  break;
                                                            default:
                                                                  text = '<p class="mb-0 text-secondary">Not Submitted</p>';
                                                      }
                  ...
                  $(document).on('click','.showSubjectGrade',function(){
                        ...
                        term_section = $(this).attr('data-term')
                        ...
                        var subjCode = $(this).closest('tr').find('.final_subjCode').text();
                        var subjDesc = $(this).closest('tr').find('.final_subjDesc').text();
                        var sectionname = $(this).closest('tr').find('td:first-of-type').text()
                        var subjectname = subjCode + ' - ' + subjDesc
                        setTimeout(() => {
                                          $('#term_select').val(term_section).trigger('change')
                                    }, 300);
                        grade_access = 'sections'
                        if(status == 1){
                              $('#final_approve_button').removeAttr('disabled')
                              $('#final_post_button').removeAttr('disabled')
                              $('#final_pending_button').removeAttr('disabled')
                              $('#final_unpost_button').attr('disabled', true)
                        }else if(status == 2 || status == 3 || status == 4){
                              $('#final_approve_button').attr('disabled',true)
                              $('#final_post_button').removeAttr('disabled')
                              $('#final_pending_button').removeAttr('disabled')
                              $('#final_unpost_button').attr('disabled', true)
                        }else if(status == 5){
                              $('#final_approve_button').attr('disabled', true)
                              $('#final_post_button').attr('disabled', true)
                              $('#final_pending_button').attr('disabled', true)
                              $('#final_unpost_button').removeAttr('disabled')
                        }else if(status == 6){
                              $('#final_approve_button').attr('disabled',true)
                              $('#final_post_button').attr('disabled', true)
                              $('#final_pending_button').attr('disabled', true)
                        ...
                        $('#section_grades_title').text(sectionname + ' - ' + subjectname)
                        $('#modal_final_grading').modal('show')
                  ...
                  $(document).on('click', '.view_section_subjects', function() {
                        ...
                        var sectionname = $(this).attr('data-section-desc')
                        setTimeout(() => {
                                          $('#term_select').val(term_section).trigger('change')
                                    }, 300);
                        grade_access = 'sections'
                  ...
                  $(document).on('change','#term_select',function(){
                        term_section = $(this).val()
                        get_sectionstudents()
                  })
                  function get_sectionstudents(){
                        var syid = $('#filter_sy').val()
                        var semid = $('#filter_semester').val()
                        $.ajax({
                              url: '/college/final_grade/get_students',
                              method: 'GET',
                              data: {
                                    sectionid: sectionid,
                                    subjectid: subjectid,
                              ...
                              columnDefs: [
                                    {
                                          ...
                                          'createdCell':  function (td, cellData, rowData, row, col) {
                                                ...
                                                $(td).html('<input checked="checked" type="checkbox" class="select final_grades_checkbox" data-subjectid="'+rowData.prospectusid+'" data-studid="'+rowData.id+'">')

                                                $(td).html('<input checked="checked" type="checkbox" class="select final_grades_checkbox" data-sectionid="'+sectionid+'" data-subjectid="'+rowData.prospectusid+'" data-studid="'+rowData.id+'">')
                  ...
                  $(document).on('click','.select_all',function(){
                        if($(this).is(':checked')){
                              $('.final_grades_checkbox').prop('checked',true)
                        }else{
                              $('.final_grades_checkbox').prop('checked',false)
                        }
                  })
                  $(document).on('click','.status_button_final_grades',function(){
                        var syid = $('#filter_sy').val()
                        var semid = $('#filter_semester').val()
                        var checked_final_grades = [];
                        var term = $('#term_select').val()

                        var status = $(this).attr('data-id')
                        $('.final_grades_checkbox:checked').each(function(){
                              var info = {
                                    studid: $(this).data('studid'),
                                    subjectid: $(this).data('subjectid'),
                                    sectionid: $(this).data('sectionid'),
                              }
                              checked_final_grades.push(info)
                        })
                        $.ajax({
                              url: '/college/final_grade/update_status',
                              method: 'GET',
                              data: {
                                    checked_final_grades: checked_final_grades,
                                    syid: syid,
                                    semid: semid,
                                    term: term,
                                    status: status
                        ...
                        if($('.final_grades_checkbox:checked').length === 0){
                              Toast.fire({
                                    type: 'error',
                              ...
                              $.ajax({
                                    ...
                                    success: function(data){
                                          Toast.fire({
                                                type: 'success',
                                                title: 'Succesfully ' + label + ' Grades'
                                          })
                                          get_all_subjects()
                                          get_sectionstudents()
                                          grade_status()

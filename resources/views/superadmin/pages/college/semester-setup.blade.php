...
@section('content')
                    ...
                    <div class="addmodalHolder">
                        <form id="form" autocomplete="off">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3 select-wrapper">
                                        ...
                                        <select class="form-control select2 sy" aria-label="Default select example"
                                            id="sy"></select>
                                    </div>

                                    <div class="col-md-6 form-group mb-3 select-wrapper">
                                        <label>Semester</label>
                                        <select class="form-control select2 semester" aria-label="Default select example"
                                            id="semester"></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="inputs form-control" id="setupDesc"
                        ...
                        <div class="terms-wapper mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6  form-group mb-3">
                                                ...
                                                <input type="number" class="inputs form-control" id="passingRate"
                                                    placeholder="1-5" value="3">
                                            </div>
                                            <div class="col-md-6  form-group mb-3">
                                                <label for="decimalPoint"> Decimal Place</label>
                                                <input type="number" class="inputs form-control" id="decimalPoint"
                                                    placeholder=".00">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12  form-group mb-0">
                                ...
                                <p class="mb-1">Make sure to add ($) in every variable or check the variable spellings.
                                </p>
                                ...
                                <span class="result hidden" for="formula">
                                    <ul class="result_list p-0 m-0">
                                        <li>
                                            <a data-value="( $prelim + $midterm + $prefi + $final ) / 4"
                                                class="formula_item">( $prelim + $midterm + $prefi + $final ) / 4</a>
                                        </li>
                                        <li>
                                            <a data-value="( $midterm + $final ) / 2" class="formula_item">( $midterm +
                                                $final ) / 2</a>
                                        </li>
                                        <li>
                                            <a data-value="( $midterm * .3 ) + ( $final * .7 )" class="formula_item">(
                                                $midterm * .3 ) + ( $final * .7 )</a>
                                        </li>
                                    </ul>
                                </span>

                                <input class="inputs form-control formula" id="formula" optionselected="0"
                                    placeholder="eg. ($prelim + $miterm)/2">
                                ...
                                <div class="mb-2 mt-2 ml-2">
                                    <div class="row">
                                        <div class="col-md-3 hidden" id="prelimvariable">
                                            <a id="prelimVar" style="cursor: pointer" data-value="$prelim"
                                                class="m-0 text-info text-sm">$prelim</a>
                                        </div>
                                        <div class="col-md-3 hidden" id="midtermvariable">
                                            <a id="midtermVar" style="cursor: pointer" data-value="$midterm"
                                                class="m-0 text-info text-sm">$midterm</a>
                                        </div>
                                        <div class="col-md-3 hidden" id="prefivariable">
                                            <a id="prefiVar" style="cursor: pointer" data-value="$prefi"
                                                class="m-0 text-info text-sm">$prefi</a>
                                        </div>
                                        <div class="col-md-3 hidden" id="finalvariable">
                                            <a id="finalVar" style="cursor: pointer" data-value="$final"
                                                class="mb-0 text-info text-sm">$final</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-check form-switch pl-2">
                                <input onClick="isPerecentageSpecified()" hidden class="form-check-input" type="checkbox"
                                    role="switch" id="checkboxPercentage">
                                <label class="form-check-label" for="checkboxPercentage"><i
                                        class="fas fa-sort-down align-middle"
                                        style="padding-b mt-1ottom: 7px;margin-right: 10px;font-size:9px"></i> Terms
                                    Advance Setup</label>
                            </div>
                                        ...
                                        <div class="card card-sm">
                                            ...
                                            <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <button id="prelimviewTrans" type="button"
                                                            class="hidden btn btn-outline-primary btn-sm float-right mt-1"
                                                            style="padding: 0rem 0.5rem;font-size:9px">View</button>
                                                    </div>
                                                </div>
                                                <select id="prelimTransmutID" name="faculty"
                                                    class="transmutation_select form-control select2"></select>

                                                <div class="form-check form-switch mt-1">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="isPrelimDisplay">
                                                    <label class="form-check-label" for="isPrelimDisplay">Student
                                                        Display</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-sm">
                                            ...
                                            <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <button id="midtermviewTrans" type="button"
                                                            class="hidden btn btn-outline-primary btn-sm float-right view_transmute mt-1"
                                                            style="padding: 0rem 0.5rem;font-size:9px">View</button>
                                                    </div>
                                                </div>
                                                <select id="midtermTransmutID" name="faculty"
                                                    class="transmutation_select form-control select2"></select>

                                                <div class="form-check form-switch mt-1">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="isMidtermDisplay">
                                                    <label class="form-check-label" for="isMidtermDisplay">Student
                                                        Display</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div>
                                        <div class="card card-sm">
                                            ...
                                            <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                                ...
                                                <select id="prefiTransmutID" name="faculty"
                                                    class="transmutation_select form-control select2"></select>

                                                <div class="form-check form-switch mt-1">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="isPrefiDisplay">
                                                    <label class="form-check-label" for="isPrefiDisplay">Student
                                                        Display</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-sm">
                                            ...
                                            <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <button id="finalviewTrans" type="button"
                                                            class="hidden btn btn-outline-primary btn-sm float-right view_transmute mt-1"
                                                            style="padding: 0rem 0.5rem;font-size:9px">View</button>
                                                    </div>
                                                </div>
                                                <select id="finalTransmutID" name="faculty"
                                                    class="transmutation_select form-control select2"></select>

                                                <div class="form-check form-switch mt-1">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="isFinalDisplay">
                                                    <label class="form-check-label" for="isFinalDisplay">Student
                                                        Display</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card card-sm">
                                            ...
                                            <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <button id="finalgradeviewTrans" type="button"
                                                            class="hidden btn btn-outline-primary btn-sm float-right view_transmute mt-1"
                                                            style="padding: 0rem 0.5rem;font-size:9px">View</button>
                                                    </div>
                                                </div>
                                                <select id="finalgradeTransmutID" name="faculty"
                                                    class="transmutation_select form-control select2"></select>

                                                <div class="form-check form-switch mt-1">
                                                    <input checked disabled class="form-check-input" type="checkbox"
                                                        role="switch" id="isFinalGradeDisplay">
                                                    <label class="form-check-label" for="isFinalGradeDisplay">Student
                                                        Display</label>
                                                </div>
                                            </div>
                                        </div>
    ...
    <!-- Edit Modals -->
    <div class="modal fade editModal" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    <form id="formEdit" autocomplete="off">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="inputs form-control" id="setupDescEdit"
                                placeholder="Setup Description">
                        ...
                        <div class="terms-wapper mb-3">
                            ...
                            <div>
                                <input hidden onClick="isCheckedEdit('prelimEdit', 'prelim-div-edit')"
                                    class="form-check-input checkbox" type="checkbox" id="prelimEdit" value="1">
                                <label class="form-check-label termsEdit" for="prelimEdit">Prelim</label>
                            </div>
                            <div>
                                <input hidden onClick="isCheckedEdit('midtermEdit', 'midterm-div-edit')"
                                    class="form-check-input checkbox" type="checkbox" id="midtermEdit" value="1">
                                <label class="form-check-label termsEdit" for="midtermEdit">Midterm</label>
                            </div>
                            <div>
                                <input hidden onClick="isCheckedEdit('prefiEdit', 'prefi-div-edit')"
                                    class="form-check-input checkbox" type="checkbox" id="prefiEdit" value="1">
                                <label class="form-check-label termsEdit" for="prefiEdit">Pre-Final</label>
                            </div>
                            <div>
                                <input hidden onClick="isCheckedEdit('finalEdit', 'final-div-edit')"
                                    class="form-check-input checkbox" type="checkbox" id="finalEdit" value="1">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-6  form-group mb-3">
                                            ...
                                            <input type="number" class="inputs form-control" id="passingRateEdit"
                                                placeholder="70 (%)">
                                        </div>
                                        <div class="col-md-6  form-group mb-3">
                                            <label for="decimalPointEdit"> Decimal Place</label>
                                            <input type="number" class="inputs form-control" id="decimalPointEdit"
                                                placeholder=".00">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12  form-group mb-3">
                            ...
                            <input class="inputs form-control formulaEdit" id="formulaEdit"
                                placeholder="eg. ($prelim + $miterm)/2">
                            ...
                            <div class="mb-2 mt-2 ml-2">
                                <div class="row">
                                    <div id="prelimEditvariable" class="col-md-3 hidden">
                                        <a id="prelimEditVar" style="cursor: pointer" data-value="$prelim"
                                            class="m-0 text-info text-sm ">$prelim</a>
                                    </div>
                                    <div id="midtermEditvariable" class="col-md-3 hidden">
                                        <a id="midtermEditVar" style="cursor: pointer" data-value="$midterm"
                                            class="m-0 text-info text-sm ">$midterm</a>
                                    </div>
                                    <div id="prefiEditvariable" class="col-md-3 hidden">
                                        <a id="prefiEditVar" style="cursor: pointer" data-value="$prefi"
                                            class="m-0 text-info text-sm">$prefi</a>
                                    </div>
                                    <div id="finalEditvariable" class="col-md-3 hidden">
                                        <a id="finalEditVar" style="cursor: pointer" data-value="$final"
                                            class="mb-0 text-info text-sm">$final</a>
                                    </div>
                        ...
                        <div class="form-check form-switch pl-2">
                            <input onClick="isPerecentageSpecifiedEdit()" hidden class="form-check-input" type="checkbox"
                                role="switch" id="checkboxPercentageEdit">
                            <label class="form-check-label" for="checkboxPercentageEdit"><i
                                    class="fas fa-sort-down align-middle"
                                    style="padding-bottom: 7px;margin-right: 10px;"></i> Terms Advance Setup</label>
                        </div>
                                    ...
                                    <label class="card-header">Prelim Setup</;>
                                        <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <button id="prelimviewTransEdit" type="button"
                                                        class="hidden btn btn-outline-primary btn-sm float-right view_transmute"
                                                        style="padding: 0rem 0.5rem;font-size: 9px;">View</button>
                                                </div>
                                            </div>
                                            <select id="prelimTransmutIDEdit" name="faculty"
                                                class="transmutation_select form-control select2"></select>

                                            <div class="form-check form-switch mt-3">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    id="isPrelimDisplayEdit">
                                                <label class="form-check-label" for="isPrelimDisplayEdit">Student
                                                    Display</label>
                                            </div>
                                        </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button id="midtermviewTransEdit" type="button"
                                                    class="hidden btn btn-outline-primary btn-sm float-right view_transmute"
                                                    style="padding: 0rem 0.5rem;font-size: 9px;">View</button>
                                            </div>
                                        </div>
                                        <select id="midtermTransmutIDEdit" name="faculty"
                                            class="transmutation_select form-control select2"></select>

                                        <div class="form-check form-switch mt-3">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="isMidtermDisplayEdit">
                                            <label class="form-check-label" for="isMidtermDisplayEdit">Student
                                                Display</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button id="prefiviewTransEdit" type="button"
                                                    class="hidden btn btn-outline-primary btn-sm float-right view_transmute"
                                                    style="padding: 0rem 0.5rem;font-size: 9px;">View</button>
                                            </div>
                                        </div>
                                        <select id="prefiTransmutIDEdit" name="faculty"
                                            class="transmutation_select form-control select2"></select>

                                        <div class="form-check form-switch mt-3">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="isPrefiDisplayEdit">
                                            <label class="form-check-label" for="isPrefiDisplayEdit">Student
                                                Display</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button id="finalviewTransEdit" type="button"
                                                    class="hidden btn btn-outline-primary btn-sm float-right view_transmute"
                                                    style="padding: 0rem 0.5rem;font-size: 9px;">View</button>
                                            </div>
                                        </div>
                                        <select id="finalTransmutIDEdit" name="faculty"
                                            class="transmutation_select form-control select2"></select>

                                        <div class="form-check form-switch mt-3">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                id="isFinalDisplayEdit">
                                            <label class="form-check-label" for="isFinalDisplayEdit">Student
                                                Display</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body d-flex flex-column" style="padding: 0.60rem;">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button id="finalgradeviewTransEdit" type="button"
                                                    class="hidden btn btn-outline-primary btn-sm float-right view_transmute"
                                                    style="padding: 0rem 0.5rem;font-size: 9px;">View</button>
                                            </div>
                                        </div>
                                        <select id="finalgradeTransmutIDEdit" name="faculty"
                                            class="transmutation_select form-control select2"></select>

                                        <div class="form-check form-switch mt-3">
                                            <input checked disabled class="form-check-input" type="checkbox"
                                                role="switch" id="isFinalGradeDisplayEdit">
                                            <label class="form-check-label" for="isFinalGradeDisplayEdit">Student
                                                Display</label>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade addTransmutation" id="addTransmutation" tabindex="-1" data-toggle="modal"
        aria-labelledby="addTransmutationLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                            ...
                            <form id="form_values_setup">
                                <div class="row" id="row_1">
                                    ...
                                    <div class="col-md-4  form-group mb-1">
                                        <input readonly type="number" name="initial1"
                                            class="inputs form-control initial1" id="initial1">
                                    </div>
                                    <div class="col-md-4 ">
                                        <input readonly type="number" name="initial2"
                                            class="inputs form-control initial2" id="initial2">
                                    </div>
                                    <div class="col-md-4 ">
                                        <input readonly type="number" name="final" class="inputs form-control final"
                                            id="final">
                                    </div>
                                </div>
                            </form>
                ...
                <div class="modal-footer" id="createfooter">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn add_transmutation btn-primary"
                        id="add_transmutation">Create</button>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2  form-group mb-0">
                                        <div class="select_container_attendance">
                                            ...
                                            <select id="syidFilter" name="syidFilter"
                                                class="sy form-control form-control-sm select2">
                                    ...
                                    <div class="col-md-2  form-group mb-0">
                                        <div class="select_container_attendance">
                                            ...
                                            <select id="semidFilter" name="semidFilter"
                                                class="semester form-control form-control-sm select2"></select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12" style="font-size:.9rem !important">
                                        <table
                                            ...
                                            style="font-size: 13px;" dataid="subscbr-tbl" id="semestertable"
                                            width="100%">
                                            <thead>
                                                <tr>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getGradeScale() {
                ...
                var gradeScale = [{
                        id: '1',
                        text: 'Decimal Point Scale'
                    },
                    {
                        id: '0',
                        text: 'Numerical Grade Scale'
                    },
                ];
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                var buttons =
                                    ...
                                    '<p value ="' + rowData.id + '" class="mb-0">' + rowData
                                    .semester + '</p>' +
                                    '</div>'
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var array = [rowData.prelim, rowData.midterm, rowData.prefi, rowData
                                    .final, 1
                                ]
                                ...
                                for (let index = 0; index < array.length; index++) {
                                    ...
                                    if (array[index] != 0) {
                                        button += '<span class="badge badge-primary mr-2">' + tems[
                                            index] + '</span>';
                                    }
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var buttons = '<p class="m-0 view_que_setup" >' + pointscale +
                                    '</p>';
                                $(td)[0].innerHTML = buttons;
...

                        {
                            ...
                            'orderable': false,
                            'createdCell': function(td, cellData, rowData, row, col) {
                                var array = [rowData.isPrelimDisplay, rowData.isMidtermDisplay,
                                    rowData.isPrefiDisplay, rowData.isFinalDisplay, 1
                                ]
                                var tems = ['Prelim', 'Midterm', 'Prefinal', 'Final', 'Final Grade']
                                var button = '<div style="white-space: normal;">';
                                for (let index = 0; index < array.length; index++) {
...

                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var buttons =
                                    '<p style="white-space: normal; font-size:11px" class="badge badge-info m-0 p-1">' +
                                    rowData.f_backend + '</p>'
                                $(td)[0].innerHTML = buttons;
                                $(td).addClass('text-center');
                                $(td).addClass('align-middle');
...

                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var buttons =
                                    '<button type="button" value ="' + rowData.id +
                                    '" class="editBtn btn btn-sm btn-outline-primary mr-2"><i class="fas fa-edit"></i></button>' +
                                    '<button type="button" value ="' + rowData.id +
                                    '" class="deleteBtn btn btn-sm btn-outline-danger"><i class="fas fa-trash-alt"></i></button>'
                                $(td)[0].innerHTML = buttons;
                                $(td).addClass('text-center');
                                $(td).addClass('align-middle');
                            }
...

                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var buttons = '<div class="custom-control custom-switch">' +
                                    '<input type="checkbox" class="custom-control-input setActive" id="switch' +
                                    rowData.id + '" data-id="' + rowData.id + '" ' + isActive +
                                    '>' +
                                    '<label class="custom-control-label" for="switch' + rowData.id +
                                    '"></label>' +
                                    '</div>';
                                $(td)[0].innerHTML = buttons;
                                $(td).addClass('text-center');
                ...
                $(document).on('click', '.view_transmute', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            console.log(data);
                            $('#transDesc').val(data[0]['transmutdetails'][0][
                                'trans_desc'
                            ]);

                            $('#createfooter').addClass('hidden');
                            $('#viewfooter').removeClass('hidden');
                            $('#edit_transmutation').val(data[0]['transmutdetails'][0][
                                'id'
                            ]);
                            $('#delete_transmutation').val(data[0]['transmutdetails'][0]
                                ['id']);

                            for (let i = 1; i < data[0]['transmutation'].length; i++) {

                                addRow(data[0]['transmutation'][i]['initial1'], data[0][
                                    'transmutation'
                                ][i]['initial2'], data[0]['transmutation'][i][
                                    'final'
                                ]);
                            ...
                            $($($('#row_1')[0].children[1])[0].children[0]).val(data[0][
                                'transmutation'
                            ][0]['initial1']);
                            $($($('#row_1')[0].children[2])[0].children[0]).val(data[0][
                                'transmutation'
                            ][0]['initial2']);
                            $($($('#row_1')[0].children[3])[0].children[0]).val(data[0][
                                'transmutation'
                            ][0]['final']);
            ...
            $(document).ready(function() {
                $('#addTransmutation').on('hidden.bs.modal', function(e) {
                    ...
                    $('.addtranmutationHolder').load(window.location.href +
                        ' .addtranmutationHolder');
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status == 200) {
                                ...
                                $(".modal-body-add").load(location.href +
                                    " .modal-body-add");
                        ...
                        success: function(response) {
                            ...
                            if (response[0].status == 200) {
                                $(document).ready(function(event) {
                                    ...
                                    var prelim = response[0].semesterSetup[0]
                                        .prelim;
                                    var midterm = response[0].semesterSetup[0]
                                        .midterm;
                                    var prefi = response[0].semesterSetup[0]
                                        .prefi;
                                    var final = response[0].semesterSetup[0]
                                        .final;


                                    var prelimTransmute = response[0]
                                        .semesterSetup[0].prelimTransmuteID;
                                    var midtermTransmute = response[0]
                                        .semesterSetup[0].midtermTransmuteID;
                                    var prefiTransmute = response[0]
                                        .semesterSetup[0].prefiTransmuteID;
                                    var finalTransmute = response[0]
                                        .semesterSetup[0].finalTransmuteID;
                                    var finalGradeTransmute = response[0]
                                        .semesterSetup[0].finalGradeTransmuteID;

                                    $('#syEdit').val(response[0].semesterSetup[
                                        0].sy).change();
                                    $('#semesterEdit').val(response[0]
                                        .semesterSetup[0].semester).change();

                                    isPointScaled = $("#isPointScaledEdit").val(
                                        response[0].semesterSetup[0]
                                        .isPointScaled).change();
                                    $("#setupDescEdit").val(response[0]
                                        .semesterSetup[0].setup_desc);

                                    $('#isPointScaledEdit  option[value="' +
                                        isPointScaled + '"]').prop(
                                        "selected", true);

                                    $('#schoolyearEdit  option[value="' +
                                        response[0].semesterSetup[0].sy +
                                        '"]').prop("selected", true);

                                    $("#id-input-edit").val(response[0]
                                        .semesterSetup[0].id);

                                    $("#passingRateEdit").val(response[0]
                                        .semesterSetup[0].passingRate);
                                    $("#decimalPointEdit").val(response[0]
                                        .semesterSetup[0].decimalPoint);
                                    $("#formulaEdit").val(response[0]
                                        .semesterSetup[0].f_backend);


                                    if (response[0].semesterSetup[0]
                                        .isPrelimDisplay == 1) {
                                        $('#isPrelimDisplayEdit').prop(
                                            'checked', true);
                                    } else {
                                        $('#isPrelimDisplayEdit').prop(
                                            'checked', false);
                                    ...
                                    if (response[0].semesterSetup[0]
                                        .isPrefiDisplay == 1) {
                                        $('#isPrefiDisplayEdit').prop('checked',
                                            true);
                                    } else {
                                        $('#isPrefiDisplayEdit').prop('checked',
                                            false);
                                    ...
                                    if (response[0].semesterSetup[0]
                                        .isFinalDisplay == 1) {
                                        $('#isFinalDisplayEdit').prop('checked',
                                            true);
                                    } else {
                                        $('#isFinalDisplayEdit').prop('checked',
                                            false);
                                    ...
                                    if (prelim == 1) {
                                        ...
                                        isCheckedEdit('prelimEdit',
                                            'prelim-div-edit');
                                        $('#checkboxPercentageEdit').prop(
                                            'checked', true);
                                        $('#prelim-input-edit').attr('disabled',
                                            false);
                                        $("#prelim-input-edit").val(response[0]
                                            .semesterSetup[0]
                                            .prelimPercentage);


                                        if (prelimTransmute > 0) {
                                            $("#prelimTransmutIDEdit").val(
                                                prelimTransmute).change();
                                        } else {
                                            $("#prelimTransmutIDEdit").val(" ")
                                                .change();
                                        }
                                    ...
                                    if (midterm == 1) {
                                        ...
                                        isCheckedEdit('midtermEdit',
                                            'midterm-div-edit');
                                        $('#checkboxPercentageEdit').prop(
                                            'checked', true);
                                        $('#midterm-input-edit').attr(
                                            'disabled', false);
                                        $("#midterm-input-edit").val(response[0]
                                            .semesterSetup[0]
                                            .midtermPercentage);

                                        if (midtermTransmute > 0) {
                                            $("#midtermTransmutIDEdit").val(
                                                midtermTransmute).change();
                                        } else {
                                            $("#midtermTransmutIDEdit").val(" ")
                                                .change();
                                        }
                                    ...
                                    if (prefi == 1) {
                                        ...
                                        isCheckedEdit('prefiEdit',
                                            'prefi-div-edit');
                                        $('#checkboxPercentageEdit').prop(
                                            'checked', true);
                                        $('#prefi-input-edit').attr('disabled',
                                            false);
                                        $("#prefi-input-edit").val(response[0]
                                            .semesterSetup[0]
                                            .prefiPercentage);


                                        if (prefiTransmute > 0) {
                                            $("#prefiTransmutIDEdit").val(
                                                prefiTransmute).change();
                                        } else {
                                            $("#prefiTransmutIDEdit").val(" ")
                                                .change();
                                        }
                                    ...
                                    if (final == 1) {
                                        ...
                                        isCheckedEdit('finalEdit',
                                            'final-div-edit');
                                        $('#checkboxPercentageEdit').prop(
                                            'checked', true);
                                        $('#final-input-edit').attr('disabled',
                                            false);
                                        $("#final-input-edit").val(response[0]
                                            .semesterSetup[0]
                                            .finalPercentage);


                                        if (finalTransmute > 0) {
                                            $("#finalTransmutIDEdit").val(
                                                finalTransmute).change();
                                        } else {
                                            $("#finalTransmutIDEdit").val(" ")
                                                .change();
                                        }
                                    ...
                                    document.getElementById(
                                            'finalgrade-div-edit').style
                                        .display = "block";
                                    if (finalGradeTransmute > 0) {
                                        $("#finalgradeTransmutIDEdit").val(
                                            finalGradeTransmute).change();
                                    } else {
                                        $("#finalgradeTransmutIDEdit").val(" ")
                                            .change();
                                    }
                                ...
                                $.ajax({
                                    ...
                                    success: function(response) {
                                        if (response[0].status == 200) {
                                            ...
                                            notify(response[0].code, response[0]
                                                .message);
                                            get_setup_data();

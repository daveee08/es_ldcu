...
<body>
    ...
    <table class="table mb-0 table-sm" style="font-size:13px;">
        <tr>
            <td width="100%" class="text-center p-0" style="font-size:15px; !important"><b>Official Class List</b></td>
        </tr>
        <tr>
    <td width="100%" class="text-center p-0" style="font-size:15px; !important"><b>Programming Basic - {{ $printdata->sectionDesc }}</b></td>
        </tr>
        <tr>
    ...
    <div id="maleStudentsContainer">
        <table id="maleStudentsTable" class="table table-bordered table-sm table-responsive-md table-vcenter text-center no-footer">
            <thead class="bg-gray">
                <tr>
                    <th>Student ID</th>
                    <th>Student Name</th>

...
@section('content')
    ...
    <div class="modal fade" id="reflist_modal" style="display: none;" aria-hidden="true" data-backdrop="static"
        data-keyboard="false">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header pb-2 pt-2 border-0">
                    <h4 class="modal-title" style="font-size: 1.1rem !important">Refrence List</h4>
                            ...
                            <table class="table table-sm table-bordered mb-0" width="100%"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th width="40%" class="text-center">Resource Path</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>principalassistant.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>Scholarship Coordinator</td>
                                        <td class="text-center">21</td>
                                        <td>scholarshipcoor.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>Subject Coordinator</td>
                                        <td class="text-center">22</td>
                                        <td>principalcoor.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>School Clinic</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>clinic_nurse.index</td>
                                    </tr>
                                    <tr>
                                        <td>Doctor</td>
                                        <td class="text-center">25</td>
                                        <td>clinic_doctor.index</td>
                                    </tr>
                                    <tr>
                                        <td>Payroll Clerk</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>idmanagement.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>Encoder</td>
                                        <td class="text-center">30</td>
                                        <td>encoder.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>Guidance</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>inventory.pages.home</td>
                                    </tr>
                                    <tr>
                                        <td>Librarian</td>
                                        <td class="text-center">34</td>
                                        <td>library.pages.home</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <div class="modal fade" id="usertype_modal" style="display: none;" aria-hidden="true" data-backdrop="static"
        data-keyboard="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="">Resource Path</label>
                            <input type="text" class="form-control form-control-sm" id="resource_path">
                        </div>
                        <div class="col-md-12 form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-primary" id="usertype_button"><i class="fa fa-save"></i>
                                Save</button>
                            <button class="btn btn-sm btn-success" id="usertype_button_update" hidden><i
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table-hover table table-striped table-sm table-bordered"
                                                id="usertype_datatable" width="100%">
                                                <thead class="thead-light">
                                                    <tr>
                                                        <th width="30%" class="align-middle">User Type</th>
                                                        <th width="11%" class="align-middle text-center p-0">With Acad
                                                        </th>
                                                        <th width="10%" class="align-middle text-center p-0">Selection
                                                        </th>
                                                        <th width="8%" class="align-middle text-center p-0">Login</th>
                                                        <th width="8%" class="align-middle text-center p-0">Ref #</th>
                                                        <th width="23%" class="align-middle text-center p-0"></th>
                            ...
                            <div class="card shadow">
                                <div class="card-body p-1 ">
                                    <div class="row" style="font-size:.9rem !important">
                                        <ul class="mb-0">
                                            <li><label class="mb-0">Selection</label> : <i class="text-dark">determine
                                                    if the type of user is included in the list of user types when creating
                                                    accounts.</i></li>
                                            <li><label class="mb-0">Login</label> : <i class="text-dark">determine if
                                                    the type of user can log in to the system. </i></li>
                                            <li><label class="mb-0">Reference #</label> : <i class="text-dark">reference
                                                    to user types that are not included in the original user type</i></li>
                                        </ul>
...
@section('footerjavascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#reflist', function() {
                $('#reflist_modal').modal()
            })
            ...
            $(document).on('click', '.edit_utype', function() {
                ...
                $('#resource_path').val(temp_data[0].resourcepath)
            ...
            $(document).on('click', '#usertype_button', function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        ref_num: $('#ref_num').val(),
                        resourcepath: $('#resource_path').val(),
                        default: isstatus,
                        status: isdefault,
                        withacad: withacad
            ...
            function display_usertype() {
                    ...
                    columnDefs: [{
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                if (rowData.with_acad == 1) {
                                    ...
                                    $(td)[0].innerHTML =
                                        '<i style="font-size:15px" class="fa text-danger">&#xf00d;</i>'
                                }
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                // if(rowData.id > 18){
                                var buttons =
                                    '<a href="javascript:void(0)" class="edit_utype" data-id="' +
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                if (rowData.id > 18) {
                                    var buttons =
                                        '<a href="javascript:void(0)" class="delete_utype" data-id="' +
                                        rowData.id +
                ...
                $(label_text)[0].innerHTML =
                    ' <button class="btn btn-primary btn-sm mr-2" id="usertype_modal_create"><i class="fa fa-plus"></i> Create User Type</button> <button class="btn btn-secondary btn-sm mr-2" id="reflist"><i class="fa fa-book"></i> Reference List</button>'
            }

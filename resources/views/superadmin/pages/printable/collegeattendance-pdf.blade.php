    ...
    @if (in_array(13, $months))
        ...
        @for ($m = 0; $m < count($months); $m++)
            ...
            <div style="height: 25px; margin-bottom: 10px;">
                ...
                <div class="quarter">
                    <p>{{ $sections->sectionDesc }} - {{ $gradelvl->levelname }}</p>
                    @if ($semid == 1)
                        <p>First Semester</p>
                    @elseif($semid == 2)
                        <p>Second Semester</p>
                ...
                <table width="100%" class="table table-bordered">
                    ...
                    <tbody>
                        @php
                            ...
                            $datas = collect($attendance)->where('monthid', $months[$m]);
                        @endphp

                        @foreach ($enrollstudents as $student)
                            <tr>
                                <td class="text-left" width="20%">{{ $student->lastname }},
                                    {{ $student->firstname }}

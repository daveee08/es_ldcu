...
<div class="modal fade" id="student_specialclass_form" style="display: none;" aria-hidden="true" data-backdrop="static" data-keyboard="false">
      <div class="modal-dialog">
            <div class="modal-content">
                  <div class="modal-header pb-2 pt-2 border-0">
                        <h4 class="modal-title" style="font-size: 1.1rem !important">Student Addition Subject Form</h4>
...
<section class="content-header">
      <div class="container-fluid">
            <div class="row mb-2">
                  <div class="col-sm-6">
                        <h1>Student Additional Subject</h1>
                  </div>
                  <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home</a></li>
                        <li class="breadcrumb-item active">Student Additional Subject</li>
                  </ol>
                  </div>
            </div>
      </div>
...
@section('footerjavascript')
      ...
      <script>
            ...
            function check_online_connection(){
                  $.ajax({
                        ...
                        success:function(data) {
                              connected_stat = true
                              get_last_index('student_specsubj',true)
                        }, 
                        error:function(){
      ...
      <script>
            ...
            function get_last_index(tablename,first=false){
                  ...
                  $.ajax({
                        type:'GET',
                        url: '/api/basiced/student/specialclass/getnewinfo',
                        data:{
                              tablename: tablename
                        },
                        success:function(data) {
            ...
            function process_create(tablename,createdata,first=false){
                  ...
                  $.ajax({
                        type:'GET',
                        url: projectsetup[0].es_cloudurl+'/api/basiced/student/specialclass/syncnew',
                        data:{
                              tablename: tablename,
                              data:b
                        },
            ...
            function get_updated(tablename){
                  ...
                  $.ajax({
                        type:'GET',
                        url: '/api/basiced/student/specialclass/getupdated',
                        data:{
                              tablename: tablename,
                        },
                        success:function(data) {
            ...
            function process_update(tablename , updated_data){
                  ...
                  $.ajax({
                        type:'GET',
                        url:  projectsetup[0].es_cloudurl+'/api/basiced/student/specialclass/syncupdate',
                        data:{
                              tablename: tablename,
                              data:b
                        },
            ...
            function get_deleted(tablename){
                  ...
                  $.ajax({
                        type:'GET',
                        url: '/api/basiced/student/specialclass/getdeleted',
                        data:{
                              tablename: tablename
                        },
                        success:function(data) {
            ...
            function process_deleted(tablename , deleted_data){
                  ...
                  $.ajax({
                        type:'GET',
                        url: projectsetup[0].es_cloudurl+'/api/basiced/student/specialclass/syncdelete',
                        data:{
                              tablename: tablename,
                              data:b
                        },
            ...
            function update_local_status(tablename,alldata,info,status,first=false){
                  $.ajax({
                        type:'GET',
                        url:  '/api/basiced/student/specialclass/updatestat',
                        data:{
                              tablename: tablename,
                              data:info
                        },
      ...
      <script>
            ...
            // $(document).ready(function(){
                  ...
                  $(document).on('click','#student_specialclass_button',function(){
                        ...
                        $('#filter_studid').removeAttr('disabled')
                  ...
                  $(document).on('click','.view_info',function(){
                        ...
                        $('#filter_studid').val(selected_info.studid).change()
                        $('#filter_studid').attr('disabled','disabled')
                        ...
                        $.ajax({
                              ...
                              success:function(data) {
                                    if(data[0].status == 0){
                                          ...
                                          load_student_special_class()
                                          get_last_index('student_specsubj')
                                    }

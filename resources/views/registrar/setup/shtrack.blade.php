                  ...
                  <div class="modal-body">
                        ...
                        <div class="row">
                              <div class="col-md-12 form-group">
                                    ...
                                    <input id="input_trackabbrv" class="form-control form-control-sm">
                              </div>
                        </div>
                        <div class="row">
                              <div class="col-md-12">
                                    ...
                                    <div class="row">
                                          <div class="col-md-12"  style="font-size:14px">
                                                <table class="table-hover table table-striped table-sm table-bordered table-head-fixed nowrap display compact" id="track_datatable" width="100%" >
                                                      <thead>
                                                            <tr>
                                                                  <th width="60%" >Track Name</th>
                                                                  <th width="12%" >Abbreviation</th>
      ...
      <script>
            $(document).ready(function(){
                  ...
                  $(document).on('click','.delete_track',function(){
                        selected_id = $(this).attr('data-id')
                        Swal.fire({
                              title: 'Do you want to remove track?',
                              type: 'warning',
                  ...
                  function create_track(){
                        ...
                        var trackabrv = $('#input_trackabbrv').val()
                  ...
                  function load_track_datatable(){
                        ...
                        var label_text = $($("#track_datatable_wrapper")[0].children[0])[0].children[0]
                        $(label_text)[0].innerHTML = '<button class="btn btn-primary btn-sm" id="button_to_modal_track">Create Track</button>'

<html>
        ...
        <header>
            @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'gbbc')
                <table style="width: 100%; table-layout: fixed;">
                    <tr>
                        <td style="width: 20%; text-align: right;"><img
                                src="{{ base_path() }}/public/{{ $schoolinfo->picurl }}" alt="school" width="80px" />
                        </td>
                        <td colspan="3"><img src="{{ base_path() }}/public/assets/images/gbbc/tor-header.png"
                                alt="school" width="520px" /></td>
                    </tr>
                    <tr>
                        <td colspan="4">&nbsp;</td>
                    </tr>
                    <tr>
                        <td rowspan="2">&nbsp;</td>
                        <td
                            style="text-align: center; font-weight: bolder; color: #2d7691; font-size: 17px;  padding-bottom: 20px; padding-top: 20px;">
                            Office of the Registrar</td>
                        <td rowspan="4" colspan="2"style="width: 25%; border: 1px solid black; height: 100px;">
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td style="text-align: center; font-weight: bolder; color: #2d6c91; font-size: 25px;">Offical
                            Transcript of Record</td>
                    </tr>
                    <tr>
                        <td colspan="3">&nbsp;</td>
                    </tr>
            ...
            <table style="width: 100%; font-size: 12px; text-align: left !important;">
                <thead>
                    <tr>
                        ...
                        <th style="width: 28%;">80-84&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- &nbsp;Denotes Satisfactory
                        </th>
                    ...
                    <tr>
                        <th style="width: 2%;"></th>
                        <th style="width: 29%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;90-94&nbsp;&nbsp;-Denotes Very Good
                        </th>
    ...
    dateissued --}}
            <table style="width: 100%; font-size: 12px; text-align: left !important;">
                <thead>
                    ...
                    <tr>
                        ...
                        <th style="width: 7%;">&nbsp;</th>
                        <th style="width: 91%;">
                            &nbsp;&nbsp;&nbsp;This transcript is valid only when it bears the seal of the College and
                            the original signature in ink of the Registrar. Any erasures or alteration made on the
                            entries of this form renders this transcript null and void.
                        </th>
                    </tr>
                </thead>
            </table>
            ...
            <table style="width: 100%; font-size: 12px;">
                <tr>
                    <td style="width: 30%; font-size: 12px;"><em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;School
                            Seal</em></td>
                    ...
                    <td style="width: 40%; font-size: 12px; text-align: center;">{{ $assistantreg ?? '' }}</td>
                </tr>
                <tr>
                    <td style="width: 30%; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O.R #: <span
                            style="font-weight: bold;">{{ $or ?? '' }}</span></td>
                    <td style="width: 40%; font-size: 12px; text-align: center;"></td>
                    <td style="width: 30%; text-align: center; font-size: 12px;">Registrar</td>
                </tr>
                <tr>
                    <td style="width: 30%; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date Issued: @if ($dateissued != null)
        ...
        <table style="width: 100%; margin: 0px; font-size: 12px; table-layout: fixed !important; margin-top: 180px;">
            ...
            <tr>
                ...
                <td style="width: 32%;border-bottom: 1px solid black;" colspan="3">{{ $studentinfo->lastname }},
                    {{ $studentinfo->firstname }} {{ $studentinfo->middlename }} {{ $studentinfo->suffix }}</td>
            ...
            <tr>
                ...
                <td style="width: 32%;border-bottom: 1px solid black;" colspan="3">{{ $details->parentguardian }}
                </td>
                <td style="">Address:</td>
            ...
            <tr>
                ...
                <td style="width: 32%;border-bottom: 1px solid black;" colspan="3">{{ $details->admissiondate }}
                </td>
                <td style="">Degree:</td>
            ...
            <tr>
                ...
                <td style="width: 32%;border-bottom: 1px solid black;" colspan="3">
                    {{ $details->basisofadmission }}</td>
            ...
            <tr>
                ...
                <td style="width: 32%;border-bottom: 1px solid black;" colspan="3">{{ $details->specialorder }}
                </td>
        ...
        <main>
            ...
            <table style="width: 100%; margin: 0px; table-layout: fixed;" class="font-two">
                ...
                <tr style="font-weight: bold; font-size: 14px; font-weight: bold;font-size: 12px;">
                    <th style="border-bottom: 1px solid black;border-top: 1px solid black;" colspan="2">COURSE
                        NUMBER</th>
                    <th style="border-bottom: 1px solid black;border-top: 1px solid black;" colspan="2">DESCRIPTIVE
                        TITLE OF THE COURSE</th>
                    <th style="text-align: center; border-bottom: 1px solid black;border-top: 1px solid black;">GRADE
                    </th>
                ...
                @if (count($records) > 0)
                    @foreach ($records as $key => $record)
                        ...
                        @else
                            ...
                            @endphp
                            <tr>
                                <td colspan="6" style="text-align: center"><u
                                        style="text-transform: uppercase; font-weight: bold; font-size: 12px;">{{ $record->schoolname }}</u><br /><span
                                        style="font-weight: bold; text-transform: uppercase; font-size: 12px;">{{ $initialcourse }}</span>
                                </td>
                            </tr>
                        @endif
                        <tr style="font-size: 12px;">
                            <td style="width: 15%; font-weight: bold;"><u>
                                    @if ($record->semid == 1)
                                        First Semester
            ...
            @if (collect($records)->where('display', '0')->count() > 0)
                ...
                @endphp
                <table style="width: 100%; margin: 0px; margin-top: 180px; page-break-before: always;"
                    class="font-two">
                    @if (count($records) > 0)
                        @foreach ($records as $key => $record)
                            @if ($initialschool == strtolower($record->schoolname))
                            @else
                                ...
                                @endphp
                                <tr>
                                    <td colspan="6" style="text-align: center; width: 100%;"><u
                                            style="text-transform: uppercase; font-weight: bold; font-size: 13px;">{{ $record->schoolname }}</u><br /><span
                                            style="font-weight: bold; text-transform: uppercase; font-size: 13px;">{{ $initialcourse }}</span>
                                    </td>
                                </tr>
                            @endif
                            <tr style="font-size: 12px;">
                                <td style="width: 14%; font-weight: bold;"><u>
                                        @if ($record->semid == 1)
                                            First Semester
                                        @elseif($record->semid == 2)
                                            Second Semester
                                ...
                                <td style="width: 5%;"></td>
                                <td style="width: 11%; text-align: right;"><u>{{ $record->sydesc }}</u>&nbsp;&nbsp;
                                </td>
                                ...
                                @foreach ($record->subjdata as $subj)
                                    <tr style="font-size: 12px;">
                                        ...
                                        <td style="width: 12%; text-align: right; font-weight: bold;">
                                            {{ $subj->subjgrade }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td style="width: 13%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $subj->subjcredit }}
                                        </td>
                                    </tr>
                                @endforeach
                            @endif
                ...
                <table style="width: 100%; margin: 0px; margin-top: 180px; page-break-before: always;"
                    ...
                    @if (count($records) > 0)
                        @foreach ($records as $key => $record)
                            <tr>
                                <td colspan="6" style="text-align: center; width: 100%;"><u
                                        style="text-transform: uppercase; font-weight: bold; font-size: 13px;">{{ $record->schoolname }}</u>
                                </td>
                            </tr>
                            <tr style="font-size: 12px;">
                                <td style="width: 14%; font-weight: bold;"><u>

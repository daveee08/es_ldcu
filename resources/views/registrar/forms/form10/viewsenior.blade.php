        ...
        {{-- <div class="col-sm-9">
            ...
            @elseif(strtolower(DB::table('schoolinfo')->first()->abbreviation) != 'hcb' && strtolower(DB::table('schoolinfo')->first()->abbreviation) != 'spct')
                <form action="/reports_schoolform10/getrecordssenior" target="_blank" method="get" class="m-0 p-0" style="display: inline;">
                    ...
                    <input type="hidden" value="{{$acadprogid}}" name="acadprogid"/>
                    <input type="hidden" value="pdf" name="exporttype"/>
                    <input type="hidden" value="depedspr" name="format"/>
                    <button type="submit" class="btn btn-outline-secondary btn-sm">
                        <i class="fa fa-file-pdf"></i>
                    Deped - SPR<div><small><em>Template 1</em></small></div>
                    </button>
                </form>
                ...
                <form action="/reports_schoolform10/getrecordssenior" target="_blank" method="get" class="m-0 p-0" style="display: inline;">
                    ...
                    <input type="hidden" value="{{$acadprogid}}" name="acadprogid"/>
                    <input type="hidden" value="pdf" name="exporttype"/>
                    <input type="hidden" value="deped-2" name="format"/>
                    <button type="submit" class="btn btn-outline-secondary btn-sm ">
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('click','.btn-exportform', function(){
                ...
                window.open('/reports_schoolform10/getrecordssenior?export='+formexport+'&format='+format+'&exporttype='+exporttype+'&studentid='+studentid+'&acadprogid='+acadprogid,'_blank')
            })
        })
    </script>
@endsection
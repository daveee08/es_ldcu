...
<div class="row mb-2">
    <div class="d-flex justify-content-between ml-3 mt-3">
        {{-- <button type="button" class="btn p-2 pr-1 pl-1 btn-success btn-download_sf10" data-exporttype="excel">Download
            SF
            10 Template</button> --}}
        ...
        <div class="form-inline" style="display: unset !important;">
            ...
            <div class="btn-group">
                ...
                <div class="dropdown-menu dropdown-menu-right" style="font-size: 14px;">
                    {{-- <button class="btn-exportform-jhs dropdown-item" data-exporttype="pdf" data-format="deped"
                        data-layout="1"><i class="fa fa-file-pdf"></i> &nbsp;Deped (Template 1)</button> --}}
                    <button class="btn-exportform-jhs dropdown-item" data-exporttype="pdf" data-format="deped"
                        data-layout="2"><i class="fa fa-file-pdf"></i> &nbsp;Deped (Template 1 - with school
                        logo)</button>
                    <button class="btn-exportform-jhs dropdown-item" data-exporttype="pdf" data-format="deped-2"
                        data-layout="1"><i class="fa fa-file-pdf"></i> &nbsp;Deped (Template 2 - with school
                        logo)</button>
                    @if ($acadprogid == 5)
                        <button class="btn-exportform-jhs dropdown-item" data-exporttype="pdf" data-format="depedspr"
                            data-layout="1"><i class="fa fa-file-pdf"></i> &nbsp;Deped - SPR (Template 3)</button>
                    @endif
                    <button class="btn-exportform-jhs dropdown-item"
                        @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sbc') data-exporttype="excel"@else data-exporttype="pdf" @endif
                ...
                <div class="tab-content">
                        ...
                        @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'xai')
                            <div class="row m-0 p-0">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm m-0" id="schoolname"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control form-control-sm m-0"
                                        value="{{ $eligibility->guardianaddress }}" id="input-guardianaddress" />
                                </div>
                                <div class="col-md-3">
                                    <small class="m-0">School Year Graduated:</small>
                                    <input type="text" class="form-control form-control-sm m-0"
                                        value="{{ $eligibility->sygraduated }}" id="input-sygraduated"
                                        placeholder="Ex. 2019-2020" />
                                </div>
                                <div class="col-md-7">
                                    <small class="m-0">Total No. of Years in school to complete Elementary
                                        Education:</small>
                                    <input type="text" class="form-control form-control-sm m-0"
                                        value="{{ $eligibility->totalnoofyears }}" id="input-totalnoofyears" />
                                </div>
                                <div class="col-2">
                                    <small class="m-0">General Average:</small><input id="generalaverage"
                                        type="number" class="form-control form-control-sm"
                                        value="{{ $eligibility->genave }}" />
                                </div>
                            </div>
                        @else
                            <div class="mb-3" style="font-size: 12px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        NAME EXTN. (Jr,I,II) <input type="text" class="form-control"
                                            id="namesuffix" value="{{ $studinfo->suffix }}" readonly />
                                    </div>
                                    <div class="col-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        Birthdate (mm/dd/yyyy): <input type="text" class="form-control"
                                            id="fname" value="{{ date('m/d/Y', strtotime($studinfo->dob)) }}"
                                            readonly />
                                    </div>
                                    <div class="col-2">
                            ...
                            <div class="row p-1" style="font-size: 12px; border: 1px solid black;">
                                <div class="col-4">
                                    <div class="form-group clearfix">
                                        <div class="icheck-primary d-inline">
                                            <input type="checkbox" id="checkbox-completer"
                                                value="{{ $eligibility->completer }}"
                                                @if ($eligibility->completer == 1) checked="" @endif>
                                ...
                                <div class="col-4">
                                    <label>General Average:</label> &nbsp; <input id="generalaverage" type="number"
                                        value="{{ $eligibility->genave }}" />
                                </div>
                                <div class="col-12">
                                    <label>Citation: (If Any)</label> &nbsp;
                                    <textarea class="form-control" id="citation">{{ $eligibility->citation }}</textarea>
                                </div>
                                <div class="col-12">&nbsp;</div>
                                <div class="col-4">
                                    Name of Elementary School: <input type="text" class="form-control"
                                        id="schoolname" value="{{ $eligibility->schoolname }}" />
                                </div>
                                <div class="col-4">
                            ...
                            <div class="row mb-3" style="font-size: 12px;">
                                ...
                                <div class="col-4">
                                    ...
                                    Rating: <input type="text" id="peptrating"
                            ...
                            <div class="row mt-2 mb-3" style="font-size: 12px;position: relative;">
                                <div class="col-3">
                                    Date of Examination/Assessment (mm/dd/yyyy):
                                </div>
                                <div class="col-3"><input type="date" id="examdate"
                                ...
                                <div class="col-3"><input type="text" id="centername"
                                        class="form-control form-control-sm"
                                        value="{{ $eligibility->centername }}" /></div>
                            </div>
                        @endif
                        <div class="row mt-1 mb-3">
                            <div class="col-12 text-right">
                                <button type="button" class="btn btn-sm btn-primary"
                                    id="btn-eligibility-update-jhs"><i class="fa fa-edit"></i> Update</button>
                            </div>
                        </div>
                        <div class="col-12 bg-gray text-center mb-2">
                        ...
                        <div class="tab-pane  {{-- @if ($key == 0) active @endif --}}" id="tab_{{ $key }}">
                                                    ...
                                                    @foreach ($defaultsubjects as $defaultsubject)
                                                        <tr class="eachsubject">
                                                            ...
                                                            <td><input type="hidden"
                                                                    ...
                                                                    placeholder="Subject"
                                                                    value="{{ $defaultsubject->subjdesc }}" /></td>
                                                            <td><input type="number"
                            ...
                            @else
                                @php
                                    ...
                                    $subjects = collect($gradelevel->subjects)
                                        ->where('sydesc', $eachrecord->sydesc)
                                        ->all();
                                @endphp
                                <div class="row">
                                    @if ($eachrecord->type == 1)
                                        <div class="col-md-6"><span class="badge badge-warning">Auto Generated: You
                                                cannot revise this record</span>
                                        ...
                                        @if ($eachrecord->type == 2)
                                            <div class="col-md-6 text-right">
                                                <span class="badge badge-warning badge-clear-record"
                                                    style="cursor: pointer;" data-id="{{ $eachrecord->id }}">Clear
                                                    This Record</span>
                                            </div>
                                        @endif
                                    @endif
                                                    ...
                                                    <tbody class="gradescontainer">
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    @else
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ $grade->finalrating > 0 ? $grade->finalrating : '' }}" />
                                                                    @endif
                                                                </td>
                                                                <td class="text-center">
                                                                    @if ($eachrecord->type == 1)
                                                        ...
                                                        @if (count($eachrecord->generalaverage) > 0)
                                                            <tr>
                                                                <td>
                                                                    @if ($eachrecord->type == 1)
                                                                        {{ ucwords(strtolower(collect($eachrecord->generalaverage)->first()->subjdesc)) ?? 'General Average' }}
                                                                    @else
                                                                        <input type="text"
                                                                            class="form-control form-control-sm p-0 input-norecord input-subjdesc"
                                                                            value="{{ collect($eachrecord->generalaverage)->first()->subjdesc ?? 'General Average' }}" />
                                                                    @endif
                                                                </td>
                                                                <td class="text-center">
                                                                    @if ($eachrecord->type == 1)
                                ...
                                {{-- @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) != 'sjaes')
                                @php
                                    $thislevelsign = collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->where('sydesc', $eachrecord->sydesc)->first();
                                @endphp

                                <form action="/reports_schoolform10v3/updatesigneachsem" method="POST" class="form-eachlevel" data-levelid="{{$gradelevel->id}}" data-sydesc="{{$eachrecord->sydesc}}">
                                    @csrf
                                    <div class="row eachsem-other-container">
                                        <div class="col-md-12">
                                            <label>Remarks</label>
                                            <textarea class="form-control" name="remarks">@if ($thislevelsign){{$thislevelsign->remarks ?? ''}}@endif</textarea>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control form-control-sm input-certncorrectname text-center" name="certncorrectname" @if (isset($eachrecord))value="{{(collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->count() > 0 ? collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->first()->certncorrectname : '') ?? ''}}"@endif/>
                                            <input type="text" class="form-control form-control-sm input-certncorrectdesc text-center" name="certncorrectdesc" @if (isset($eachrecord))value="{{(collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->count() > 0 ? collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->first()->certncorrectdesc : "SHS-School Record's In-Charge") ?? "SHS-School Record's In-Charge"}}"@else value="SHS-School Record's In-Charge" @endif/>
                                        </div>
                                        <div class="col-md-4 text-right">
                                            <small><label>Date Checked (MM/DD/YYYY)</label></small>
                                            <input type="date" class="form-control form-control-sm input-datechecked" name="datechecked" @if (isset($eachrecord))value="{{(collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->count() > 0 ? collect($eachlevelsignatories)->where('levelid', $gradelevel->id)->first()->datechecked : '') ?? ''}}"@endif/>
                    ...
                    <div class="tab-pane" id="tab_certification">
                        @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'hcb' ||
                            ...
                            <div class="row mb-2">
                                <div class="col-md-4">
                                    <label>Copy sent to / Copy for:</label>
                        ...
                        @elseif(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sihs' ||
                                strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sjaes')
                        ...
                        @else
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6">
                                    <label>Records In-charge/Records Assistant </label>
                                    <input type="text" class="form-control" id="recordsincharge"
                                        value="{{ $footer->recordsincharge }}" placeholder="Records In-charge" />
                                </div>
                                <div class="col-md-6">
...
<script>
    ...
    $('#btn-eligibility-update-jhs').on('click', function() {
    ...
    $('.btn-saverecord').on('click', function() {
        ...
        var thiscardbody = $(this).closest('.tab-pane');
        ...
        // else{
        var remarks = thiscardbody.find('.input-semremarks').val();
    ...
    $('.btn-remedial-addrow').on('click', function() {
        ...
        $(this).closest('table').find('#remedial-tbody').append(
            ...
            levelid + `-` + counter + `" data-studid="` + studentid + `" data-sydesc="` + sydesc +
        ...
        $('#btn-edit-addremedial' + levelid + '-' + counter).on('click', function() {
            ...
            var addsubject = $(this).closest('tr').find('input[name="add-new-subject"]').val()
            var addfinalrating = $(this).closest('tr').find('input[name="add-new-finalrating"]').val()
            var addclassmark = $(this).closest('tr').find('input[name="add-new-classmark"]').val()
            var addrecomputed = $(this).closest('tr').find('input[name="add-new-recomputed"]').val()
            var addremarks = $(this).closest('tr').find('input[name="add-new-remarks"]').val()
            ...
            if (addfinalrating.replace(/^\s+|\s+$/g, "").length == 0) {
                validationcheck += 1;
                $(this).closest('tr').find('input[name="add-new-finalrating"]').css('border',
                    '1px solid red');
            } else {
    ...
    $('.btn-edit-editremedial').on('click', function() {
        ...
        var editfinalrating = $(this).closest('tr').find('#finalrating' + $(this).attr('data-id')).val()
        var editclassmark = $(this).closest('tr').find('#remclassmark' + $(this).attr('data-id')).val()
        var editrecomputed = $(this).closest('tr').find('#recomputedfinal' + $(this).attr('data-id')).val()
        var editremarks = $(this).closest('tr').find('#remarks' + $(this).attr('data-id')).val()

        var validationcheck = 0;
        if (editsubject.replace(/^\s+|\s+$/g, "").length == 0) {
            validationcheck += 1;
            $(this).closest('tr').find('#subject' + $(this).attr('data-id')).css('border', '1px solid red');
        } else {
        ...
        if (editfinalrating.replace(/^\s+|\s+$/g, "").length == 0) {
            validationcheck += 1;
            $(this).closest('tr').find('#finalrating' + $(this).attr('data-id')).css('border', '1px solid red');
        } else {
        ...
        if (editclassmark.replace(/^\s+|\s+$/g, "").length == 0) {
            ...
            $(this).closest('tr').find('#remclassmark' + $(this).attr('data-id')).removeAttr('style')
        }
        if (editrecomputed.replace(/^\s+|\s+$/g, "").length == 0) {
            ...
            $(this).closest('tr').find('#recomputedfinal' + $(this).attr('data-id')).removeAttr('style')
        }
        if (editremarks.replace(/^\s+|\s+$/g, "").length == 0) {
            validationcheck += 1;
            $(this).closest('tr').find('#remarks' + $(this).attr('data-id')).css('border', '1px solid red');
        } else {
    ...
    $('.btn-exportform-jhs').on('click', function() {
        ...
        window.open('/schoolform10/getrecordsjunior?export=' + formexport + '&format=' + format +
            '&exporttype=' + exporttype + '&studentid=' + studentid + '&acadprogid=' + acadprogid +
            '&layout=' + layout + '&papersize=' + papersize, '_blank')
    })

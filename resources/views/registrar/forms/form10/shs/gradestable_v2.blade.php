        ...
        <div class="card">
            <div class="card-header d-flex p-0">
                <ul class="nav nav-pills ml-auto p-2">
                    ...
                    <li class="nav-item"><a class="nav-link @if($key == 0) active @endif" href="#tab_{{$key}}-1" data-toggle="tab">{{$gradelevel->levelname}} - 1st Sem</a></li>
                    <li class="nav-item"><a class="nav-link" href="#tab_{{$key}}-2" data-toggle="tab">{{$gradelevel->levelname}} - 2nd Sem</a></li>
                    @endforeach
                </ul>
            </div>
            <div class="card-body">
                <div class="tab-content">
                    @foreach ($gradelevels as $key=>$gradelevel)
                        ...
                        <div class="tab-pane  @if($key == 0) active @endif" id="tab_{{$key}}-1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            @php
                                                ...
                                                $defaultsubjects = collect($gradelevel->subjects)->where('levelid', $gradelevel->id)->where('semid', 1)->unique('subjcode');
                                            @endphp
                        ...
                        <div class="tab-pane" id="tab_{{$key}}-2">   
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                @php
                                                    ...
                                                    $defaultsubjects = collect($gradelevel->subjects)->where('levelid', $gradelevel->id)->where('semid', 2)->unique('subjcode');
                                                @endphp
                                                <table class="table table-striped" style="font-size: 11px; table-layout: fixed;">
                                                    <thead class="text-center">
                                                        <tr>
                                    ...
                                    @else
                                        @php
                                            ...
                                            $grades = collect($records)->where('levelid', $gradelevel->id)->where('semid','2')->first()->grades;
                                            $grades = collect($grades)->where('semid','2');
                                        @endphp
                                        <div class="row">
                                            @if($eachrecord->type == 1)
                                                <div class="col-md-12"><span class="badge badge-warning">Auto Generated</span></div>

...
<head>
    <title>SHS - Student Permanent Record</title>
    <style>
        * {
...
<body>
    @php
        ...
        $numofrecords = 0;
    @endphp
    <table style="width: 100%;  top: -0.2cm; position: absolute;">
        <tr>
            ...
            <td width="20%" style="text-align:left !important;" rowspan="5"><span
                    style="float: right; font-weight: bold; font-size: 12px;">SF10-SHS</span><img
                    src="{{ base_path() }}/public/assets/images/deped_logo.png" alt="school" width="90px"></td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="text-align:center; font-size: 15px; font-weight: bold; text-transform: uppercase;">SENIOR HIGH
                SCHOOL STUDENT PERMANENT RECORD</td>
        </tr>
    ...
    <div style="width: 100%; line-height: 1px; margin-top: 65px;">&nbsp;</div>
    ...
    <table class="table table-sm table-bordered" width="100%"
        style="font-size: 11px !important; margin-top:.5rem !important;">
        <tr>
            <td class="text-center" style="font-weight: bold; background-color: #bfbfbf;"> ELIGIBILITY FOR SHS ENROLMENT
            </td>
        </tr>
    </table>
    <table class="table table-sm table-bordered" width="100%"
    ...
    {{-- {{$eligibility->peptpasser}} --}}
    <table class="table table-sm table-bordered" width="100%"
        style="font-size: 10px !important; margin-top:.2rem !important">
        <tr>
    ...
    @foreach ($gradelevels as $eachlevelkey => $eachgradelevel)
        ...
        @foreach ($eachgradelevel->records as $eachrecordkey => $eachrecord)
            ...
            <div style="width: 100%; page-break-inside: avoid;">
                <table style="width: 100%; font-size: 9.5px;">
                    <tr>
                        ...
                        <td style="width: 38%; border-bottom: 1px solid black;">{{ $eachrecord->schoolname }}</td>
                        <td style="width: 7%;">School ID:</td>
                        <td style="width: 7%; border-bottom: 1px solid black;">{{ $eachrecord->schoolid }}</td>
                        ...
                        <td style="width: 13%; border-bottom: 1px solid black;">{{ $eachrecord->sydesc }}</td>
                ...
                <table style="width: 100%; font-size: 9.5px;">
                    <tr>
                        ...
                        <td style="width: 60%; border-bottom: 1px solid black;">{{ $eachrecord->trackname }} /
                            {{ $eachrecord->strandname }}</td>
                        <td style="width: 7%;">SECTION:</td>
                        <td style="width: 23%; border-bottom: 1px solid black;">{{ $eachrecord->sectionname }}</td>
                    </tr>
                </table>
                ...
                <table style="width: 100%; table-layout: fixed; font-size: 10px;">
                    <thead
                        ...
                        <tr>
                            <th rowspan="2" style="width: 10%; border: solid 1px black;background-color: #bfbfbf;">
                                INDICATE IF SUBJECT IS CORE, APPLIED, OR SPECIALIZED</th> //grade 11 1st sem
                            <th rowspan="2" style="width: 40%; border: solid 1px black;background-color: #bfbfbf;">
                                SUBJECTS</th>
                            <th colspan="2" style="width: 10%; border: solid 1px black;background-color: #bfbfbf;">
                                Quarter</th>
                            <th rowspan="2" style="width: 10%; border: solid 1px black;background-color: #bfbfbf;">
                                SEM FINAL<br />GRADE</th>
                            <th rowspan="2" style="width: 10%; border: solid 1px black;background-color: #bfbfbf;">
                                ACTION<br />TAKEN</th>
                        </tr>
                        <tr>
                        ...
                        @if (collect($eachrecord->grades)->where('semid', $eachrecord->semid)->unique('subjdesc')->count() > 1)
                                    ...
                                    @if (strtolower($grade->subjdesc) != 'general average')
                                        <tr>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ $grade->subjcode }}</td>
                                            <td style="border: solid 1px black;">{{ lower_case($grade->subjdesc) }}
                                            </td>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ $grade->q1 > 0 ? $grade->q1 : '' }}</td>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ $grade->q2 > 0 ? $grade->q2 : '' }}</td>
                                            <td class="text-center" style="border: solid 1px black;">
                                ...
                                @else
                                    @if (strtolower($grade->subjdesc) != 'general average')
                                        <tr>
                                            ...
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ number_format($grade->q1) }}</td>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ number_format($grade->q2) }}</td>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ $grade->finalrating }}</td>
                                            <td class="text-center" style="border: solid 1px black;">
                                                {{ $grade->remarks }}</td>
                                        </tr>
                                    @endif
                            ...
                            @if ($eachrecord->type == 1)
                                ...
                                <tr style="font-weight: bold;">
                                    ...
                                    @endphp
                                    <td colspan="4"
                                        style="text-align: right; border: solid 1px black;background-color: #bfbfbf;">
                                        General Average</td>
                                    <td class="text-center" style="border: solid 1px black;">
                                        @if (count($genave) > 0)
                                    ...
                                    @else
                                        <td class="text-center" style="border: solid 1px black;">
                                            @if (count($genave) > 0)
                                                @if ($genave[0]->finalrating > 0)
                                                    {{ $genave[0]->finalrating >= 75 ? 'PASSED' : ($genave[0]->finalrating == 0 ? '' : 'FAILED') }}
                                                @endif
                                            @endif
                                        </td>
                                    @endif
                            ...
                            @elseif($eachrecord->type == 2)
                                ...
                                @endphp
                                <tr style="font-weight: bold;">
                                    <td colspan="4" style="text-align: right;background-color: #bfbfbf;">General
                                        Average</td>
            ...
            @else
                ...
                <table class="watermark" width="100%" style=" font-size: 10px;">
                    <tr>
                        <td width="10%">Page {{$eachlevelkey+1}}  {{count($records)}}</td>
                        <td width="80%">{{$studinfo->lastname}}, {{$studinfo->firstname}}</td>
                        <td width="10%" style="text-align: right;">SF10-SHS</td>
                    </tr>
                </table>
            ...
            <div style="width: 100%; line-height: 1px;">&nbsp;</div>
            <table
                style="width: 100%; table-layout: fixed; border: 2px solid black; font-size: 9px; text-transform: uppercase;"
                border="1">
                ...
                @if (collect($record[0]->grades)->where('semid', 1)->unique('subjdesc')->count() > 1)
                    ...
                    @if ($record[0]->type == 1)
                        ...
                        <tr style="font-weight: bold;">
                            ...
                            @else
                            <td class="text-center" style="border: solid 1px black;">@if (count($genave) > 0)@if ($genave[0]->finalrating > 0){{ $genave[0]->finalrating >= 75 ? 'PASSED' : ($genave[0]->finalrating == 0 ? '' : 'FAILED')  }}@endif @endif</td>
                            @endif
                        </tr>
        ...
        <table style="width: 100%; table-layout: fixed; font-size: 10px;">
            ...
            <table style="width: 100%; table-layout: fixed; border: 2px solid black; font-size: 10px; " border="1">
                <thead>
                    ...
                    <tr>
                        <th style="width: 8%;background-color: #bfbfbf;">3</th>
                        <th style="width: 8%;background-color: #bfbfbf;">4</th>
                    </tr>
                </thead>
                @php
                    $gen_ave_for_sem = 0;
...
@endif --}}
    <table style="text-align: none; text-transform:none; font-size: 10px; width: 100%;">
        <tr>
            ...
            <td style="border-bottom: 1px solid;width:45%; text-align: center;">
                {{ $numofrecords >= 4 ? $footer->strandaccomplished : '' }}
            </td>
                        ...
                        <td>
                            <div style="width: 90%;">
                                @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'dcc')
                                    <center>Registrar Consultant</center>
                                @else
    ...
    <br />
    <br />
    <div style="width: 100%; font-weight: bold; font-size: 11px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date
        Issued (MM/DD/YYYY):
        <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
    </div>
    @if (count($records) > 2)

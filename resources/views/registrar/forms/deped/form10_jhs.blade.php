...
<head>
    <title>JHS - School Form 10</title>
    <style>
        * {
        ...
        body {
            margin-top: 130px;
            /* margin-bottom: 160px; */
            /* Ensure content does not overlap with the header */
        }

        /* Table styling to ensure it fits well in the header */
        #table1 {
            width: 100%;
            border-collapse: collapse;
        }
...
<body>
    ...
    <header>
        <table id="table1">
            <tr>
                ...
                <td width="15%" style="text-align:right;" rowspan="4">
    ...
    <!--
    <footer>
        <table style="width: 100%; margin-top: 4px; border: 1px solid black;" border="1">
            <tr>
                <th style="text-align: center; background-color: #bfc48b; font-size: 12px;">CERTIFICATION</th>
            </tr>
            <tr>
                <td style="padding: 10px 2px 0px; font-size: 11px;">
...
I CERTIFY that this is a true record of <u>{{ $studinfo->lastname }},
                        ...
                        <u>&nbsp;&nbsp;&nbsp;
                            {{-- @if ($key == 0)
                                ...
                                @endif
                            @else
                                @if (isset($footer->admissiontograde))
                                    @if ($footer->admissiontograde != null && $footer->admissiontograde > 0)
                                        {{ $footer->admissiontograde ?? '' }}
                                    @else
                                        11
                                    @endif
                                @else
...
Name of School:
                            ...
                            <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $footer->lastsy ?? '' }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
@else
Name of School: <u>{{ $attended_lastschool ?? '' }}</u>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; School ID:
                            <u>{{ $attended_lastschoolid }}</u> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Last
                            School
                            Year Attended: <u>&nbsp;&nbsp;@if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sbc')
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    @else{{ $attended_lastschoolyear ?? '' }}
@endif&nbsp;&nbsp;</u>
@endif
@endif
                    <br />&nbsp;
...
-->
    ...
    {{-- <table style="width: 100%" id="table1">
        <tr>
            ...
            <td style="text-align:center; font-size: 11px;">Republic of the Philippines</td>
            <td width="15%" style="text-align:right;" rowspan="4"><img
        ...
        <tr>
            <td style="text-align:center; font-size: 15px; font-weight: bold;">Learner's Permanent Academic Record for
                Junior High School (SF10-JHS)</td>
        </tr>
        <tr style="line-height: 5px;font-size: 11px;">
            <td style="text-align:center; font-style: italic;">(Formerly Form 137)</td>
        </tr>
    ...
    <table style="width: 100%" id="table2">
        <tr>
            <td colspan="8"
                style="text-align: center; font-size: 13px; font-weight: bold; background-color: #bfc48b; border: 1px solid black;">
    ...
    <div style="width: 100%; border: 1px solid black; padding-top: 4px;">
        <table style="width: 100%; font-size: 11px;" id="table5">
            <tr style="font-style: italic;">
                <td><input type="checkbox" name="check-1"@if ($eligibility->completer == 1) checked @endif>Elementary
                    School Completer</td>
    ...
    <table style="width: 100%; font-size: 11px;" id="table7">
        ...
        <tr>
            <td style="width: 28%; "> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"
                    name="check-1"@if ($eligibility->peptpasser == 1) checked @endif>PEPT Passer
                &nbsp;&nbsp;&nbsp;&nbsp;Rating:<u>&nbsp;&nbsp;&nbsp;&nbsp;{{ $eligibility->peptrating }}&nbsp;&nbsp;&nbsp;&nbsp;</u>
            </td>
            <td style="width: 28%; "> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"
                    name="check-1"@if ($eligibility->alspasser == 1) checked @endif>ALS A & E Passer
                &nbsp;&nbsp;&nbsp;&nbsp;Rating:<u>&nbsp;&nbsp;&nbsp;&nbsp;{{ $eligibility->alsrating }}&nbsp;&nbsp;&nbsp;&nbsp;</u>
            </td>
    ...
    <table style="width: 100%; font-size: 11px;" id="table8">
        <tr>
            ...
            <td style="width: 28%; "> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;Name and Address of Testing
                Center:</td>
        ...
        @foreach ($records as $key => $record)
            ...
            {{-- @if ($key > 0)
                <table style="width: 100%; font-size: 9px; page-break-before: always;">
                    <tr>
                        <td>SF10-JHS</td>
                        <td style="text-align: right;">Page 2 of
                            <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>
                        </td>
                    </tr>
                </table>
            @endif --}}
            <table
                style="width: 100%; table-layout: fixed; border: 2px solid black; font-size: 11px; page-break-inside: avoid;"
                id="table10" border="1">
                <thead>
                    <tr>
                        <td colspan="7">
                            <table style="width: 100%; font-size: 9px;">
                                <tr>
                                    ...
                                    <td style="width: 15%; border-bottom: 1px solid black;">{{ $record[0]->schoolid }}
                                    </td>
                            ...
                            <table style="width: 100%; font-size: 9px;">
                                <tr>
                                    <td style="width: 12%;">Classified as Grade:</td>
                                    <td style="width: 5%; border-bottom: 1px solid black;">
                                        {{ preg_replace('/\D+/', '', $record[0]->levelname) }}</td>
                                    <td style="width: 5%;">Section:</td>
                                    <td style=" border-bottom: 1px solid black;">{{ $record[0]->sectionname }}</td>
                                    <td style="width: 7%;">SchoolYear:</td>
                                    <td style="width: 8%; border-bottom: 1px solid black;">{{ $record[0]->sydesc }}
                                    </td>
                                    <td style="width: 15%;">Name of Adviser/Teacher:</td>
                    ...
                    @foreach ($record[0]->grades as $grade)
                        @if ($record[0]->type == 2)
                            @if (strtolower($grade->subjtitle) != 'general average')
                                <tr
                                    @if ($key == 0) style="font-size: 10px;" @else style="font-size: 9px;" @endif>
                                    <td>
                                        @if ($grade->inMAPEH == 1)
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                            @endif @if (isset($grade->inTLE))
                                                @if ($grade->inTLE == 1)
                                                    &nbsp;&nbsp;&nbsp;
                                                @endif
                                                @endif @if (strtolower($grade->subjtitle) == 't.l.e' || strtolower($grade->subjtitle) == 'mapeh')
                                                    {{ strtoupper($grade->subjtitle) }}
                                                @else
                                                    {{ $grade->subjtitle }}
                                                @endif
                                    </td>
                ...
                @if ($record[0]->type == 1)
                    @if (DB::table('schoolinfo')->first()->schoolid == '405308')
                        ...
                        <tr style="font-weight: bold; font-size: 9px;">
                            ...
                            <td class="text-center">{{ collect($record[0]->generalaverage)->first()->finalrating }}
                            </td>
                            <td class="text-center">
                                @if (collect($record[0]->generalaverage)->first()->finalrating > 0)
                                    {{ collect($record[0]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED' }}
                                @endif
                            </td>
                        </tr>
                    @else
                        <tr style="font-weight: bold; font-size: 9px;">
                            ...
                            <td class="text-center">
                                @if (isset(collect($record[0]->generalaverage)->first()->finalrating))
                                    @if (collect($record[0]->generalaverage)->first()->finalrating > 0)
                                        {{ collect($record[0]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED' }}
                                    @endif
                                @endif
                            ...
                            <td class="text-center">{{ number_format(collect($record[0]->grades)->sum('finalrating')/count($record[0]->grades)) >= 75 ? 'PROMOTED' : 'FAILED'}}</td> --}}
                        </tr>
                    @endif
                                    ...
                                    @else
                                        <td class="text-center">
                                            @if ($grade->finalrating > 0)
                                                {{ $grade->finalrating >= 75 ? 'PROMOTED' : 'FAILED' }}
                                            @endif
                                        </td>
                                    @endif
                                </tr>
            ...
            @php
                if (collect($record[0]->grades)->count() > 0) {
                    if (collect($record[0]->generalaverage)->first()) {
                        if (collect($record[0]->generalaverage)->first()->finalrating >= 75) {
                            $firsttable = 1;
                        }
                    }
                }
            @endphp
            <div
                style="background-color: #bfc48b; height: 4px; border-right: 2px solid black; border-left: 2px solid black;">
            </div>
                    ...
                    @foreach (collect($record[0]->remedials)->where('type', '1')->values() as $remedial)
                        @if ($remedial->type == 2)
                            <tr>
                                ...
                                <td colspan="4">Conducted from
                                    (mm/dd/yyyy)
                                    &nbsp;&nbsp;{{ $remedial->datefrom != null ? date('m/d/Y', strtotime($remedial->datefrom)) : '' }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to
                                    (mm/dd/yyyy)&nbsp;&nbsp;{{ $remedial->dateto != null ? date('m/d/Y', strtotime($remedial->dateto)) : '' }}
                                </td>
                            </tr>
                        @endif
                    @endforeach
            ...
            @if (isset($record[1]))
                <table
                            ...
                            <td colspan="7">
                                ...
                                <table style="width: 100%; font-size: 9px;">
                                    <tr>
                                        ...
                                        <td style="width: 5%;">Section:</td>
                                        <td style=" border-bottom: 1px solid black;">{{ $record[1]->sectionname }}
                                        </td>
                                        <td style="width: 7%;">SchoolYear:</td>
                                        <td style="width: 8%; border-bottom: 1px solid black;">
                                            {{ $record[1]->sydesc }}</td>
                                        <td style="width: 15%;">Name of Adviser/Teacher:</td>
                                        <td style="border-bottom: 1px solid black;">{{ $record[1]->teachername }}
                                        </td>
                                        <td style="width: 7%;">Signature:</td>
                                        <td style="width: 10%; border-bottom: 1px solid black;"></td>
                                    </tr>
                    ...
                    @php
                        ...
                        if ($record[1]->promotionstatus == 1) {
                            ...
                            $secondpage_cert_level = $firstpage_cert_level;
                        }
                    @endphp
                    ...
                    @if ($record[1]->type == 1)
                        @if (DB::table('schoolinfo')->first()->schoolid == '405308')
                            ...
                            <tr style="font-weight: bold; font-size: 9px;">
                                ...
                                <td colspan="4" class="text-center"><em>General Average</em></td>
                                <td class="text-center">
                                    {{ number_format(collect($record[1]->generalaverage)->first()->finalrating) }}
                                </td>
                                <td class="text-center">
                                    @if (collect($record[1]->generalaverage)->first()->finalrating > 0)
                                        {{ collect($record[1]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED' }}
                                    @endif
                                </td>
                            </tr>
                        @else
                            <tr style="font-weight: bold;font-size: 9px;">
                                ...
                                <td class="text-center">
                                    @if (isset(collect($record[1]->generalaverage)->first()->finalrating))
                                        @if (collect($record[1]->generalaverage)->first()->finalrating > 0)
                                            {{ collect($record[1]->generalaverage)->first()->finalrating >= 75 ? 'PROMOTED' : 'FAILED' }}
                                        @endif
                                    @endif
                            ...
                            <td style="text-align: center;">{{number_format(collect($record[1]->grades)->where('subjtitle','!=','General Average')->sum('finalrating')/count($record[1]->grades)) > 74 ? 'PROMOTED' : 'FAILED'}}</td> --}}
                            </tr>
                        @endif
                ...
                <table style="width: 100%; table-layout: fixed; border: 2px solid black; font-size: 11px;"
                    border="1">
                    @if (collect($record[1]->remedials)->contains('type', '2'))
                        @foreach (collect($record[1]->remedials)->where('type', '2')->values() as $remedial)
                            @if ($remedial->type == 2)
                                <tr>
                                    <td style="width: 30%;">Remedial Classes</td>
                                    <td colspan="4">Conducted from
                                        ...
                                        &nbsp;&nbsp;{{ $remedial->datefrom != null ? date('m/d/Y', strtotime($remedial->datefrom)) : '' }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;to
                                        (mm/dd/yyyy)
                                        &nbsp;&nbsp;{{ $remedial->dateto != null ? date('m/d/Y', strtotime($remedial->dateto)) : '' }}
                                    </td>
                                </tr>
                            @endif
                        @endforeach
                    ...
                    @if (collect($record[1]->remedials)->contains('type', '1'))
                        @foreach (collect($record[1]->remedials)->where('type', '1')->values() as $remedial)
                            @if ($remedial->type == 1)
                                <tr>
                                    <td>{{ $remedial->subjectname }}</td>
                                    <td class="text-center">{{ $remedial->finalrating }}</td>
                ...
                @php
                    if (collect($record[1]->grades)->count() > 0) {
                        if (collect($record[1]->generalaverage)->first()) {
                            if (collect($record[1]->generalaverage)->first()->finalrating >= 75) {
                                $secondtable = 1;
                            }
                        }
                    }
            ...
            @if ($key == 1 && count($records) <= 2)
                            ...
                            <td colspan="7">
                                ...
                                <table style="width: 100%; font-size: 9px;">
                                    <tr>
                                        ...
                                        <td style="width: 7%;">SchoolYear:</td>
                                        <td style="width: 8%; border-bottom: 1px solid black;">&nbsp;</td>
                                        <td style="width: 15%;">Name of Adviser/Teacher:</td>
                                        <td style="border-bottom: 1px solid black;">&nbsp;</td>
                                        <td style="width: 7%;">Signature:</td>
                                        <td style="width: 10%; border-bottom: 1px solid black;"></td>
                ...
                <table style="width: 100%; table-layout: fixed; border: 2px solid black; font-size: 9px;"
                    border="1">
                    <tr>
                        <td style="width: 30%;">Remedial Classes</td>
                        <td colspan="4">Conducted from
                        ...
                        @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'mci')
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr style="font-size: 11px;">
                                    <td style="text-align: center;">Date</td>
                                    <td></td>
                                    <td style="text-align: center;">Name of School Registrar over Printed Name</td>
                                    <td></td>
                                    <td style="text-align: center;">(Affix School Seal Here)</td>
                                </tr>
                            </table>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td style="width: 30%; border-bottom: 1px solid black; text-align: center;">
                                        {{ date('M d, Y') }}</td>
                                    <td style="width: 5%;"></td>
                                    @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'bct' || strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'mci')
                                        <td style="border-bottom: 1px solid black; text-align: center;">
                                        </td>
                                    @else
                                        <td style="border-bottom: 1px solid black; text-align: center;">
                                            ...
                                            @if ($principalname)
                                                {{ $principalname->firstname }}
                                                {{ $principalname->middlename != null ? $principalname->middlename[0] . '.' : '' }}
                                                {{ $principalname->lastname }} {{ $principalname->suffix }}
                                            @endif
                                        </td>
                                    @endif
                                    <td style="width: 10%;"></td>
                                ...
                                <tr style="font-size: 11px;">
                                    ...
                                    <td></td>
                                    @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'bct' || strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'mci')
                                        <td style="text-align: center;">Name of School Registrar over Printed Name
                                        </td>
                                    @else
                                        <td style="text-align: center;">Signature of Principal/School Head over
                                            Printed
                                            Name</td>
                                    @endif
                                    <td></td>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            @if (strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'bct' ||
                                    strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'mci')
                                <td style="border-bottom: 1px solid black; text-align: center;">
                                </td>
                            @else
                                <td style="border-bottom: 1px solid black; text-align: center;">

<div class="card shadow" style="border: none !important; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
    <div class="card-header">
        <div class="row">
            <div class="col-md-4">
                <input type="text" id="input-search" placeholder="Search" class="form-control form-control-sm">
            </div>
            <div class="col-md-8 text-right">
                @if(count($allschedules)>0)
                <button type="button" class="btn btn-sm btn-outline-success" id="btn-export-allpdf"> <i class="fa fa-file-pdf"></i> &nbsp;Export All to&nbsp; PDF</button>
                <button type="button" class="btn btn-sm btn-default" id="btn-export-pdf"> <i class="fa fa-file-pdf"></i> &nbsp;Export list to&nbsp; PDF</button>
                <button type="button" class="btn btn-sm btn-default" id="btn-export-excel"> <i class="fa fa-file-excel"></i> &nbsp;Export list to&nbsp; Excel</button>
                @endif
            </div>
        </div>
    </div>

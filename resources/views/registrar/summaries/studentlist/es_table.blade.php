<div class="row mb-2">
    <div class="col-md-3 text-left">
        ...
        <button type="button" class="btn btn-default btn-sm" id="btn-export-excel"><i class="fa fa-file-excel"></i> Export Excel</button>
            @if($department == '6')
                ...
                @foreach($students as $key => $eachstudent)
                    ...
                    $totaleachstudent = $eachstudent;
                        ...
                        //}
                            ...
                            $totaleachstudent = collect($totaleachstudent)->sortBy('sortid')->values()->all();
...
<script>
    @if(count($students) == 0)
                            toastr.warning('No enrolled students!')
    @endif
</script>
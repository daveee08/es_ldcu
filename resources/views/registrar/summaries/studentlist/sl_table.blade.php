<div class="row mb-2">
    <div class="col-md-12 text-left">
        <button type="button" class="btn btn-default" id="btn-export-sl">
            <i class="fa fa-file-pdf"></i> Export to PDF
        </button>
        @include('components.xmljsonexport')
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td colspan="2" style="border-top: 1px solid black; border-bottom: 1px solid black;">GRAND TOTAL
                        : {{ $gtotal }}</td>
                    <td></td>
                    <td></td>
                </tr>

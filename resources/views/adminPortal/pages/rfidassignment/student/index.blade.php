...
@section('content')
      <section class="content-header">
            <div class="container-fluid">
                  <div class="row">
                        <div class="col-sm-6">
                            <h1>Student RFID Assignment</h1>
                        </div>
                        <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                              <li class="breadcrumb-item"><a href="/home">Home</a></li>
                              <li class="breadcrumb-item active">Student RFID Assignment</li>
                        </ol>
                        </div>
                  </div>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control select2" id="filter_studentstatus">
          ...
          <div class="modal-dialog modal-md" role="document">
              <div class="modal-content">
                  <div class="modal-header">
                       <h5 class="modal-title">Image Upload</h5><span id="stud_info" class="pl-1 pt-1"></span>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                         </button>
                     </div>
                <div class="modal-body">
                    ...
                    <br>
                    <br>
                    <button class="btn btn-success " id="upload-result">Upload Image</button>
                     </div>
                </div>
             </div>
        </div>
...
@section('footerjavascript')
    ...
    <script>
            ...
            $(document).on('click','.view_image',function(){
                ...
                var temp_data = allstudent.filter(x=>x.id == temp_id)
            ...
            $(document).on('click','.btn-app-1',function(){
                ...
                var tempstud = allstudent.filter(x=>x.id == tempid)
                ...
                if(tempstud[0].history.length > 0){
                    ...
                    $('#rfidhis_body').append('<tr><td colspan="4">No Records Found</td></tr>')
                }
            ...
            function getstudents(){
                ...
                $('#example2').DataTable({
                    ...
                    stateSave: true,
                    ajax:{
                        url: '/adminstudentrfidassign/index',
                        type: 'GET',
                        data: {
                            action : 'getstudents',
                                    ...
                                    '<div class="col-md-3">'+
                                        ...
                                        '<div class="col-md-9">'+
                                            '<div class="row">'+
                                                ...
                                                '<div class="col-md-12">'+ '<span class="text-primary">'+rowData.sid+'</span></div>   ' +
                                            '</div>'+
            ...
            $(document).on('click','.edit-pic-icon', function(){
                ...
                var tempinfo = allstudent.filter(x=>x.id == studid)
                $('#stud_info').text(' ( '+tempinfo[0].lastname+', '+tempinfo[0].firstname+' )')
        ...
        function process_input(data,renew=null){
            ...
            if(data.val().replace(/^\s+|\s+$/g, "").length == 0){
                    ...
                    $.ajax({
                        url: '/adminstudentrfidassign/update',
                        type: 'GET',
                        dataType: 'json',
                        data: {
                            studentid   : studentid,
        ...
        $(document).on('click','.btn-reset', function(){
            ...
            Swal.fire({
                title: 'Are you sure you want to reset student\'s RFID?',
                html:
                ...
                if (result.value) {
                    $.ajax({
                        url: '/adminstudentrfidassign/reset',
                        type:"GET",
                        dataType:"json",
                        data:{
                            studentid: studentid
                        ...
                        complete: function(){
                            ...
                            $('input[data-id='+studentid+']').val('')
                            $('input[data-id='+studentid+']').removeAttr('readonly')
                            getstudents()
                        }
                    })
                }

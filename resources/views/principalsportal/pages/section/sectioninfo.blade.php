...
@section('modalSection')
    @php
        ...
        $gradelevel = [];
        $vacantTeachers = \App\Models\Principal\SPP_Teacher::filterTeacherFaculty(
            null,
            null,
            null,
            null,
        ...
        $schedtimetemplate = DB::table('schedtimetemplate')
            ->where('deleted', 0)
                ...
                <div class="modal-body pt-0">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label>Subject</label>
                            <select data-placeholder="Select a Subject" name="input_subject" id="input_subject"
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <select data-placeholder="Select a teacher" name="secttea" id="secttea"
                                class="form-control select2">
                                <option value="">Select Teacher</option>
                                @foreach (\App\Models\Principal\SPP_Teacher::filterTeacherFaculty(null, null, null, null, null, $sectionInfo->acadprogid, 'all', '1', ['1', '18'])[0]->data as $item)
                                    {{-- @if ($item->usertypeid == 1)
                                    @endif --}}
                                    <option value="{{ $item->id }}">{{ $item->tid }} -
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control  form-control-sm reservationtime" name="time"
                                id="time">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group  col-md-12">
                            <label>Room</label>
                            <select data-placeholder="Select a Room"
                                class="form-control select2 @error('r') is-invalid @enderror" name="sectroo" id="sectroo"
                                style="width: 100%;">
                                @php
                                ...
                                @foreach ($vacantRooms[0]->data as $room)
                                    <option value="{{ $room->id }}"
                                        {{ $room->id == $sectionInfo->roomid ? 'selected' : '' }}>{{ $room->roomname }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="">Schedule Classification <a href="javascript:void(0)"
                                    class="edit_schedclass pl-2" hidden><i class="far fa-edit"></i></a>
                                <a href="javascript:void(0)" class="delete_schedclass pl-2" hidden><i
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-primary" id="create_schedclass_button">Create Schedule
                                Classification</button>
                            <button class="btn btn-success btn-primary" id="update_schedclass_button" hidden>Update
                                Schedule Classification</button>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label for="">Time Template <a href="javascript:void(0)" class="edit_timetemp pl-2"
                                    hidden><i class="far fa-edit"></i></a>
                                <a href="javascript:void(0)" class="delete_timetemp pl-2" hidden><i
                                        class="far fa-trash-alt text-danger"></i></a></label>
    ...
    <div class="modal fade" id="timetemp_form_modal" style="display: none;" aria-hidden="true" data-backdrop="static"
        data-keyboard="false">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header pb-2 pt-2 border-0">
                ...
                <div class="modal-body pt-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-primary" id="create_timetemp_button"
                                style="font-size:.8rem !important">Create Time</button>
                            <button class="btn btn-success btn-primary" id="update_timetemp_button" hidden
                                style="font-size:.8rem !important">Update Time</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="timetempdeatil_form_modal" style="display: none;" aria-hidden="true"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="">Time</label>
                            <input type="text" class="form-control  form-control-sm" name="timetempdetail_input"
                                id="timetempdetail_input">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <button class="btn btn-sm btn-primary" id="create_timetempdetail_button"
                                style="font-size:.8rem !important">Create Time Template</button>
                            <button class="btn btn-success btn-primary" id="update_timetempdetail_button" hidden
                                style="font-size:.8rem !important">Update Time Tempate</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row  mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">{{ $sectionInfo->levelname }} -
                            {{ $sectionInfo->sectionname }}</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-2 filter_semester_holder " hidden>
                                ...
                                <select class="form-control form-control-sm select2" id="filter_semester">
                                    @foreach ($semester as $item)
                                        <option value="{{ $item->id }}"
                                            {{ $item->isactive == 1 ? 'selected="selected"' : '' }}>{{ $item->semester }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="card-body p-1">
                        ...
                        <div class="row" id="sched_format2" hidden>
                            <div class="col-md-12">
                                <div class="row mt-2">
                                    <div class="col-md-5">
                                        <button class="btn btn-sm btn-primary add_sched" data-type="regular">Add
                                            Schedule</button>
                                        <button hidden class="btn btn-sm btn-primary add_sched_specsubj"
                                            data-type="special">Special Subject</button>
                                    </div>
                                    {{-- <div class="col-md-3"></div> --}}
                                    <div class="col-md-3">
                                        <button class="btn btn-sm btn-primary btn-block" id="time_templatelist">Time
                                            Template List</button>
                                    </div>
                                    <div class="col-md-4">
                                        <select class="form-control form-control-sm teacher select2"
                                            id="filter_timetemplate">
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <p class="mb-0 text-sm"><i>Click the subject name to edit or delete schedule.</i>
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 table-responsive tableFixHead" style="height: 323px;">
                                        <table class="table-sm table-bordered table table-head-fixed mb-0"
                                            id="sched_holder" style="font-size:.7rem !important">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3 card h-100 shadow">
                            ...
                            <div class="card-footer">
                                <span class="float-right">Number of Students: <span class="h4 text-success"
                                        id="student_count"></span></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8">
                                    ...
                                    <thead class="bg-warning">
                                        <tr>
                                            <th rowspan="2" width="25%"
                                                class="text-center align-middle h6 bg-warning">SUBJECTS</th>
                                            <th colspan="4" width="75%"
                                                class="text-center align-middle h6 p-1 bg-warning">PERIODIC RATINGS</th>
                                        </tr>
                                        <tr class="text-center">
                                            <th width="15%" class="text-center align-middle h6 p-1 isHPS bg-warning">1
                                            </th>
                                            <th width="15%" class="text-center align-middle h6 p-1 isHPS bg-warning">2
                                            </th>
                                            <th width="15%" class="text-center align-middle h6 p-1 isHPS bg-warning">3
                                            </th>
                                            <th width="15%" class="text-center align-middle h6 p-1 isHPS bg-warning">4
                                            </th>
                                        </tr>
                                    </thead>
            ...
            <div class="col-md-3">
                <div class="card card-primary h-100 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <p class="small pl-4 mb-0" style="color: #af8402" id="label_sectionname">
                            {{ $sectionInfo->sectionname }}</p>
                        @if ($sectionInfo->session == 1)
                            <p class="small pl-4 mb-0"><span class="badge badge-secondary">Morning Sessio</span></p>
                        @elseif($sectionInfo->session == 2)
                            <p class="small pl-4 mb-0"> <span class="badge badge-secondary">Afternoon Session</span></p>
                        @elseif($sectionInfo->session == 3)
                            <p class="small pl-4 mb-0"><span class="badge badge-secondary">Night Session</span></p>
                        @else
                            <p class="small pl-4 mb-0"><span class="badge badge-secondary">Whole Day</span></p>
                        @endif
                        @if ($sectionInfo->sd_issp)
                            <p class="small pl-4">
                                <span class="badge badge-primary">Special Section</span>
                            </p>
                        @elseif($sectionInfo->sd_ismwsp)
                            <p class="small pl-4">
                                <span class="badge badge-primary">MWSP</span>
                            </p>
                        @endif
                        <hr>
                        <strong><i class="fas fa-layer-group mr-1"></i>Grade Level</strong>
                        <p class="small pl-4" style="color: #af8402" id="label_levelname">{{ $sectionInfo->levelname }}
                        </p>
                        ...
                        <hr>
                        <strong><i class="fas fa-door-open mr-1"></i>Room</strong>
                        <p class="small pl-4" style="color: #af8402" id="label_roomname">
                            {{ $sectionInfo->roomname != null ? $sectionInfo->roomname : 'No Room Assigned' }}</p>
                        <hr>
                        <strong><i class="fas fa-users mr-1"></i>Students</strong>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Enrolled</label> : <span id="s-1"
                                class="badge badge-success">0</span>
                        </p>
                        <p class="pl-4 mb-0">
                            <label class="small mb-0">Late Enrolled</label> : <span id="s-2"
                                class="badge badge-primary">0</span>
                        </p>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Transferred In</label> : <span id="s-4"
                                class="badge badge-warning">0</span>
                        </p>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Dropped Out</label> : <span id="s-3"
                                class="badge badge-danger">0</span>
                        </p>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Transferred Out</label> <span id="s-5"
                                class="badge badge-secondary">0</span>
                        </p>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Withdrawn</label> <span id="s-6" class="badge bg-orange"
                                style="color:white !important">0</span>
                        </p>
                        <p class=" pl-4 mb-0">
                            <label class="small mb-0">Not Enrolled</label> <span id="s-0"
                        ...
                        @else
                            <hr>
                        @endif
                        <button type="button" class="btn btn-sm btn-outline-primary btn-block" id="print_sched"><i
                                class="fa fa-print mr-1"></i>Print Section Schedule</button>
                        {{-- <span>
                        ...
                        @if ($sectionInfo->acadprogid == 2)
                            ...
                            <span>
                                <button type="button" class="btn btn-sm btn-outline-primary btn-block"
                                    id="grade_status"><i class="far fa-edit mr-1"></i>View
                                    {{ $sectionInfo->sectionname }} Grade Status</button>
                            </span>
                        @endif
                    </div>
                </div>
        ...
        @section('footerjavascript')
            ...
            <script>
                ...
                function timetempdetail_datatable() {
                    $("#timetempdetail_datatable").DataTable({
                        ...
                        columnDefs: [{
                                ...
                                'createdCell': function(td, cellData, rowData, row, col) {
                                    var buttons =
                                        '<a href="javascript:void(0)" class="edit_timetempdetail" data-id="' +
                            ...
                            },
                            {
                                ...
                                'createdCell': function(td, cellData, rowData, row, col) {
                                    ...
                                    var buttons = '<a href="javascript:void(0)" ' + disabled +
                                        ' class="delete_timetempdetail" data-id="' + rowData.id +
                    ...
                    $(label_text)[0].innerHTML =
                        '<button class="btn btn-sm btn-primary" id="create_timetempdetail_modal_button">Create Time</button>'
            ...
            <script>
                ...
                function display_option() {
                    ...
                    $('#input_timetemplate').append(
                        '<option value="create"><i class="fas fa-plus"></i>Create Time Template</option>')
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (temp_daylist.length != 0) {
                                var text =
                                    '<thead><tr><th width="12%" style="background-color:CornflowerBlue; color:white" class="text-center"></th>';
                                $.each(temp_daylist, function(a, b) {
                                    text += '<th width="' + temp_width +
                                        '%"  class="text-center align-middle" style="background-color:CornflowerBlue; color:white">' +
                                        b + '</th>'
                                })
                                text += '</tr></thead><tbody>'
                                ...
                                $.each(temp_timelist, function(a, b) {
                                    ...
                                    var text = '<tr><td class="text-center align-middle">' + timeinfo.stime +
                                        '<br>' + timeinfo.etime +
                                        '<p class="mb-0"><a href="javascript:void(0)" class="add_sched " data-stime="' +
                                        timeinfo.stime + '" data-etime="' + timeinfo.etime +
                                        '">Add Schedule</a></p>' + '</td>';
                                    $.each(temp_daylist, function(c, d) {

                                        var day_sched = temp_sched.filter(x => x.description == d && x
                                            .time == b)
                                        var temp_bg = '';
                                        ...
                                        $.each(day_sched, function(e, f) {
                                            text +=
                                                '<p  class="mb-0"><b><a href="javascript:void(0)" class="edit_sched" data-id="' +
                                                f.detailid + '">' + f.subjdesc + '</a></b></p>'
                                            text +=
                                                '<p style="font-size:.6rem !important" class="mb-0">' +
                                                f.sectionname + '</p>'
                                            text +=
                                                '<p style="font-size:.6rem !important;"  class="mb-0"><i>' +
                                                f.teacher + '</i></p>'
                                            text +=
                                                ' <p style="font-size:.6rem !important; color:red" class="mb-1">' +
                                                f.classification + '</p>'
                                        })
                                ...
                                if (data[0].status == 2) {
                                    ...
                                    if (syid == active_sy[0].id) {
                                        if (teacherinfo.length > 0) {
                                            ...
                                            $('#adviser_holder').text(teacherinfo[0].firstname + ' ' +
                                                teacherinfo[0].lastname)
                                        }
                                    }
            ...
            <script>
                ...
                $.each(all_rooms, function(a, b) {
                    b.text = b.roomname
                })
                $.each(all_session, function(a, b) {
                    b.text = b.sessionDesc
                })
                $.each(gradelevel, function(a, b) {
                    b.text = b.levelname
                })
                $.each(all_teacher, function(a, b) {
                    b.text = b.tid + ' - ' + b.lastname + ', ' + b.firstname
                })
                    ...
                    if (data.length == 0) {
                        ...
                        $.each(data, function(a, b) {
                            ...
                            text += '<tr><td class="small">' +
                                ...
                                '<p class="text-muted mb-0" style="font-size:.7rem">' + b.sid + ' ' + strand + ' ' + desc +
                                '</p>'
                            '</td></tr>'
                        })
                ...
                function load_students(params) {
                    ...
                    $.ajax({
                        ...
                        error: function() {
                            var text =
                                '<tr><td>Something went wrong! <br><a href="#" id="reload_student">Click here</a> to reload students.</td></tr>'
                            $('#student_holder')[0].innerHTML = text
                        }
                ...
                function load_strand() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.length == 0) {
                                $('#scheduletable')[0].innerHTML =
                                    '<tr><td colspan="6">No strand added. Please add strand to section.<a href="javascript:void(0)" class="add_block">Click here</a> to add strand</td></tr>'
                            } else {
                                all_strand = data;
                                $.each(data, function(a, b) {
                                    $('#filter_strand').append('<option value="' + b.strandid + '">' + b
                                        .strandcode + '</option>')
                                    $('#block_list').append(
                                        '<p class="small mb-0 pl-4" style="color: #af8402">  <span class="text-success">[ ' +
                                        b.strandcode + ' ]</span>  ' + b.blockname + '</p>')
                                    $('#student_strandholder').append(' <p class="small pl-4 mb-0">' + b
                                        .strandcode + ' : <span  id="ste-' + b.strandid + '">0</span></p>')
                                })
                                load_students()
                                loadSched_ajax()
                                loadsubjectstatus()
                ...
                function loadSched() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (utype == 1) {
                                $('button[id="add_sched"]').remove();
                                $('button[id="dropdownMenuButton"]').remove();
                                $('.add_sched').remove();
                                $('#time_templatelist').remove();
                            }
                            // sortDays($("#sorted-day"))
                            // sortDays($("#sorted-day2"))
                        },
                    })
                }

                // function sortDays(elem) {
                //     // Wrap the passed element in a jQuery object
                //     let dayElement = $(elem);

                //     // Get the text content of the element
                //     let dayString = dayElement.text().trim(); // Ensure to remove any leading/trailing spaces
                //     let daysArray = dayString.split(" / ");
                //     console.log(daysArray);

                //     const dayOrder = ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"];

                //     // Sort the days based on the custom dayOrder
                //     daysArray.sort(function(a, b) {
                //         return dayOrder.indexOf(a) - dayOrder.indexOf(b);
                //     });

                //     let sortedDayString = daysArray.join(" / ");

                //     console.log(sortedDayString);

                //     // Update the text content with the sorted string
                //     dayElement.text(sortedDayString);
                // }
            </script>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $(document).on('change', '#sectroo, #classification, #time, .day, #secttea, #input_subject',
                        function() {
                    ...
                    $(document).on('click', '.edit_sched, .update_sched', function() {
                        ...
                        var temp_days = all_sched.filter(x => x.time == temp_sched_info[0].time && x.subjid ==
                            temp_sched_info[0].subjid && x.schedclassid == temp_sched_info[0].schedclassid)
                    ...
                    $(document).on('click', '.eval', function() {
                        ...
                        if ($(this).text() === 'Conflict : Proceed Update') {
                            valid_data = false
                            Swal.fire({
                                title: 'Conflict Schedule',
                                text: 'Do you want to continue or not?',
                                type: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: '#3085d6',
                                cancelButtonColor: '#d33',
                                ...
                                if (result.value) {
                                    ...
                                    if (valid_data) {
                                        ...
                                        var temp_url = section.acadprogid == 5 ?
                                            '/principal/setup/schedule/sh/add' :
                                            '/principal/setup/schedule/gshs/add'
                                        $(this).attr('disabled', 'disabled')

                                        if (section.acadprogid == 5) {
                                            copy_com = 0;
                                        } else {
                                            var check_subject = all_subjects.filter(x => x.id == $(
                                                '#input_subject').val())
                                            if (check_subject[0].subjCom == null) {
                                                copy_com = 0;
                                            } else {
                                            ...
                                            success: function(data) {
                                                ...
                                                if (data[0].status == 1) {
                                                    ...
                                                    if (data[0].data == 'conflict') {
                                                        ...
                                                        Swal.fire({
                                                            title: 'Conflict Schedule',
                                                            text: 'Please see below link for more Conflict Info?',
                                                            type: 'warning',
                                                        ...
                                                        $('#conflict_holder').removeAttr(
                                                            'hidden')

                                                        $('#sched_con_holder').removeAttr(
                                                            'hidden')
                                                        ...
                                                        $.each(data[0].details, function(a, b) {
                                                            ...
                                                            if (b.conflict == 'TSC') {
                                                                ...
                                                                var text = ` <div class="col-md-6" style="font-size:.7rem !important">
                                                                            <div class="card shadow">
                                                                                <div class="card-body p-1">
                                                                                    <p class="mb-0">Subject: ` + b
                                                                    .subject + `</p>
                                                                                    <p class="mb-0">Section: ` + b
                                                                    .section + `</p>
                                                        ...
                                                        if (iscreate) {
                                                            $('.eval').text(
                                                                'Conflict : Proceed Create')
                                                        } else {
                                                            $('.eval').text(
                                                                'Conflict : Proceed Update')
                                                        }
                        ...
                        if (valid_data) {
                            ...
                            var temp_url = section.acadprogid == 5 ? '/principal/setup/schedule/sh/add' :
                                '/principal/setup/schedule/gshs/add'
                            $(this).attr('disabled', 'disabled')
            ...
            <script>
                ...
                $(document).ready(function() {
                    ...
                    $(document).on('click', '#print_sched', function() {
                        ...
                        if(format == 2 && $('#filter_timetemplate').val() != ''){
                            window.open('/principal/setup/section/print?schedtype=section&syid=' + $(
                                '#filter_schoolyear').val() + '&semid=' + $('#filter_semester').val() +
                            '&sectionid=' + section.id + '&timetemp=' + $('#filter_timetemplate').val(),
                            '_blank');
                        }else if(format == 1){
                            console.log(section.id)
                            window.open('/principal/setup/section/print/format1?syid=' + syid + '&semid=' + semid + '&strand=' + strand + '&section=' + section.id);
                        }else{
                            Toast.fire({
                                type: 'warning',
                                title: 'No Time Template Selected',
                            })
                        }
                    ...
                    $(document).on('click', '.button_post', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                var tem_gradestatus_index = gradestatus_list.findIndex(x => x.studid ==
                                    studid && x.id == psgradestatusid)
                                if (quarter == 1) {
                    ...
                    $(document).on('click', '.view_printable', function(a, b) {
                        ...
                        if (section.levelid == 3) {
                            window.open('/grade/preschool/pdf?studid=' + $(this).attr('data-id') + '&syid=' + 3,
                                '_blank');
                        } else {
                            window.open('/grade/prekinder/pdf?studid=' + $(this).attr('data-id') + '&syid=' + 3,
                                '_blank');
                        }
                    })
                    ...
                    function loadgradestatus() {
                        ...
                        $("#grade_status_holder").DataTable({
                            ...
                            columnDefs: [{
                                    ...
                                    'orderable': true,
                                    'createdCell': function(td, cellData, rowData, row, col) {
                                        $(td)[0].innerHTML = '<a class="view_printable" data-id="' + rowData
                                            .studid + '" href="#">' + rowData.lastname + ', ' + rowData
                                            .firstname + '</a>'
                                    }
                                },
                                {
                                    ...
                                    'createdCell': function(td, cellData, rowData, row, col) {
                                        if (rowData.q1status == null || rowData.q1status == "") {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-primary btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="1" data-quarter="1">Approve</button>'
                                        } else if (rowData.q1status == 1) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-info btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="2" data-quarter="1">Post</button>'
                                        } else if (rowData.q1status == 2) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-danger btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="" data-quarter="1">Unpost</button>'
                                        }
                                    }
                                },
                                {
                                    ...
                                    'createdCell': function(td, cellData, rowData, row, col) {
                                        if (rowData.q2status == null || rowData.q2status == "") {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-primary btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="1" data-quarter="2">Approve</button>'
                                        } else if (rowData.q2status == 1) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-info btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="2" data-quarter="2">Post</button>'
                                        } else if (rowData.q2status == 2) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-danger  btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="" data-quarter="2">Unpost</button>'
                                        }
                                    }
                                },
                                {
                                    ...
                                    'createdCell': function(td, cellData, rowData, row, col) {
                                        if (rowData.q3status == null || rowData.q3status == "") {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-primary btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="1" data-studid="' + rowData.studid +
                                                '" data-id="' + rowData.id +
                                                '" data-status="" data-quarter="3">Approve</button>'
                                        } else if (rowData.q3status == 1) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-info btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="2" data-quarter="3">Post</button>'
                                        } else if (rowData.q3status == 2) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-danger btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="" data-quarter="3">Unpost</button>'
                                        }
                                    }
                                },
                                {
                                    ...
                                    'createdCell': function(td, cellData, rowData, row, col) {
                                        if (rowData.q4status == null || rowData.q4status == "") {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-primary btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="1" data-quarter="4">Approve</button>'
                                        } else if (rowData.q4status == 1) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-info btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="2" data-quarter="4">Post</button>'
                                        } else if (rowData.q4status == 2) {
                                            $(td)[0].innerHTML =
                                                '<button class="btn btn-sm btn-info btn-block button_post" data-studid="' +
                                                rowData.studid + '" data-id="' + rowData.id +
                                                '" data-status="" data-quarter="4">Unpost</button>'
                                        }
                                    }
                                },
                            ]
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $('#classification').append(
                                '<option value="create"><i class="fas fa-plus"></i>Create Schedule Classification</option>'
                            )
                            $("#classification").select2({

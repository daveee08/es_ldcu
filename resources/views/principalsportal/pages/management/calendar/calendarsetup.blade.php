        ...
        <div class="col-md-10">
          <div class="card">
            ...
            <span style="font-size: 16px"><b><i class="nav-icon fa fa-thumbtack"></i> SCHOOL CALENDAR</b></span>
              ...
              <button class="btn btn-sm btn-primary float-right mr-2 mb-2" data-toggle="modal"  data-target="#modal-primary" title="Contacts" data-widget="chat-pane-toggle" module_processs="create" ><b>ADD EVENT</b></button>
            </div>

                ...
                <table class="table table-sm mb-0" style="table-layout: fixed;">
                    <tr>
                        <td width="100%" class="p-0" style="padding-left: .8cm!important; padding-right: .65cm!important;">
                            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 20px;">
                                <tr>
                                    ...
                                    <td width="60%" class="text-center p-0">
                                        ...
                                        <div style="font-size: 12.5px; padding-top: 10px;"><b>JUNIOR HIGH SCHOOL</b></div>
                            ...
                            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 15px;">
                                <tr>
                                    <td width="53%" class="text-left p-0" style="font-size: 12px;"></td>
                                    <td width="47%" class="text-center p-0" style="font-size: 12px; border-bottom: 1px solid #000;"><b>{{$adviser}}</b></td>
                                </tr>
                                <tr>
                                    <td width="53%" class="text-left p-0" style="font-size: 12px;"></td>
                                    <td width="47%" class="text-center p-0" style="font-size: 12px; padding-top: 4px!important;">Adviser</td>
                                </tr>
                            </table>
                            ...
                            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 25px;">
                                <tr>
                                    <td width="43%" class="text-center p-0" style="font-size: 12px; border-bottom: 1px solid #000;"><b>EVELYN L. YEE</b></td>
                                    <td width="10%" class="text-left p-0" style="font-size: 12px;"></td>
                                    <td width="47%" class="text-center p-0" style="font-size: 12px; border-bottom: 1px solid #000;"><b>{{$adviser}}</b></td>
                                </tr>
                                <tr>
                                    <td width="43%" class="text-center p-0" style="font-size: 12px; padding-top: 4px!important;">Principal</td>
                ...
                <table class="table table-sm mb-0" style="table-layout: fixed;">
                    <tr>
                        <td width="100%" class="p-0" style="padding-left: .7cm!important; padding-right: .6cm!important;">
                            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 30px;">
                                <tr>
                                    <td width="100%" class="text-center" style="font-size: 12.5px;"><b>REPORT ON LEARNING PROGRESS AND ACHIEVEMENT</b></td>
                                </tr>
                            </table>
                            <table width="100%" class="table table-sm table-bordered" style="">
                                <thead>
                                    <tr>
                                        <td width="59.5%" class="align-middle text-center p-0" style="font-size: 11px!important;">LEARNING AREAS</td>
                                        <td width="23.5%" colspan="4"  class="text-center align-middle p-0" style="font-size: 11px!important; height: 80px;">QUARTER</td>
                                        <td width="6%" rowspan="2" class="text-center p-0 finalratingside" style="font-size: 11px!important;"><div>FINAL&nbsp;GRADING</div></td>
                                        <td width="10%" rowspan="2"  class="text-center p-0 remarksside" style="font-size: 11px!important;"><div>REMARKS</div></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td class="text-center align-middle p-0" style="font-size: 11px!important;">1</td>
                                        <td class="text-center align-middle p-0" style="font-size: 11px!important;">2</td>
                                        <td class="text-center align-middle p-0" style="font-size: 11px!important;">3</td>
                                        <td class="text-center align-middle p-0" style="font-size: 11px!important;">4</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4" class="text-center" style="font-size: 11px!important;">General Average</td>
                            ...
                            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 30px;">
                                <tr>
                                    ...
                                    <td width="90%" class="text-left p-0" style="font-size: 12.5px;"><b>Legend:</b></td>
                                </tr>
                            </table>
                            <table class="table table-sm mb-0" style="table-layout: fixed;">
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;"><b>Descriptors</b></td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;"><b>Grading Scale</b></td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;"><b>Remarks</b></td>
                                </tr>
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;">Outstanding</td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;">90-100</td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;">Passed</td>
                                </tr>
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;">Very Satisfactory</td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;">85-89</td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;">Passed</td>
                                </tr>
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;">Satisfactory</td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;">80-84</td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;">Passed</td>
                                </tr>
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;">Fairly Satisfactory</td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;">75-79</td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;">Passed</td>
                                </tr>
                                <tr>
                                    <td width="15%" class="text-center"></td>
                                    <td width="40%" class="text-left p-0" style="font-size: 12.5px;">Did Not Meet Expectations</td>
                                    <td width="25%" class="text-left p-0" style="font-size: 12.5px;">Below 75</td>
                                    <td width="20%" class="text-left p-0" style="font-size: 12.5px;">Failed</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table class="table table-sm mb-0" style="table-layout: fixed;">
                                <tr>
                                    <td width="100%" class="p-0" style="padding-left: .7cm!important; padding-right: .6cm!important;">
                                        <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 15px;">
                                            <tr>
                                                <td width="100%" class="text-left p-0" style="font-size: 12px; padding-left: 85px!important;"><b>Legend:</b></td>
                                            </tr>
                                        </table>
                                        <table class="table table-sm mb-0" style="table-layout: fixed;">
                                            <tr>

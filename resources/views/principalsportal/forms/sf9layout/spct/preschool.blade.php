                ...
                <tr>
                    <td>
                        <table style="width: 100%; font-style: italic;">
                            ...
                            <tr>
                                <td class="text-center"><u>{{isset(collect($remarks_setup)->where('group','A')->first()->q1grade) ? collect($remarks_setup)->where('group','A')->first()->q1grade : ''}}</u></td>
                            </tr>
                        </table>
                        <br/>
                        <table style="width: 100%; font-style: italic;">
                ...
                <tr>
                    <td>
                        <table style="width: 100%; font-style: italic;">
                            ...
                            <tr>
                                <td class="text-center"><u>{{isset(collect($remarks_setup)->where('group','A')->first()->q2grade) ? collect($remarks_setup)->where('group','A')->first()->q2grade : ''}}</u></td>
                            </tr>
                        </table>
                        <br/>
                        <table style="width: 100%; font-style: italic;">
                ...
                <tr>
                    <td>
                        <table style="width: 100%; font-style: italic;">
                            ...
                            <tr>
                                <td class="text-center"><u>{{isset(collect($remarks_setup)->where('group','A')->first()->q3grade) ? collect($remarks_setup)->where('group','A')->first()->q3grade : ''}}</u></td>
                            </tr>
                        </table>
                        <br/>
                        <table style="width: 100%; font-style: italic;">
                ...
                <tr>
                    <td>
                        <table style="width: 100%; font-style: italic;">
                            ...
                            <tr>
                                <td class="text-center"><u>{{isset(collect($remarks_setup)->where('group','A')->first()->q4grade) ? collect($remarks_setup)->where('group','A')->first()->q4grade : ''}}</u></td>
                            </tr>
                        </table>
                        <br/>
                        <table style="width: 100%; font-style: italic;">
        ...
        <td style="width: 32%; vertical-align: top; padding: 0px;">
            ...
            <table style="width: 100%; margin: 0px 20px;">
                <tr>
                    ...
                    <td style="border-bottom: 1px solid black;" class="text-center">{{isset(collect($age_setup)->where('group','A')->first()->q1grade) ? collect($age_setup)->where('group','A')->first()->q1grade : ''}}</td>
                    <td style="width: 5%;">Months</td>
                    <td style="border-bottom: 1px solid black;" class="text-center">{{isset(collect($age_setup)->where('group','A')->first()->q2grade) ? collect($age_setup)->where('group','A')->first()->q2grade : ''}}</td>
                </tr>
                <tr>
                    <td colspan="5">&nbsp;</td>
                </tr>
                <tr>
                    ...
                    <td style="width: 5%;">Years</td>
                    <td style="border-bottom: 1px solid black;" class="text-center">{{isset(collect($age_setup)->where('group','B')->first()->q1grade) ? collect($age_setup)->where('group','B')->first()->q1grade : ''}}</td>
                    <td style="width: 5%;">Months</td>
                    <td style="border-bottom: 1px solid black;" class="text-center">{{isset(collect($age_setup)->where('group','B')->first()->q2grade) ? collect($age_setup)->where('group','B')->first()->q2grade : ''}}</td>
                </tr>
            </table>
            <br/>
            <br/>

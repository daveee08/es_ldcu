...
<body>  
    ...
    <table style="width: 100%; table-layout: fixed;">
        <tr>
            ...
            <td style="width: 50%; text-align: center;">
                ...
                <div style="width: 100%; font-weight: bold; font-size: 18px;">Elementary Department</div>
                <div style="width: 100%; font-size: 12px;"><i>(Government Recognition No. 275, s. 1965)</i></div>
                <div style="width: 100%; font-weight: bold; font-size: 15px;">SCHOOL ID - 405492</div>
                <div style="width: 100%; font-weight: bold; font-size: 13px;">(PAASCU ACCREDITED LEVEL 2)</div>
    ...
    <table style="width: 100%; margin: 20px 120px; font-size: 12px;">
        <tr>
            <td style="width: 45%;">Eligible for transfer and admission to 1</td>

...
<table style="width: 100%; font-size: 12px; margin-top: 5px;" >
    ...
    <tr>
        <td  class="text-left p-0">Grade/Section :</td>
        <td class="text-left p-0"><u><b>{{$student->levelname}} - {{$student->sectionname}}</b></u></td>
        <td class="text-left p-0">Academic Year :</td>
        <td class="text-left p-0"><u><b>{{$schoolyear->sydesc}}</b></u></td>
    </tr>
    <tr>
        <td  class="text-left p-0">TRACK:</td>
        <td class="text-left p-0"><u><b>
            @if($strandInfo->trackid == 1)
                Academic
            @else
                TVL
            @endif
        </b></u></td>
        <td class="text-left p-0">LRN :</td>
        <td class="text-left p-0"><u><b>{{$student->lrn}}</b></u></td>
    </tr>
    <tr>
        <td class="text-left p-0">STRAND:</td>
        <td class="text-left p-0"><u><b>{{$strandInfo->strandcode}}</b></u></td>

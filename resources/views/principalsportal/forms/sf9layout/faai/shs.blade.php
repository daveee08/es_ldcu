...
<table class="table-sm table table-bordered" width="100%">
    ...
    <tr style="font-size: 9px;">
        <td width="31%" class="align-middle text-center">Core Values</td>
        <td width="6%"><center>1st Quarter</center></td>
        <td width="6%"><center>2nd Quarter</center></td>
        <td width="6%"><center>3rd Quarter</center></td>
        <td width="6%"><center>4th Quarter</center></td>
        <td width="30%"><center>Marking</center></td>
        <td width="15%"><center>Non-numerical Rating</center></td>
    </tr>
    {{-- ========================================================== --}}
    @foreach (collect($checkGrades)->groupBy('group') as $groupitem)
        ...
        @foreach ($groupitem as $item)
            ...
            @else
                <tr >
                    @if($count == 0)
                            <td width="21%" class="text-center align-middle" rowspan="{{count($groupitem)}}">{{$item->group}}</td>
                            @php
                                $count = 1;
                            @endphp
                    @endif
    ...
    <tr>
        <td  width="100%" class="p-0">
            ...
            <table class="table table-bordered table-sm grades mb-0" width="100%">
                ...
                <tr>
                    <td width="18%" style="border: 1px solid #000; text-align: center"></td>
...
<table class="table table-sm" style="font-size: 10px!important;" width="100%">
    <tr>
        <td>REMARKS; Eligible to transfer and admission to College</td>
    </tr>
</table>
<table style="width: 100%; font-size: 10px;">
    <tr>
        <td width="10%" class="p-0"></td>
        <td width="30%" class="p-0" style="width: 45%;text-align: center; border-bottom: 1px solid #000;">{{$adviser}}</td>
        <td width="20%" class="p-0" style="width: 5%;"></td>
        <td width="30%" class="p-0 text-center" style="border-bottom: 1px solid #000;">{{$principal_info[0]->name}}</td>
        <td width="10%" class="p-0"></td>
    </tr>
    <tr>
        <td width="10%" class="p-0"></td>

...
<head>
    ...
    <style>
        ...
        @page { size: 11in 8.5in; margin: 10px 20px 0px 20px;  }
...
<body>
                        ...
                        <div style="background-color: rgb(208, 206, 206); padding: 5px 5px;">
                            ...
                            <table width="100%" style="table-layout: fixed; font-size: 10px;">
                                <tr>
                                    ...
                                    <td width="34%" class="text-left" style="text-transform: uppercase!important;"><b>{{$student->dob}}</b></td>
                ...
                <tr>
                    <td width="50%" class="p-0" style="vertical-align: top; padding-right: 12px!important;">
                        ...
                        <table width="100%" class="table table-bordered table-sm grades mb-0">
                            ...
                            @endforeach
                            <tr>
                                <td class="" style="text-align: left;font-size: 12px!important; background-color:rgb(208, 206, 206);" colspan="5"><b>INSTITUTIONAL SUBJECTS</b></td>
                            </tr>
                            @foreach (collect($studgrades)->where('type',4)->where('semid',$x) as $item)
                                <tr>
                                    <td style="font-size: 8px!important;">{{$item->subjdesc!=null ? $item->subjdesc : null}}</td>
                                    @if($x == 1)
                                        <td class="text-center align-middle" style="font-size: 9px!important;">{{$item->quarter1 != null ? $item->quarter1:''}}</td>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="font-weight: bold; font-size: 12px!important;">{{isset($genave->actiontaken) ? $genave->actiontaken : ''}}</td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td width="50%" class="p-0" style="vertical-align: top; padding-right: 12px!important;">
                        <table width="100%" class="table-bordered" style="table-layout: fixed; font-size: 9px;;">
                            <tr>
                                ...
                                <td rowspan="2" class="align-middle text-center" style="font-size: 8px">Student's Level of Commitment to DCC Core Values (DCCI)</td>
                                ...
                                <td width="100%" class="p-0">
                                    ...
                                    <div style="background-color:rgb(208, 206, 206); margin-top: 10px;">
                                        <table width="100%" class="mb-0" style="font-size: 12px;">
                                            <tr>
                                                <td width="28%" class="text-left p-0" style="">The student is eligible for:</td>
                                                <td width="27%" class="text-left p-0" style="border-bottom: 1px solid #000;">
                                                    @php
                                                        $remarks = isset($genave->actiontaken) ? $genave->actiontaken : '';

                                                        if($remarks == 'PASSED'){

                                                            if (str_replace('GRADE', '', $student->levelname) == 12) {
                                                                echo 'First Year College';
                                                            } else {
                                                                $level = str_replace('GRADE', '', $student->levelname) + 1;
                                                                echo 'Grade'.' '.$level;
                                                            }
                                                ...
                                                <td width="6%" class="text-left p-0" style="">Date:</td>
                                                <td width="20%" class="text-left p-0" style="border-bottom: 1px solid #000;">
												
													@php
														echo date('F j, Y', strtotime($schoolyear->edate));
													@endphp
                                    ...
                                    <div style="margin-top: 20px;">
                                        ...
                                        <table width="100%" class="mb-0" style="font-size: 11px; margin-top: 30px;">
                                            <tr>
                                                <td width="28%" class="text-center p-0" style="font-size: 10px"><b>{{$adviser}}</b></td>
                                                <td width="3%" class="p-0"></td>
                                                <td width="33%" class="text-center p-0" style="font-size: 10px"><b>SPENCER WILLY G. HERNAEZ</b></td>
                                                <td width="3%" class="p-0"></td>
                                                <td width="33%" class="text-center p-0" style="font-size: 10px"><b>AGNES E. GANDULFO, MAED</b></td>
                                            </tr>
                                            <tr>
                                                <td class="text-center p-0">Adviser</td>
                                                <td class="p-0"></td>
                                                <td class="text-center p-0">Senior HS Coordinator</td>
                                                <td class="p-0"></td>
                                                <td class="text-center p-0">
													@if($student->acadprogid == 5)
														<span>SHS, Basic Ed Principal</span>
													@elseif($student->acadprogid == 4)
														<span>JHS, Basic Ed Principal</span>
													@elseif($student->acadprogid == 3)
														<span>OIC Elementary Principal</span>
													@else
														<span>OIC Elementary Principal</span>
													@endif
												</td>
    ...
    <div class="secondpage">
        <div id="watermark1" style="padding-top: 100px;">
            @if($student->acadprogid == 5)
                <img src="{{base_path()}}/public/assets/images/dcc/new.jpg" height="100%" width="100%" />
            @elseif($student->acadprogid == 4)

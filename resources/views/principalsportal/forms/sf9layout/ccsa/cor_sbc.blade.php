...
<head>
    ...
    <style>
        ...
        @page { size: 8.5in 14in; margin: 70px 60px 0px;  }
...
<table style="width: 100%; table-layout: fixed;">
    <tr>
        <td width="30%" style="text-align: left; vertical-align: top">
            <img src="{{base_path()}}/public/{{DB::table('schoolinfo')->first()->picurl}}" alt="school" width="90px" style="padding-left: 20px!important;">
        </td>
        <td style="width: 40%; text-align: center; vertical-align: top;">
            <div style="width: 100%; font-size: 15px;">{{$schoolinfo[0]->schoolname}}</div>
            <div style="width: 100%; font-size: 10px;">{{$schoolinfo[0]->address}}</div>
            <div style="width: 100%; font-size: 24px; margin-top: 40px;"><b>CERTIFICATION</b></div>
        </td>
        <td width="30%" style="">
        </td>
    </tr>
...
<table class="" style="width: 100%; table-layout: fixed; font-size: 15px; margin-top: 20px;">
    <tr>
        <td width="100%" class="text-left" style="">This is to certify that <u>{{$student->student}}</u> is enrolled in <b>Souther Baptist College</b> for the <u>1ST SEMESTER, {{$schoolyear->sydesc}}</u></td>
    </tr>
</table>
<table class="" style="width: 100%; table-layout: fixed; font-size: 15px; margin-top: 10px;">
    <tr>
        <td width="100%" class="text-left" style=""><b>Period Covered:</b> &nbsp;&nbsp;&nbsp;&nbsp;1ST SEMESTER&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$schoolyear->sydesc}}</td>
    </tr>
</table>
<table class="table-bordered" style="width: 100%; table-layout: fixed; font-size: 11px;">
    <tr>
...
<table width="100%" class="" style="table-layout: fixed; font-size: 15px; margin-top: 20px">
    ...
    <tr>
        <td width="42%" class="text-left" style="padding-left: 0;"><b>Total Tuition and Other School fees:</b></td>
...
<table class="" style="width: 100%; table-layout: fixed; font-size: 15px; margin-top: 20px;">
    <tr>
        <td width="100%" class="text-left" style="padding-left: 0;"><b>Period Covered:</b></td>
    </tr>
</table>
...
<table width="100%" class="" style="table-layout: fixed; font-size: 15px; padding-left: 5px; padding-right: 5px;">
    <tr>
        <td width="100%" class="text-left" style="padding-left: 0;"><b>General Weighted Avg. (GWA):</b></td>
    </tr>
</table>
<table width="100%" class="" style="table-layout: fixed; font-size: 15px; margin-top: 160px;">
    <tr>
        <td width="58%" class="text-left" style="padding-left: 0;"><b>Household per Capita Income of Parents/Guardian/s:</b></td>
        <td width="14%" class="text-center" style="border-bottom: 1px solid #000;"><b>5000</b></td>
        <td width="28%" class="text-left" style=""></td>
    </tr>
    <tr>
        <td colspan="3" class="text-left" style="padding-left: 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This certification is issued for scholarship purposes/s.</td>
    </tr>
</table>
<table width="100%" class="" style="table-layout: fixed; font-size: 15px;">
    <tr>
        <td width="100%" class="text-left" style="padding-left: 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Given this &nbsp;&nbsp;<u>&nbsp;06/28/2022&nbsp;</u>&nbsp;&nbsp;&nbsp;at&nbsp;&nbsp;&nbsp;<u>Souther Baptist College, Mlang, Cotabato&nbsp;&nbsp;&nbsp;&nbsp;</u></td>
    </tr>
</table>

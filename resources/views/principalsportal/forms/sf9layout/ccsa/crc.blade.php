...
<table style="width: 100%; table-layout: fixed;">
    <tr>
        <td width="20%" class="p-0" style="text-align: right;">
            <img src="{{base_path()}}/public/{{DB::table('schoolinfo')->first()->picurl}}" alt="school" width="70px">
        </td>
        <td class="p-0" style="width: 60%; text-align: center; vertical-align: middle; padding-top: 20px!important;">
            {{-- <div style="width: 100%; font-size: 18px;"><b>{{$schoolinfo[0]->schoolname}}</b></div> --}}
            <div style="width: 100%; font-size: 18px;"><b>CHRISTIAN COLLEGES OF SOUTHEAST ASIA</b></div>
            {{-- <div style="width: 100%; font-size: 10px;"><b>{{$schoolinfo[0]->address}}</b></div> --}}
        </td>
        <td class="text-left p-0" width="20%" style="">
            <img src="{{base_path()}}/public/{{DB::table('schoolinfo')->first()->picurl}}" alt="school" width="70px">
        </td>
    </tr>
</table>
<table width="100%" style="table-layout: fixed; border-top: .5px solid rgb(59, 59, 59); border-bottom: .5px solid rgb(59, 59, 59); margin-top: 10px;">
    <tr>
        <td width="100%" class="text-center" style="font-size: 15px;"><i>Provides Quality Education in a Christ-centered Institution</i></td>
    </tr>
</table>
<table width="100%" style="table-layout: fixed; margin-top: 10px;">
    <tr>
        <td width="100%" class="text-center" style="font-size: 18px;">
            <div><b>SCHOOL OF HIGHER EDUCATION</b></div>
            <div><b>COLLEGE DEPARTMENT</b></div>
        </td>
    </tr>
</table>
<table width="100%" style="table-layout: fixed; margin-top: 10px;">
    <tr>
        <td width="100%" class="text-center" style="font-size: 18px;">
            ...
            <div>COLLEGIATE REPORT CARD</div>
        </td>
    </tr>
</table>
<table width="100%" class="calibris" style="table-layout: fixed; font-size: 15px; margin-top: 20px; ">
    <tr>
        <td width="21%" class="text-left" style="">NAME <span style="float: right;">:</span></td>
        <td width="40%" class="text-left border-bottom" style="">{{$student->student}}</td>
        <td width="6%" class="text-left" style=""></td>
        <td width="18%" class="text-left" style="">I.D. NO <span style="float: right;">:</span></td>
        <td width="15%" class="text-left border-bottom" style=""></td>
    </tr>
    <tr>
        <td class="text-left" style="">PROGRAM <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
        <td class="text-left" style=""></td>
        <td class="text-left" style="">YEAR LEVEL <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
    </tr>
    <tr>
        <td class="text-left" style="">MAJOR <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
        <td class="text-left" style=""></td>
        <td class="text-left" style=""></span></td>
        <td class="text-left" style=""></td>
    </tr>
    <tr>
        <td class="text-left" style="">ACADEMIC YEAR <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
        <td class="text-left" style=""></td>
        <td class="text-left" style="">SEMESTER <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
    </tr>
    <tr>
        <td class="text-left" style="">UNITS ENROLLED <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
        <td class="text-left" style=""></td>
        <td class="text-left" style="">UNITS EARNED <span style="float: right;">:</span></td>
        <td class="text-left border-bottom" style=""></td>
    </tr>
</table>

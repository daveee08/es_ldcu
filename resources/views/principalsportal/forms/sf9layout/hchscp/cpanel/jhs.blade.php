    ...
    <table class="table table-sm mb-1" width="100%">
        <tbody>
            <tr>
                ...
                <td width="12%" class="text-left p-0" style=""><b><u>{{\Carbon\Carbon::create($student->dob)->isoFormat('MM-DD-YYYY')}}</u></b></td>
                <td width="5%" class="text-left p-0">Age: </td>
                <td width="5%" class="text-left p-0" style=""><b><u>{{$student->age}}</u></b></td>
                <td width="5%" class="text-left p-0">Sex: </td>
                <td width="5%" class="text-left p-0" style=""><b><u>{{$student->gender[0]}}</u></b></td>
            </tr>
        </tbody>
    </table>
    <table class="table table-sm mb-1" width="100%">
        <tbody>
            <tr>
                ...
                <td width="44%" class="text-left p-0" style="border-bottom: 1px solid #000;">
                    <b>
                    @if($syid == 2)

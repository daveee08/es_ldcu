                          ...
                          <table width="100%" style="border:solid 1px black; font-size:11px !important;" >
                            ...
                            <table style="width: 100%; font-size:12px !important;padding-top: 5px;">
                                <tr>
                                    ...
                                    <td style="padding-right: 5px;width: 40%;border-bottom: 1px solid black; ">
                                    
                                    </td>
                                    <td rowspan="2" style="padding-right: 5px;width: 40%; text-align:center;">
                                        <span style="border-bottom: 1px solid black; width: 100%;">

...
<body>
        ...
        <table style="width: 100%; margin-top: 0px;">
            <tr>
                <td  width="48%" class="p-0" style="vertical-align: top;">
                    <table class="table table-bordered table-sm grades" width="100%">
                    <tr>
                        <td width="63%" class="align-middle text-center">SUBJECTS</td>
                        <td width="25%" colspan="2"  class="text-center align-middle" >First Semester</td>
                        <td width="15%" class="text-center align-middle" >Final <br> Grade</td>
                        <td width="17%" class="text-center align-middle" >Remarks</td>
                    </tr>
                    <tr>
                        @if($x == 1)
                            <td style="text-align: center;"><b>Core</b></td>
                            <td width="10%" class="text-center align-middle">1</td>
                            <td width="10%" class="text-center align-middle">2</td>
                            <td></td>
                            <td></td>
                        @elseif($x == 2)
                            <td style="text-align: center;"><b>Core</b></td>
                    ...
                    @foreach (collect($studgrades)->where('type',1)->whereNotIn('id',[29,23,34,20])->where('semid',$x) as $item)
                        <tr>
                            <td style="font-size: 10px!important;">{{$item->subjdesc!=null ? $item->subjdesc : null}}</td>
                            @if($x == 1)
                    ...
                    @endforeach
                    <tr class="trhead">
                        <td style="text-align: center;"><b>Applied</b></td>
                    ...
                    @endforeach
                    <tr class="trhead">
                        <td style="text-align: center;"><b>Specialized</b></td>
                        <td style="text-align: left;" colspan="4"></td>
                    </tr>
                    ...
                    @endforeach
                    <tr class="trhead">
                        <td style="text-align: center;"><b>Other Subjects</b></td>
                        <td style="text-align: left;" colspan="4"></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        @endphp
                        <td class="text-left"><b>Gen. Average</b></td>
                        <td></td>
                        <td></td>
                        <td class="text-center align-middle"><b>{{ isset($genave->finalrating) ? $genave->finalrating != null ? number_format($genave->fcomp):'' :''}}</b></td>
                ...
                <td width="48%" style="vertical-align: top;" class="p-0">
                @php
                    $x = 2;
                @endphp
                    <table class="table table-bordered table-sm grades" width="100%">
                        <tr>
                            <td width="63%" class="align-middle text-center">SUBJECTS</td>
                            <td width="25%" colspan="2"  class="text-center align-middle" >Second Semester</td>
                            <td width="15%" class="text-center align-middle" >Final <br> Grade</td>
                            <td width="17%" class="text-center align-middle" >Remarks</td>
                        </tr>
                        <tr>
        ...
        <table class="table table-sm plot_11" width="100%">
            ...
            <tr>
                <td></td>
                <td style=" text-indent: 13.5%; font-size:14.5px !important;"> This report card shows the ability and progresses your child has made in the different<br>learning areas as well as his/her core value. The school welcomes your desire to know more about<br>your child's progress.</td>
                <td></td>
            </tr>
        </table>
        <table  class="table table-sm plot_11" width="100%" style="margin-top:4rem !important">
            ...
            <tr>
                ...
                <td class="p-0"></td>
                <td class="text-center p-0" style="font-size:8px !important">{{$student->levelname}} CLASS ADVISER</td>
                <td class="p-0"></td>
            </tr>

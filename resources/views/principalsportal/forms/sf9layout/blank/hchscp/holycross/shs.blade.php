...
<body>  
    ...
    <table style="width: 100%; table-layout: fixed;">
        <tr>
            ...
            <td style="width: 70%; text-align: center;">
                ...
                <span style="width: 100%; font-size: 16px;"><b>{{$schoolinfo[0]->schoolname}}</b></span><br>
    ...
    <table style="width: 100%; font-size: 11px; margin-top: 5px;" >
        <tr>
            ...
            <td width="45%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>{{$student->street.', '.$student->barangay.', '.$student->city.', '.$student->province}}</b></td>
        </tr>
    ...
    <table style="width: 100%; font-size: 11px; margin-top: 5px;" >
        <tr>
            ...
            <td width="38%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>
                
                @if($syid == 2)
                    @if($studid == 240 || $studid == 179 || $studid == 895 || $studid == 889 || $studid == 6 || $studid == 9)
                        MS. 
                    @elseif($studid == 764 || $studid == 836 || $studid == 833 || $studid == 38 || $studid == 40 || $studid == 49 || $studid == 50 || $studid == 53 || $studid == 59 || $studid == 823 || $studid == 13 || $studid == 874 || $studid == 797 || $studid == 21 || $studid == 20 || $studid == 828 || $studid == 899 || $studid == 759 || $studid == 840 || $studid == 859)
                        MRS. 
                    @elseif($studid == 746 || $studid == 34)
                        MR.
                    @elseif($studid == 174)
                        REV. FR.
                    @else
    ...
    <table style="width: 100%; font-size: 11px; margin-top: 5px;" >
        <tr>
            ...
            <td width="38%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>
                @if($syid == 2)
                    @if($studid == 899  ||  $studid == 17 || $studid == 828 || $studid == 33 || $studid == 752 || $studid == 797 || $studid == 15 || $studid == 892 || $studid == 839 || $studid == 11 || $studid == 745 || $studid == 918 || $studid == 748 || $studid == 38 || $studid == 836 || $studid == 798 || $studid == 859 || $studid == 41 || $studid == 45 || $studid == 50)
                        18
                    @elseif($studid == 31 || $studid == 747 || $studid == 779 ||$studid == 834 || $studid == 867 || $studid == 13 || $studid == 765 || $studid == 900 || $studid == 19 || $studid == 759 || $studid == 749 || $studid == 56 || $studid == 6 || $studid == 34 || $studid == 36 || $studid == 37 || $studid == 42 || $studid == 53 || $studid == 44 || $studid == 780)
                        19
                    @elseif($studid == 18 || $studid == 889 || $studid == 46)
                        20
                    @else
                        {{$student->age}}
                    @endif
    ...
    <table style="width: 100%; margin-top: -7px;">
        <tr>
            ...
            @php
                $failing_grades = collect($studgrades)->where('finalrating','<',75)->whereNotNull('finalrating')->values();
                $count = 1;
            @endphp
            <table style="width: 100%; font-size: 11px;">
                ...
                <tr>
                    <td width="54%" class="text-left">The bearer is promoted to: </td>
                    <td width="33%" class="text-left" style="border-bottom: 1px solid #000;">
                        @if(collect($finalgrade)->where('semid',1)->first()->finalrating != null && collect($finalgrade)->where('semid',2)->first()->finalrating != null)
                            @if(count($failing_grades) > 0)
                                    <span style="font-size: 9px;">LACKING UNITS: </span>
                            @endif
                        @endif
                    </td>
                    <td width="3%"></td>
            ...
            <table style="width: 100%; font-size: 8px!important;">
                <tr>
                    <td width="20%" class="text-left">&nbsp;</td>
                   
                        @if(collect($finalgrade)->where('semid',1)->first()->finalrating != null && collect($finalgrade)->where('semid',2)->first()->finalrating != null)
                            @if(count($failing_grades) == 0)
                                 <td width="77%" class="text-left" style="border-bottom: 1px solid #000; font-size: 9px;">
                                    {{$student->levelid == 14 ? 'GRADE 12' : 'COLLEGE'}}
                                </td>
                            @else
                             <td width="77%" class="text-left" style="font-size: 9px;">
                                 
                                <u>@foreach($failing_grades as $item) {{$item->subjdesc}} @if($count != count($failing_grades)) , @endif  @php $count +=1; @endphp@endforeach</u>
                             </td>
                            @endif
                        @else
                            <td width="77%" class="text-left" style="border-bottom: 1px solid #000; font-size: 9px;">

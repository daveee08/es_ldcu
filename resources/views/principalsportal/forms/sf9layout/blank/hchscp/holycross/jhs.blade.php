...
<body>  
    ...
    <table class="table table-sm mb-1" width="100%">
        <tbody>
            <tr>
                ...
                <td width="44%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>{{$student->street.', '.$student->barangay.', '.$student->city.', '.$student->province}}</b></td>
                <td width="12%" class="text-left p-0">Birthday: </td>
                <td width="12%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>{{\Carbon\Carbon::create($student->dob)->isoFormat('MM-DD-YYYY')}}</b></td>
                <td width="5%" class="text-left p-0">Age: </td>
                <td width="5%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>{{$student->age}}</b></td>
                <td width="5%" class="text-left p-0">Sex: </td>
                <td width="5%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>{{$student->gender[0]}}</b></td>
            </tr>
        </tbody>
    </table>
    <table class="table table-sm mb-1" width="100%">
        <tbody>
            <tr>
                ...
                <td width="44%" class="text-left p-0" style="border-bottom: 1px solid #000;"><b>
                    @if($syid == 2)
                        @if($studid == 812 || $studid == 788 || $studid == 627 || $studid == 597 || $studid == 577 || $studid == 895 || $studid == 344 || $studid == 355 || $studid == 541 || $studid == 674 || $studid == 791 || $studid == 846)
                            MS. 
                        @elseif($studid == 408)
                            MS. 
                        @elseif($studid == 593 || $studid == 590)
                            MRS. 
                        @elseif($studid == 557 || $studid == 330)
                            MR. 
                        @else
                            MR. AND MRS. 
                        @endif
    ...
    <table class="table table-sm table-bordered grades" width="100%"  style="border: 1px solid #000!important;">
        ...
        <tbody style="border-top: 1px solid #000!important;">
            ...
            <tr>
                ...
                <td class="text-center">{{isset(collect($finalgrade)->first()->fcomp) ? number_format(collect($finalgrade)->first()->fcomp, 3) : ''}}</td>
        ...
        <tr>
            ...
            <td style="vertical-align: top; width: 30%;">
                <table style="width: 100%; padding-top: 8px;">
                    <tr>
                        <td>Eligible for transfer & admission to</td>
                        <td style="border-bottom: 1px solid #000; width: 20%;">
                            @if(collect($finalgrade)->first()->finalrating != null && count($failing_grades) == 0)
                                Grade {{str_replace('GRADE ','',$student->levelname) + 1}}
                            @endif
                ...
                <table style="width: 100%; padding-top: 5px;">
                    <tr>
                        @if(count( $failing_grades) == 0)
                            <td width="100%">Lack credits in:</td>
                        @else
                            @if(collect($finalgrade)->first()->finalrating != null)
                                <td width="100%">Lack credits in: <u>@foreach($failing_grades as $item) {{$item->subjdesc}} @if($count != count($failing_grades)) , @endif  @php $count +=1; @endphp@endforeach</u></td>
                            @else
                                <td width="100%">Lack credits in:</td>
                            @endif
                ...
                <table style="width: 100%; padding-top: 5px;">
                    <tr>
                        <td>Date:</td>
                        <td style="border-bottom: 1px solid #000; width: 80%;text-align:center;">June 30, 2022</td>
    ...
    <table style="width: 100%; padding-top: 25px; text-align: center;">
        <tr>
            <td width="45%" style="border-bottom: 1px solid #000; font-size: 12px; text-transform: uppercase!important;">{{$adviser}}</td>
            <td width="10%" style=""></td>
            <td width="45%" style="border-bottom: 1px solid #000; font-size: 12px; text-transform: uppercase!important;">Sr. Mary Gertrude C. Juance, RSM</td>
        </tr>
        <tr>

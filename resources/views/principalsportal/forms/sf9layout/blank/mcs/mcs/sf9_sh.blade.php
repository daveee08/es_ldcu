...
<head>
    ...
    <style>
        ...
        @page { size: 11.7in 8.3in; margin: .25in;  }
                ...
                <tr>
                    <td width="50%" style="padding-right: .25in !important">
                        ...
                        <table class="table table-sm" width="100%" style="border-right:  solid 1px black; border-left:  solid 1px black; border-bottom:  solid 1px black; ">
                            <tr>
                                <td  width="100%" class="p-0">
                                    ...
                                    <table class="table table-sm" width="100%">
                                        <tr>
                                            <td width="21%" class="p-0 pl-1">Admitted to Grade: </td>
                                            <td width="29%" class="border-bottom p-0 pl-1">
                                                @if(!$dropped)
                                                    {{$student->levelname}}
                                                @endif
                                            </td>
                                            <td width="10%" class="p-0 pl-1">Section: </td>
                                            <td width="40%" class="border-bottom p-0 pl-1">{{$student->sectionname}}</td>
                                        </tr>
                                    </table>
                                    <table class="table table-sm mb-0" width="100%">
                                        <tr>
                                            <td width="34%" class="p-0 pl-1">Elegiblity of Admission to Grade: </td>
                                            <td width="66%" class="border-bottom p-0 pl-1" style="font-size: 10px;">
                                                @php
                                                    $is_retained = false;
                                                    if($schoolyear->id == 22){
                                                        if($student->studid == 781 || $student->studid == 549 || $student->studid == 521 || $student->studid == 518){
                                                            $is_retained = true;
                                                        }
                                                    }
                                                @endphp
                                                @if(!$dropped)
                                                    @if(!$is_retained)
                                                        @php
                                                            $failed_subjects = collect($studgrades)->where('actiontaken','FAILED')->values();
                                                            $count = 0;
                                                        @endphp
                                                        
                                                        
                                                        @if(count($failed_subjects) > 0)
                                                            @if($student->levelid == 14)
                                                                Grade 12, but with lacking unit in 
                                                            @else
                                                                First Year College, but with lacking unit in 
                                                            @endif
                                                            
                                                            @if(count($failed_subjects) == 2) 
                                                                @foreach($failed_subjects as $item) {{$item->subjdesc}} @if($count == 0) and @endif @php $count += 1 @endphp @endforeach
                                                            @else
                                                                @foreach($failed_subjects as $item) {{$item->subjdesc}} @endforeach
                                                            @endif
                                                        @else
                                                            @if($student->levelid == 14)
                                                                Grade 12
                                    ...
                                    <table class="table table-sm" width="100%">
                                        <tr>
                                            <td width="100%" class="text-center"><b><u>MARIA ISABEL C. SALCEDO, MAEd</u></b></td>
                                        </tr>
                                        <tr>
                        ...
                        @if($student->esignature != null)
                            ...
                            <tr>
                                <td width="15%" class="p-0 align-middle">1<sup>st</sup> Quarter</td>
                                <td width="35%" class="p-0 text-center border-bottom"> <img src="{{base_path()}}/public/{{$student->esignature}}" alt="school" width="50px"></td>
                                <td width="15%" class="p-0 align-middle">2<sup>nd</sup> Quarter</td>
                                <td width="35%" class="p-0 text-center border-bottom"> <img src="{{base_path()}}/public/{{$student->esignature}}" alt="school" width="50px"></td>
                            </tr>
                            <tr>
                                <td class="p-0  align-middle">3<sup>rd</sup> Quarter</td>
                                <td class="p-0  text-center border-bottom"> <img src="{{base_path()}}/public/{{$student->esignature}}" alt="school" width="50px"></td>
                        ...
                        @else
                           ...
                           <tr class="text-center">
                            ...
                            <tr>
                                ...
                                <td width="15%" class="align-middle">2<sup>nd</sup> Quarter</td>
                                <td width="35%" class="text-center border-bottom"></td>
                            </tr>
                            <tr>
                    ...
                    <td width="50%" style="padding-left: .25in !important" >
                        ...
                        <table class="table table-sm" width="100%" style="font-size:11px !important;margin-top:40px !important">
                            <tr>
                                ...
                                @endphp
                                <td class="p-1" style="padding: .25rem !important" width="60%"><b>{{$student->student}}</b></td>
                                <td class="p-1" style="padding: .25rem !important" width="10%"></td>
                                <td class="p-1" style="padding: .25rem !important" width="10%"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" style="padding: .25rem !important">
                                    @if($strand->trackid == 1)
                                        ACADEMIC
                                    @else
                                        TVL
                            ...
                            <tr>
                                ...
                                <td width="30%">{{$strand->strandcode}}</td>
                                <td width="20%"></td>
                                <td width="30%"></td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-sm grades" width="100%" style="margin-top:40px !important; ">
                            <tbody>
                                <tr>
                                    <td width="100%" class="text-center align-middle" style="font-size: 12px !important"><b><u>MARIA ISABEL C. SALCEDO, MAEd</u></b></td>
                                </tr>
                                <tr>
                                ...
                                <table class="table table-sm table-bordered grades" width="100%">
                                    ...
                                    @foreach ($temp_subjects as $item)
                                        <tr>
                                            ...
                                            @if($x == 1)
                                                <td class="text-center align-middle {{$item->quarter1 < 75 ? 'text-danger':''}}">{{$item->quarter1 != null ? $item->quarter1:''}}</td>
                                                <td class="text-center align-middle {{$item->quarter2 < 75 ? 'text-danger':''}}">{{$item->quarter2 != null ? $item->quarter2:''}}</td>
                                            @elseif($x == 2)
                                                <td class="text-center align-middle {{$item->quarter3 < 75 ? 'text-danger':''}}">{{$item->quarter3 != null ? $item->quarter3:''}}</td>
                                                <td class="text-center align-middle {{$item->quarter4 < 75 ? 'text-danger':''}}">{{$item->quarter4 != null ? $item->quarter4:''}}</td>
                                            @endif
                                            <td class="text-center align-middle {{$item->finalrating < 75 ? 'text-danger':''}}">{{$item->finalrating != null ? $item->finalrating:''}}</td>
                                   ...
                                   <tr><td colspan="5" class="text-center" style="background-color:gray; color:white; border:solid 1px black">APPLIED SUBJECTS</td></tr>
                                    ...
                                    <tr>
                                            ...
                                            <td class="text-center align-middle {{$genave->finalrating < 75 ? 'text-danger':''}}">{{ isset($genave->finalrating) ? $genave->finalrating != null ? $genave->finalrating:'' :''}}</td>

                    ...
                    <td width="50%" >
                        ...
                        <table class="table table-sm mb-0 studentinfo"  width="100%">
                            <tr>
                                ...
                                <td width="27%" class="text-center border-bottom">{{$student->lastname}} {{$student->suffix}}</td>
                                <td width="15%">First Name:</td>
                                <td width="30%" class="text-center border-bottom" style="font-size:{{strlen($student->firstname) > 15 ? '10px':'11px'}} !important">{{$student->firstname}}</td>
                                <td width="5%">M.I.:</td>
                                <td width="10%" class="text-center border-bottom">{{$student->middlename}}</td>
                            </tr>
                        </table>
                        <table class="table table-sm mb-0 studentinfo"  width="100%">
                            ...
                            <tr>
                                <td width="5%">LRN: </td>
                                <td width="95%" class="text-center border-bottom">{{$student->lrn}}</td>
                        ...
                        <table class="table table-sm mb-0 studentinfo"  width="100%">
                            <tr>
                                <td width="5%">Age: </td>
                                <td width="10%" class="text-center border-bottom">{{$student->age}}</td>
                                <td width="5%">Sex:</td>
                                <td width="10%" class="text-center border-bottom">{{$student->gender}}</td>
                                <td width="18%">Year & Section:</td>
                                <td width="42%" class="text-center border-bottom">{{$student->levelname}} - {{$student->sectionname}}</td>
                            </tr>
                        </table>
                        ...
                        <table class="table table-sm studentinfo"  width="100%">
                            <tr>
                                ...
                                <td width="82%" class="text-center border-bottom">{{$schoolyear->sydesc}}</td>
                            </tr>
                        </table>
                        <p><b>Dear Parents,</b></p>
                        <p style="font-size:11px!important; text-indent: 50px;">This report card shows the ability and progress of your child in the different learning areas including its core values.</p>
                        ...
                        <table class="table table-sm "  width="100%">
                            <tr>
                                <td colspan="3" class="text-center p-0 ">{{$adviser}}</td>
                                <td colspan="2" class="text-center p-0">{{$principal->firstname}} {{$principal->middlename}} {{$principal->lastname}}</td>
                            </tr>
                            <tr>

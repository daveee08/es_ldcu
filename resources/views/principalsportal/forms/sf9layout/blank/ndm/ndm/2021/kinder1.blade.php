        ...
        <td width="50%" style="vertical-align: top;">
            <table with="100%" class="table table-bordered" style="table-layout: fixed; padding-right: 50px;">
                ...
                <tr>
                    ...
                    @endforeach
                    <!--<td width="6%" class="text-center p-0">{{collect($setup)->where('sort','AA')->first()->grade[0]->q1grade}}</td>-->
                    <!--<td width="6%" class="text-center p-0">{{collect($setup)->where('sort','AA')->first()->grade[0]->q2grade}}</td>-->
                    <!--<td width="6%" class="text-center p-0">{{collect($setup)->where('sort','AA')->first()->grade[0]->q3grade}}</td>-->
                    <!--<td width="6%" class="text-center p-0">{{collect($setup)->where('sort','AA')->first()->grade[0]->q4grade}}</td>-->
                </tr>
                <tr>

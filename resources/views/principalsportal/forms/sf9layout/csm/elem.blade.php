    ...
    <table class="table table-sm mb-0" style="table-layout: fixed;">
        <tr>
            <td width="100%" style="">
                ...
                <table class="table table-sm table-bordered grades" width="100%" style="padding-top: 10px; padding-right: 15px!important; padding-left: 5px!important;">
                    <thead>
                ...
                <table style="width: 100%; margin-top: 8px; padding-right: 15px!important; padding-left: 5px!important;">
                    <tr>

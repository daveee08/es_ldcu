            ...
            <table width="100%" class="table mt-0 mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="25%" class="text-center">
                        ...
                        <div style="padding-top: 5px;"><img src="{{base_path()}}/public/assets/images/hsa/deped.png" alt="school" width="60px" height="30px"></div>
                    </td>
                </tr>
            </table>
                        ...
                        @for ($x=1; $x <= 2; $x++)
                            ...
                            <table class="table table-bordered grades_2 mb-0" width="100%" style="table-layout: fixed;">
                                ...
                                @foreach (collect($studgrades)->where('type',1)->where('semid',$x) as $item)
                                    <tr>
                                        <td class="p-0" width="66%" style="padding-left: 5px!important; font-size: 10px!important;"><b>{{$item->subjdesc!=null ? $item->subjdesc : null}}</b></td>
                                        @if($x == 1)

...
<body>  
    ...
    <table style="width: 100%; table-layout: fixed;">
        <tr>
            ...
            <td style="width: 60%; text-align: center;">
                ...
                <div style="width: 100%; font-size: 12px;"><b>{{$schoolinfo[0]->address}}</b></div>
                <span>=============================================================================</span>
    ...
    <table style="width: 100%; table-layout: fixed;">
        <tr>
            <td style="width: 50%; text-align: center;">
                ...
                <div style="width: 100%; font-size: 12px;">Government Recognition No. 314 s. 2008</div>
                <div style="width: 100%; font-size: 12px;"><b>JUNIOR HIGH SCHOOL PROGRESS</b></div>
                <div style="width: 100%; font-size: 11px;">REPORT CARD</div>
            </td>
        </tr>
    </table>
    <br>
    <div style="width: 70%; margin: auto; border: 2px solid rgb(4, 168, 4); padding: .5em; border-radius: 15px;font-size:11px!important;">
        <table class="table mb-1" width="100%">
            <tr>
                <td width="15%" class="text-left p-0"><b>NAME:</b></td>
                <td width="85%" class="text-center p-0" style="border-bottom: 1px solid #000; color: blue;"><b>{{$student->student}}</b></td>
            </tr>
        </table>
        <table class="table mb-1" width="100%">
            <tr>
                <td width="15%" class="text-left p-0"><b>LRN:</b></td>
                <td width="85%" class="text-center p-0" style="border-bottom: 1px solid #000; color: blue;"><b>{{$student->lrn}}</b></td>
            </tr>
        </table>
        <table class="table mb-1" width="100%">
            <tr>
                <td width="35%" class="text-left p-0"><b>Grade & Section:</b></td>
                <td width="65%" class="text-center p-0" style="border-bottom: 1px solid #000;"><b>{{$student->levelname}} - {{$student->sectionname}}</b></td>
            </tr>
        </table>
        <table class="table mb-1" width="100%">
            <tr>
                <td width="13%" class="p-0"></td>
                <td width="22%" class="text-left p-0"><b>School Year:</b></td>
                <td width="65%" class="text-center p-0" style="border-bottom: 1px solid #000;"><b>{{$schoolyear->sydesc}}</b></td>
            </tr>
        </table>
    ...
    <table style="width: 100%; padding-top: 10px; text-align: center;">
        <tr>
            <td width="35%" style="border-bottom: 1px solid #000; font-size: 11px;">{{$principal_info[0]->name}}</td>
            <td width="30%" style=""></td>
            <td width="35%" style="border-bottom: 1px solid #000; font-size: 11px;">{{$adviser}}</td>
        </tr>
        <tr>
            <td width="30%" style="text-align: center; font-size: 11px;"><b>{{$principal_info[0]->title}}</b></td>
            <td width="40%" style=""></td>
            <td width="30%" style="text-align: center; font-size: 11px;"><b>Class Adviser</b></td>
        </tr>
    </table>
        ...
        <tr>
            <td width="48%" style="text-align: center; font-size: 10px; padding: 5px; border: 1px solid blue; vertical-align: top;">
                <table width="100%" style="">
                    ...
                    <tr>
                        <td>San Isidro High School-Kadingilan, Inc, is a
							community of learners and evangelizers that provides
							sustainable, transformative, quality Catholic
							Education guided by the Gospel values.</td>
                    </tr>
                </table>
            </td>
            <td width="1%"></td>
    ...
    <table class="table-sm table mb-0 mt-0" width="100%" style="border: 1px solid #000; margin-top: 10px;">
        <tr>
            <td class="align-middle text-center"><b>RATING ON STUDENT'S MANIFESTATION OF THE SEVEN(7) CORE VALUES</b></td>
        </tr>
    </table>
    <table class="table-sm table mb-0 mt-0" width="100%" style="border: 1px solid #000;font-weight: bold;">
        <tr style="font-size: 8px!important;">
            ...
            <td class="align-middle text-center"><span style="color: cornflowerblue">AO</span>-Always Observed;</td>
            <td class="align-middle text-center"><span style="color: cornflowerblue">SO</span>-Sometimes Observed;</td>
            <td class="align-middle text-center"><span style="color: cornflowerblue">G</span>-Good;</td>
            <td class="align-middle text-center"><span style="color: cornflowerblue">F</span>-Fair;</td>
            <td class="align-middle text-center"><span style="color: cornflowerblue">NI</span>-Needs Improvement</td>
        </tr>
    </table>

   ...
   <!-- <title>{{$student->firstname.' '.$student->middlename[0].' '.$student->lastname}}</title> -->
    <style>
       ...
       .p-1 {
        ...
        @page { size: 11in 8.5in; margin: 20px 30px;  }
        ...
        <td width="50%" class="p-0" style="padding-left: 15px!important;">
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="33%" class="text-left p-0" style="font-size: 12px; border: 1px solid #000; margin-top: 2px!important;">&nbsp;{{$student->lrn}}</td>
                </tr>
            </table>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 5px!important;">
                <tr>
                    <td width="100%" class="text-center p-0" style="font-size: 13px;"><b>{{$schoolinfo[0]->schoolname}}</b></td>
                </tr>
                <tr>
    ...
    <tr>
        <td width="50%" class="p-0" style="vertical-align: top; padding-right: 50px!important;">
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="100%" class="text-center p-0" style="font-size: 14px;">
                        <b>PROGRESS ON PUPIL'S PROGRESS IN LEARNING</b>
                    </td>
                </tr>
            </table>
            <table width="100%" class="table table-sm table-bordered grades" style="">
                <thead>
                    <tr>
                        <td rowspan="2"  class="align-middle text-center p-0" width="43%" style="font-size: 12px!important;"><b>LEARNING AREAS</b></td>
                        <td colspan="4"  class="text-center align-middle p-0" style="font-size: 12px!important;"><b>Grading Period</b></td>
                        <td class="text-center align-middle p-0" width="9%"  style="font-size: 12px!important;"><b>Final <br> Rating</b></td>
                        
                        <td class="text-center align-middle p-0" width="16%" style="font-size: 12px!important;"><b>Remarks</b></td>
                    </tr>
                    <tr>
                        <td class="text-center align-middle" width="8%" style="font-size: 12px!important;"><b>1</b></td>
                        <td class="text-center align-middle" width="8%" style="font-size: 12px!important;"><b>2</b></td>
                        <td class="text-center align-middle" width="8%" style="font-size: 12px!important;"><b>3</b></td>
                        <td class="text-center align-middle" width="8%" style="font-size: 12px!important;"><b>4</b></td>
                        <td></td>
                        <td></td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="5" class="text-right p-1" style="font-size: 12px!important; padding: 10px 0px!important;"><b>General Average&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
            ...
            <table class="table table-bordered table-sm grades mb-0" width="100%" style="margin-top: 10px;">
                ...
                <tr class="table-bordered">
                    ...
                    @foreach ($attendance_setup as $item)
                        <td class="text-center align-middle p-1" style="font-size: 9px!important;"></td>
                    @endforeach
                    <td class="text-center align-middle p-1" style="font-size: 9px!important;"></td>
                </tr>
            </table>
        ...
        <td width="50%" class="p-0" style="vertical-align: top;">
            <table class="table table-sm mb-0" style="table-layout: fixed; padding-left: 10px!important;">
                <tr>
                    <td width="100%" class="text-center p-0" style="font-size: 14px;">
                        <b>PROGRESS ON PUPIL'S VALUE AND ATTITUDE</b>
                    </td>
                </tr>
            </table>

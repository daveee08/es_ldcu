    ...
    <tr>
        ...
        <td width="50%" style="vertical-align: top; padding-left: .5in!important;">
            ...
            <table class="table table-sm mb-0 p-0" style="width: 100%; table-layout: fixed;">
                <tr>
                    <td class="p-0" width="25%" style="text-align: right;">
                        <img style="" src="{{base_path()}}/public/assets/images/mslu/msllogo.png" alt="school" width="90px">
                    </td>
                ...
                <tr>
                    <td colspan="3" width="100%" class="p-0" style="text-align: center; font-size: 12px;">
                        <div style="width: 100%; font-size: 18px;"><u>MARYKNOLL SCHOOL OF LUPON, INC.</u></div>
            ...
            <table style="width: 100%; font-size: 14px; margin-top: 10px;" >
                <tr>
                    <td width="100%" class="text-center p-0" style=""><b>ELEMENTARY DEPARTMENT</b></td>
                </tr>
            </table>
            ...
            <table style="width: 100%; font-size: 13px;">
                <tr>
                    ...
                    <td width="16%" class="p-0 text-center" style="border-bottom: 1px solid #000">&nbsp;<b>10</b></td>
                    <td width="10%" class="p-0">Section:</td>
                    <td width="28%" class="p-0 text-center" style="border-bottom: 1px solid #000"><b>{{$student->sectionname}}</b></td>
            ...
            <table style="width: 100%; font-size: 13px;">
                <tr>
                    ...
                    <td width="37%" class="p-0 text-center" style="border-bottom: 1px solid #000"><b>10</b></td>
                    <td width="22%" class="p-0 text-center"></td>
                </tr>
            </table>
            <table style="width: 100%; font-size: 13px;">

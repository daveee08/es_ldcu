        ...
        <td width="50%" class="p-0" style="vertical-align: top; padding-right: .25in!important;">
            ...
            <table width="100%" style="font-size: 12px;" >
                <tr>
                    ...
                    <td width="41%" class="p-0 text-left border-bottom" style=""><b>{{$student->student}}</b></td>
            ...
            <table width="100%" style="font-size: 12px; margin-top: 30px;">
                <tr>
                    ...
                    <td width="45%" class="p-0 border-bottom text-center" style="">{{$adviser}}</td>
                </tr>
                <tr>
                    <td width="55%" class="p-0" style=""></td>
            ...
            <table width="100%" style="font-size: 12px; margin-top: 15px">
                <tr>
                    <td width="35%" class="p-0 border-bottom text-center" style="">{{$principal_info[0]->name}}</td>

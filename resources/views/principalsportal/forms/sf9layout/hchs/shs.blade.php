...
<head>
    ...
    <style>
        ...
        @page { size: 4.3in 10in; margin: 10px 10px 10px 10px;  }
...
<body>  
    ...
    <table class="table table-sm grades mb-0"  width="100%" style="">
        <tr>
            <td width="25%" class="text-center">
                <div><span style="font-size: 6px!important;"><b>DepEd Form 9-SHS</b></span></div>
    ...
    <table class="table table-sm grades mt-0" width="100%" style="padding-top: 3px !important;">
        <tr>
            <td class="text-center p-0"  style="">
                  ...
                  <div style="font-size:8px !important"><b>(Formerly Holy Cross High School)</b></div>
    ...
    <div style="border: 2px solid rgb(6, 74, 137); padding: 4px !important; margin-top: 5px;">
        <table class="table table-sm grades" width="100%" style="font-size: 10px!important; margin-bottom: 3px!important;">
            <tr style="">
                ...
                <td width="25%" class="p-0 text-center" style="font-size: 10px!important"><b>Grade-Section:</b></td>
    ...
    <div style="border: 2px solid rgb(6, 74, 137); padding: 4px !important; margin-top: 5px;">
        <table class="table table-sm grades mb-1" width="100%" style="font-size: 10px !important">
            <tr>
                <td class="p-0" width="7%"><b>Track:</b></td>
                <td width="43%" class="border-bottom p-0" style=""></td>
                <td class="p-0" width="7%"><b>Strand:</b></td>
                <td width="43%" class="border-bottom p-0"></td>
            </tr>
        </table>
    </div>
    <div style="border: 2px solid rgb(6, 74, 137); padding: 4px !important; margin-top: 5px;">
        <table class="table table-sm grades mb-1" width="100%" style="font-size: 10px !important">
            <tr>
                <td class="p-0" width="39%"><b>Specialization (for TVL only): </b></td>
                <td width="61%" class="border-bottom p-0"></td>
            </tr>
        </table>
    </div>
    <table class="table table-sm grades mt-0" width="100%" style="padding-left: 10px!important; margin-top: 5px !important;">
    <tr>
    ...
    <table class="table table-sm grades mb-0" width="100%" style="border-bottom:2px solid rgb(6, 74, 137)">
        <tr>
            <td class=""></td>
        </tr>
    </table>
    <table class="table table-sm grades mb-0" width="100%" style="padding-bottom: 10px; margin-top: 10px;">
    <tr>
    ...
    @for ($x=1; $x <= 2; $x++)
        <table  class="table table-sm grades mb-0 table-bordered" width="100%" style="background-color:rgb(6, 74, 137); color:white; page-break-inside:avoid; ">
            <tr >
                <td colspan="5"  class="align-middle text-center" width="100%"><b>REPORT ON PROGRESS AND ACHIEVEMENT  - Sem. {{$x}}</b></td>
            </tr>
        </table>
        <table class="table table-sm table-bordered  table-bordered mb-0 grades-7" width="100%">
            <tr>
                <td width="60%" rowspan="2"  class="align-middle text-center" style="font-size: 8px !important;"><b>Learning Areas</b></td>
                <td width="18%" colspan="2"  class="text-center align-middle" style="font-size: 8px !important;"><b>Quarter</b></td>
                <td width="10%" rowspan="2"  class="text-center align-middle" style="font-size: 8px !important;"><b>Final Rating</b></td>
                <td width="12%" rowspan="2"  class="text-center align-middle" style="font-size:8px !important"><b>Remarks</b></td>
            </tr>
            <tr>
                @if($x == 1)
                    <td class="text-center align-middle p-0" style="font-size: 8px!important;"><b>1</b></td>
                    <td class="text-center align-middle p-0" style="font-size: 8px!important;"><b>2</b></td>
                @elseif($x == 2)
                    <td class="text-center align-middle p-0" style="font-size: 8px!important;"><b>3</b></td>
                    <td class="text-center align-middle p-0" style="font-size: 8px!important;"><b>4</b></td>
                @endif
            </tr>
            @foreach (collect($studgrades)->where('semid',$x) as $item)
                <tr>
                    <td class="p-0" style="font-size: 7px !important; padding-left: 2px!important; padding-top: 2px!important; padding-bottom: 2px!important;">{{$item->subjdesc!=null ? $item->subjdesc : null}}</td>
                    @if($x == 1)
                        <td class="p-0 text-center align-middle {{$item->quarter1 != null ? $item->quarter1 < 75 ? 'bg-red':'':'' }}" style="font-size: 7px !important;">{{$item->quarter1 != null ? $item->quarter1:''}}</td>
                        <td class="p-0 text-center align-middle {{$item->quarter2 != null ? $item->quarter2 < 75 ? 'bg-red':'':'' }}" style="font-size: 7px !important;">{{$item->quarter2 != null ? $item->quarter2:''}}</td>
                    @elseif($x == 2)
                        <td class="p-0 text-center align-middle {{$item->quarter3 != null ? $item->quarter3 < 75 ? 'bg-red':'':'' }}" style="font-size: 7px !important;">{{$item->quarter3 != null ? $item->quarter3:''}}</td>
                        <td class="p-0 text-center align-middle {{$item->quarter4 != null ? $item->quarter4 < 75 ? 'bg-red':'':'' }}" style="font-size: 7px !important;">{{$item->quarter4 != null ? $item->quarter4:''}}</td>
                    @endif
                    <td class="p-0 text-center align-middle" style="font-size: 7px !important">{{$item->finalrating != null ? $item->finalrating:''}}</td>
                    <td class="p-0 text-center align-middle" style="font-size:6px !important">{{$item->actiontaken != null ? $item->actiontaken:''}}</td>
                </tr>
            @endforeach
            <tr>
                @php
                ...
                @endphp
                <td colspan="3" style="font-size: 8px !important;"><b>GENERAL AVERAGE</b></td>
                {{-- @if($x == 1)
                ...
                @endif --}}
                <td class="text-center align-middle {{ isset($genave->finalrating) ? $genave->finalrating != null ? number_format($genave->fcomp,2) < 75 ? 'bg-red':'' :'' :''}}" style="font-size: 8px !important;">{{ isset($genave->finalrating) ? $genave->finalrating != null ? number_format($genave->fcomp,2):'' :''}}</td>
                <td class="text-center align-middle" style="font-size:8px !important">{{ isset($genave->actiontaken) ? $genave->actiontaken != null ? $genave->actiontaken:'' :''}}</td>
            </tr>
        </table>
    @endfor
    ...
    <table class="table table-bordered mb-0"  width="100%" style="table-layout: fixed;">
        <tr style="background-color:rgb(6, 74, 137); color: #fff;">
            ...
            <tr>
                ...
                <td colspan="2" width="14%" class="text-center p-0" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>1<sup>st</sup> Sem</b></td>
                <td colspan="2" width="14%" class="text-center p-0" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>2<sup>nd</sup> Sem</b></td>
            </tr>
            <tr>
                <td class="align-middle text-center" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>Q1</b></td>
                <td class="align-middle text-center" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>Q2</b></td>
                <td class="align-middle text-center" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>Q3</b></td>
                <td class="align-middle text-center" style="padding-top: 5px!important; padding-bottom: 5px!important;font-size: 8px!important;"><b>Q4</b></td>
            </tr>
    ...
    <table class="table table-sm grades" width="100%" style="font-size: 8px !important; margin-top: -2.5px; border: .5px solid #000; border-top: none !important; padding-bottom: 4px !important;">
        {{-- <thead>
            <tr>
        ...
        <tr>
            ...
            <td width="20%" class="p-0 text-center" width="18%" style="padding-top: 4px!important;font-size: 8px !important;"><b>MARKING</b></td>
            <td width="30%" class="p-0 text-center" style="padding-top: 4px!important;font-size: 8px !important;"><b>NON-NUMERICAL RATING</b></td>
            <td width="25%" class="p-0"></td>
        </tr>

        ...
        <tr>
            <td width="50%" style="padding-right: 50px;">
                <table style="width: 100%; font-size: 13px; margin-top: 10px;">
                    <tr>
                        <td width="100%" class="p-0 text-center">REPORT ON ATTENDANCE</td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td width="100%" class="p-0">
                            ...
                            <table class="table table-bordered table-sm grades mb-0" width="100%">
                                ...
                                {{-- <tr class="table-bordered">
                                    <td class="text-center">No. of days tardy</td>
                                    @foreach ($attendance_setup as $item)
                                        <td class="text-center align-middle" >{{$item->days != 0 ? $item->absent : ''}}</td>
                                    @endforeach
                                    <td class="text-center align-middle" >{{collect($attendance_setup)->sum('absent')}}</td>
            ...
            <td width="50%" style="padding-right: 50px;">
                <table width="100%" class="table table-sm" style="font-size: 12px!important;">
                    <tr>
                        ...
                        <table class="table table-sm table-bordered grades" width="100%" style="margin-top: 10px;">
                            <thead>
                                {{-- <tr>
                                    <td colspan="7" class="align-middle text-center"><b>ACADEMIC ACHIEVEMENT</b></td>
                                </tr> --}}
                                <tr>
                                    <td rowspan="2"  class="text-center" width="28%"><b>Learning areas</b></td>
                                    <td colspan="4"  class="text-center align-middle"><b>GRADING PERIOD</b></td>
                                    <td rowspan="2" class="text-center align-middle" width="14%" ><b>Final <br> Grade</b></td>
                                    <td rowspan="2"  class="text-center" width="16%" style="font-size: 12px!important"><b>Remarks</b></span></td>
                                </tr>
                                <tr>
                        ...
                        <table class="table-sm mb-0 mt-0" width="100%">
                            <tr>
                                ...
                                <td width="20%" class="p-0 text-left"><b>Grading Scale</b></td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left"><b>Remarks</b></td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                            <tr>
                                <td width="40%" class="p-0">Outstanding</td>
                                <td width="20%" class="p-0 text-left" style="padding-left: 15px!important;">90-100</td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left" style="padding-left: 3px!important;">Passed</td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                            <tr>
                                <td width="40%" class="p-0">Very Satisfactory</td>
                                <td width="20%" class="p-0 text-left" style="padding-left: 15px!important;">85-89</td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left" style="padding-left: 3px!important;">Passed</td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                            <tr>
                                ...
                                <td width="20%" class="p-0 text-left" style="padding-left: 15px!important;">80-84</td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left" style="padding-left: 3px!important;">Passed</td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                            <tr>
                                ...
                                <td width="20%" class="p-0 text-left" style="padding-left: 15px!important;">75-79</td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left" style="padding-left: 3px!important;">Passed</td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                            <tr>
                                ...
                                <td width="20%" class="p-0 text-left" style="padding-left: 15px!important;">Below 75</td>
                                <td width="25%" class="p-0"></td>
                                <td width="10%" class="p-0 text-left" style="padding-left: 3px!important;">Failed</td>
                                <td width="5%" class="p-0"></td>
                            </tr>
                        </table>
                        </td>

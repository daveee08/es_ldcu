    ...
    <tr>
        <td width="50%" class="p-0" style="vertical-align: top; font-size: 13px; padding-right: .40in!important;">
            ...
            <table width="100%" style="margin-top: 15px;">
                <tr>
                    <td class="p-0 text-center" width="45%" style="border-bottom: 1px solid #000; font-size: 13px;"><b>{{$principal_info[0]->name ?? $principal_name}}</b></td>
            ...
            <table style="width: 100%; font-size: 13px;">
                ...
                <tr>
                    ...
                    <td width="43%" class="p-0 text-center" style="border-bottom: 1px solid #000; font-size: 12px;">
                        <b>{{ $principal_info[0]->name ?? $principal_name }}
                        </b>
                    </td>
                </tr>
            </table>
        ...
        <td width="50%" class="p-0" style="vertical-align: top; padding-left: .40in!important;">
            ...
            <table style="width: 100%; padding-top: 45px; text-align: center;">
                <tr>
                    ...
                    <td class="p-0" width="45%" style="font-size: 12px;"><b><u>{{$principal_info[0]->name ?? $principal_name}}</u></b></td>
                    <td class="p-0" width="10%" style=""></td>

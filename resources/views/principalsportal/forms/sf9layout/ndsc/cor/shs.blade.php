...
<table width="100%" style=" table-layout: fixed;margin-top: 5px; font-size: 11px" >
    <tr>
        <td width="26%" class="p-0">
            ...
            <table width="100%" style=" table-layout: fixed; font-size: 11px">
                <tr>
                    ...
                    <td width="58%" class="p-0" style="border-bottom: 1px solid #000;">{{$strandInfo->strandcode}}</td>
                </tr>
            </table>
            <table width="100%" style=" table-layout: fixed; font-size: 11px">
                <tr>
        ...
        <td width="40%" class="p-0">
            <table width="100%" style=" table-layout: fixed; font-size: 11px">
                <tr>
                    <td class="text-center p-0" style="font-size: 13px; color: red;"><b><u>CERTIFICATE</u> <u>OF</u> <u>REGISTRATION</u></b></td>
                </tr>
                
            </table>
            <table width="100%" style=" table-layout: fixed; font-size: 11px">
                <tr>
                    <td class="text-center p-0" style="font-size: 13px; color: red;"><b>SENIOR HIGH SCHOOL</b></td>
                </tr>
            </table>
            <table width="100%" style=" table-layout: fixed; font-size: 11px">
                <tr>
                    <td width="30%" class="p-0"></td>
                    <td width="10%" class="text-center p-0" style="font-size: 13px; color: red;"><b>SY</b></td>
                    <td width="30%" class="p-0" style="border-bottom: 1px solid red;"></td>
                    <td width="30%" class="p-0"></td>
                </tr>
            </table>
        </td>

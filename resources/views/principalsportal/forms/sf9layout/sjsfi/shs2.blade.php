...
<head>
    ...
    <style>
        ...
        @page { size: 8.5in 14in; margin: 20px 20px;  }
                ...
                <tr>
                    <td class="p-0">
                        ...
                        <table width="100%" class="table table-bordered table-sm grades mb-0" style="margin-top: 5px;">
                            ...
                            <tr style="background-color: #bebebe;">
                                @if($x == 1)
                                    <td width="12%" class="text-center align-middle p-0">1</td>
                                    <td width="8%" class="text-center align-middle p-0">2</td>
                                @elseif($x == 2)
                                    <td width="12%" class="text-center align-middle p-0">3</td>
                                    <td width="8%" class="text-center align-middle p-0">4</td>
                                @endif
                            </tr>
                            <tr class="trhead">
                            ...
                            <tr>
                                ...
                                @endphp
                                <td class="text-right" colspan="3" style="font-size: 9px!important;">Gen. Ave for First semester</td>
                        ...
                        <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 10px; font-size: 8px; padding-right: 10px!important;">
                            <tr>
                                ...
                                <td width="45%" class="text-center p-0" style="border-bottom: 1px solid #000; font-size: 8px;">{{$principal_info[0]->name}}</td>
                            </tr>
                            <tr>
                                <td width="55%" class="text-center p-0" style=""></td>
                                <td width="45%" class="text-center p-0" style="font-size: 7px; padding-top: 2px!important;">{{$principal_info[0]->title}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td class="p-0">
                        ...
                        <table class="table table-bordered table-sm grades mb-0" width="100%">
                            <tr>
                                ...
                                @foreach ($attendance_setup as $item)
                                    <td class="aside text-center align-middle;" width="{{$width}}%"><span style="font-size: 8px!important;">{{\Carbon\Carbon::create(null, $item->month)->format('F')}}</span></td>
                                @endforeach
                        ...
                        <table class="table table-bordered table-sm grades mb-0" width="100%">
                            <tr>
                                ...
                                @endforeach
                                <td class="text-center p-0" width="8%" style="vertical-align: middle; font-size: 8px!important;"><span style="transform-origin: 13 22; transform: rotate(-90deg); top: 0; bottom: 10;"><b>TOTAL</b></span></td>
                            </tr>
                            <tr class="table-bordered">

...
<table class="table table-sm mb-0" style="table-layout: fixed;">
    <tr>
        <td style="width: 100%; text-align: center; vertical-align: middle;">
            <span class="p-0" style="width: 100%; font-weight: bold; font-size: 12px;">{{$schoolinfo[0]->schoolname}}</span><br>
            <span class="p-0" style="width: 100%; font-size: 12px;">Basic Education Department</span> <br>
            <span class="p-0" style="width: 100%; font-size: 12px;"><img style="padding-top: 5px!important;padding-bottom: 5px!important" src="{{base_path()}}/public/{{DB::table('schoolinfo')->first()->picurl}}" alt="school" width="60px"></span><br>
            <span class="p-0" style="width: 100%; font-size: 12px;">sss</span>
        </td>
    </tr>
</table>
<div width="100%" style="">
    <table width="100%" class="table table-sm table-bordered mb-0 p-0" style="table-layout: fixed;">
        <tr>
            <td width="15%" class="text-center">ssss</td>
...
<div width="100%" style="">
    <table width="100%" class="table table-sm table-bordered mb-0 p-0" style="table-layout: fixed;">
        <tr>
            ...
            <td width="25%" class="text-left">ssss</td>
...
<div width="100%" style="">
    <table width="100%" class="table table-sm table-bordered mb-0 p-0" style="table-layout: fixed;">
        <tr>
            <td width="20%" class="text-center">ssss</td>
            <td width="12.5%" class="text-center"></td>
            <td width="12.5%" class="text-center"></td>
            <td width="12.5%" class="text-center"></td>
            <td width="12.5%" class="text-center"></td>
            <td width="15%" class="text-center"></td>

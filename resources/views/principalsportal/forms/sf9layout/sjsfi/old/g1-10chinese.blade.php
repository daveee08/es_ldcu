...
<table class="table table-sm mb-0" style="table-layout: fixed;">
    ...
    <tr>
        <td class="p-0" style="border: 1px solid black;">
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td class="p-1" style="width: 100%; border-bottom: 1px solid #000; padding-top: 10px!important; padding-bottom: 10px!important;">&nbsp;</td>
                </tr>
                <tr>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="18%" style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding-top: 10px!important; padding-bottom: 10px!important;">&nbsp;</td>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td style="width: 100%; border-bottom: 1px solid #000; padding-top: 10px!important; padding-bottom: 10px!important;">&nbsp;</td>
                </tr>
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="20%" style="border-bottom: 1px solid #000; border-right: 1px solid #000; padding-top: 10px!important; padding-bottom: 10px!important;">&nbsp;</td>
                    <td width="57%" style="border-bottom: 1px solid #000;">&nbsp;</td>
                    <td width="8%" style="border-bottom: 1px solid #000; border-right: 1px solid #000; border-left: 1px solid #000;">&nbsp;</td>

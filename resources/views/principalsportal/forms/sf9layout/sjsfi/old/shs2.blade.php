        ...
        <td class="p-0">
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: .1em; font-size: 10px;">
                <tr>
                    ...
                    <td width="55%" class="text-left p-0" style="border-bottom: 1px solid #000; font-size: 7px; vertical-align: middle!important;">&nbsp;{{$strandInfo->strandname}}</td>
                </tr>
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: .1em; font-size: 10px;">
                <tr>
            ...
            <table width="100%" class="table table-bordered table-sm grades mb-0" style="margin-top: 5px;">
                ...
                <tr>
                    ...
                    @endphp
                    <td class="text-right" colspan="3" style="font-size: 9px!important;">Gem. Ave for Second semester</td>

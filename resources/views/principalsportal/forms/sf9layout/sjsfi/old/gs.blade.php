...
<head>
    ...
    <style>
        ...
        @page { size: 11in 8.5in; margin: 20px 15px;  }
    ...
    <tr>
        <td width="50%">
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; padding-top: 0px;">
                <tr>
                    <td width="100%" class="p-1" style="border-bottom: 2px solid #000;">&nbsp;</td>
                </tr>
                <tr>
                    <td width="100%" class="p-1" style="border-bottom: 2px solid #000;">&nbsp;</td>
                </tr>
        ...
        <td width="50%">
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="48%" class="text-center p-0" style="border-bottom: 1px solid #000;font-size: 15px;">{{$student->lrn}}</td>
                </tr>
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 15px;">
                <tr>
                    <td width="100%" class="text-center p-0" style="font-size: 16px;">
                        ...
                        <div><b>REGION 1X, ZAMBOANGA PENINSULA</b></div>
                    </td>
                </tr>
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="100%" class="text-center p-0" style="font-size: 15px;">
                        <div class="p-0" style="width: 100%;"><img style="padding-top: 10px;" src="{{base_path()}}/public/assets/images/sjsfi/logo.png" alt="school" width="110px"></div>
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; margin-top: 15px;">
                <tr>
                    ...
                    <td width="54%" class="text-center p-0" style="border-bottom: 1px solid #000; font-size: 14px!important;">{{$student->lastname.', '.$student->firstname.' '.$student->middlename[0].'.'}}</td>
                    <td width="9%" class="text-center p-0"><b>Age:</b></td>
                    <td width="9%" class="text-center p-0" style="border-bottom: 1px solid #000;">{{$student->age}}</td>
                    <td width="9%" class="text-center p-0"><b>Sex:</b></td>
                    <td width="9%" class="text-center p-0" style="border-bottom: 1px solid #000;">{{$student->gender[0]}}</td>
                </tr>
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; margin-top: 15px;">
                <tr>
                    <td width="18%" class="p-0"><b>Curriculum:</b></td>
                    <td width="37%" class="text-left p-0" style="border-bottom: 1px solid #000;">K-12</td>
                    <td width="12%" class="text-right p-0"><b>Grade:&nbsp;</b></td>
                    <td width="21%" class="text-center p-0" style="border-bottom: 1px solid #000;">{{str_replace('GRADE', '', $student->levelname)}}</td>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; margin-top: 15px;">
                <tr>
                    ...
                    <td width="36%" class="p-0" style="border-bottom: 1px solid #000;">{{$schoolyear->sydesc}}</td>
                    <td width="17%" class="text-right p-0"><b>Section:&nbsp;</b></td>
                    <td width="17%" class="p-0" style="border-bottom: 1px solid #000;">{{$student->sectionname}}</td>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; margin-top: 20px;">
                <tr>
                    ...
                    <td width="45%" class="text-center p-0" style="border-bottom: 1px solid #000; text-transform: uppercase!important;">{{$adviser}}</td>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; font-size: 15px; margin-top: 20px;">
                <tr>
                    <td width="4%" class="p-0"></td>
                    <td width="45%" class="p-0"></td>
                    <td width="51%" class="text-center p-0" style="border-bottom: 1px solid #000;">Sr. Josephine C. Sambrano, OP, MaED</td>
                </tr>
                <tr>
                    <td width="4%" class="p-0"></td>
...
<table class="table table-sm mb-0" style="table-layout: fixed;">
    <tr>
        <td width="50%" class="p-0" style="padding-right: 15px!important;">
            <table width="100%" class="table table-sm table-bordered grades" style="margin-top: 20px;">
                <thead>
                    <tr>
                        <td rowspan="2"  class="align-middle text-center" width="57%" style="font-size: 14px!important;">Learning Areas</td>
                        <td colspan="5"  class="text-center align-middle" style="font-size: 14px!important;"><b>QUARTER</b></td>
                        
                        <!-- <td rowspan="2"  class="text-center align-middle" width="17%" style="font-size: 9px!important;"><b>Remarks</b></span></td> -->
                    </tr>
                    <tr>
                        <td class="text-center align-middle" width="7.5%" style="font-size: 14px!important;">1</td>
                        <td class="text-center align-middle" width="7.5%" style="font-size: 14px!important;">2</td>
                        <td class="text-center align-middle" width="7.5%" style="font-size: 14px!important;">3</td>
                        <td class="text-center align-middle" width="7.5%" style="font-size: 14px!important;">4</td>
                        <td class="text-center align-middle" width="13%"  style="font-size: 14px!important;">Final <br> Rating</td>
                    </tr>
                </thead>
                <tbody>
                    @foreach ($studgrades as $item)
                        <tr>
                            ...
                            <td class="text-center align-middle" style="font-size: 15px!important;">{{$item->quarter1 != null ? $item->quarter1:''}}</td>
                            <td class="text-center align-middle" style="font-size: 15px!important;">{{$item->quarter2 != null ? $item->quarter2:''}}</td>
                            <td class="text-center align-middle" style="font-size: 15px!important;">{{$item->quarter3 != null ? $item->quarter3:''}}</td>
                            <td class="text-center align-middle" style="font-size: 15px!important;">{{$item->quarter4 != null ? $item->quarter4:''}}</td>
                            <td class="text-center align-middle" style="font-size: 15px!important;">{{isset($item->finalrating) ? $item->finalrating:''}}</td>
                            <!-- <td class="text-center align-middle" style="font-size: 9px!important;">{{isset($item->actiontaken) ? $item->actiontaken:''}}</td> -->
                        </tr>
                    @endforeach
                    <tr>
                        <td class="text-left" style="font-size: 14px!important;"><b>GEN. AVERAGE</b></td>
            ...
            <table class="table table-sm table-bordered mb-0" style="table-layout: fixed; margin-top: 10px; font-size: 13px; padding-left: 30px; padding-right: 30px;">
                <tr>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="100%" class="text-left" style="font-size: 15px;">
                        ATTENDANCE RECORD
                    </td>
                </tr>
            </table>
            ...
            <table class="table table-bordered table-sm grades mb-0" width="100%">
                <tr>
                    ...
                    @foreach ($attendance_setup as $item)
                        <td class="aside text-center align-middle;" width="{{$width}}%"><span style="font-size: 12px!important;"><b>{{\Carbon\Carbon::create(null, $item->month)->isoFormat('MMM')}}</b></span></td>
                    @endforeach
                    <td class="text-center p-0" width="9%" style="vertical-align: middle; font-size: 12px!important;"><span style="transform-origin: 17 25; transform: rotate(-90deg); top: 0; bottom: 10;"><b>TOTAL</b></span></td>
                </tr>
                <tr class="table-bordered">
                    <td width="19%" class="text-center" style="font-size: 12px!important;"><b>No. of School <br> Days</b></td>
                    @foreach ($attendance_setup as $item)
                        <td class="text-center align-middle p-0" style="font-size: 12px!important;">{{$item->days != 0 ? $item->days : '' }}</td>
                    @endforeach
                    <td class="text-center align-middle p-0" style="font-size: 8px!important;">{{collect($attendance_setup)->sum('days')}}</td>
                </tr>
                <tr class="table-bordered">
                    <td class="text-center"  style="font-size: 12px!important;"><b>No. of School <br> Days Present</b></td>
                    @foreach ($attendance_setup as $item)
                        <td class="text-center align-middle p-0" style="font-size: 12px!important;">{{$item->days != 0 ? $item->present : ''}}</td>
                    @endforeach
                    <td class="text-center align-middle p-0" style="font-size: 12px!important;">{{collect($attendance_setup)->where('days','!=',0)->sum('present')}}</td>
                </tr>
                <tr class="table-bordered">
                    <td class="text-center" style="font-size: 12px!important;"><b>No. of Times <br> Tardy</b></td>
                    @foreach ($attendance_setup as $item)
                        <td class="text-center align-middle p-0" style="font-size: 12px!important;">{{$item->days != 0 ? $item->absent : ''}}</td>
                    @endforeach
                    <td class="text-center align-middle p-0" style="font-size: 12px!important;">{{collect($attendance_setup)->sum('absent')}}</td>
                </tr>
            </table>
        </td>
        <td width="50%" class="p-0" style="padding-left: 15px!important;">
            ...
            <table class="table table-sm mb-0 table-bordered" style="table-layout: fixed; padding-left: 180px; padding-right: 180px; font-size: 15px;">
                <tr>

                    ...
                    <td class="p-0">
                        ...
                        <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 10px; font-size: 12px;">
                            <tr>
                                ...
                                <td width="55%" class="text-center p-0" style="border-bottom: 1px solid #000; font-size: 10px;"><b>{{$principal_info[0]->name}}</b></td>
                            </tr>
                            <tr>
                                <td width="45%" class="text-center p-0" style=""></td>
                                <td width="55%" class="text-center p-0" style="font-size: 10px; padding-top: 2px!important;"><b><i>{{$principal_info[0]->title }}</i></b></td>
                            </tr>
                        </table>
                    </td>
                </tr>

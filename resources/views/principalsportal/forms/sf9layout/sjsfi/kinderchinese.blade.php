...
<table class="table table-sm mb-0 p-0" style="table-layout: fixed;">
    ...
    <tr>
        <td width="100%">
            <img style="padding-top: 4px;" src="{{base_path()}}/public/assets/images/sjsfi/kinder1.png" alt="school" width="100%"  height="100%">
        </td>
    </tr>
</table>
<table class="table table-sm mb-0" style="table-layout: fixed;">
    <tr>
        <td width="100%">
            <img style="padding-top: 4px;" src="{{base_path()}}/public/assets/images/sjsfi/kinder2.png" alt="school" width="100%"  height="100%">
        </td>
    </tr>
    {{-- <tr>
        <td class="p-0">

    ...
    <tr>
                ...
                <td class="p-0" style="border: 1px solid black;">
                      ...
                      <table class="table table-sm mb-0" width="100%">
                            <tr>
                                  ...
                                  <td width="10%" class="text-center chineseLanguage align-middle" style="border-bottom: 1px solid #000;">&nbsp;</td>
            ...
            <table class="table table-sm mb-0 " width="100%">
                <tr>
                        ...
                        <td width="37%" class="text-center chineseLanguage align-middle" style="border: 1px solid #000;">&nbsp;</td>
                        <td width="12%" class="text-center chineseLanguage align-middle" style="border: 1px solid #000;">西名</td>
                        <td width="37%" class="text-center align-middle" style="border: 1px solid #000; font-size:.5rem !important">&nbsp;</td>
                </tr>
            </table>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="57%" style="border-bottom: 1px solid #000;" class=" align-middle">&nbsp;</td>
                    ...
                    <td width="15%" style="border-bottom: 1px solid #000;" class="chineseLanguage align-middle">&nbsp;</td>
                </tr> 
            </table>
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td width="80%" style="border-bottom: 1px solid #000;" class=" align-middle">&nbsp;</td>
                </tr> 
            </table>
                ...
                <tbody>
                    @foreach($chinesesubjects as $item)
                        ...
                        <tr>
                            ...
                            <td width="10%" class="text-center align-middle">&nbsp;</td>
                            <td width="10%" class="text-center align-middle">&nbsp;</td>
                            <td width="10%" class="text-center align-middle">&nbsp;</td>
                            <td width="10%" class="text-center align-middle">&nbsp;</td>
                            <td width="15%" class="text-center align-middle">&nbsp;</td>

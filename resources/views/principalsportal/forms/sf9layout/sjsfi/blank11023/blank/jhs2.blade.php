        ...
        <td class="p-0">
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    ...
                    <td style="width: 50%; text-align: center; vertical-align: middle; margin-top: 10px;">
                        ...
                        <div class="p-0" style="width: 100%; font-size: 10px;">REGION IX</div>
                    </td>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed;">
                <tr>
                    <td width="100%" class="text-center" style="vertical-align: top; ">
                        ...
                        <div class="p-0" style="font-size: 9px;">Gov. Camins Avenue, Canelar, Zamboanga City</div>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: .5em; font-size: 10px;">
                <tr>
                    ...
                    <td width="7%" class="text-left p-0" style="vertical-align: top; border-bottom: 1px solid #000;">&nbsp;</td>
            ...
            <table width="100%" class="table table-sm table-bordered grades" style="margin-top: 10px;">
                ...
                <tbody>
                    <!--@foreach (collect($studgrades)->where('subjid','!=',20)->values() as $item)-->
                    <!--@endforeach-->
                    @foreach ($studgrades as $item)
                        @if($item->subjid!=21 && $item->subjid!=20)
                        <tr>
                            <td style="padding-left:{{$item->subjCom != null ? '2rem':'.25rem'}}; font-size: 9px!important;">{{$item->subjdesc!=null ? $item->subjdesc : null}}</td>
                            <td class="text-center align-middle" style="font-size: 9px!important;">&nbsp;</td>
                            <td class="text-center align-middle" style="font-size: 9px!important;">&nbsp;</td>
                            <td class="text-center align-middle" style="font-size: 9px!important;">&nbsp;</td>
                            <td class="text-center align-middle" style="font-size: 9px!important;">&nbsp;</td>
                            <td class="text-center align-middle" style="font-size: 9px!important;">&nbsp;</td>
                    ...
                    @endforeach
                    <tr>
                        <td class="text-left" style="font-size: 10px!important; font-weight: bold;">GENERAL AVERAGE</td>
                        <td class="text-right"></td>
                        <td class="text-right"></td>
                        <td class="text-right"></td>
                        <td class="text-right"></td>
                        <td class="text-center" style="font-size: 10px!important;"></td>
                        <td class="text-center align-middle" style="font-size: 10px!important;"></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 10px; font-size: 12px; padding-left: 78px; padding-right: 50px;">
                <tr>
                    <td width="100%" class="text-center p-0" style="border-bottom: 1px solid #000;"><span style="text-transform: uppercase!important; first-line">&nbsp;</span></td>
                </tr>
                <tr>
            ...
            <table class="table table-sm mb-0" style="table-layout: fixed; margin-top: 10px; font-size: 12px;">
                <tr>
                    <td width="40%" class="text-center p-0" style=""></td>
                    <td width="60%" class="text-center p-0" style="border-bottom: 1px solid #000; font-size: 10px;"><b>Sr. Josephine C. Sambrano, O.P., MAEd</b></td>
                </tr>
                <tr>
                    <td width="40%" class="text-center p-0" style=""></td>
                    <td width="60%" class="text-center p-0" style="font-size: 10px; padding-top: 2px!important;"><b><i>Principal</i></b></td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td class="p-0">
            ...
            <table class="table-sm table table-bordered mb-0 mt-0" width="100%"  style="table-layout: fixed; margin-top: 3px; font-size: 15px;">
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">1. Honesty</td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">2. Courteousness</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">3. Responsibility</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">4. Resourcefulness and Creativity</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">5. Fairness</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">6. Leadership</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">7. Obedience</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">8. Self-Reliance</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">9. Industry</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                ...
                <tr>
                    <td class="align-middle" style="font-size: 10px;">10. Cleanliness and Orderliness</td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
                    <td class="text-center align-middle" style="font-size: 10px;"></td>
            ...
            <table class="table table-bordered table-sm grades mb-0" width="100%">
                <tr>
                    ...
                    @foreach ($attendance_setup as $item)
                        <td class="aside text-center align-middle;" width="{{$width}}%"><span style="font-size: 8px!important;"><b>{{\Carbon\Carbon::create(null, $item->month)->format('F')}}</b></span></td>
                    @endforeach
                    <td class="text-center p-0" width="7%" style="vertical-align: middle; font-size: 8px!important;"><span style="transform-origin: 13 22; transform: rotate(-90deg); top: 0; bottom: 10;"><b>TOTAL</b></span></td>
                </tr>

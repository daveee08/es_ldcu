...
<head>
    ...
    <style>
        ...
        @page { size: 4in 8.5in; margin: 15px 0px;  }
...
<table class="table table-sm mb-0 p-0" style="table-layout: fixed;">
    ...
    <tr>
        <td width="100%">
            <img style="padding-top: 4px;" src="{{base_path()}}/public/assets/images/sjsfi/g1-101.png" alt="school" width="100%"  height="100%">
            <img style="padding-top: 4px;" src="{{base_path()}}/public/assets/images/sjsfi/ext.png" alt="school" width="100%"  height="100%">
        </td>
    </tr>
</table>
<table class="table table-sm mb-0" style="table-layout: fixed;">
    <tr>
        <td width="100%">
            <img style="padding-top: 4px;" src="{{base_path()}}/public/assets/images/sjsfi/g1-102.png" alt="school" width="100%"  height="100%">
        </td>
    </tr>
    {{-- <tr>
        <td class="p-0">

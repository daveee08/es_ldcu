...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed  pace-primary">
    ...
    <div class="wrapper">
        ...
        @include('bookkeeper.inc.sidenav')
    ...
    <!-- 1. jQuery (must be first for all jQuery plugins) -->
    <script src="{{ asset('plugins/jquery/jquery.min.js') }}"></script>

    <!-- 2. Bootstrap (depends on jQuery) -->
    <script src="{{ asset('plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>

    <!-- 3. Pace and Moment (utilities; moment is needed by daterangepicker) -->
    <script src="{{ asset('plugins/pace-progress/pace.min.js') }}"></script>
    <script src="{{ asset('plugins/moment/moment.min.js') }}"></script>

    <!-- 4. InputMask (jQuery plugin) -->
    <script src="{{ asset('plugins/inputmask/min/jquery.inputmask.bundle.min.js') }}"></script>

    <!-- 5. OverlayScrollbars (jQuery plugin) -->
    ...
    <!-- 7. Select2 (jQuery plugin) -->
    <script src="{{ asset('plugins/select2/js/select2.full.min.js') }}"></script>

    <!-- 8. Croppie (jQuery plugin) -->
    <link rel="stylesheet" href="{{ asset('plugins/croppie/croppie.css') }}">
    ...
    <!-- 10. Daterangepicker (depends on moment) -->
    <script src="{{ asset('plugins/daterangepicker/daterangepicker.js') }}"></script>

    <!-- 11. Summernote (jQuery plugin) -->
    <script src="{{ asset('plugins/summernote/summernote-bs4.min.js') }}"></script>

    <!-- 12. Toastr (jQuery plugin) -->
    <script src="{{ asset('plugins/toastr/toastr.min.js') }}"></script>

    <!-- 13. Bootstrap Switch (jQuery plugin) -->

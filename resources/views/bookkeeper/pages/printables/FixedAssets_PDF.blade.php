...
<body>
    <div style="text-align: center; margin-bottom: 10px;">
        ...
        <h4 style="margin-top: 20px; font-weight: bold;font-size: 16px;">Fixed Assets</h4>
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th>Purchase Date</th>
                <th>Useful Life</th>
                <th>Depreciation Rate per Annum</th>
        ...
        <tbody>
            ...
            @foreach ($entries as $entry)
                ...
                <tr> 
                    ...
                    <td>{{ $entry->asset_value }}</td>
                    <td>{{ explode(' ', $entry->purchased_date)[0] }}</td>
                    <td>{{ $entry->asset_life_yrs ?? '--' }}</td>
                    <td>{{ $entry->depreciation_rate_per_annum  ?? '--' }}</td>

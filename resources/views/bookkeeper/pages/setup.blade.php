                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-box">
                                            <div class="card-body d-flex align-items-top" onclick="window.location.href='/bookkeeper/chart_of_accounts'" style="cursor: pointer;">
                                                <i class="fas fa-book fa-2x  mr-3"></i>
                                                <div>
                                                    <h6 class="mb-0">Chart of Accounts Setup</h6>
                                                    <small class="text-muted">Create and manage COA.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-box">
                                            <div class="card-body d-flex align-items-top" onclick="window.location.href='/bookkeeper/fiscal_year' " style="cursor: pointer;">
                                                <i class="fas fa-cogs fa-2x  mr-3"></i>
                                                <div>
                                                    <h6 class="mb-0">Fiscal Year</h6>
                                                    <small class="text-muted">Specify the start and end date financial year.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Card 3 -->
                                    <div class="col-md-3">
                                        <div style="cursor: pointer;" class="card card-box" onclick="window.location.href='/bookkeeper/enrollment_setup'">
                                            <div class="card-body d-flex align-items-top">
                                                <i class="fas fa-table fa-2x  mr-3"></i>
                                                <div>
                                                    <h6 class="mb-0">Enrollment Setup</h6>
                                    ...
                                    <!-- Card 4 -->
                                    <div class="col-md-3">
                                        <div class="card card-box" onclick="window.location.href='/bookkeeper/other_setup'"  style="cursor: pointer;">
                                            <div class="card-body d-flex align-items-top">
                                                <i class="fas fa-layer-group fa-2x  mr-3"></i>
                                                <div>
                                                    <h6 class="mb-0">Others</h6>
                                                    <small class="text-muted">
                                                        Manage other setups.</small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

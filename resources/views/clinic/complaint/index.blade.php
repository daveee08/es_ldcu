                    ...
                    <div class="card shadow-none" >
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-2">
                                    <label>&nbsp;</label><br/>
                                    <button type="button" class="btn btn-light btn-block" id="btn-create"><i class="fa fa-plus"></i> Create</button>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <label>&nbsp;</label><br/>
                                    <button type="button" class="btn btn-light btn-block" id="btn-generate"><i class="fa fa-sync"></i> Generate</button>
                                </div>
                                <div class="col-md-4 ">
                                    @php
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-7 mb-2">
                        ...
                        <input type="text" class="form-control" id="addcomplaint-benefeciary" placeholder="Leave blank if for self"/>
                    </div>
                    <div class="col-md-5 mb-2">
                        <label>Relationship <span class="text-danger"></span></label><br/>
                        {{-- <input type="text" class="form-control" id="addcomplaint-relationship"/> --}}
    ...
    <div class="modal" id="modal-viewPrescription">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id="viewDescriptionclose">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-body" style="font-size:.8rem !important">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="button" class="btn btn-info btn-sm" style="height: 22px; width :100px; margin: 5px; margin-bottom: 25px" id="btn-approve-prescription"><i class="fa fa-check" aria-hidden="true">Approve</i></button>
                            </div>
                            ...
                            <table class="table table-sm table-striped table-bordered table-hovered table-hover " id="prescription_datatable">
                            <thead>
                                <tr>
                                <th width="10%">#</th>
                                <th width="30%">  Name</th>
            ...
            <div class="modal-footer justify-content-right">
                <button type="button" class="btn btn-primary text-light"  id="btn-export-prescription"><i class="fa fa-download"></i> Download PDF</button>
                <button type="button" class="btn btn-danger " id="btn-delete-prescriptiom"><i class="fa fa-trash"></i> Delete Prescription</button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" id = "addprescriptionclose">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default text-right" data-dismiss="modal" id="btn-close-addprescription">Close</button>
                <button type="button" class="btn btn-primary " id="btn-submit-medicineadd"><i class="fa fa-plus"></i> Add medicine</button>
                <button type="button" class="btn btn-primary" id="btn-submit-addprescription"><i class="fa fa-share"></i> Submit</button>
                </div>
            </div>
            </div>
            <!-- /.modal-content -->
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('#btn-create').on('click', function(){
                ...
                $('#addcomplaint-relationship').val($('#addcomplaint-relationship option:first').val()).trigger('change');
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        $('#addcomplaint-complainant').val($('#addcomplaint-complainant option:first').val()).trigger('change');
                    }
                })
            })
            ...
            $(document).on('click','#btn-approve-prescription', function(){
                id = approvalcomplain;
                var data1 = <?php echo json_encode($check_refid->refid);?>;
                ...
                $.ajax({
                    url:'/clinic/complaints/viewPres',
                            ...
                            success:function(data) {
                                ...
                                var markdate2 = date3.toLocaleDateString("en-US", {month: "long", year: "numeric", day: "numeric"});
                                ...
                                doctorNameElement.innerHTML = 'Prescribed by: ' + '<strong>' + data[0].doctorname +'</strong>';
                                if(data[0].benefeciaryname != null|| data[0].benefeciaryname =="" ){
                                patientNameElement.innerHTML ="<strong>" + " Patient Name:" + "</strong>" + '&nbsp;' +data[0].benefeciaryname + '&nbsp' +"(Beneficiary of " + text.replace(/^\s+|\s+$/g, "") + ')';
                                }else{
                                    patientNameElement.innerHTML ="<strong>" + "Patient name:" + "</strong>" + '&nbsp;' + text.replace(/^\s+|\s+$/g, "");

                                }
                                followupElement.innerHTML = "<strong>" +"Date: " + markdate2 + "</strong>";
                                var data1 = <?php echo json_encode($check_refid->refid);?>;
                                var data2 = <?php echo json_encode(auth()->user()->id);?>;
                                ...
                                if(data1 == 25){
                                    if(data[0].docid != data2){
                                        if (data[0].Approve == 0){
                                            ...
                                            statuseElement.innerHTML = '<span class= "badge badge-success">'+ 'Prescription Approved by the doctor' + '</span>';
                                        }else{
                                            document.getElementById('btn-approve-prescription').style.visibility = 'hidden';  
                                            statuseElement.innerHTML = '<span class= "badge badge-warning">'+ 'Pending Approval by the Doctor' + '</span>';
                                            }
                                        }else{
                                            if (data[0].Approve == 0){
                                            document.getElementById('btn-approve-prescription').style.visibility = 'hidden';
                                            ...
                                            document.getElementById('btn-approve-prescription').style.visibility = 'visible';
                                            statuseElement.innerHTML = '<span class= "badge badge-warning">'+ 'Pending Approval by the Doctor' + '</span>';
                                            }
                                ...
                                if(data1 == 24){
                                    if (data[0].Approve == 0){
                                    document.getElementById('btn-approve-prescription').style.visibility = 'hidden';
                                    document.getElementById("btn-export-prescription").style.visibility = 'visible';
                                    statuseElement.innerHTML = '<span class= "badge badge-success">'+ 'Prescription Approved by the doctor' + '</span>';
                                    }else{
                                    statuseElement.innerHTML = '<span class= "badge badge-warning">'+ 'Pending Approval by the Doctor' + '</span>';
                                    document.getElementById('btn-approve-prescription').style.visibility = 'hidden';
                                    document.getElementById("btn-export-prescription").style.visibility = 'hidden';
                                    }
            ...
            columnDefs: [
                    ...
                    'createdCell':  function (td, cellData, rowData, row, col) {
                            if(rowData.duration == 1){
                                ...
                                $(td)[0].innerHTML = rowData.duration + " "+"Days" + "<br/>" + " Total Medicine:" + "&nbsp" + rowData.quantity
                            }
                    }
                    },
            ...
            $(document).on('click','.btn-complaint-addprescription', function(){
                ...
                var docid = <?php echo json_encode(auth()->user()->id);?>;
                var data1 = <?php echo json_encode($check_refid->refid);?>;
                $('#viewDescriptionclose').click();
                ...
                $.ajax({
                    ...
                    success:function(data)
                    {
                        ...
                        if(data1 == 25)
                        {
                            $('#selectdoctor-docid option[value="'+docid+'"]').prop('selected', true);
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        if(type == "STUDENT"){
                            ...
                            document.getElementById("addcomplaint-benefeciary").readOnly = false;
            ...
            $('#btn-submit-addprescription').on('click', function(){
                ...
                name1=  jQuery("#selectdoctor-docid").find("option[value='" + jQuery("#selectdoctor-docid").val() + "']").text();
            ...
            $('#btn-submit-addcomplaint').on('click', function(){
                ...
                if(disabled == 1){
                    if(relationship == "Select Relationship" && beneficiary.replace(/^\s+|\s+$/g, "").length > 0 ){

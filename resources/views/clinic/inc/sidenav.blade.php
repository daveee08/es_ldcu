...
<aside class="main-sidebar sidebar-dark-primary elevation-4 asidebar">
    ...
    <div class="ckheader">
        <a href="#" class="brand-link sidehead">
            ...
            <span class="brand-text font-weight-light"
                style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>CLINICS'S
                    PORTAL</b></span>
        </a>
    </div>
    @php
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="/clinic/personnel/index" id="dental"
                        class="nav-link {{ Request::url() == url('/clinic/personnel/index') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="/clinic/inventory/index" id="dental"
                        class="nav-link {{ Request::url() == url('/clinic/inventory/index') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="/clinic/records/index" id="dental"
                        class="nav-link {{ Request::url() == url('/clinic/records/index') ? 'active' : '' }}">
                        <i class="nav-icon fa fa-folder"></i>
                        <p>
                            Reports
                        </p>

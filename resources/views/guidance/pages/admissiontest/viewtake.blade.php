                        ...
                        @else
                            ...
                            @else
                                    ...
                                    <div class="card mt-5" style="border-top: 10px solid #55bedb; border-radius: 10px;">
                                        <div class="card-header">
                                            <h1 class="card-title" style="font-size: 24px;">{{$testinfo->title}}</h1>
                                        </div>

                                        <div class="card-body" style="font-size: 16px;">
                                            <h5><span>Status:</span> <b>Active</b></h5>
                                            <ul class="list-unstyled">
                                                <li>Deadline: {{\Carbon\Carbon::create($admissiontestsched->dateto.' '.$admissiontestsched->timeto)->isoFormat('MMMM DD, YYYY hh:mm A')}}</li>
                                                <li>Time limit: {{$admissiontestsched->hour}}
                                            ...
                                            <label for="poolingnumber" style="font-size: 16px;">Enter Pooling Number Here:</label>

                                ...
                                <div class="card-body position-relative">
                                    <div class="row">
                                        <div class="col-md-4"> <!-- Adjusted column classes for responsiveness -->
                                            <img src="{{ asset('${REPORT_DATA[i].picurl}') }}" alt="profile"  onerror="this.onerror = null, this.src='{{asset('/avatar/T(M) 3.png')}}'" style="max-height: 100px; width: 50px; border-radius: 50%; overflow: hidden;" class="w-100"> <!-- Added 'img-fluid' class for responsive images -->
                                        </div>
                                        <div class="col-md-8">
                ...
                for (var i = 0; i < REPORT_DATA2.length; i++) {
                    ...
                    html +=`<div class="card shadow rounded draggable-card" data-id="${REPORT_DATA2[i].id}" data-type="1" style="background-color: ${REPORT_DATA2[i].color}">
                                <div class="card-body position-relative">
                                    <div class="row">
                                        <div class="col-md-4"> <!-- Adjusted column classes for responsiveness -->
                                            <img src="{{ asset('${REPORT_DATA2[i].picurl}') }}" alt="profile"  onerror="this.onerror = null, this.src='{{asset('/avatar/T(M) 3.png')}}'" style="max-height: 100px; width: 50px; border-radius: 50%; overflow: hidden;" class="w-100"> <!-- Added 'img-fluid' class for responsive images -->
                                        </div>
                                        <div class="col-md-8">
                ...
                for (var i = 0; i < RESOLVE_REPORT.length; i++) {
                    ...
                    html +=`<div class="card shadow rounded" data-id="${RESOLVE_REPORT[i].id}" id="resolve" data-type="0" style="background-color: ${RESOLVE_REPORT[i].color}">
                                <div class="card-body position-relative">
                                    <div class="row">
                                        <div class="col-md-4"> <!-- Adjusted column classes for responsiveness -->
                                            <img src="{{ asset('${RESOLVE_REPORT[i].picurl}') }}" alt="profile"  onerror="this.onerror = null, this.src='{{asset('/avatar/T(M) 3.png')}}'"   style="max-height: 100px; width: 50px; border-radius: 50%; overflow: hidden;" class="w-100"> <!-- Added 'img-fluid' class for responsive images -->
                                        </div>
                                        <div class="col-md-8">
                ...
                for (var i = 0; i < ABSENT_TABLE.length; i++) {
                    ...
                    html +=`<div class="card shadow rounded" id="absenttable" data-studid="${ABSENT_TABLE[i].studid}">
                                <div class="card-body position-relative">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="{{ asset('${ABSENT_TABLE[i].picurl}') }}" alt="profile" ile"  onerror="this.onerror = null, this.src='{{asset('/avatar/T(M) 3.png')}}'"  style="height: 50px; width: 50px; border-radius: 50%; overflow: hidden;" class="h-100 w-100">
                                        </div>
                                        <div class="col-md-8">

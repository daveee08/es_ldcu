        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="input-group mb-3">
                    <input id="coa_search" type="text" class="form-control filter" placeholder="Account Title"
...
@section('modal')
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content text-sm" style="">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-10">
                            <select id="coa_map" class="select2 form-control">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-primary btn-block" data-toggle="tooltip" title="Create Mapping"><i
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content text-sm" style="">
                ...
                <div class="modal-body">
                    <div class="row form-group">
                        <div class="col-md-12">
                            <input id="group_accounttype" class="form-control" placeholder="Account Type"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-warning btn-block" data-toggle="tooltip"
                                title="View Sorting">Sort</i></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button id="coa_groupsave" type="button" class="btn btn-primary" data-id="0"
    ...
    <div class="modal fade show" id="modal-classifications" aria-modal="true"
            ...
            $(document).on('click', '.account_edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#coa_map').val(data.mapid).trigger('change')
                        $('#modal-accounts').modal('show');
                    }
                });
            });

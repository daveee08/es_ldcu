        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap">
          <div class="mb-2 mb-md-0">
            <h4 class="mb-0 font-weight-bold">
              <i class="fas fa-exchange-alt mr-2"></i>ADJUSTMENTS
            </h4>
          </div>
          
          <div>
            <button class="btn btn-light text-primary font-weight-bold mr-2" id="btn-export" data-toggle="tooltip" title="Export to Excel">
                <i class="fas fa-file-excel mr-1"></i> Export
            </button>
            <button class="btn btn-light text-primary font-weight-bold" id="btn-adjnew" data-toggle="tooltip" title="Create New Adjustment">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">School Year</label>
              <select id="cbosy" class="form-control form-control-sm shadow-sm searchcontrol">
          ...
          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Semester</label>
              <select id="cbosem" class="form-control form-control-sm shadow-sm searchcontrol">
          ...
          <div class="col-md-8 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Description</label>
              <select id="cbodesc" class="form-control form-control-sm shadow-sm searchcontrol" multiple>
          ...
          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Select Level</label>
              <select id="cbolevel" class="form-control form-control-sm shadow-sm  searchcontrol">
                <option value="">ALL LEVEL</option>
                @foreach(DB::table('gradelevel')->where('deleted', 0)->get() as $level)
          ...
          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Date From</label>
              <input type="date" id="datefrom" class="form-control form-control-sm shadow-sm  searchcontrol" value="{{DB::table('sy')->where('isactive', 1)->value('sdate')}}">
            </div>
          </div>
      
          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Date To</label>
              <input type="date" id="dateto" class="form-control form-control-sm shadow-sm  searchcontrol" value="{{\Carbon\Carbon::now('Asia/Manila')->toDateString()}}">
            </div>
          </div>

          <div class="col-md-2 mb-2">
            <div class="form-group mb-0">
              <label class="mb-0 small font-weight-bold">Select Credit/Debit</label>
              <select id="cbocreditdebit" class="form-control form-control-sm shadow-sm searchcontrol">
            ...
            <div class="col-md-4">
              <div class="card card-widget">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label>Available Particulars</label>
                      <select id="txtdescriptionselect" class="select2bs4 form-control">
                        <option value="">&nbsp;</option>
                        @php
                          $particulars = db::table('adjustments')
                        ...
                        @foreach($particulars as $particular)
                          <option value="{{$particular->description}}">{{$particular->description}}</option>
                        @endforeach
                    ...
                    <div class="col-md-12">
                      ...
                      <input type="text" id="txtdescription" class="form-control is-invalid validation" placeholder="Enter Adjustment Particulars">
                    </div>
...
@section('js')
  ...
  function exportToExcel() {
      ...
      var desc = $('#cbodesc').val();
      var datefrom = $('#datefrom').val();
      var dateto = $('#dateto').val();
      var cbocreditdebit = $('#cbocreditdebit').val();

      // Create a form dynamically
      var form = document.createElement('form');
      form.method = 'GET';
      form.action = "{{ route('exportadj') }}";
  ...
  $(document).ready(function() {
    ...
    $(document).on('change', '#txtdescriptionselect', function(){
        if($(this).val() == ''){
            $('#txtdescription').val('');
        }else{
            $('#txtdescription').val($(this).val());
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      function searchADJ() {
        ...
        var semid = $('#cbosem').val();
        var level = $('#cbolevel').val();
        var desc = $('#cbodesc').val(); // This will now be an array of selected values
        var datefrom = $('#datefrom').val();
        var dateto = $('#dateto').val();
        var cbocreditdebit = $('#cbocreditdebit').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                semid: semid,
                level: level,
                desc: desc, // Pass array of selected descriptions
                datefrom: datefrom,
                dateto: dateto,
                cbocreditdebit: cbocreditdebit
            },
            ...
            success: function(data) {
                ...
                // Update description dropdown options
                var descarr = data.desc.map(function(v){ 
                    return $('<option>').val(v).text(v); 
                });
                $('#cbodesc').select2({
                    multiple: true
                })
                $('#cbodesc').empty().append(descarr);

                // Re-select previously selected options if any

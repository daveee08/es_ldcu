        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="input-group mb-3">
                    <input id="txtsearchitem" type="text" class="form-control" placeholder="Search Item"
              ...
              <div id="modalhead" class="modal-header bg-info text-white">
                ...
                <div class="modal-body">
                  <div class="form-group row">
                      ...
                      <label for="item_classcode" class="col-sm-3 col-form-label text-right">Consolidated Grouping</label>
                      <div class="col-sm-3">

            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <small class="ml-2"><a href="/home">Home</a> > Expenses Monitoring</small>
                    </div>
                </div>
                <br>
                ...
                <div class="row mb-3">
                    <div class="col-md-2">
                      <label for="">Status</label>
                        <select id="expense_filter" class="form-control form-control-sm">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            <input id="datefrom" type="date" name="" class="form-control form-control-sm"
                    ...
                    <div class="col-md-2">
                        <label for="">Date from</label>
                        <div class="input-group">
                            <input id="dateto" type="date" name="" class="form-control form-control-sm"
                ...
                <div class="row mb-2 mt-2">
                    <div class="col-md-2">
                        <button id="expense-new" class="btn btn-sm btn-success btn-block" data-toggle="modal"
                            data-target="#modal-expense">+ Add Expenses</button>
                    </div>
                    <div class="col-md-2">
                      <button id="expense-report" class="btn btn-sm btn-info btn-block">
                        <i class="fa fa-file-pdf mr-1" aria-hidden="true"></i>Print</button>
                    </div>

                    <div class="col-md-4 ml-auto">
                      <div class="input-group">
                          <input id="search" type="text" class="form-control form-control-sm" placeholder="Search Expenses">
...
@endsection
@section('modal')
    <div class="modal fade show" id="modal-expense" aria-modal="true"
        style="display: none; margin-top: -25px; overflow-y: hidden; height: 768px" data-backdrop="static">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input id="voucherno" type="text" class="form-control border-0 text-xl text-bold"
                                placeholder="Voucher No.">
                        </div>
                        <div class="col-md-6">
                            <button id="expense_print" class="btn btn-primary float-right"><i class="fas fa-print"></i>
                                Print</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group input-group-lg">
                                ...
                                <input id="description" type="text"
                                    class="form-control form-control-lg text-lg validate is-invalid"
                    ...
                    <div class="card">
                        <div class="card-body bg-light">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input id="je_debitamount" type="number"
                                        class="form-control calc text-right p-1 text-sm" name="currency-field"
                                        pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="" data-type=""
                                        data-toggle="tooltip" title="Press enter to save" placeholder="0.00">
                                </div>
                                <div class="col-md-2">
                                    <input id="je_creditamount" type="number"
                                        class="form-control calc text-right p-1 text-sm" name=""
                                        pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value="" data-type=""
                                        data-toggle="tooltip" title="Press enter to save" placeholder="0.00">
                                </div>
                                <div class="col-md-2" style="padding-top: 3px">
                                    <button id="float_je_save" class="btn btn-primary btn-sm"><i
                                            class="fas fa-save"></i></button>
                                    <button id="float_je_close" class="btn btn-danger btn-sm"><i
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                        <button id="btncreateItem" class="btn btn-primary" data-toggle="tooltip"
                                            title="Create Items"><i class="fas fa-external-link-alt"></i></button>
                                    </span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Total</label>
                                <input id="totalamount" type="text" class="form-control" placeholder="0.00"
                                    disabled="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-2">
                            <button id="btnadd" type="button" data-id="0" class="btn btn-primary"
                    ...
                    <form class="form-horizontal">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation"
                                        id="company_name" placeholder="Pay To"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation"
                                        id="company_department" placeholder="Department"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
    ...
    <div class="modal fade show" id="modal-supplierdetail" aria-modal="true"
        style="padding-right: 17px; margin-top:15em; display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">Supplier</h4>
                    ...
                    <form class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation"
                                        id="sup_department" placeholder="Department"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
    ...
    <div class="modal fade show" id="modal-reports" aria-modal="true" style="padding-right: 17px; display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="margin-top: 18em">
                <div class="modal-header bg-info">
                ...
                <div class="modal-body text-sm">
                    <div class="card-body">
                        <div class="row form-group">
                            <div class="col-md-6">
                                <div id="cv_print" class="col-md-12" style="cursor: pointer;">
                                    <div class="small-box bg-success">
                                        <div class="inner">
                                            <br>
                                            <span class="text-bold">
                                                <h4>Cash Voucher</h4> <br>
                                            </span>
                                        </div>
                                        <div class="icon">
                                        ...
                                        <a href="#" class="small-box-footer">
                                            {{-- SUMMARY <i class="fas fa-arrow-circle-right"></i> --}}
                                            &nbsp;
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div id="chv_print" class="col-md-12" style="cursor: pointer;">
                                    <div class="small-box bg-primary">
                                        <div class="inner">
                                            <br>
                                            <span class="text-bold">
                                                <h4>Check Voucher</h4> <br>
                                            </span>
                                        </div>
                                        <div class="icon">
                                            <i class="fas fa-money-check"></i>
    ...
    <div class="modal fade show" id="modal-itemdetail" aria-modal="true"
        style="padding-right: 17px; margin-top:6em; display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function loadje(headerid) {
                $.ajax({
                  ...
                  `)
                        ...
                        $('#totaldebit').text(parseFloat(dtotal, 10).toFixed(2).replace(
                            /(\d)(?=(\d{3})+\.)/g, "$1,").toString())
                        $('#totalcredit').text(parseFloat(ctotal, 10).toFixed(2).replace(
                            /(\d)(?=(\d{3})+\.)/g, "$1,").toString())
                    }
                });
            }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (trans == 1) {
                                ...
                                // console.log(data);
                                $('#btnsaveheader').attr('data-id', data.ins);
            ...
            $(document).on('click', '#expense-new', function() {
                ...
                if ($('#expense_cash').prop('checked') == true) {
                    ...
                    $('#expense_bank').attr('disabled', true);
                    $('#expense_checkno').attr('disabled', true);
                    $('#expense_checkdate').attr('disabled', true);
                } else {
                    paytype = "CHECK"

                    $('#expense_bank').attr('disabled', false);
                    $('#expense_checkno').attr('disabled', false);
                    $('#expense_checkdate').attr('disabled', false);
                }

                $('#voucherno').val('');

                getVoucherNo('EXP', paytype);
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.status == 'APPROVED') {
                            ...
                            $('#modal-expense .modal-header').removeClass(
            ...
            $(document).on('click', '#expense-detail tr', function() {
                ...
                if ($('#lblrefnum').attr('data-status') != 'APPROVED' && $('#lblrefnum').attr(
        ...
        `)
            ...
            $(document).on('click', '#cv_print', function() {
                let datefrom = $('#datefrom').val()
                let dateto = $('#dateto').val()
                let paytype = 'CASH'

                window.open('/finance/cv_print?paytype=' + paytype + '&datefrom=' + datefrom + '&dateto=' +
                    dateto, '_blank');
            })

            $(document).on('click', '#chv_print', function() {
                let datefrom = $('#datefrom').val()
                let dateto = $('#dateto').val()
                let paytype = 'CHECK'
            ...
            $(document).on('click', '#expense-report', function() {

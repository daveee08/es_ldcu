...
.table-responsive > .table-bordered {
  ...
  <body>
      ...
      <br><br>
      <table style="width: 100%; font-size: 10;" cellpadding = 0 cellspacing = 0>
        <tr>
          <td>Pay to: <span class="text-bold">{{$supplier->companyname}}</span></td>
          <td style="text-align: right;;">No.: <span class="text-bold">{{($expense->paytype == 'CASH') ? 'CV - ' . $expense->voucherno:'CHV - ' . $expense->voucherno}}</span></b></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="text-right">Date Printed: {{ date_format(date_create(\App\FinanceModel::getServerDateTime()), 'm/d/Y h:i A') }}</td>
      ...
      <div class="" style="margin-left: 0em">
        <table cellspacing="0" cellpadding="0" class="table" style="width: 100%">
          <thead>
            <tr>
              ...
              <th class="" style="text-align: left;">Explanation</th>
        ...
        @if($paytitle == 'CHECK')
          <table cellspacing="0" cellpadding="0" class="table" style="width: 100%; font-size: 11px;">
            <tr>
        ...
        @php
            $sig = db::table('finance_sigs')
                ->where('report_description', 'VOUCHER')
                ->first();
        @endphp
        <div style="line-height: 3px;"></div>
        <div style="line-height: 3px; font-weight: bold; font-size: 11px; ">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            {{$sig->title_1 ?? ''}}:
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br><br><br>
        <div style="line-height: 3px;"></div>
        <table style="width: 100%; table-layout: fixed; font-size: 11px; font-weight: bold;">
            <tr>
                ...
                <td style="width: 10%;"></td>
                <td style="width: 30%; border-bottom: 1px solid black; text-align: center;">{{$sig->sig_3 ?? ''}}</td>
                <td style="width: 10%;"></td>
            </tr>
            <tr>
                <td style="width: 10%;"></td>
                ...
                <td style="width: 10%;"></td>
                <td style="width: 30%; text-align: center;">{{$sig->designation_3 ?? ''}}</td>
                <td style="width: 10%;"></td>
            </tr>
        ...
        <table style="width: 100%; table-layout: fixed; font-size: 11px; font-weight: bold;">
            <tr>
                <td style="width: 10%;"></td>
                <td style="width: 30%; border-bottom: 1px solid black; text-align: center">Jaime Rafael U. Paguio</td>
                <td style="width: 20%;"></td>
            ...
            <tr>
                <td style="width: 10%;"></td>
                <td style="width: 30%; text-align: center;">President</td>
                <td style="width: 20%;"></td>
                <td style="width: 30%; text-align: center;"></td>
                <td style="width: 10%;"></td>
            </tr>

    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-1">
            <button id="expense-report" class="btn btn-info btn-block">Reports</button>
          </div>
        </div>
...
@section('modal')
  ...
  <div class="modal fade show" id="modal-expense" aria-modal="true" style="display: none; margin-top: -25px; overflow-y: hidden; height: 768px" data-backdrop="static">
              ...
              <div class="col-md-6">
                <div id="cv_print" class="col-md-12" style="cursor: pointer;">
                  <div class="small-box bg-success">
                    <div class="inner">
                      <br>
                      <span class="text-bold"><h4>Cash Voucher</h4> <br></span>
                    </div>
                    <div class="icon">
              ...
              <div class="col-md-6">
                <div id="chv_print" class="col-md-12" style="cursor: pointer;">
                  <div class="small-box bg-primary">
                    <div class="inner">
                      <br>
                      <span class="text-bold"><h4>Check Voucher</h4> <br></span>
                    </div>
                    <div class="icon">
                      <i class="fas fa-money-check"></i>
                    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(document).on('click', '#cv_print', function(){
        ...
        window.open('/finance/cv_print?paytype='+paytype+'&datefrom='+datefrom+'&dateto='+dateto, '_blank');
      })

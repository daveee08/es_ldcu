                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group mb-3">
                            <select id="cbosy" class="form-control searchcontrol" data-toggle="tooltip"
                                title="School Year">
                    ...
                    <div class="col-md-2">
                        <div class="form-group mb-3">
                            <select id="cbosem" class="form-control searchcontrol" data-toggle="tooltip"
                                title="Semester">
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <select id="cboglevel" class="form-control searchcontrol" data-toggle="tooltip"
                                title="Grade Level">
                            ...
                            <div class="input-group-append">
                                @if (DB::table('schoolinfo')->first()->lockfees == 0)
                                    <button class="btn btn-primary" id="btnitem-new" {{-- onclick="window.location= '{!! route('feesnew')!!}'" --}}
                                        data-toggle="tooltip" title="New">New</button>
                                @else
                                    <button class="btn btn-primary" id="btnitem-new" {{-- onclick="window.location= '{!! route('feesnew')!!}'" --}}
                                        data-toggle="tooltip" title="New" disabled="">New</button>
                                @endif
                            </div>
                            <div class="input-group-append">
                                @if (DB::table('schoolinfo')->first()->lockfees == 0)
                                    <button class="btn btn-warning" id="btndupAll" data-toggle="tooltip"
                                        title="Duplicate Entire Setup">Duplicate</button>
                                @else
                                    <button class="btn btn-warning" id="btndupAll" data-toggle="tooltip"
                                        title="Duplicate Entire Setup" disabled="">Duplicate</button>
                                @endif
                            </div>
                        </div>
                    </div>
...
@section('modal')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">School Fees - New</h4>
    ...
    <div class="modal fade show" id="modal-dupAll" aria-modal="true" style="padding-right: 17px; display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button id="btndup" type="button" class="btn btn-primary"
                        data-dismiss="modal">Duplicate</button>
                </div>
            </div>
        </div> {{-- dialog --}}
    </div>
        ...
        <div class="modal-dialog modal-xl mt-0">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">SCHOOL FEES - <span id="action"></span></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control is-invalid is-val" id="txtdesc"
                                    placeholder="Description" onkeyup="this.value = this.value.toUpperCase();">
                            </div>
                        </div>

                        <div class="col-md-2 semUI">
                            <div class="form-group">
                                <label for="txtnopay">Semester</label>
                                <select class="form-control" id="feesSem">
                                    @foreach (App\FinanceModel::getSem() as $sem)
                                        @if ($sem->isactive == 1)
                                            <option selected="" value="{{ $sem->id }}">{{ $sem->semester }}
                                            </option>
                                        @else
                                            <option value="{{ $sem->id }}">{{ $sem->semester }}</option>
                                        @endif
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="feesSY">
                                    @foreach (App\FinanceModel::getSY() as $sy)
                                        @if ($sy->isactive == 1)
                                            <option selected="" value="{{ $sy->id }}">{{ $sy->sydesc }}
                                            </option>
                                        @else
                                            <option value="{{ $sy->id }}">{{ $sy->sydesc }}</option>
                                        @endif
                            ...
                            <div class="form-group">
                                ...
                                <select id="course" class="form-control select2bs4">
                                    ...
                                    @foreach (App\FinanceModel::loadCourses() as $course)
                                        <option value="{{ $course->id }}" data-value="{{ $course->courseabrv }}">
                        ...
                        <div id="detailui" class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <button id="viewpaysched" class="btn btn-warning">VIEW PAYMENT
                                                SCHEDULE</button>
                                            <button id="coladdclass" class="btn btn-primary">ADD CLASSIFICATION</button>
                                        </div>
                                        @if (DB::table('schoolinfo')->first()->paymentplan == 1)
                                            <div class="col-md-4 text-right">
                                                <button id="btnpaymentplan" class="btn btn-success">ENTER PAYMENT
                                                    PLAN</button>
                                            </div>
                                        @endif
                                    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button id="printFC" class="btn bg-info btn-default btn-block"><i class="fas fa-print"></i>
                                Print</button>
                        </div>
                        <div class="col-md-2 dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a id="headdelete" class="dropdown-item" href="#"><i class="fas fa-trash"></i>
                                    Delete</a>
                                <a id="headduplicate" class="dropdown-item" href="#"><i class="fas fa-copy"></i>
                                    Duplicate</a>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <button id="saveFC" type="button" class="btn btn-primary btn-block"><i
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" name="" id="txtpaymentplan" class="form-control"
                                placeholder="REGULAR/WORKING STUDENT/NIGHT CLASS">
                        </div>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
    ...
    <div class="modal fade show" id="modal-paysched" aria-modal="true" style="display: none;">
        <div class="modal-dialog modal-xl mt-1">
            <div class="modal-content">
                <div id="schedOverlay" class="overlay d-flex justify-content-center align-items-center"
                    style="display: none !important;">
                    <i class="fas fa-2x fa-sync fa-spin"></i>
                </div>
                <div class="modal-header bg-primary">
                    <h4 class="modal-title">Payment Schedule</h4> 
                    <input type="hidden" id="payschedid">

                    <span id="desc" hidden></span>
                    <span id="sydesc" hidden></span>
                    <span id="granteedesc" hidden></span>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button id="print-paysched" type="button" class="btn btn-info"><i class="fas fa-file-pdf"></i> Print</button>
                </div>
            </div>
        </div> {{-- dialog --}}
    </div>
            ...
            <div class="modal-content">
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responisve overflow-auto" style="height: 243px">
                                    <table class="table table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="2"><span id="col-add-item"
                                                        class="text-primary cursor-pointer"><u>Add Item</u></span></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                ...
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <button id="col-delPayClass" type="button" class="btn btn-danger btn-block"
                                data-id="0">Delete</button>
                        </div>
                        <div class="col-md-2">
                            <button id="col-savePayClass" type="button" class="btn btn-primary btn-block"
                                data-id="0" data-dismiss="modal">Save</button>
                        </div>
                    </div>
                </div>
                {{-- <div class="modal-footer justify-content-between">
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    ...
                    <button id="modal-payitem_close" type="button" class="close" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-1 mt-1">
                                ...
                                <button id="fc-btnadditem" class="btn btn-primary btn-sm" data-toggle="tooltip"
                                    title="Add new item">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="">
                                    <input type="text" class="form-control val-item is-invalid" name="currency-field"
                                        id="fc-txtamount" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" value=""
                                        data-type="currency">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button id="fc-deleteItem" type="button" class="btn btn-danger btn-block"
                                data-id=0>Delete</button>
                        </div>
                        <div class="col-md-3">
                            <button id="fc-appendItem" type="button" class="btn btn-dark btn-block" data-id=0><i
                                    class="fas fa-save"></i> Save</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content text-sm">
                ...
                <div id="modalhead" class="modal-header bg-info text-white">
                    ...
                    <button id="modal-items_detail_close" type="button" class="close text-black" aria-label="Close">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9 d-flex justify-content-between">
                            <div class="icheck-primary d-inline">
                                <input type="checkbox" id="item_cash" disabled>
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control validation" id="fc-item-code"
                                    placeholder="Item Code" onkeyup="this.value = this.value.toUpperCase();">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control validation" id="fc-item-desc"
                                    placeholder="Description" onkeyup="this.value = this.value.toUpperCase();">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="number" class="form-control validation" id="fc-item-amount"
                                    placeholder="0.00">
                            </div>
                        </div>
    ...
    <div class="modal fade show" id="modal-col-class-mopid" aria-modal="true"
                            ...
                            <div class="col-sm-12">
                                <select class="form-control select2bs4" id="col-class-mopid_mopid">
                                    ...
                                    @foreach (db::table('paymentsetup')->where('deleted', 0)->get() as $mop)
                                        <option value="{{ $mop->id }}">[{{ $mop->noofpayment }}]
                                            {{ $mop->paymentdesc }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#modal-payitem').on('hidden.bs.modal', function(e) {
                descriptions = [];
            });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == 1) {
                            Swal.fire(
                                'Warning',
                                'SY has already a setup. Please remove all the School Fees setup of the selected School Year to use the Duplicate Function',
                                'warning'
                            );
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data == 1) {
                                    searchfees($('#cbosy').val(), $('#cbosem').val(), $(
                                        '#cboglevel').val());
            ...
            $(document).on('click', '#btndup', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        Swal.fire(
                            'Success!',
                            'School Fees has been duplicated.',
                            'success'
                        );
            ...
            $(document).on('click', '#printFC', function() {
                var headid = $(this).attr('data-id');
                if (headid) {
                    window.open('/finance/printFC/' + headid, '_blank');
                } else {
                    Swal.fire({
                        icon: 'error',
                        title: 'Error',
                        text: 'No head ID found. Please try again.'
                    });
                }
            });
            ...
            function searchItems() {
                ...
                if ($('#col-classification').val() != '' && $('#col-classification').val() != null) {
                    // Loop through each row with class col-item-list and get the description
                    $('#col-payclass-list .col-item-list').each(function() {
                        let description = $(this).find('td:first').text().trim();
                        descriptions.push(description);
                    });

                    console.log(descriptions, 'first description');
            ...
            $(document).on('click', '#fc-appendItem', function() {
                ...
                var itemdesc = $('#fc-item').find('option:selected').text();
                var itemamount = $('#fc-txtamount').val().replace(',', '');

                var desc_array = descriptions;
                ...
                if (desc_array.includes(itemdesc)) {
                    Toast.fire({
                        type: 'error',
            ...
            $(document).on('click', '#saveFC', function() {
                ...
                if (vCount > 0) {
                    $('#coladdclass, #saveFC').prop('disabled', true);
                } else {
                    $('#coladdclass, #saveFC').prop('disabled', false);
                }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            Swal.fire({
                                type: 'success',
                                title: 'Success!',
                                text: 'School Fees successfully saved.',
                                timer: 1500,
                                showConfirmButton: false
                            });

                            $('#modal-fees').modal('hide');
                            searchfees($('#cbosy').val(), $('#cbosem').val(), $('#cboglevel')
                                .val());
                        },
                        error: function(xhr) {
                            if (xhr.status === 400) {
            ...
            $(document).on('click', '#fc-btnadditem', function() {
                ...
                $('#item_classid').select2({
                    theme: 'bootstrap4'
                });
                $('#item_classcode').select2({
                    theme: 'bootstrap4'
                });
                $('#item_glid').select2({
                    theme: 'bootstrap4'
            ...
            $(document).on('click', '#item_save', function() {
                ...
                if (classcode == 0) {
                    Swal.fire({
                        title: "Do you want to proceed without payment group?",
                        text: "",
                        type: "warning",
                        showCancelButton: true,
                        confirmButtonColor: "#3085d6",
            ...
            $(document).on('click', '#viewpaysched', function() {
                ...
                var description = $('#txtdesc').val();
                var sydescription = $('#feesSY option:selected').text();
                var grantedescription = $('#grantee option:selected').text(); 

                $('#payschedid').val(tuitionid);
                $('#desc').text(description);
                $('#sydesc').text(sydescription);
                $('#granteedesc').text(grantedescription);
            ...
            $(document).on('click', '#print-paysched', function() {

                var tuitionid = $('#payschedid').val();
                var description = $('#desc').text();
                var sydescription = $('#sydesc').text();
                var grantedescription = $('#granteedesc').text(); 

                var url = '/finance/printpaysched/' + tuitionid +
                    '?description=' + encodeURIComponent(description) +
                    '&sydescription=' + encodeURIComponent(sydescription) +
                    '&grantedescription=' + encodeURIComponent(grantedescription);
            ...
            $(document).on('click', '#modal-payitem_close', function() {
                $('#modal-payitem').modal('hide');
            })
            $(document).on('click', '#modal-items_detail_close', function() {
                $('#modal-items_detail').modal('hide');
            })

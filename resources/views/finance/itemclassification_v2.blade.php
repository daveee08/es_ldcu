                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="main_table" class="table-responsive p-0">
                            ...
                            <table width="100%" id="class_list" class="table table-hover table-sm text-sm" style="table-layout: fixed">
                                <thead class="bg-warning p-0">
                                  <tr>
                                    <th width="40%">DESCRIPTION</th>
                                    <th width="15%">ACCOUNTS</th>
                                    <th width="15%">CASHIER SETUP</th>
                                    <th width="10%">ITEMIZED - CASHIER</th>
		...
		$(document).on('click', '#class_body tr', function(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#class_code").val(data.classcode).change()

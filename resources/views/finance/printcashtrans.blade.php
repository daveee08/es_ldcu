			...
			<table class="table" style="border-top: 0px">
				<thead>
					<tr>
						...
						<th width="10%" class="text-left">OR NO.</th>
						<th width="28%" class="text-left">NAME</th>
						<th width="10%" class="text-right">AMOUNT</th>
						{{-- <th class="text-left">POSTED</th> --}}
						<th width="20%" class="text-left">CASHIER</th>
						<th width="8%" class="text-center">PAYMENT</th>
						<th width="14%" class="text-left">REMARKS</th>
					</tr>
				</thead>
				<tbody>
					@php
					...
					<tr>
						...
						@if($trans->cancelled == 1)
							<td class="text-danger"><del>{{ date('Y-m-d', strtotime($trans->transdate)) }}</del></td>
							...
							<td class="text-danger" >{{$trans->cancelledremarks}}</td>
						@else

            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2 pt-1">
                            <button id="asclassifiedsetup" class="btn btn-success btn-block">
                                Classified Setup
                            </button>
                        </div>
                        <div class="col-md-2 pt-1">
                            <button id="ascostcenters" class="btn btn-primary btn-block">
                                Cost Centers
                            </button>
                        </div>
                    </div>
...
@section('modal')
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <select id="item_gradelevel" class="select2 form-control" style="width: 100%;">
                                <option value="">ALL</option>
                                @foreach (db::table('gradelevel')->where('deleted', 0)->get() as $grade)
                                    <option value="{{ $grade->id }}">{{ $grade->levelname }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <table width="100%" id="level_data" class="table table-hover table-sm text-sm display nowrap"
                                style="">
                                <thead>
                                    <th>Level</th>
                                    <th>First Sem</th>
    ...
    <div class="modal fade show" id="modal-classifiedsetup" aria-modal="true" style="display: none;">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h4 class="modal-title">Classified Setup</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-1 float-right table-responsive" style="height: 25em; overflow: scroll">
    ...
    <div class="modal fade show" id="modal-classifiedsetupdetail" aria-modal="true" style="display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content" style="margin-top: 5em">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title_detail"></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            ...
                            <select id="classified_class" class="select2 form-control form-control-sm">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <select id="classified_debit" class="select2 form-control form-control-sm">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <select id="classified_credit" class="select2 form-control form-control-sm">
                                @foreach (db::table('acc_coa')->where('deleted', 0)->orderBy('code')->get() as $coa)
                                    <option value="{{ $coa->id }}">{{ $coa->code }} - {{ $coa->account }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label for="">Debit Account</label>
                            <select id="classified_payment_debit" class="select2 form-control form-control-sm">
                                @foreach (db::table('acc_coa')->where('deleted', 0)->orderBy('code')->get() as $coa)
                                    <option value="{{ $coa->id }}">{{ $coa->code }} - {{ $coa->account }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label for="">Credit Account</label>
                            <select id="classified_payment_credit" class="select2 form-control form-control-sm">
                                @foreach (db::table('acc_coa')->where('deleted', 0)->orderBy('code')->get() as $coa)
                                    <option value="{{ $coa->id }}">{{ $coa->code }} - {{ $coa->account }}
                                    </option>
                                @endforeach
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        <button id="classified_save" class="btn btn-primary" data-id="0" prog-id="0">
                            Save
                        </button>
                    </div>
                </div>
            ...
            <div class="modal-content" style="margin-top: 13em;">
                        ...
                        <div class="col-md-12">
                            ...
                            <select id="gl_1" class="select2" style="width: 100% !important;">
                                ...
                                @foreach (db::table('acc_coa')->where('deleted', 0)->orderBy('code')->orderBy('account')->get() as $gl)
                                    <option value="{{ $gl->id }}">{{ $gl->code }} - {{ $gl->account }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        ...
                        <button id="editlevel_save" type="button" class="btn btn-primary" data-dismiss="modal"
            ...
            <div class="modal-content" style="margin-top: 13em;">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        ...
                        <button id="editoa_save" type="button" class="btn btn-primary" data-dismiss="modal"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
            ...
            <div class="modal-content" style="margin-top: 13em;">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        ...
                        <button id="editcashier_save" type="button" class="btn btn-primary" data-dismiss="modal"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
            ...
            <div class="modal-content" style="margin-top: 13em;">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        ...
                        <button id="payroll_save" type="button" class="btn btn-primary" data-dismiss="modal"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
            ...
            <div class="modal-content" style="margin-top: 13em;">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        ...
                        <button id="expense_save" type="button" class="btn btn-primary" data-dismiss="modal"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive" style="height: 15em">
                            <label>Revenue</label>
                            <table width="100%" id=""
                                class="table table-striped table-sm text-sm display nowrap" style="">
                                <thead>
                                    <th>Account</th>
                                    <th class="text-right" style="width: 20em">
                                        <button id="is_revenue_add" class="btn btn-sm btn-primary"
                                            style="width: 7em">Add</button>
                                    </th>
                                </thead>
                        ...
                        <div class="col-md-12 table-responsive" style="height: 15em">
                            ...
                            <table width="100%" id="level_data"
                                ...
                                <thead>
                                    <th>Account</th>
                                    <th class="text-right" style="width: 20em">
                                        <button id="is_expense_add" class="btn btn-sm btn-primary"
                                            style="width: 7em">Add</button>
                                    </th>
                                </thead>
        ...
        <div class="modal-dialog modal-md mt-5">
            <div class="modal-content">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        <button id="is_delete" type="button" class="btn btn-danger" data-toggle="tooltip"
                            title="Delete">
                            Delete
                        </button>
                        <button id="is_save" data-id="0" type="button" class="btn btn-primary"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
                        ...
                        <div class="col-md-12 table-responsive" style="height: 11em">
                            ...
                            <table width="100%" id=""
                                ...
                                <thead>
                                    <th>Account</th>
                                    <th class="text-right" style="width: 20em">
                                        <button id="bs_assets_add" class="btn btn-sm btn-primary"
                                            style="width: 7em">Add</button>
                                    </th>
                                </thead>
                        ...
                        <div class="col-md-12 table-responsive" style="height: 11em">
                            ...
                            <table width="100%" id="level_data"
                                ...
                                <thead>
                                    <th>Account</th>
                                    <th class="text-right" style="width: 20em">
                                        <button id="bs_liabilities_add" class="btn btn-sm btn-primary"
                                            style="width: 7em">Add</button>
                                    </th>
                                </thead>
                        ...
                        <div class="col-md-12 table-responsive" style="height: 11em">
                            ...
                            <table width="100%" id="level_data"
                                ...
                                <thead>
                                    <th>Account</th>
                                    <th class="text-right" style="width: 20em">
                                        <button id="bs_equity_add" class="btn btn-sm btn-primary"
                                            style="width: 7em">Add</button>
                                    </th>
                                </thead>
        ...
        <div class="modal-dialog modal-md mt-5">
            <div class="modal-content">
                ...
                <div class="modal-footer float-right">
                    ...
                    <div>
                        <button id="bs_delete" type="button" class="btn btn-danger" data-toggle="tooltip"
                            title="Delete">
                            Delete
                        </button>
                        <button id="bs_save" data-id="0" type="button" class="btn btn-primary"
                            data-toggle="tooltip" title="Save">
                            Save
                        </button>
                    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 text-right"><button id="bank_add"
                                class="btn btn-primary btn-sm text-sm">Add Bank</button></div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 table-responsive" style="height: 22em;">
                            <table width="100%" id="level_data"
                                class="table table-hover table-sm text-sm display nowrap" style="">
                                <thead>
                                    <th>Bank Name</th>
                                    <th>Account No.</th>
                                    <th>Branch</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group mb-2">
                                            <input id="item_filter" type="text" class="form-control"
    ...
    <div class="modal fade show" id="modal-itemdetail" aria-modal="true"
        style="padding-right: 17px; margin-top:1em; display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">Items</h4>
                    <input type="text" class="form-control form-control-sm" id="item_id">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                <div class="modal-body text-sm" style="overflow:auto; max-height: 350px">
                    <form class="form-horizontal">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm item_val"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm text-right" id="item_cost"
                                        placeholder="0.00" onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="non_inventory" name="inventory" checked>
                                                <label for="non_inventory">Non Inventory
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="icheck-primary d-inline">
                                                <input type="radio" id="inventory" name="inventory">
                            ...
                            <div class="form-group row" style="display: none" id="qtyContainer">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control form-control-sm" id="item_min_quantity"
                                        placeholder="0" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                </div>
                            </div>
                        </div>
                ...
                <div class="p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <button id="item_delete" type="button" class="btn btn-danger"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="input-group mb-2">
                                            <input id="sup_filter" type="text" class="form-control"
    ...
    <div class="modal fade show" id="modal-supplierdetail" aria-modal="true"
        style="padding-right: 17px; margin-top:5em; display: none;">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    ...
                    <form class="form-horizontal">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation" id="sup_name"
                                        placeholder="Pay To" onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="class-desc" class="col-sm-3 col-form-label">Address</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation"
                                        id="sup_address" placeholder="Address"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm validation"
                                        id="sup_contactno" placeholder="Contact Number"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 text-right">
                            <button id="sup_delete" type="button" class="btn btn-danger"
                                style="display: none">Delete</button>
    ...
    <div class="modal fade show" id="modal-costcenter" aria-modal="true" style="display: none;">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary">
...
@section('jsUP')
    <style>
        <link rel="stylesheet" href="{{ asset('plugins/datatables-bs4/css/dataTables.bootstrap4.css') }}"><link rel="stylesheet" href="{{ asset('plugins/datatables-fixedcolumns/css/fixedColumns.bootstrap4.css') }}">
    </style>
@endsection
@section('js')
    <script>
        $(document).ready(function() {
            ...
            function getlevel() {
                var gradeLevel = $('#item_gradelevel')
                    .val(); // Get selected grade level
                ...
                $.ajax({
                    ...
                    }, // Send selected grade level
                    success: function(data) {
                        var table = $(
                                '#level_data')
                            .DataTable();
                        table.clear()
                            .destroy(); // Destroy and reset table
            ...
            $('#item_gradelevel').change(function() {
                getlevel();
            });
            ...
            $(document).on('click', '#item_delete', function() {
                ...
                if (qty > 0) {
                    ...
                    Toast.fire({
                        type: 'error',
                        title: 'You cannot delete an item with quantity'
                    })
                }
            ...
            $(document).on('change', 'input[name="inventory"]', function() {
                if ($(this).is(':checked') && $(this).attr('id') === 'inventory') {
                    // Perform your action here when 'Non Inventory' radio button is checked
                    $('#qtyContainer').show();
                    // Example action: Changing background color of the div with class 'icheck-primary d-inline'
                } else {
            ...
            function loadclassifiedSetup() {
                $.ajax({
                    type: "GET",
                    url: "{{ route('loadclassifiedsetup') }}",
                    success: function(data) {
            ...
            $(document).on('click', '.classified_addsetup', function() {
                var text = $(this).closest('td').text().trim();
                var title = text.split('Add Setup')[0].trim();

                $('#classified_save').attr('prog-id', $(this).attr('data-id'))
                $('.modal-title_detail').text(title)
                $('#modal-classifiedsetupdetail').modal('show')
            })

            $(document).on('click', '#classified_save', function() {
                let acadprogid = $(this).attr('prog-id')
                let id = $(this).attr('data-id')
                let classid = $('#classified_class').val()
                let debitid = $('#classified_debit').val()
                let creditid = $('#classified_credit').val()
                let payment_debit = $('#classified_payment_debit').val()
                let payment_credit = $('#classified_payment_credit').val()

                $.ajax({
                    type: "GET",
                    url: "{{ route('loadclassifiedsave') }}",
                    data: {
                    ...
                    success: function(data) {
                        if (data != 'exist') {
                            $('#modal-classifiedsetupdetail').modal('hide')
                            loadclassifiedSetup()
            ...
            $(document).on('click', '#asclassifiedsetup', function() {
                $('#modal-classifiedsetup').modal('show');
            })

            $(document).on('click', '.classified_delete', function() {
                var id = $(this).attr('data-id');

                $.ajax({
                    type: "GET",
                    url: "{{ route('loadclassifieddelete') }}",
                    data: {
                        id: id
                    },
                    success: function(response) {
                        ...
                        Toast.fire({
                            type: "success",
                            title: "Setup has been deleted"
                        });
                    }
                });
            })

            $(document).on('click', '#ascostcenters', function() {
                $('#modal-costcenter').modal('show');
            })

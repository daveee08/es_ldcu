    ...
    <div class="card-header">
        <div class="row">
            <div class="col-md-12 text-right">
                <button type="button" class="btn btn-primary" id="btn-exportpdf"><i class="fa fa-file-pdf"></i> Export to
                    PDF</button>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered" id="consolidated_list">
                    <thead>
                        @if ($gentotal == 0 || $rangeOR == 'N/A')
                            <tr>
                                <td colspan="8" style="text-align:  left; font-weight: bold;color:red;">
                                    <h5>No Transactions</h4>
                                </td>
                            </tr>
                        @endif

                        <tr>
                            <th colspan="8"><strong>OFFICIAL RECEIPT NO.:
                                    {{ $rangeOR }}</strong></th>
                        </tr>
                        <tr>
                            ...
                            <th class="text-right">CASH ITEMS</th>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th colspan="3"
                                style="border-bottom: 1px solid black; font-weight: bold; font-size: 12px;">
                                {{ number_format($gentotal, 2) }}</th>
                            <th>&nbsp;</th>
                            <th>&nbsp;</th>
                        </tr>
                    </tfoot>

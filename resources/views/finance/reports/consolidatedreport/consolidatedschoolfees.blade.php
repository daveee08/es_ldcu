...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Consolidated School Fees</h1>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Consolidated School Fees</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            {{-- <input type="text" class="form-control" id="selecteddaterange"
                            ...
                            {{-- This input field is for selecting a date range and is initialized with today's date in the format "mm/dd/yyyy - mm/dd/yyyy". --}}
                            {{-- <input type="text" class="form-control" id="selecteddaterange"
                                value="{{ date('m/d/Y') . ' - ' . date('m/d/Y', strtotime('+1 day')) }}"
                                placeholder="Select date range"> --}}
                            {{-- <input type="text" class="form-control" id="selecteddaterange"
                                value="{{ date('m') . '/01/' . date('Y') . ' - ' . date('m/d/Y') }}"
                                placeholder="Select date range"> --}}
                        ...
                        {{-- <div class="col-md-2 d-block text-right">
                            <label>&nbsp;</label><br />
                            <button type="button" class="btn btn-primary btn-block" id="generatebutton"
    ...
    <script>
        $(document).ready(function() {
            ...
            //     var selecteddisplay = $('#selecteddisplay').val();
            //     var selecteddaterange = $('.drp-selected').val();
            //     Swal.fire({
            //         title: loadingtext,
            //         onBeforeOpen: () => {
            //             Swal.showLoading()
            ...
            $('#selecteddaterange').on('apply.daterangepicker', function(event, picker) {
                loadingtext = 'Loading...';
                $(this).val(picker.startDate.format('MM/DD/YYYY') + ' - ' + picker.endDate.format(
                    'MM/DD/YYYY'));
                selecteddaterange = $(this).val();
                ...
                $.ajax({
                    ...
                    data: {
                        selecteddaterange: selecteddaterange,
                        selectedterminal: selectedterminal,
                        selecteddisplay: $('#selecteddisplay').val()
                    },
                    success: function(data) {
                        // $('#consolidated_list').DataTable();
                        if (data == 'no data') {
            ...
            // $('#selecteddaterange').on('change', function() {
            //     var selecteddisplay = $('#selecteddisplay').val();
            ...
            $(document).on('click', '#btn-exportpdf', function() {
                ...
                window.open("/finance/reports/consolidated/generate?exporttype=" + exporttype + "&" + $
                    .param(paramet));
            })
        ...
        <div class="modal-dialog modal-md" style="margin-top: 11em;">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="trxhead_save" type="button" data-id="0" class="btn btn-primary"
                            style="width: 90px"><i class="fas fa-save"></i> Save</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade show" id="modal-checktrans_detail" aria-modal="true"
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <div class="float-right">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button id="trxdetail_save" type="button" class="btn btn-primary" style="width: 90px"><i

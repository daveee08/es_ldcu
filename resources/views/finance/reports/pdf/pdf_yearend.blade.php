...
<body>
	...
	<div class="body">
		<table  cellpadding="0" style="width: 100%; font-size: 10;">
			<tr>
				<td style="width: 40%; text-align: right;">
          <img src="{{$picurl}}" width="60px">
        </td>
		...
		<table  cellpadding="0" style="width: 100%; border-collapse: collapse; page-break-before: avoid !important; ">
			<thead>
				{!!$headerlist!!}	
			</thead>
			<tbody>

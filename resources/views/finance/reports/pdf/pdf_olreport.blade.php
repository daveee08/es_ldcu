    ...
    <table style="font-size: 14; font-weight: bold; font-family: Sans-serif; padding-top: 5px; width: 100%;">
        ...
        <tr>
            <td colspan="2" style="text-align: center; font-size:12">
                ONLINE PAYMENTS <br>
                <span style="font-size: 8; font-weight: normal;">
                    SCHOOL YEAR {{ $sy->sydesc }}
                </span><br>
                <span style="font-size: 8; font-weight: normal;">
                    Date Printed: {{date_format(date_create(App\FinanceModel::getServerDateTime()), 'm/d/Y')}}
                </span><br>
                @if($filter != '')
                    <span style="font-size: 8; font-weight: normal;">
                        FILTER: {{ $filter }}
      ...
      <div class="">
        <table class="table" style="width: 100%; border: solid 1px; border-collapse: collapse; font-size: 9px">
          <thead>
            <tr>
              ...
              <th width="10%" class="">REFERENCE</th>
          ...
          <tbody>
            ...
            <tr>
              <td colspan="5" class="text-right text-bold" style="border: solid 1px">TOTAL: </td>
              <td colspan="0" class="text-right text-bold" style="border-top: solid 1px; border-right: solid 2px;">{{ number_format($total, 2) }}</td>
              <td colspan="0" class="text-right text-bold" style="border-top: solid 1px; "></td>
            </tr>
        ...
        <table width="100%">
            ...
            <tr>
                <td style="border-bottom: solid 2px; width: 30%">
                    &nbsp;
                </td>
                <td style="width: 70%">
                    &nbsp;

...
<form action="/hr/employees/addnewemployee/save" method="get" class="m-0 p-0">
    <div class="card shadow p-2" style="border: 1px solid #ddd; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
        <div class="row">
            <div class="col-md-12">  
                <fieldset class="form-group border p-2">
                    <legend class="w-auto m-0">Personal Information</legend>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            <label>Street</label>
                            <input type="text" name="pobstreet" class="form-control form-control-sm"/>
                        </div>
                        <div class="col-md-3 mb-2">
                            <label>Barangay</label>
                            <input type="text" name="pobbarangay" class="form-control form-control-sm"/>
                        </div>
                        <div class="col-md-3 mb-2">
                            <label>City</label>
                            <input type="text" name="pobcity" class="form-control form-control-sm"/>
                        </div>
                        <div class="col-md-3 mb-2">
                            <label>Province</label>
                            <input type="text" name="pobprovince" class="form-control form-control-sm"/>
                        </div>
                    </div>
                    <hr/>
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <em>Emergency Contact Info</em>
                        </div>
    ...
    <div class="card shadow p-2" style="border: 1px solid #ddd; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
        <div class="row">
            <div class="col-md-12">  
                <fieldset class="form-group border p-2">
                    <legend class="w-auto m-0">Educational Qualification</legend>
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label>Degree/Post Graduate</label>
                            <input type="text" name="educ-degree" class="form-control form-control-sm"/>
                        </div>
                        <div class="col-md-3 mb-2">
                            <label>Major/Specialization</label>
                            <input type="text" name="educ-major" class="form-control form-control-sm"/>
                        </div>
                        <div class="col-md-3 mb-2">
                            <label>Minor</label>
                            <input type="text" name="educ-minor" class="form-control form-control-sm"/>
                        </div>
                    </div>
                </fieldset> 
            </div>
    ...
    <div class="card shadow p-2" style="border: 1px solid #ddd; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
        <div class="row">
            <div class="col-md-12">  
                <fieldset class="form-group border p-2">
                    <legend class="w-auto m-0">Employment Information</legend>
                    <div class="row">
                        <div class="col-md-3 mb-2">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <select name="employmentstatsid" class="form-control form-control-sm text-uppercase">
    ...
    <div class="card shadow p-2" style="border: 1px solid #ddd; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
        <div class="row">
            <div class="col-md-12">  
                <fieldset class="form-group border p-2">
                    <legend class="w-auto m-0">Other Information</legend>
                    <div class="row">
                        <div class="col-md-3 mb-2">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            <label>Tax Identification Number (T.I.N)</label>
                            <input type="number" name="account-tin" class="form-control form-control-sm"/>
                        </div>
                    </div>
                    {{-- <hr/>
                    <div class="row">
    ...
    <div class="row mb-5">
        <div class="col-md-12 text-right">
            <button type="submit" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Submit</button>
        </div>
    </div>
</form>

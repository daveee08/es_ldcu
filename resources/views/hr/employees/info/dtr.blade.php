<div class="tab-pane fade show active" id="custom-content-above-dtr" role="tabpanel"
    aria-labelledby="custom-content-above-dtr-tab">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <input type="text" name="dtrchangeperiod" class="form-control form-control-sm col-md-3" id="dtrdaterange"
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    ...
                    if (value.day.toLowerCase() == 'sunday' || value.day.toLowerCase() ==
                        'saturday') {
                        $('#dtr' + countrow).append(
                            ' <span class="right badge badge-secondary">' + value.day +
                            '</span>'
                        )
                    } else {
                        $('#dtr' + countrow).append(
                            ' <span class="right badge badge-default">' + value.day +
                            '</span>'
                        )
                    }
                    // $('#dtr'+countrow).append(

...
<div class="col-12">
    <div class="form-group">
        <label>Payroll as of:</label>

        <div class="input-group">
          <div class="input-group-prepend">
            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
          </div>
          <input type="text" class="form-control daterangeupdate" id="reservation" value="{{$payroll_daterange->date_from}} - {{$payroll_daterange->date_to}}" >
          <div class="input-group-append">
            <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
          </div>
          
            <input type="text" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="" im-insert="false" value="{{$payroll_daterange->date_fromstring}} - {{$payroll_daterange->date_tostring}}" readonly>
        </div>
        <!-- /.input group -->
      </div>
</div>
...
<script>
    $(function () {
        ...
        $('#reservation').daterangepicker({
            minDate:'{{$payroll_daterange->date_from}}',
            locale: {
                format: 'YYYY-MM-DD'
            }
        })
   ...
   $(document).ready(function(){
        ...
        $("span.salary").digits();
        $('input.daterangeupdate').on('change', function(){
            var date = $(this).val();
            $.ajax({
                url: '/employeesalary/changedaterange',
                type:"GET",
                dataType:"json",
                data:{
                    newdate: date

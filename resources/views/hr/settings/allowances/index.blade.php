                            ...
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <span class="badge badge-primary" style="font-size: 12px;" >Base on Attendance</span>
                                    </div>
                                                        ...
                                                        @if(count($eachemployee->allowances)>0)
                                                            ...
                                                            <td class="text-right" style="overflow: hidden">
                                                                @if($eachparticular->automatic == 1)
                                                                    @if ($eachparticular->baseonattendance == 1)
                                                                        <span class="badge badge-primary each-badge-amount" style="width: 100%; font-size: 12px; cursor: pointer;" data-particularstatus="{{$eachparticular->status}}" data-particularid="{{$eachparticular->id}}" data-employeeid="{{$eachemployee->employeeid}}" data-name="{{$eachemployee->sortname}}" data-default="{{$eachparticular->cont_amount_default}}" data-amount="{{$eachparticular->amountperday}}">{{$eachparticular->amountperday}}</span>
                                                                    @else

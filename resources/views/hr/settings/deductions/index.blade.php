...
#table-standard-deductions td, #table-standard-deductions th {
    padding: 3px;
}
#table-other-deductions td, #table-other-deductions th {
    padding: 3px;
}
</style>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Deduction Setup</li>
                </ol>
            </div>
      </div>
    </div><!-- /.container-fluid -->
                    ...
                    {{-- <div class="tab-pane active" id="tab_1">
                        ...
                        <div class="tab-content"> --}}
                            <div class="tab-pane active" id="tab_1">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <span class="badge badge-success" style="font-size: 12px;" >Bracket Based Amount</span>
                                        <span class="badge badge-info" style="font-size: 12px;" >Custom Amount</span>
                                    </div>
                                    <div class="col-md-6 text-right">
                                        <span class="badge badge-warning" style="font-size: 12px;" >Standard deductions</span>
                                        <span class="badge badge-default border-1" style="font-size: 12px; border: 1px solid #ddd;" >Other deductions</span>
                                    </div>
                                    <div class="col-md-12">      
                                            ...
                                            <tbody>
                                                @foreach($employees as $eachemployee)
                                                    <tr>
                                                        ...
                                                        @if(count($eachemployee->contributions)>0)
                                                            @foreach($eachemployee->contributions as $eachparticular)
                                                            <td class="text-right">
                                                                
                                                                @if($eachparticular->automatic == 1)
                                                                <span class="badge badge-success each-badge-amount" style="width: 100%; font-size: 12px; cursor: pointer;" data-particularstatus="{{$eachparticular->status}}" data-particularid="{{$eachparticular->id}}" data-employeeid="{{$eachemployee->employeeid}}" data-name="{{$eachemployee->sortname}}" data-default="{{str_replace(',', '', $eachparticular->cont_amount_default)}}" data-amount="{{str_replace(',', '', $eachparticular->cont_amount)}}">{{$eachparticular->cont_amount}}</span>
                                                                @else
                                                                <span class="badge @if($eachparticular->status == 1)badge-info @else badge-secondary @endif each-badge-amount" style="width: 100%; font-size: 12px; cursor: pointer;" data-particularid="{{$eachparticular->id}}" data-particularstatus="{{$eachparticular->status}}" data-employeeid="{{$eachemployee->employeeid}}" data-name="{{$eachemployee->sortname}}" data-default="{{str_replace(',', '', $eachparticular->cont_amount_default)}}" data-amount="{{str_replace(',', '', $eachparticular->cont_amount)}}"> {{$eachparticular->cont_amount}}</span>
                                                                @endif
                                                            </td>
                                                            @endforeach
                                                        @endif
                                                        @if(count($otherdeductions)>0)
                                                            @foreach($otherdeductions as $eachother)   
                                                                @if(collect($eachemployee->othercontributions)->where('id',$eachother->id)->count()>0)
                                                                    ...
                                                                    @endphp
                                                                    <td>
                                                                        <span class="badge @if($otherinfo->status == 1) {{$otherinfo->custom == 1 ? 'badge-info' : 'badge-success'}} @else badge-secondary  @endif each-badge-otherdeduction-amount-edit" style="width: 100%; font-size: 12px; cursor: pointer; border: 1px solid #ddd;" data-particularid="{{$eachother->id}}" data-particularstatus="{{$otherinfo->status}}" data-employeeid="{{$eachemployee->employeeid}}" data-name="{{$eachemployee->sortname}}" data-default="{{str_replace(',', '', $otherinfo->cont_amount_default)}}" data-amount="{{str_replace(',', '', $otherinfo->cont_amount)}}">{{$otherinfo->cont_amount}}</span>
                                                                    </td>
                                                                @else
                                                                    <td>
                                                                        <span class="badge each-badge-otherdeduction-amount" style="width: 100%; font-size: 12px; cursor: pointer; border: 1px solid #ddd;" data-particularid="{{$eachother->id}}" data-particulardesc="{{$eachother->description}}" data-employeeid="{{$eachemployee->employeeid}}" data-name="{{$eachemployee->sortname}}"  data-default="{{str_replace(',', '', $eachother->amount)}}" data-amount="{{str_replace(',', '', $eachother->amount)}}"><i class="fa fa-plus"></i>Add</span>
                                                                    </td>
                                                                @endif
                                                            @endforeach
                                                        @endif
                            ...
                            <div class="tab-pane" id="tab_2">
                                <div class="row">
                                    <div class="col-md-12">                                
                                        <ul class="nav nav-tabs mb-3" id="tab-deductions" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" id="tab_2_1-tab" href="#tab_2_1" data-toggle="pill" role="tab" aria-controls="tab_2_1" aria-selected="true">Standard Deductions</a></li>
                                        ...
                                        <div class="tab-content" id="tab-deductionsContent">
                                            <div class="tab-pane fade show active" id="tab_2_1" role="tabpanel" aria-labelledby="tab_2_1-tab"> 
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <table class="table" id="table-standard-deductions" >
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                @foreach($standarddeductions as $eachstandard)
                                                                    <tr>
                                                                        ...
                                                                        <td style="vertical-align: middle;  width:  15%;" class="td-amount-{{$eachstandard->id}} text-right pr-5">@if($eachstandard->withbracket == 1)@else {{$eachstandard->amount ?? '0.00'}}@endif</td>
                                                                        <td style="vertical-align: middle;  width:  10%;">@if($eachstandard->withbracket == 1)<button type="button" class="btn btn-outline-info btn-sm btn-block btn-bracket" data-id="{{$eachstandard->id}}" data-desc="{{$eachstandard->description}}" data-type="{{$eachstandard->brackettype}}"><small class="text-bold">Bracket</small></button>@else <button type="button" class="btn btn-outline-warning btn-sm btn-block btn-deduction-standard-edit" data-id="{{$eachstandard->id}}" data-desc="{{$eachstandard->description}}" data-amount="{{$eachstandard->amount ?? '0.00'}}" data-type="{{$eachstandard->brackettype}}"><small class="text-bold">Edit</small></button>@endif</td>
                                                                        {{-- <td><button type="button" class="btn btn-outline-secondary btn-sm btn-block"><i class="fa fa-ban"></i> </button></td> --}}
                                                                        <td class="text-right">
                                                                            @if($eachstandard->constant == 1)
                                                                            <small>You can't delete this particular</small>
                                                                            @else
                                                                            <button type="button" class="btn btn-outline-danger btn-sm btn-deduction-standard-delete" data-id="{{$eachstandard->id}}"><i class="fa fa-trash-alt"></i> </button>
                                                                            @endif
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Custom Monthly Contribution</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="/hr/setup/deductions/custom" method="GET" id="form-custom-contribution">
                @csrf
...
<div class="modal fade" id="modal-other-add">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span id="modal-other-add-particular-desc">Other deduction</span> </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="modal-xl">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><span id="particular-desc"></span> Bracket</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div id="container-brackets">
...
<div class="modal fade" id="modal-other-deduction-add">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="btn-modal-other-addemployee-save">Add deduction</button>
            </div>
        </div>
...
<div class="modal fade" id="modal-other-deduction-edit">
    <div class="modal-dialog modal-default">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
    $(document).ready(function(){
        var table_standard = $('#table-standard-deductions').DataTable({
            paging:         false,
            "info": false,
            "ordering": false,
            "aaSorting": []
        ...
        var table_other = $('#table-other-deductions').DataTable({
            paging:         false,
            "info": false,
            "ordering": false,
            "aaSorting": []
        ...
        $('.each-badge-amount').on('click', function(){
            ...
            if(particularstatus == 1)
            {
                ...
                $('#container-custom-buttons').append(`<button type="button" class="btn btn-sm btn-outline-secondary" id="btn-deduction-disable">Disable</button>`)
            }else if(particularstatus == 0)
            {
                $('#container-custom-buttons').empty()
                $('#container-custom-buttons').append(`<button type="button" class="btn btn-sm btn-outline-secondary" id="btn-deduction-enable">Enable</button>`)
            }
        })
        $('#btn-custom-save').on('click', function(){
            ...
            if($('#input-new-amount').val().replace(/^\s+|\s+$/g, "").length > 0)
            {
                ...
                $.ajax({
                    url: '/hr/setup/deductions/custom',
                    type: 'GET',
                    data: {
                        action        : 'custom_add',
                        employeeid    : employeeid,
                    ...
                    success:function(data) {
                        if(data == 1)
                        {
                            ...
                            toastr.success('Updated successfully!','Custom Monthly Contribution')
                        }
                    }
                    ,error:function(){
                        toastr.error('Something went wrong!','Custom Monthly Contribution')
                    }
                })
            }else{
                toastr.warning('This field cannot be empty!','Custom Monthly Contribution')
            }
        })
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if(data == 1)
                        {
                            ...
                            $('body').removeClass('swal2-shown')
                            $('body').removeClass('swal2-height-auto')
                            toastr.success('Reset successfully!','Custom Monthly Contribution')
                        }
                    }
                    ,error:function(){
                        toastr.error('Something went wrong!','Custom Monthly Contribution')
        ...
        $(document).on('click','#btn-deduction-disable', function(){
            var thisbutton = $(this);
            Swal.fire({
                    title: 'Disabling deduction...',
                    onBeforeOpen: () => {
                        Swal.showLoading()
                    },
                    allowOutsideClick: false
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if(data == 1)
                        {
                            ...
                            thisbutton.attr('id','btn-deduction-enable')
                            ...
                            $('body').removeClass('swal2-shown')
                            $('body').removeClass('swal2-height-auto')
                            toastr.success('Disabled successfully!','Custom Monthly Contribution')
                        }
                    }
                    ,error:function(){
                        toastr.error('Something went wrong!','Custom Monthly Contribution')
        ...
        $(document).on('click','#btn-deduction-enable', function(){
            var thisbutton = $(this);
            Swal.fire({
                    title: 'Enabling deduction...',
                    onBeforeOpen: () => {
                        Swal.showLoading()
                    },
                    allowOutsideClick: false
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if(data == 1)
                        {
                            ...
                            $('body').removeClass('swal2-shown')
                            $('body').removeClass('swal2-height-auto')
                            toastr.success('Enabled successfully!','Custom Monthly Contribution')
                        }
                    }
                    ,error:function(){
                        toastr.error('Something went wrong!','Custom Monthly Contribution')
        ...
        $(document).on('click','.each-badge-otherdeduction-amount', function(){
            ...
            $('#modal-other-deduction-add').modal('show')
        })
        $('#btn-modal-other-addemployee-save').on('click', function(){
            ...
            if(newamount.replace(/^\s+|\s+$/g, "").length == 0)
            {
                ...
                $.ajax({
                    url: '/hr/setup/deductions/otherdeductions',
                    type: 'get',
                    data: 
                        {
                    ...
                    success:function(data) {
                        ...
                        $('#modal-other-deduction-add').modal('toggle');
                    }
                    ,error:function(){
        ...
        $(document).on('click','.each-badge-otherdeduction-amount-edit', function(){
            ...
            $('#modal-other-deduction-edit').modal('show')
            ...
            if(newamount.replace(/^\s+|\s+$/g, "").length == 0)
            {
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        ...
                        $('#modal-other-deduction-edit').modal('toggle');
                    }
                    ,error:function(){
                        toastr.error('Something went wrong!')
                    }
        ...
        $(document).on('click','#btn-otherdeduction-toemployee-delete', function(){
            var thisbutton = $(this);
            Swal.fire({
                title: 'Are you sure you want to delete this deduction for this employee?',
                type: 'warning',
        ...
        $('#table-standard-deductions_filter').closest('.row').find('div').first().append('<button type="button" class="btn btn-sm btn-outline-primary" id="btn-standard-deduction-add"><i class="fa fa-plus"></i> Add particular</button>')
        ...
        $('#btn-standard-deduction-add').on('click', function(){
        ...
        $('#btn-modal-standard-add-save').on('click', function(){
            ...
            if(desc.replace(/^\s+|\s+$/g, "").length == 0)
            {
                ...
                $.ajax({
                    url: '/hr/setup/deductions',
                    type: 'get',
                    data: 
                        {
                        action        : 'add_standarddeduction',
                        desc          : desc,
                        amount        : amount
                        },
                    success:function(data) {
                        $('#table-standard-deductions tbody').append(
                            `
                            <tr>
                                ...
                                <td style="vertical-align: middle;  width:  10%;"><button type="button" class="btn btn-outline-warning btn-sm btn-block btn-deduction-standard-edit" data-id="`+data+`" data-desc="`+desc+`" data-amount="`+amount+`" data-type="0"><small class="text-bold">Edit</small></button></td>
                                <td class="text-right">
                                    <button type="button" class="btn btn-outline-danger btn-sm btn-deduction-standard-delete" data-id="`+data+`"><i class="fa fa-trash-alt"></i> </button>
                                </td>
                            </tr>`
                        )
                        $('#modal-standard-add-modal-body').find('input').val('')
                        toastr.success('Added successfully!','Standard Deduction')
        ...
        $(document).on('click','.btn-deduction-standard-edit', function(){
        ...
        $('#btn-modal-standard-edit-save').on('click', function(){
            ...
            // }else{
                $.ajax({
                    ...
                    data: 
                        {
                        action        : 'update_standarddeduction',
                        id          : id,
                        desc          : desc,
                        amount        : amount
                        },
                    success:function(data) {
                        if(data == 0)
                        {
                            ...
                            $('.btn-deduction-standard-edit[data-id="'+id+'"]').attr('data-amount', amount)
                            $('#table-standard-deductions .td-amount-'+id).text((amount>0 ? amount : '0.00'))
                            $('#modal-standard-edit-modal-body').find('input').val('')
                            toastr.success('Updated successfully!','Standard Deduction')
        ...
        $(document).on('click','.btn-deduction-standard-delete', function(){
            var id = $(this).attr('data-id');
            var thisbutton = $(this);
            Swal.fire({
                title: 'Are you sure you want to delete this standard deduction?',
                type: 'warning',
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Delete',
                showCancelButton: true,
                allowOutsideClick: false,
                    ...
                    if (confirm.value) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            data: {
                                action  :  'delete_standarddeduction',
                                id: id
                            },
                            success: function(data){
                                thisbutton.closest('tr').remove()
                                toastr.success('Deleted successfully!','Standard Deduction')
                            }
                        })
                    }
                })
        })
        $('#table-other-deductions_filter').closest('.row').find('div').first().append('<button type="button" class="btn btn-sm btn-outline-primary" id="btn-other-deduction-add"><i class="fa fa-plus"></i> Add particular</button>')
        
        $('#btn-other-deduction-add').on('click', function(){
            ...
            if(desc.replace(/^\s+|\s+$/g, "").length == 0)
            {
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if('{{count($otherdeductions)}}' == 0)
                        {
                            $('#table-other-deductions tbody').empty();
                        }
                        $('#table-other-deductions tbody').append(
                            `
                            <tr>
                                <td style="vertical-align: middle; width: 50%;">`+desc+`</td>
                                <td style="vertical-align: middle;  width:  15%;" class="td-amount-`+data+` text-right pr-5">`+amount+`</td>
                                <td style="vertical-align: middle;  width:  10%;"><button type="button" class="btn btn-outline-warning btn-sm btn-block btn-deduction-other-edit" data-id="`+data+`" data-desc="`+desc+`" data-amount="`+amount+`" data-type="0"><small class="text-bold">Edit</small></button></td>
                                <td class="text-right">
                                    <button type="button" class="btn btn-outline-danger btn-sm btn-deduction-other-delete" data-id="`+data+`"><i class="fa fa-trash-alt"></i> </button>
                                </td>
                            </tr>`
                        )
                        $('#modal-other-add-modal-body').find('input').val('')
                        toastr.success('Added successfully!','Other Deduction')
        ...
        $(document).on('click','.btn-deduction-other-edit', function(){
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if(data == 0)
                        {
                            ...
                            $('.btn-deduction-other-edit[data-id="'+id+'"]').attr('data-amount', amount)
                            $('#table-other-deductions .td-amount-'+id).text((amount>0 ? amount : '0.00'))
                            $('#modal-other-edit-modal-body').find('input').val('')
                            toastr.success('Updated successfully!','Other Deduction')
        ...
        $(document).on('click','.btn-deduction-other-delete', function(){
            var id = $(this).attr('data-id');
            var thisbutton = $(this);
            Swal.fire({
                title: 'Are you sure you want to delete this other deduction?',
                type: 'warning',
                confirmButtonColor: '#3085d6',
                confirmButtonText: 'Delete',
                showCancelButton: true,
                allowOutsideClick: false,
                    ...
                    if (confirm.value) {
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                thisbutton.closest('tr').remove()
                                toastr.success('Deleted successfully!','Other Deduction')
                            }
                        })
                    }
                })

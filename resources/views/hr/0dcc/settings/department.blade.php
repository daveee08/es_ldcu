...
<div class="row mb-2">
    ...
    <div class="col-md-2">
        <a class="btn btn-block btn-primary text-white" data-toggle="modal" data-target="#add_dept"><i class="fa fa-plus" ></i> Department</a>
        <div class="modal fade" id="add_dept" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <form action="/departments/adddepartment" method="get">
                    <div class="modal-content text-uppercase">
                ...
                <div class="card col-md-4 " style="border: none !important;box-shadow: none !important;" data-string="{{$department->department}}<">
                    <div class="card-body p-2 @if($department->constant == '1') bg-warning @endif"  @if($department->constant == '0')style="border: 1px solid#ddd;background: #e8e8e8;"@endif>
                        ...
                        @if($department->constant == '1')
                            <small>
                                <sub>
                                    Note: You cannot make changes to this department
                                </sub>
                            </small>
                        @else
                            
                            <button type="button" class="btn btn-sm btn-warning p-1 mr-2 mb-2 mt-2 updatebutton" data-toggle="modal" data-target="#edit{{$department->id}}"><small>Edit</small></button>
                            ...
                            <button type="button" class="btn btn-sm btn-danger p-1 mb-2 mt-2 deletebutton"  data-toggle="modal" data-target="#delete{{$department->id}}"><small><i class="fa fa-trash"></i></small></button>

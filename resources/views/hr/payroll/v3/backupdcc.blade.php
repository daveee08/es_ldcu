                                  ...
                                  @endphp
									...
									<table class="table table-striped m-0">
                                      ...
                                      <tr>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;">@if($basicsalaryinfo) @if ($basicsalaryinfo->flexitime == 1) Undertime  @else Late  @endif @endif<br/>(mins)</th>
            ...
            <table style="width: 100% !important;">
              ...
              <tr>
                ...
                <td class="text-right text-danger" style="width: 50%;" id="amountundertime" 
                  ...
                  @endphp
                  {{$min}}">
                  <small class="text-bold">{{number_format($min,2,'.','')}}</small></td>
              </tr>
            </table>
            {{-- @php

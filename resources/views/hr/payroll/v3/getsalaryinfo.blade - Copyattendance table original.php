                                    ...
                                    <tr>
                                      ...
                                      @foreach($attendance as $eachattendance)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;">{{number_format($eachattendance->lateminutes,2)}}mins&nbsp;&nbsp;&nbsp;</td>
          ...
          <td colspan="2" style="vertical-align: top;">
            <table style="width: 100% !important;">
              <tr>
                ...
                @else
                <td style="width: 50%; text-align: right;" class="text-danger text-bold" id="amountabsent" data-value="{{$basicsalaryinfo->attendancebased == 1 ? (bcdiv(collect($attendance)->where('totalworkinghours',0)->count()*$basicsalaryinfo->amountperday,1,2)) : 0}}">{{$basicsalaryinfo->attendancebased == 1 ? (bcdiv(collect($attendance)->where('totalworkinghours',0)->count()*$basicsalaryinfo->amountperday,1,2)) : 0}}</td>
                @endif
              </tr>
              <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="icheck-primary d-inline mr-2 otherdeduction" 
                        ...
                        dataid="{{$eachotherdeduction['deductionotherid']}}"
                        data-totalamount="{{$eachotherdeduction['totalamount']}}" 
                        data-amount="{{number_format($eachotherdeduction['totalamount']/2,2)}}" 
                        data-description="{{$eachotherdeduction['description']}}" style="font-size: 11.5px;">

...
@if ($basicsalaryinfo)
    @php
        ...
        if ($basicsalaryinfo->amount > 0) {
            if (strtolower($basicsalaryinfo->ratetype) == 'daily') {
                ...
                $totalearnings = (float) number_format(
                    $basicsalaryinfo->amount / 2 + collect($leaves)->sum('amount'),
                    2,
                );
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
            ...
            <div class="col-md-9"></div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table width="100%" class="table table-head-fixed" id="listreleasedpayroll_datatable"
                                style="table-layout: fixed; font-size: 16px">
                                <thead>
                                    <tr>
                                        <th width="40%" class="p-1" style="vertical-align: middle;">Payroll Dates
                                        </th>
                                        <th width="20%" class="" style="vertical-align: middle;">Total Earning
                                        </th>
                                        <th width="20%" class="" style="vertical-align: middle;">Total
                                            Deduction</th>
                                        <th width="10%" class="" style="vertical-align: middle;">Net Pay</th>
                                        <th width="10%" class="p-1 text-center" style="vertical-align: middle;">
                                            Action</th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 justify-content-between" style="display: flex;">
                            <button type="button" class="btn btn-primary btn-sm" id="btn_savestandardallowance"
                                style="visibility: hidden"><i class="fas fa-plus"></i> Add</button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-bordered"
                                style="font-size: 10.5px; width: 100%; table-layout: fixed;"
                                id="modal_payrolldetailsdatatable">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;">Undertime<br />(mins)
                                        </th>
                                        ...
                                        <th style="text-align: center; vertical-align: middle;">Undertime<br>Penalty
                                        </th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
    ...
    <div class="card shadow"
        style="border: none !important; border: none !important; box-shadow: 0 .5rem 1rem rgba(0,0,0,.15)!important;">
            ...
            <div class="row">
                <div class="col-md-4 text-center">
                    ...
                    <div class="table-avatar">
                        ...
                        @endphp
                        <a href="#" class="avatar">
                            <img src="{{ asset($employeeinfo->picurl) }}" alt=""
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-7">
                            <h5><a href="/hr/employees/profile/index?employeeid={{ $employeeid }}"
                                    target="_blank">{{ $employeeinfo->lastname }}, {{ $employeeinfo->firstname }}</a>
                            </h5>
                        </div>
                        <div class="col-md-5 text-right">
                            <button type="button" class="btn btn-sm btn-outline-info" id="all_releasedpayslip">All
                                Released Payslip</button>
                            <button type="button" class="btn btn-sm btn-outline-info" id="btn-refresh"><i
                            ...
                            <div class="form-group mb-0" style="display: -webkit-box;">
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->mondays == 1) checked @endif disabled>
                                    <label class="form-check-label">M</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->tuesdays == 1) checked @endif disabled>
                                    <label class="form-check-label">T</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->wednesdays == 1) checked @endif disabled>
                                    <label class="form-check-label">W</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->thursdays == 1) checked @endif disabled>
                                    <label class="form-check-label">Th</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->fridays == 1) checked @endif disabled>
                                    <label class="form-check-label">F</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input bg-primary" type="checkbox"
                                        @if ($basicsalaryinfo->saturdays == 1) checked @endif disabled>
                                    <label class="form-check-label">Sat</label>
                                </div>
                                <div class="form-check pr-2">
                                    <input class="form-check-input" type="checkbox"
                                        @if ($basicsalaryinfo->sundays == 1) checked @endif disabled>
                        ...
                        <div class="col-md-12">
                            @if ($released == 1)
                                <span>{{ $payrollinfo->basicsalarytype }} :
                                    {{ number_format($payrollinfo->monthlysalary, 2, '.', ',') }}</span>
                                @if (strtolower($basicsalaryinfo->ratetype) != 'daily') / Daily rate:
                                    {{ number_format($basicsalaryinfo->amountperday, 2) }} @endif/
                                Hourly rate: {{ number_format($basicsalaryinfo->amountperhour, 2) }}
                            @else
                                <label><span id="salarytype"
                                        data-dailyrate="{{ $basicsalaryinfo->amountperday }}">{{ $basicsalaryinfo->salarytype }}</span>
                                    :
                                    @if (strtolower($basicsalaryinfo->ratetype) != 'daily')
                                        {{ number_format($basicsalaryinfo->amount, 2, '.', ',') }}@else{{ number_format($basicsalaryinfo->amount / count($attendance), 2, '.', ',') }}
                                    @endif
                                    <span id="monthlysalary" hidden>{{ $basicsalaryinfo->amount }}</span>
                                </label>
                                @if (strtolower($basicsalaryinfo->ratetype) != 'daily') / Daily rate:
                                    {{ bcdiv($basicsalaryinfo->amountperday, 1, 2) }} @endif /
                                Hourly rate:
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            @php
                                                ...
                                                $total_minutes =
                                                    collect($attendance)
                                                        // ->where('totalworkinghours', '>', 0)
                                                        ->sum('latehours') * 60;
                                                $hours = intval($total_minutes / MINUTES_PER_HOUR); // integer division
                                                $mins = $total_minutes % MINUTES_PER_HOUR; // modulo
                                                $latedays = [];
                                            @endphp
                                            <button type="button" class="btn btn-sm btn-warning p-0 btn-block"
                                                data-toggle="modal" data-target="#modal-view-late-history"
                                                style="font-size: 11px;">View</button>
                                            <div class="modal fade" id="modal-view-late-history">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Attendance Details @if ($basicsalaryinfo)
                                                                    @if ($basicsalaryinfo->flexitime == 1) <span
                                                                            class="badge badge-success">Flexi
                                                                            Time</span> @endif
                                                                @endif
                                                            </h4>
                                        ...
                                        @endphp --}}
                                                                ...
                                                                @foreach ($attendance as $eachattendance)
                                                                    <tr>
                                                                        <td class="text-center">
                                                                            {{ $eachattendance->daystring }}<br />{{ $eachattendance->day }}
                                                                        </td>
                                                                        <td class="text-center"
                                              ...
                                              @endif --}}
                                                                        ...
                                                                        <td class="text-center"
                                                                            ...
                                                                            @if ($basicsalaryinfo->flexitime == 1)
                                                                                @if ($eachattendance->latehours > 0)
                                                                                    {{ number_format($eachattendance->flexihoursundertime * 60) }}
                                                                                    mins
                                                                                @else
                                                                                    0 min
                                                                                @endif
                                                                            @else
                                                                                ...
                                                                                {{ $eachattendance->totalminutesundertime }}
                                                                                mins
                                                                            @endif
                                                                        </td>
                                                                        ...
                                                                        <td class="text-center"
                                                                            style="vertical-align: middle;">
                                                                            @if ($basicsalaryinfo->flexitime == 1)
                                                                                {{ floor($eachattendance->flexihours) }}
                                                                                hours
                                                                                {{ number_format(($eachattendance->flexihours - floor($eachattendance->flexihours)) * 60, 0) }}
                                                                                minutes
                                                                            @else
                                                                        ...
                                                                        <td class="text-center"
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                if ($basicsalaryinfo->flexitime == 1) {
                                                                                    ...
                                                                                    if (
                                                                                        $basicsalaryinfo->attendancebased ==
                                                                                        1
                                                                                    ) {
                                                                                        if ($tardinessbaseonsalary) {
                                                                                            // $latetime = number_format($eachattendance->lateminutes);
                                                                                            $latetime =
                                                                                                $eachattendance->totalminuteslate;

                                                                                            // $amountperhour = floor(($basicsalaryinfo->amountperhour / 60) * 100)  / 100;
                                                                                            $amountperhour = number_format(
                                                                                                $basicsalaryinfo->amountperhour /
                                                                                                    60,
                                                                                                2,
                                                                                            );
                                                                                            // $min = number_format($amountperhour - .005, 2) * $latetime;
                                                                                            ...
                                                                                            $min =
                                                                                                $eachattendance->latedeductionamount;
                                                                                        }
                                                                                    } else {
                                                                                        $min = 0;
                                                                                    }
                                                                                ...
                                                                                @if ($basicsalaryinfo->flexitime == 1)
                                                                                    @php
                                                                                        if (
                                                                                            ...
                                                                                            if (
                                                                                                $tardinessbaseonsalary
                                                                                            ) {
                                                                                                if (
                                                                                                    $basicsalaryinfo->flexitime ==
                                                                                                    1
                                                                                                ) {
                                                                                                    $latetime =
                                                                                                        $eachattendance->flexihoursundertime *
                                                                                                        60;
                                                  ...
                                                  @endif --}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center" id="countlateminutes"
                                                                        data-value="
                                          @if ($basicsalaryinfo->flexitime == 1) {{-- {{collect($latedays)->sum('flexihoursundertime')}} --}}
                                            0
                                          @else
                                            {{-- {{collect($latedays)->sum('lateminutes')}} --}}
                                            {{-- {{number_format(collect($latedays)->sum('latehours') * 60)}} --}}
                                            {{ collect($latedays)->sum('totalminuteslate') }} @endif
                                          ">
                                                                        @if ($basicsalaryinfo->flexitime == 1)
                                                                    ...
                                                                    <td class="text-center" id="countundertimeminutes"
                                                                        data-value="
                                          @if ($basicsalaryinfo->flexitime == 1) {{ collect($latedays)->sum('flexihoursundertime') }}
                                          @else
                                            {{-- {{collect($latedays)->sum('undertime')}} --}}
                                            {{ collect($latedays)->sum('totalminutesundertime') }} @endif
                                          ">
                                                                        @if ($basicsalaryinfo->flexitime == 1)
                                                                            {{ number_format(collect($latedays)->sum('flexihoursundertime') * 60, 2) }}
                                                                            min(s)
                                                                        @else
                                                                            {{-- {{number_format(collect($attendance)->sum('undertimehours') * 60,2)}} min(s) --}}
                                                                            {{ collect($attendance)->sum('totalminutesundertime') }}
                                                                            min(s)
                                                                        @endif
                                                                    </td>
                                                                    <td id="totalworkedhours"
                                                                        data-value="
                                          @if ($basicsalaryinfo->flexitime == 1) {{ collect($attendance)->where('flexihours', '>', 0)->sum('flexihours') }}
                                          @else
                                            {{ collect($attendance)->where('totalworkinghoursrender', '>', 0)->sum('totalworkinghoursrender') }} @endif
                                          "
                                                                        class="text-center">
                                                                        ...
                                                                        @else
                                                                            @php
                                                                                if (
                                                                                    ...
                                                                                    if (
                                                                                        $basicsalaryinfo->flexitime == 1
                                                                                    ) {
                                                                                        if ($tardinessbaseonsalary) {
                                                                                            $latetime =
                                                                                                collect($latedays)->sum(
                                                                                                    'flexihoursundertime',
                                                                                                ) * 60;
                                                                                            $amountperhour =
                                                                                                $basicsalaryinfo->amountperhour /
                                                                                        ...
                                                                                        if ($tardinessbaseonsalary) {
                                                                                            ...
                                                                                            if (
                                                                                                $employeeinfo->tardinessperdepactivated ===
                                                                                                1
                                                                                            ) {
                                                                                                $min = collect(
                                                                                                    $latedays,
                                                                    ...
                                                                    <td class="text-center"
                                                                        ...
                                                                        @else
                                                                            @php
                                                                                $undertime = collect($attendance)
                                                                                    // ->where('totalworkinghours', '>', 0)
                                                                                    ->sum('totalminutesundertime');
                                                                                $amountperhour = number_format(
                                                                                    $basicsalaryinfo->amountperhour /
                                                                                        60,
                                                                                    2,
                        ...
                        @endphp --}}
                                        ...
                                        <td id="dayspresent" class="text-center"
                                            dayspresentwithsat="{{ collect($attendance)->where('totalworkinghours', '>', 0)->count() + $satcount }}">
                                            <strong>{{ collect($attendance)->where('totalworkinghours', '>', 0)->count() }}</strong>
                                        </td>
                                        <td id="daysabsent" class="text-center">
                                            <strong>{{ collect($attendance)->where('totalworkinghours', 0)->count() }}</strong>
                                        </td>
                                        <td id="lateminutes" data-value="{{ collect($attendance)->sum('latehours') }}" class="text-center">
                                            <strong>{{ collect($attendance)->sum('latehours') }} min(s)
                                        </td>
                                        <td class="text-center" id="undertimeminutes" data-value=" {{ collect($attendance)->sum('undertimehours') }}">
                                            <strong>
                                                {{ collect($attendance)->sum('undertimehours') }} min(s)
                                            </strong>
                                        </td>
                                        {{-- @php
                            dd($saturdayCount);
                        @endphp --}}
                                        ...
                                        <td id="totalworkedhours"
                                            data-value="{{ number_format(collect($attendance)->where('totalworkinghours', '>', 0)->sum('totalworkinghours') / 60, 2) }}"
                                            class="text-center">
                                            <strong>
                                                @php
                                                    $totalminutes = collect($attendance)
                                                        ->where('totalworkinghours', '>', 0)
                                        ...
                                        <th hidden class="text-right" id="amountperday"
                                            data-value="@if ($basicsalaryinfo->amount > 0 && count($attendance) > 0) {{ number_format(floor(($basicsalaryinfo->amount / 2 / (count($attendance) + $satcount)) * 100) / 100, 2) }} @endif">
                                            @if ($basicsalaryinfo->amount > 0 && count($attendance) + $satcount > 0)
                                                {{ number_format(floor(($basicsalaryinfo->amount / 2 / (count($attendance) + $satcount)) * 100) / 100, 2) }}
                                                @php $amountperday=floor((($basicsalaryinfo->amount/2)/(count($attendance) + $satcount))*100)/100; @endphp @endif
                                        </th>
                                        <th>
                                            @php
                                                // define('MINUTES_PER_HOUR', 60);
                                                            ...
                                                            <table class="table table-striped m-0">
                                                                ...
                                                                @foreach ($attendance as $eachattendance)
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-center"
                                                                            style="vertical-align: middle;">
                                                                            {{ $eachattendance->latehours }} mins
                                                                        </td>
                                                                        <td class="text-center"
                                                                            style="vertical-align: middle;">
                                                                            {{ $eachattendance->undertimehours }}
                                                                            mins
                                                                        </td>
                                                                        <td class="text-center"
                                                                            style="vertical-align: middle;">
                                                                            <?php
                                                                            $totalMinutes = $eachattendance->totalworkinghours;
                                                                            $hours = floor($totalMinutes / 60);
                                                                            $remainingMinutes = ($totalMinutes / 60 - $hours) * 60;
                                                                        ...
                                                                        <td class="text-center"
                                                                            style="vertical-align: middle;">
                                                                            @if (is_object($eachattendance->holiday))
                                                                                <div class="holidayname">
                                                                                    <span>{{ $eachattendance->holiday->holidayname }}</span>
                                                                                </div>
                                                                            @elseif (!is_null($eachattendance->appliedleave) && is_object($eachattendance->appliedleave))
                                                                                <div class="leavename">
                                                                                    <span>{{ $eachattendance->appliedleave->leavetype }}</span>
                                                                                </div>
                                                                            @else
                                                                                @php
                                                                                    $undertime =
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center" id="countlateminutes"
                                                                        data-value="
                                                                          {{-- {{collect($latedays)->sum('lateminutes')}} --}}
                                                                          {{-- {{number_format(collect($latedays)->sum('latehours') * 60)}} --}}
                                                                          {{ collect($latedays)->sum('latehours') }}
                                                                        ">
                                                                        {{ collect($latedays)->sum('latehours') }}
                                                                        min(s)
                                                                    </td>
                                                                    <td class="text-center" id="countundertimeminutes"
                                                                        data-value="
                                                                          {{ collect($latedays)->sum('undertimehours') }}
                                                                        ">
                                                                        {{ collect($latedays)->sum('undertimehours') }}
                                                                        min(s)
                                                                    </td>
                                                                    <td id="totalworkedhours"
                                                                        data-value="
                                                                            {{ collect($attendance)->where('totalworkinghours', '>', 0)->sum('totalworkinghours') }}
                                                                          "
                                                                        class="text-center">
                                                                        @php
                                                                            $totalminutes = collect($attendance)
        ...
        <div class="card-body p-1">
                                ...
                                <tr>
                                    ...
                                    @else
                                        <td class="text-right text-bold text-success" id="td-basicpay-amount"
                                            data-amount=" 
                    @if ($basicsalaryamount > 0) {{ floor(($basicsalaryinfo->amount / 2) * 100) / 100 }}
                    @else
                      {{ $basicsalaryamount }} @endif
                  ">
            ...
            @endphp --}}
                            @if (collect($leaves)->where('amount', '>', '0')->count() > 0)
                                <table style="width: 100%; table-layout: fixed; font-size: 14px;" hidden>
                                    @foreach (collect($leaves)->where('amount', '>', '0')->values() as $eachleaf)
                                        <tr>
                                            <td>{{ $eachleaf->leave_type }} <small
                                                    class="text-bold">{{ date('m/d/Y', strtotime($eachleaf->ldate)) }}</small>
                                            </td>
                                            {{-- @if ($released == 1)
                    <td class="text-right text-bold text-success">
                    ...
                    @else --}}
                                            <td class="text-right text-bold text-success td-leaves"
                                                data-ldateid="{{ $eachleaf->ldateid }}"
                                                data-amount="{{ $eachleaf->amount }}"
                                                data-description="{{ $eachleaf->leave_type }}"
                                                data-empleaveid="{{ $eachleaf->employeeleaveid }}"
                                                data-ldateid="{{ $eachleaf->ldateid }}">
                                                {{ $eachleaf->amount }}
                                            </td>
                                            {{-- @endif --}}
                            ...
                            @if ($holidays)
                                @if (count($holidays) > 0)
                                    @if ($totalPresentHolidaypay > 0)
                                        <table style="width: 100%; table-layout: fixed; font-size: 14px;" hidden>
                                            <tr>
                                                <td>HOLIDAY&nbsp;<span class="text-info listholiday"><i
                                                            class="fas fa-caret-right"></i></span></td>
                                                @if ($released == 1)
                                                    <td class="text-right text-bold text-success">
                ...
                <table style="width: 100% !important;">
                  ...
                  <p hidden>Total Holiday Pay: <span id="holiday-amount" data-value="{{$totalHolidayPay}}">{{ number_format($totalHolidayPay, 2, '.', ',') }}</span></p>
                                    ...
                                    <div class="listherediv" hidden>
                                        <table style="width: 100% !important;">
                                            @foreach ($holidays as $eachholiday)
                                                @if ($eachholiday['matching'] == 'Matching')
                                                    <tr>
                                                        <td style="width: 70%;"><small><span
                                                                    style="padding-left: 18px!important"><i
                                                                        class="fas fa-circle fa-rotate-270 fa-xs"></i>
                                                                    {{ $eachholiday['typename'] }}</span>
                                                                @if ($eachholiday['duration'] > 1)
                                                                    &nbsp;<span class="text-info"
                                                                        style="text-transform: uppercase;">({{ $eachholiday['description'] }})</span>&nbsp;<span
                                                                        class="text-info"
                                                                        style="text-transform: uppercase;">({{ \Carbon\Carbon::parse($eachholiday['start'])->format('Y-m-d') }})</span>
                                                                    - <span class="text-info"
                                                                        style="text-transform: uppercase;">({{ \Carbon\Carbon::parse($eachholiday['end'])->format('Y-m-d') }})</span>
                                                                @else
                                                                    &nbsp;<span class="text-info"
                                                                        style="text-transform: uppercase;">({{ $eachholiday['description'] }})</span>&nbsp;<span
                                                                        class="text-info"
                                                        ...
                                                        @if ($released == 1)
                                                            <td style="width: 30%; text-align: right;"
                                                                class="text-success">
                                                                <small><b>{{ number_format($eachholiday['holidaypay'], 2, '.', ',') }}</b></small>
                                                            </td>
                                                        @else
                                                            <td style="width: 30%; text-align: right;"
                                                                class="text-success amountholiday"
                                                                data-typename="{{ $eachholiday['typename'] }}"
                                                                data-id="{{ $eachholiday['id'] }}"
                                                                data-amount="{{ $eachholiday['holidaypay'] }}">
                                                                <small><b>{{ $eachholiday['holidaypay'] }}</b></small>
                                                            </td>
                                                            @php
                                                                $totalHolidayPay += $eachholiday['holidaypay']; // Add the holiday pay to the total
                                                            @endphp
                                        ...
                                        <!-- Output the total holiday pay -->
                                        <p hidden>Total Holiday Pay: <span id="holiday-amount"
                                                data-value="{{ $totalHolidayPay }}">{{ number_format($totalHolidayPay, 2, '.', ',') }}</span>
                                        </p>
                                    </div>
                                @endif
                            @endif
            ...
            @endphp --}}
                                ...
                                <table style="width: 100% !important;">
                                    @foreach ($standardallowances as $eachstandard)
                                        @if ($eachstandard->baseonattendance == 1)
                                            <tr>
                                                <td style="width: 40%;">
                                                    <small>{{ strtoupper($eachstandard->description) }}</small>
                                                </td>
                                                <td>
                                                    @if ($eachstandard->paidforthismonth == 0)
                                                        <div class="icheck-primary d-inline mr-2 standardallowance"
                                                            data-allowancetype="0" {{-- data-allowanceid="{{$eachstandard->empallowanceid}}"  --}}
                                                            ...
                                                            data-description="{{ $eachstandard->description }}"
                                                            style="font-size: 11.5px;">
                                                            <input type="checkbox"
                                                                id="standardallowance{{ $eachstandard->id }}1"
                                                                name="standardallowance{{ $eachstandard->id }}"
                            ...
                            @if ($eachstandard->lock == 1 && $eachstandard->paymenttype == 0) @endif @if ($eachstandard->paymenttype == 1 && $eachstandard->totalDaysAmount != 0) @endif --}}
                                                                @if (
                                                                    ($configured == 1 &&
                                                                        $eachstandard->paymenttype == 0 &&
                                                                        $eachstandard->paidstatus == 1 &&
                                                                        $eachstandard->totalDaysAmount != 0) ||
                                                                        ($eachstandard->lock == 1 &&
                                                                            $eachstandard->paymenttype == 0 &&
                                                                            $eachstandard->paidstatus == 1 &&
                                                                            $eachstandard->totalDaysAmount != 0)) checked @endif
                                                                @if ($released == 1) disabled @endif
                                                                @if ($eachstandard->totalDaysAmount == 0) disabled @endif
                                                                @if ($eachstandard->paymenttype == 0 && $eachstandard->paidstatus == 1 && $eachstandard->totalDaysAmount != 0)  @endif checked>
                                                            <label
                                                                for="standardallowance{{ $eachstandard->id }}1">Full
                                                                &nbsp;&nbsp;&nbsp;<span class="text-info">Base on
                                                                    Attendance ( {{ $eachstandard->amountperday }} *
                                                                    {{ $eachstandard->totalDayspresent + $saturdayCount }}
                                                                    )</span>
                                                            </label>
                            ...
                            @if ($eachstandard->lock == 1 && $eachstandard->paymenttype == 0) @endif @if ($eachstandard->paymenttype == 1) @endif --}}
                                                ...
                                                <td class="text-right text-success"><small class=" text-bold"
                                                        id="text-amount-standardallowance-{{ $eachstandard->empallowanceid }}">{{ number_format($eachstandard->totalDaysAmount, 2, '.', ',') }}</small>
                                                </td>
                                            </tr>
                                        @elseif ($eachstandard->amountbaseonsalary == 1)
                                            <tr>
                                                    ...
                                                    @if ($eachstandard->paidforthismonth == 0)
                                                        <div class="icheck-primary d-inline mr-2 standardallowance"
                                                            ...
                                                            <input type="checkbox"
                                                                ...
                                                                style="height:35px; width:35px; vertical-align: middle;"
                                                                @if (
                                                                    ($configured == 1 && $eachstandard->paymenttype == 0) ||
                                                                        ($eachstandard->lock == 1 && $configured == 1 && $eachstandard->paymenttype == 0)) checked @endif
                                                                @if ($released == 1) disabled @endif
                                                                @if ($eachstandard->lock == 1 && $eachstandard->paymenttype == 0)  @endif
                                                                @if ($eachstandard->paymenttype == 1)  @endif checked>
                                                            <label
                                                                for="standardallowance{{ $eachstandard->id }}1">Full
                                                                &nbsp;&nbsp;&nbsp;<span class="text-info">Amount Base
                                                                    on Daily Salary</span>
                                                            </label>
                                                ...
                                                @if ($basicsalaryinfo->salarybasistype == 5)
                                                    <td class="text-right text-success"><small class=" text-bold"
                                                            id="text-amount-standardallowance-{{ $eachstandard->empallowanceid }}">{{ number_format($eachstandard->totalamount, 2, '.', ',') }}</small>
                                                    </td>
                                                @else
                                                    <td class="text-right text-success"><small class=" text-bold"
                                                            id="text-amount-standardallowance-{{ $eachstandard->empallowanceid }}">{{ number_format($eachstandard->totalamount, 2, '.', ',') }}</small>
                        ...
                        @endif --}}
                                                    ...
                                                    @if ($eachstandard->paidforthismonth == 0)
                                                        ...
                                                        <div class="icheck-primary d-inline mr-2 standardallowance"
                                                            ...
                                                            style="font-size: 11.5px;">
                                                            <input type="checkbox"
                                                                class="standard_a{{ $eachstandard->id }}"
                                                                id="standardallowance{{ $eachstandard->id }}1"
                                                                name="standardallowance{{ $eachstandard->id }}"
                                                                style="height:35px; width:35px; vertical-align: middle;"
                                                                @if ($basicsalaryinfo->salarybasistype == 9) @if ($configured == 1 && $eachstandard->paidstatus == 1 && $eachstandard->paymenttype == 0) checked @endif
                                                                @if ($configured == 1 && $eachstandard->paidstatus == 1 && $eachstandard->lock == 1 && $eachstandard->paymenttype == 0) checked @endif
                                                            @if ($eachstandard->lock == 1)  @endif @else
                                                                @if (
                                                                    ($configured == 1 && $eachstandard->paymenttype == 0 && $eachstandard->paidstatus == 1) ||
                                                                        ($eachstandard->lock == 1 &&
                                                                            $configured == 1 &&
                                                                            $eachstandard->paymenttype == 0 &&
                                                                            $eachstandard->paidstatus == 1)) checked @endif
                                                                @if ($eachstandard->lock == 1 && $eachstandard->paymenttype == 0)  @endif
                                                                @if ($eachstandard->paymenttype == 1)  @endif
                                                                @if ($released == 1) disabled @endif
                                                                @endif
                                                            >
                                                            <label
                                                        ...
                                                        <div class="icheck-primary d-inline mr-2 standardallowance"
                                                            data-allowancetype="1" {{-- data-allowanceid="{{$eachstandard->empallowanceid}}"  --}}
                                                            data-allowanceid="{{ $eachstandard->id }}"
                                                            data-totalamount="{{ $eachstandard->totalamount }}"
                                                            dataid="{{ $eachstandard->id }}"
                                                            ...
                                                            <input type="checkbox"
                                                                class="standard_a{{ $eachstandard->id }}"
                                                                id="standardallowance{{ $eachstandard->id }}2"
                                                                name="standardallowance{{ $eachstandard->id }}"
                                                                style="height:35px; width:35px; vertical-align: middle;"
                                                                @if ($basicsalaryinfo->salarybasistype == 9) @if ($configured == 1 && $eachstandard->paidstatus == 1 && $eachstandard->paymenttype == 1) checked @endif
                                                                @if ($configured == 1 && $eachstandard->paidstatus == 1 && $eachstandard->lock == 1 && $eachstandard->paymenttype == 1) checked @endif
                                                            @if ($eachstandard->lock == 1)  @endif @else
                                                                @if (
                                                                    ($configured == 1 && $eachstandard->paymenttype == 1 && $eachstandard->paidstatus == 1) ||
                                                                        ($eachstandard->lock == 1 && $eachstandard->paymenttype == 1 && $eachstandard->paidstatus == 1)) checked @endif
                                                                @if ($released == 1) disabled @endif
                                                            ...
                                                            <label
                                                                for="standardallowance{{ $eachstandard->id }}2">Half
                                                            </label>
                                                        </div>
                            ...
                            @endif --}}
                                                ...
                                                <td class="text-right text-success"><small class=" text-bold"
                                                        id="text-amount-standardallowance-{{ $eachstandard->id }}">{{ number_format($eachstandard->eesamount, 2, '.', ',') }}</small>
                                                </td>
                                            </tr>
                                        @endif
                            ...
                            @if (count($otherallowances) > 0)
                                <table style="width: 100% !important;">
                                    @foreach ($otherallowances as $eachotherallowance)
                                        <tr>
                                            <td style="width: 40%;">
                                                <small>{{ strtoupper($eachotherallowance->description) }}</small>
                                            </td>
                                            <td>
                                                @if ($eachotherallowance->paidforthismonth == 0)
                                                    <div class="icheck-primary d-inline mr-2 otherallowance"
                                                        ...
                                                        dataid="{{ $eachotherallowance->id }}" {{-- data-odid="{{$eachotherallowance->id}}" --}}
                                                        data-amount="{{ $eachotherallowance->totalamount }}"
                                                        data-description="{{ $eachotherallowance->description }}"
                                                        style="font-size: 11.5px;">
                                                        <input type="radio"
                                                            id="otherallowance{{ $eachotherallowance->id }}1"
                                                            name="otherallowance{{ $eachotherallowance->id }}"
                                                            style="height:35px; width:35px; vertical-align: middle;"
                                                            @if (($configured == 1 && $eachotherallowance->paymenttype == 0) || $eachotherallowance->lock == 1) checked @endif
                                                            @if ($eachotherallowance->lock == 1) disabled @endif>
                                                        <label
                                                            for="otherallowance{{ $eachotherallowance->id }}1">Full
                                                        </label>
                                                    </div>
                                                    <div class="icheck-primary d-inline mr-2 otherallowance"
                                                        ...
                                                        style="font-size: 11.5px;">
                                                        <input type="radio"
                                                            id="otherallowance{{ $eachotherallowance->id }}2"
                                                            name="otherallowance{{ $eachotherallowance->id }}"
                                                            style="height:35px; width:35px; vertical-align: middle;"
                                                            @if (($configured == 1 && $eachotherallowance->paymenttype == 1) || $eachotherallowance->lock == 1) checked @endif
                                                            @if ($eachotherallowance->lock == 1) disabled @endif>
                                                        <label
                                                            for="otherallowance{{ $eachotherallowance->id }}2">Half
                                                        </label>
                                                    </div>
                                                @else
                                                    Paid for this month
                                            ...
                                            <td class="text-right text-success"><small class=" text-bold"
                                                    id="text-amount-otherallowance-{{ $eachotherallowance->id }}">{{ number_format($eachotherallowance->totalamount, 2, '.', ',') }}</small>
                                            </td>
                                        </tr>
                                        ...
                                        @php
                                            ...
                                            if ($eachotherallowance->paymenttype == 0) {
                                                ...
                                                $totalearnings += number_format(
                                                    $eachotherallowance->totalamount / 2,
                                                    2,
                                                );
                                            }
                                        @endphp
                            ...
                            @if (count($filedovertimes) > 0)
                                <table style="width: 100%; table-layout: fixed; font-size: 14px;"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-bold text-success" id="td-overtimepay"
                                            data-amount="{{ collect($filedovertimes)->sum('amount') }}">
                ...
                @endif --}}
                                    ...
                                    @foreach ($filedovertimes as $filedovertime)
                                        <tr>
                                            <td></td>
                                            <td></td>
                                            <td class="text-right text-bold text-success filedovertimes"
                                                data-id="{{ $filedovertime->id }}"
                                                data-amount="{{ $filedovertime->amount }}"
                                                data-totalhours="{{ $filedovertime->totalhours }}">
                                            </td>
                                        </tr>
                                        @php
                        ...
                        <td colspan="2" style="vertical-align: top;">
                            <table style="width: 100% !important;">
                                <tr>
                                    ...
                                    @if ($released == 1)
                                        <td style="width: 50%; text-align: right;" class="text-danger"><small
                                                class="text-bold">{{ number_format($payrollinfo->daysabsentamount, 2, '.', ',') }}</small>
                                        </td>
                                    @else
                                        <td style="width: 50%; text-align: right;" class="text-danger text-bold"
                                            id="amountabsent"
                                            ...
                                            <small
                                                class="text-bold">{{ $basicsalaryinfo->attendancebased == 1 ? bcdiv(collect($attendance)->where('totalworkinghours', 0)->count() * $basicsalaryinfo->amountperday, 1, 2) : 0 }}</small>
                                        </td>
                                    @endif
                                </tr>
                                <tr>
                                    ...
                                    @if ($released == 1)
                                        <td style="width: 50%; text-align: right;" class="text-danger"><small
                                                class="text-bold">{{ number_format($payrollinfo->lateamount, 2, '.', ',') }}</small>
                                        </td>
                                    @else
                                        <td style="width: 50%; text-align: right;" class="text-danger text-bold" id="amountlate"
                                            ...
                                            @php
                                                if ($tardinessbaseonsalary) {
                                                    $latetime = collect($latedays)->sum('latehours');
                                                    $amountperhour = number_format(
                                                        $basicsalaryinfo->amountperhour / 60,
                                                        2,
                                                    );
                                                    $min = $amountperhour * $latetime;
                                                } else {
                                ...
                                <tr>
                                    ...
                                    @if ($released == 1)
                                        <td style="width: 50%; text-align: right;" class="text-danger"><small
                                                class="text-bold">{{ number_format($payrollinfo->undertimeamount, 2, '.', ',') }}</small>
                                        </td>
                                    @else
                                        <td class="text-right text-danger" style="width: 50%;" id="amountundertime"
                                            data-value=" 
                                                @php
                                                    $undertime = collect($attendance)->where('totalworkinghours','>',0)->sum('undertimehours');
                                                    $amountperhour = number_format($basicsalaryinfo->amountperhour / 60,2);
                                                    $min = $amountperhour * $undertime;
                                                @endphp
...
if ($basicsalaryinfo->flexitime == 1) {
                    ...
                    {{ $min }}">
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-danger" style="width: 50%;"
                                        id="amounttardyemergencyload"
                                        data-value=" 
                  @php
if ($basicsalaryinfo->flexitime == 1) {
                      $min = 0;
                                ...
                                @if ($basicsalaryinfo->salarybasistype == 9)
                                    <table style="width: 100% !important;">
                                        @foreach ($standarddeductions as $eachstandarddeduction)
                                            <tr>
                                                <td style="width: 30%;">
                                                    <small>{{ strtoupper($eachstandarddeduction->description) }}</small>
                                                </td>
                                                <td>
                                                    @if ($eachstandarddeduction->paidforthismonth == 0)
                                                        <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                            ...
                                                            data-description="{{ $eachstandarddeduction->description }}"
                                                            style="font-size: 11.5px;">

                                                            <input type="checkbox"
                                                                class="standard_d{{ $eachstandarddeduction->id }}"
                                                                id="standarddeduction{{ $eachstandarddeduction->id }}1"
                                                                name="standarddeduction{{ $eachstandarddeduction->id }}"
                                                                style="height:35px; width:35px; vertical-align: middle;"
                                                                ...
                                                                @if (
                                                                    $configured == 1 &&
                                                                        $eachstandarddeduction->paidstatus == 1 &&
                                                                        $eachstandarddeduction->lock == 1 &&
                                                                        $eachstandarddeduction->paymenttype == 0) checked @endif
                                                                @if ($eachstandarddeduction->lock == 1)  @endif>
                                                            <label
                                                                for="standarddeduction{{ $eachstandarddeduction->id }}1">Full
                                                            </label>
                                                        ...
                                                        <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                            ...
                                                            <input type="checkbox"
                                                                class="standard_d{{ $eachstandarddeduction->id }}"
                                                                id="standarddeduction{{ $eachstandarddeduction->id }}2"
                                                                name="standarddeduction{{ $eachstandarddeduction->id }}"
                                                                style="height:35px; width:35px; vertical-align: middle;"
                                                                {{-- @if (($configured == 1 && $eachstandarddeduction->paymenttype == 1) || ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 1))checked @endif  --}} {{-- @if (($configured == 1 && $eachstandarddeduction->paymenttype == 1) || ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 1))checked @endif  --}}
                                                                @if ($configured == 1 && $eachstandarddeduction->paidstatus == 1 && $eachstandarddeduction->paymenttype == 1) checked @endif
                                                                @if (
                                                                    $configured == 1 &&
                                                                        $eachstandarddeduction->paidstatus == 1 &&
                                                                        $eachstandarddeduction->lock == 1 &&
                                                                        $eachstandarddeduction->paymenttype == 1) checked @endif
                                                                @if ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 1) checked @endif>
                                                            <label
                                                                for="standarddeduction{{ $eachstandarddeduction->id }}2">Half
                                                            </label>
                                                ...
                                                <td class="text-danger text-right"><small class=" text-bold"
                                                        id="text-amount-standarddeduction-{{ $eachstandarddeduction->id }}">{{ number_format($eachstandarddeduction->totalamount, 2, '.', ',') }}</small>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </table>
                                                    ...
                                                    @if ($released == 0)
                                                        ...
                                                        @else
                                                            <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                                ...
                                                                dataid="{{ $eachstandarddeduction->id }}"
                                                                data-totalamount="{{ $eachstandarddeduction->totalamount }}"
                                                                @if ($eachstandarddeduction->updatedamount == 0) data-amount="{{ $eachstandarddeduction->totalamount }}" 
                            @else
                              data-amount="{{ $eachstandarddeduction->updatedamount }}" @endif
                                                                data-description="{{ $eachstandarddeduction->description }}"
                                                                style="font-size: 11.5px;">
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    style="height:35px; width:35px; vertical-align: middle;"
                                                                    {{-- @if (($configured == 1 && $eachstandarddeduction->paymenttype == 0) || ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 0))checked  @endif  --}}
                                                                    @if ($employeeinfo->departmentid != 6) @if ($configured == 1 && $eachstandarddeduction->paidstatus == 1 && $eachstandarddeduction->paymenttype == 0) checked @endif
                                                            ...
                                                            <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                                ...
                                                                @if ($eachstandarddeduction->updatedamount == 0) data-amount="{{ floor(($eachstandarddeduction->totalamount / 2) * 100) / 100 }}" 
                              @else
                                data-amount="{{ floor(($eachstandarddeduction->updatedamount / 2) * 100) / 100 }}" @endif
                                                                data-amount="{{ floor(($eachstandarddeduction->totalamount / 2) * 100) / 100 }}"
                                                                data-description="{{ $eachstandarddeduction->description }}"
                                                                style="font-size: 11.5px;">
                                                                ...
                                                                <input type="checkbox"
                                                                    ...
                                                                    style="height:35px; width:35px; vertical-align: middle;"
                                                                    {{-- @if (($configured == 1 && $eachstandarddeduction->paymenttype == 1) || ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 1))checked @endif  --}} {{-- @if (($configured == 1 && $eachstandarddeduction->paymenttype == 1) || ($eachstandarddeduction->lock == 1 && $eachstandarddeduction->paymenttype == 1))checked @endif  --}}
                                                                    @if ($employeeinfo->departmentid != 6) @if ($configured == 1 && $eachstandarddeduction->paidstatus == 1 && $eachstandarddeduction->paymenttype == 1) checked @endif
                                                                    @if (
                                                                        $configured == 1 &&
                                                                            $eachstandarddeduction->paidstatus == 1 &&
                                                                            $eachstandarddeduction->lock == 1 &&
                                                                    ...
                                                                    @if ($eachstandarddeduction->lock == 1)  @endif
                                                                    @if ($released == 1) disabled @endif
                                                                    @if ($eachstandarddeduction->paymenttype == 1) checked @endif
                                                                    checked @endif
                                                                >
                                                                <label
                                                                    for="standarddeduction{{ $eachstandarddeduction->id }}2">Half
                                                    ...
                                                    @else
                                                        @if ($eachstandarddeduction->paidforthismonth == 0)
                                                            <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                                ...
                                                                data-amount="{{ $eachstandarddeduction->totalamount }}"
                                                                @php
$dataamount = floor($eachstandarddeduction->totalamount * 100) / 100 @endphp
                                                            ...
                                                            <div class="icheck-primary d-inline mr-2 standarddeduction"
                                                                ...
                                                                {{-- data-amount="{{number_format($eachstandarddeduction->totalamount/2,2)}}"  --}}
                                                                @php
$dataamount = floor(($eachstandarddeduction->totalamount/2) * 100) / 100 @endphp
                                                                data-amount="{{ $dataamount }}"
                                                                data-description="{{ $eachstandarddeduction->description }}"
                                                                style="font-size: 11.5px;">
            ...
            @endphp --}}
                            @if (count($otherdeductions) > 0)
                                ...
                                <table style="width: 100% !important;">
                                    @foreach ($otherdeductions as $eachotherdeduction)
                                        <tr>
                                            <td style="width: 30%;">
                                                <small>{{ strtoupper($eachotherdeduction['description']) }}</small>
                                            </td>
                                            <td class="p-0">
                                                @if ($basicsalaryinfo->salarybasistype !== 9)
                                                    ...
                                                    <div class="icheck-primary d-inline mr-2 otherdeduction"
                                                        data-deducttype="0" {{-- data-odid="{{$eachotherdeduction->deductionotherid}}" --}}
                                                        ...
                                                        style="font-size: 11.5px; z-index: 1000;  padding-left: 1px!important;">
                                                        <input type="checkbox"
                                                            class="other_d{{ $eachotherdeduction['id'] }}"
                                                            id="otherdeduction{{ $eachotherdeduction['id'] }}1"
                                                            name="otherdeduction{{ $eachotherdeduction['id'] }}"
                                                            style="height:16px!important; width: 16px!important; vertical-align: middle;"
                                                            @if ($eachotherdeduction['paidforthismonth'] == 1) @if (
                                                                $configured == 1 &&
                                                                    $eachotherdeduction['paymenttype'] == 0 &&
                                                                    $eachotherdeduction['paidstatus'] == 1 &&
                                                                    ($eachotherdeduction['lock'] == 1 &&
                                                                        $eachotherdeduction['paymenttype'] == 0 &&
                                                                        $eachotherdeduction['paidstatus'] == 1)) @endif
                                                        ...
                                                        @if ($eachotherdeduction['lock'] == 1)  @endif @else
                                                            @if (
                                                                $configured == 1 &&
                                                                    $eachotherdeduction['paymenttype'] == 0 &&
                                                                    $eachotherdeduction['paidstatus'] == 1 &&
                                                                    ($eachotherdeduction['lock'] == 1 &&
                                                                        $eachotherdeduction['paymenttype'] == 0 &&
                                                                        $eachotherdeduction['paidstatus'] == 1)) checked @endif
                                                            ...
                                                            {{-- @if ($eachotherdeduction['deductionstatus'] == 1 && $eachotherdeduction['description'] != 'PERAA') checked @endif --}} {{-- @if ($eachotherdeduction['description'] == 'PERAA' && (Carbon::parse($payrollperiod->datefrom)->day == 21 && Carbon::parse($payrollperiod->dateto)->day == 5)) checked @endif --}}
                                                            {{-- @if ($eachotherdeduction['description'] == 'PERAA' && $eachotherdeduction['paidstatus'] == 1) checked @endif --}}
                                                            @if ($eachotherdeduction['lock'] == 1)  @endif @endif
                                                        >
                                                        <label
                                                            for="otherdeduction{{ $eachotherdeduction['id'] }}1">Full
                                                        </label>
                                                    </div>
                                                    <div class="icheck-primary d-inline mr-2 otherdeduction"
                                                        data-deducttype="1"
                          ...
                          data-amount="{{$dataamount}}"  --}}
                                                        data-description="{{ $eachotherdeduction['description'] }}"
                                                        style="font-size: 11.5px; z-index: 1000">
                                                        <input type="checkbox"
                                                            class="other_d{{ $eachotherdeduction['id'] }}"
                                                            id="otherdeduction{{ $eachotherdeduction['id'] }}2"
                                                            name="otherdeduction{{ $eachotherdeduction['id'] }}"
                                                            style="height:16px!important; width:16px!important; vertical-align: middle;"
                              ...
                              @if ($configured == 1 && $eachotherdeduction['paymenttype'] == 1 && $eachotherdeduction['paidstatus'] == 1 && $eachotherdeduction['description'] != 'PERAA')checked @endif   --}}
                                                            @if ($released == 1) disabled @endif
                                                            @if ($eachotherdeduction['lock'] == 1)  @endif
                                    ...
                                    $eachotherdeduction->paidstatus = 0;
                                                            ...
                                                            @if ($eachotherdeduction['paymenttype'] != 3 && $eachotherdeduction['deductionstatus'] == 0) @php
                                ...
                                @if (
                                    ($deductionStartDate <= $payrollperiod->datefrom || $deductionStartDate <= $payrollperiod->dateto) &&
                                        $eachotherdeduction['paymenttype'] == 1)
                                  checked @endif
                                                            @endif
                                                        >
                                                        <label for="otherdeduction{{ $eachotherdeduction['id'] }}2">
                                                            Half
                                                        </label>
                                                    </div>
                                                    @if ($basicsalaryinfo->salarybasistype !== 9)
                                            ...
                                            <td class="text-info"
                                                style="font-size: 12px; vertical-align: top!important; position: relative;"
                                                data-totalamountdeductpaid="{{ $eachotherdeduction['totalotherdeductionpaid'] }}">
                                                <div><span>AP :<b>
                                                            {{ number_format($eachotherdeduction['totalotherdeductionpaid'], 2) }}</b></span><br><span
                                                        class=""
                                                        style="position: absolute; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; top: 11px;">
                                                        @if ($eachotherdeduction['paidforthismonth'] == 0)
                                                        @else
                                                            Paid for this month @endif
                                                    </span></div>
                                            </td>
                                            @if ($eachotherdeduction['paymenttype'] == 1)
                                                <td width="20%" class="text-danger text-right">
                                                    <input type="number"
                                                        class="otherdeductionentryamount form-control text-right"
                                                        data-deductionid="{{ $eachotherdeduction['id'] }}"
                                                        dataid="{{ $eachotherdeduction['deductionotherid'] }}"
                                                        ...
                                                        data-deducttype="3"
                                                        @if ($released == 1) disabled @endif
                                                        id="text-amount-otherdeduction-{{ $eachotherdeduction['id'] }}"
                                                        placeholder="Amount"
                                                        style="
                        padding: 0px;
                        height: 25px;
                        ...
                        font-size: 14px;"
                                                        min="0"
                                                        @if ($eachotherdeduction['paidstatus'] = 0) value="0"
                        @else
                          {{-- value="{{$eachotherdeduction['totalamount'] / 2}}" --}}
                          value="{{ $eachotherdeduction['totalamount'] }}" @endif>
                        ...
                        @endif --}}
                                            ...
                                            @elseif($eachotherdeduction['paymenttype'] == 3)
                                                <td width="20%" class="text-danger text-right">
                                                    <input type="number"
                                                        class="otherdeductionentryamount form-control text-right otherdeductionentryamountactive"
                                                        data-deductionid="{{ $eachotherdeduction['id'] }}"
                                                        dataid="{{ $eachotherdeduction['deductionotherid'] }}"
                                                        data-totalamount="{{ $eachotherdeduction['totalamount'] }}"
                                                        data-description="{{ $eachotherdeduction['description'] }}"
                        ...
                        margin-left: 40px;
                        font-size: 14px;"
                                                        min="0" value="{{ $eachotherdeduction['amount'] }}">
                                                    {{-- @if ($eachotherdeduction['totalotherdeductionpaid'] > $eachotherdeduction['fullamount'])
                        <small class="text-bold" id="text-amount-otherdeduction-{{$eachotherdeduction['id']}}">{{number_format(0,2)}}</small></td>
                      @else
                        <small class="text-bold" id="text-amount-otherdeduction-{{$eachotherdeduction['id']}}">{{number_format($eachotherdeduction['totalamount'],2,'.',',')}}</small></td>
                    ...
                    <tr>
                        <td colspan="2">
                            @if ($released == 0)
                                <button type="button" class="btn btn-sm btn-warning pt-0 pb-0 btn-add-particular"
                                    data-type="1"><i class="fa fa-plus fa-xs"></i>&nbsp;Add earning</button>
                            @endif
                        </td>
                        <td>&nbsp;</td>
                        <td colspan="2">
                            @if ($released == 0)
                                <button type="button" class="btn btn-sm btn-warning pt-0 pb-0 btn-add-particular"
                                    data-type="2"><i class="fa fa-plus fa-xs"></i>&nbsp;Add deduction</button>
                            @endif
                        </td>
                    </tr>
                    <tr>
                                ...
                                @if (collect($addedparticulars)->where('type', '1')->count() > 0)
                                    @foreach (collect($addedparticulars)->where('type', '1')->values() as $addedparticular)
                                        <tr>
                                            <td>
                                                @if ($released == 0)
                                                    <i class="fa fa-times fa-xs text-danger delete-particular"
                                                        dataemployeeid="{{ $addedparticular->employeeid }}"
                                                        additionalid="{{ $addedparticular->additionalid }}"
                                                        data-id="{{ $addedparticular->id }}"
                                                        data-amount="{{ $addedparticular->amount }}"
                                                        style="cursor: pointer;"></i>
                                                @endif <span id="{{ $addedparticular->id }}"
                                                    class="text-right m-0 span-description additional-paticular"
                                                    data-type="1" data-id="{{ $addedparticular->additionalid }}"
                                                    data-amount="{{ $addedparticular->amount }}">{{ $addedparticular->description }}</span>
                                            </td>
                                            <td><span class="text-right m-0 span-amount float-right text-success"
                                                    data-type="1"
                                                    data-id="1">{{ $addedparticular->amount }}</span></td>
                                        </tr>
                                    @endforeach
                                @endif
            ...
            @endphp --}}
                                    ...
                                    @foreach (collect($addedparticularearndeductions)->where('type', '1')->values() as $addedparticularearndeduction)
                                        <tr>
                                            <td>
                                                @if ($released == 0)
                                                    <i class="fa fa-times fa-xs text-danger delete-particular"
                                                        dataemployeeid="{{ $addedparticularearndeduction->employeeid }}"
                                                        additionalid="{{ $addedparticularearndeduction->id }}"
                                                        data-id="{{ $addedparticularearndeduction->id }}"
                                                        data-amount="{{ $addedparticularearndeduction->amount }}"
                                                        style="cursor: pointer;"></i>
                                                @endif <span
                                                    id="{{ $addedparticularearndeduction->id }}"
                                                    class="text-right m-0 span-description additional-paticular text-success"
                                                    data-type="1" data-id="{{ $addedparticularearndeduction->id }}"
                                                    data-amount="{{ $addedparticularearndeduction->amount }}">{{ $addedparticularearndeduction->description }}</span>
                                            </td>
                                            <td><span class="text-right m-0 span-amount float-right text-success"
                                                    data-type="1"
                                                    data-id="1">{{ $addedparticularearndeduction->amount }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                                ...
                                @if (collect($addedparticulars)->where('type', '2')->count() > 0)
                                    @foreach (collect($addedparticulars)->where('type', '2')->values() as $addedparticular)
                                        <tr>
                                            ...
                                            <td><span class="text-right m-0 span-amount float-right text-danger"
                                                    data-type="2">{{ $addedparticular->amount }}</span></td>
                                        </tr>
                                    @endforeach
                                @endif
                            </table>
                                    ...
                                    @foreach (collect($addedparticularearndeductions)->where('type', '2')->values() as $addedparticularearndeduction)
                                        <tr>
                                            <td>
                                                ...
                                                @endif <span
                                                    id="{{ $addedparticularearndeduction->id }}"
                                                    class="text-right m-0 span-description additional-paticular text-danger"
                                                    data-type="2" data-id="{{ $addedparticularearndeduction->id }}"
                                                    data-amount="{{ $addedparticularearndeduction->amount }}">{{ $addedparticularearndeduction->description }}</span>
                                            </td>
                                            <td><span class="text-right m-0 span-amount float-right text-danger"
                                                    data-type="2">{{ $addedparticularearndeduction->amount }}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
                ...
                @if ($released == 1)
                    <tfoot>
                        <tr>
                            ...
                            <th class="text-right text-success" style="font-size: 17px;">
                                {{ number_format($payrollinfo->totalearning, 2, '.', ',') }}</th>
                            <th></th>
                            <th>Total Deductions</th>
                            <th class="text-right text-danger" style="font-size: 17px;">
                                {{ number_format($payrollinfo->totaldeduction, 2, '.', ',') }}
                            </th>
                        </tr>
                        <tr>
                            ...
                            <td style="border-top: 1px solid #ddd; font-size: 30px;"
                                class="text-bold text-right text-success"></td>
                        </tr>
                        <tr>
                            ...
                            <td></td>
                            <td style="font-size: 40px;" colspan="2" class="text-bold text-right text-success"
                                id="">{{ number_format($payrollinfo->netsalary, 2, '.', ',') }}</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                @if ($configured == 1)<span
                                        class="badge badge-success">Configured</span> @endif @if ($released == 1)<span
                                            class="badge badge-success">Released</span> <a href="javascript:void(0)"
                                            class="text-danger" id="void_payslip" hidden>&nbsp;<i
                                                class="fas fa-stop-circle"></i> Void&nbsp;</a><a
                                            href="javascript:void(0)" class="text-primary" id="edit_payslip">&nbsp;<i
                                                class="fas fa-edit"></i> Edit Payslip&nbsp;</a>@endif
                            </td>
                            <td></td>
                            <td colspan="2" class="text-right">
                                @if ($released == 0)
                                    <button type="button" class="btn btn-sm btn-default"
                                        id="btn-release-payslip">&nbsp;Release Payslip&nbsp;</button>

                                    <button type="button" class="btn btn-sm btn-primary btn-compute p-0"
                                        data-id="0" hidden>&nbsp;Compute&nbsp;</button>
                                    <button type="button" class="btn btn-sm btn-primary btn-compute" data-id="1"
                                        id="btn-save-computation">&nbsp;Save this computation&nbsp;</button>
                                @else
                                    <button type="button" class="btn btn-sm btn-secondary"
                                        id="btn-export-payslip">&nbsp;<i class="fa fa-print"></i> Print
                                        Payslip&nbsp;</button>
                                @endif
                            </td>
                        </tr>
                ...
                @else
                    <tfoot>
                        <tr>
                            <th>Total Earnings</th>
                            <th class="text-right text-success" style="font-size: 17px;"><span
                                    id="span-total-earn-display">{{ $totalearnings }}</span><span
                                    id="span-total-earn" hidden>{{ $totalearnings }}</span></th>
                            <th></th>
                            <th>Total Deductions</th>
                            <th class="text-right text-danger" style="font-size: 17px;"><span
                                    id="span-total-deduct-display"></span>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td style="font-size: 40px;" colspan="2" class="text-bold text-right text-success">
                                <span id="span-netpay-display"></span><span id="span-netpay" hidden></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                @if ($configured == 1)<span
                                        class="badge badge-success">Configured</span> @endif @if ($released == 1)<span
                                            class="badge badge-success">Released</span> @endif
                            </td>
                            <td></td>
                            <td colspan="2" class="text-right">
                                @if ($released == 0)
                                ...
                                @else
                                    <button type="button" class="btn btn-sm btn-secondary"
                                        id="btn-release-payslip">&nbsp;<i class="fa fa-print"></i> Print
                                        Payslip&nbsp;</button>
                                @endif
                            </td>
                        </tr>
    ...
    <script>
        ...
        $('.otherallowance').on('click', function() {
            ...
            if ($('#container-added-allowance').find('#otherallowance' + allowanceid).length == 0) {
                $('#container-added-allowance').append('<p id="otherallowance' + allowanceid +
                    '" class="text-right m-0 amountcontainer">' + amount + '</p>')
            } else {
        ...
        $('.standarddeduction').on('change', function() {
            ...
            if ($('#container-added-deduction').find('#standeduction' + deductionid).length == 0) {
                $('#container-added-deduction').append('<p id="standeduction' + deductionid +
                    '" class="text-right m-0 amountcontainer">' + amount + '</p>')
            } else {
                $('#standeduction' + deductionid).text(amount)
            }
        ...
        $('.otherdeduction').on('change', function() {
            ...
            if ($('#container-added-deduction').find('#otherdeduction' + deductionid).length == 0) {
                $('#container-added-deduction').append('<p id="otherdeduction' + deductionid +
                    '" class="text-right m-0 amountcontainer">' + amount + '</p>')
            } else {
                $('#otherdeduction' + deductionid).text(amount)
            }
                ...
                if (particulartype == 1) {
                    if ($('.span-description').filter(function() {
                        ...
                        $('#container-addearnings').append(
                            '<tr>' +
                            '<td> <i class="fa fa-times fa-xs text-danger remove-particular" data-id="1" data-amount="' +
                            amount +
                            '" style="cursor: pointer;"></i> <span id="0" class="text-right m-0 span-description additional-paticular text-success" data-id="0" data-type="' +
                            particulartype + '" data-amount="' + amount + '">' + description + '</span></td>' +
                            '<td><span class="text-right m-0 span-amount float-right text-success" data-type="' +
                            particulartype + '">' + amount + '</span></td>' +
                            '</tr>'
                        )
                    }
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-danger" role="alert">
                ...
                Configure the employee's <span class="text-bold">Basic Salary Information</span> <a
                    href="/hr/employees/profile/index?employeeid={{ $employeeid }}">now</a>!
            </div>

<style>
   ...
   .p-2 {
    ...
    .dashed-border {
        border: .5px dashed rgb(114, 114, 114); /* 1px width, dashed style, black color */
        width: 100%;
        margin: 10px 0; /* Adjust margin as needed */
    }
    .first-data {
        border-bottom: 1px dashed #000; /* Add your preferred border style here */
    }
     .check_mark {
           font-family: ZapfDingbats, sans-serif;
        }
    @page{ size: 8.5in 11in; margin: 0px 20px 0px 20px;}
...
@foreach ($histories as $index => $history)
    <div class="data-container @if ($index % 2 === 0) first-data @endif" style="height: {{ $index % 2 === 0 ? '50%' : 'auto' }};">
        <div>
            <div class="row {{ $index % 2 === 0 ? 'watermark' : 'watermark2' }}">
                <div class="col-md-12">
                    <img src="{{ base_path() }}/public/{{ DB::table('schoolinfo')->first()->picurl }}" alt="school" width="300px">
                </div>
            </div>
        ...
        {{-- <div class="watermarkks" style="@if ($index % 2 === 1) page-break-after: always; @endif"> --}}
        <div class="watermarkks" style="@if ($index % 2 === 1) page-break-after: always; @endif">
                ...
                <tr>
                    ...
                    <div class="table-avatar">
                        @php
                            ...
                            @endphp
                            <a href="#" class="avatar">
                                <img src="{{ asset($history->picurl) }}" alt="" onerror="this.onerror = null, this.src='{{asset($avatar)}}'" style="width: 50px;height: 50px;border: 2px double #000; position: absolute" />
                        </a>
                    ...
                    <td width="65%" colspan="2" class="p-0" style="vertical-align: top; font-size: 12px; padding-left: 10px!important;">
                        <table width="100%" class="p-0" style="table-layout: fixed;">
                            <tr>
                                ...
                                <td class="p-0" width="72%"><b><span>:</span> {{$history->tid}}</b></td>
                            </tr>
                        </table>
                        <table width="100%" class="p-0" style="table-layout: fixed;">
                            <tr>
                                <td class="p-0" width="28%"><b>Employee Name</b></td>
                                <td class="p-0" width="72%"><b><span>:</span> {{$history->lastname}}@if ($history->lastname != null), @endif {{$history->firstname}} {{$history->middlename}}  {{$history->suffix}}</b></td>
                            </tr>
                        </table>
                        <table width="100%" class="p-0" style="table-layout: fixed;">
                            <tr>
                                <td class="p-0" width="28%"><b>Rate</b></td>
                                <td class="p-0" width="23%"><b><span>:</span> {{number_format($history->basicsalaryamount,2,'.',',')}}</b></td>
                                <td class="p-0" width="49%"><b>Position :&nbsp;&nbsp;{{$history->utype}}</b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                ...
                                <td width="33.3333333333%" class="text-center p-0" style="border: 1px solid #000;  height: 270px!important; ">
                                    ...
                                    <table width="100%" class="table table-sm" style="table-layout: fixed;font-size: 9px;">
                                        <tr>
                                            ...
                                            <td class="p-0"></td>
                                            <td class="text-right p-0" width="40%"><b>{{number_format($history->basicsalaryamount,2,'.',',')}}</b>&nbsp;</td>
                                        </tr>
                                        @if(count($holidays)>0)
                                            @foreach($holidays as $holiday)
                                                @if ($holiday->employeeid == $history->employeeid)
                                        ...
                                        @if(count($leavedetails)>0)
                                            @foreach($leavedetails as $leavedetail)
                                                @if ($leavedetail->employeeid == $history->employeeid)
                                                    <tr>
                                        ...
                                        @foreach($particulars as $particular)
                                            @if ($particular->employeeid == $history->employeeid)
                                            ...
                                            <td class="p-0" colspan="3">
                                                <table class="table" style="padding-top: 20px;">
                                                    @foreach($addedparticulars as $addedparticular)
                                                        @if ($addedparticular->employeeid == $history->employeeid)
                                ...
                                <td width="33.3333333333%" class="text-center p-0"  style="border: 1px solid #000;">
                                    ...
                                    <table class="table table-sm" style="width: 100%; font-size: 9px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0"><b>{{$history->absentdays > 0 ? $history->absentdays.'days' : ''}}</b></td>
                                            <td class="text-right p-0">
                                                <b>{{number_format($history->daysabsentamount,2,'.',',')}}&nbsp;</b>
                                            </td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0"><b>{{$history->lateminutes > 0 ? $history->lateminutes.' min(s)' : ''}}</b></td>
                                            <td class="text-right p-0">
                                                <b>{{number_format($history->lateamount,2,'.',',')}}&nbsp;</b>
                                            </td>
                                        </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0"><b>{{$history->undertimeminutes > 0 ? $history->undertimeminutes.' min(s)' : ''}}</b></td>
                                            <td class="text-right p-0">
                                                <b>{{number_format($history->undertimeamount,2,'.',',')}}&nbsp;</b>
                                            </td>
                                        </tr>
                                        @endif
                                        @if ($history->regulartardyamount > 0)
                                            <tr>
                                                <td class="text-left p-0" width="60%">&nbsp;<span><b>Regular Load Tardy</b></span></td>
                                                <td class="p-0"></td>
                                                <td class="text-right p-0" width="40%"><b>{{number_format($history->regulartardyamount,2,'.',',')}}</b>&nbsp;</td>
                                            </tr>
                                        @endif
                                        @if ($history->overloadtardyamount > 0)
                                            <tr>
                                                <td class="text-left p-0" width="60%">&nbsp;<span><b>Overload Tardy</b></span></td>
                                                <td class="p-0"></td>
                                                <td class="text-right p-0" width="40%"><b>{{number_format($history->overloadtardyamount,2,'.',',')}}</b>&nbsp;</td>
                                            </tr>
                                        @endif
                                        @if ($history->emergencyloadtardyamount > 0)
                                            <tr>
                                                @if ($payrollinfo->id < 34)
                                                    <td class="text-left p-0" width="60%">&nbsp;<span><b>Part Time</b></span></td>
                                                @else
                                                    <td class="text-left p-0" width="60%">&nbsp;<span><b>Emergency Tardy</b></span></td>
                                                @endif
                                                <td class="p-0"></td>
                                                <td class="text-right p-0" width="40%"><b>{{number_format($history->emergencyloadtardyamount,2,'.',',')}}</b>&nbsp;</td>
                                            </tr>
                                        @endif
                                        @foreach($particulars as $particular)
                                            @if ($particular->employeeid == $history->employeeid)
                                    ...
                                    <table class="table table-sm" style="width: 100%; font-size: 9px;">
                                        @foreach($otherdeductions as $otherdeduction)
                                            @if ($otherdeduction->totalamountpaid != $otherdeduction->fullamount)
                                                @if ($payrollinfo->id < 34)
                                                    @if ($otherdeduction->employeeid == $history->employeeid)
                                                        <tr>
                                                            <td class="text-left p-0" colspan="2">&nbsp;<b>{{$otherdeduction->description}}</b>
                                                            </td>
                                                            <td class="text-right p-0">
                                                                @if ($otherdeduction->term == 0)
                                                                    <b>{{ number_format($otherdeduction->amount - $otherdeduction->totalamountpaid, 2, '.', ',')}}&nbsp;</b>
                                                                @else
                                                                    <b>{{ number_format($otherdeduction->amount * $otherdeduction->term - $otherdeduction->totalamountpaid, 2, '.', ',')}}&nbsp;</b>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @endif
                                                @else
                                                    @if ($otherdeduction->employeeid == $history->employeeid && $otherdeduction->term != 0)
                                                        <tr>
                                                            <td class="text-left p-0" colspan="2">&nbsp;<b>{{$otherdeduction->description}}</b>
                                                            </td>
                                                            <td class="text-right p-0">
                                ...
                                <td width="33.3333333333%" class="p-0" style="">
                                    <table width="100%" style="">
                                        <tr>
                                            ...
                                            <td class="text-right" style="padding-top: 7px!important;"><span><b>{{number_format($history->totalearning,2,'.',',')}}</b></span></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="33.3333333333%" class="p-0">
                                    <table width="100%" style="">
                                        <tr>
                                            ...
                                            <td class="text-right" style="padding-top: 7px!important;"><span><b>{{number_format($history->totaldeduction,2,'.',',')}}</b></span></td>
                                        </tr>
                                    </table>
                                </td>
                                <td width="33.3333333333%" class="p-0">
                                    <table width="100%" style="">
                                        <tr>
                                            ...
                                            <td class="text-right" style="padding-top: 7px!important;"><span><b>{{number_format($history->netsalary,2,'.',',')}}</b></span></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="  border: 1px solid #000;">
                                    <table>
                                        ...
                                        <tr>
                                            <td class="text-left p-0" style="padding-top: 5px!important"><b>{{$history->tid}}</b></td>
                                        </tr>
                                        <tr>
                                            <td class="text-left p-0" style="font-size: 8px;">{{$history->lastname}}@if ($history->lastname != null), @endif {{$history->firstname}} {{$history->middlename}}  {{$history->suffix}}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center p-0" style="font-size: 12px; padding-top: 10px!important;"><b>== NETPAY == </b></td>
                                        </tr>
                                        <tr>
                                            <td class="text-center p-0" style="font-size: 13px; padding-top: 5px!important;"><b>{{number_format($history->netsalary,2,'.',',')}}</b></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="text-center p-0" style="padding-top: 8px!important; font-size: 8px;">{{$history->lastname}}@if ($history->lastname != null), @endif {{$history->firstname}} {{$history->middlename}}  {{$history->suffix}}</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center p-0" style="padding-top: 5px!important; border-bottom: 1px solid #000;"></td>
                                        </tr>

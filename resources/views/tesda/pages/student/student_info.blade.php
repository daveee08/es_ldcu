...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <h1><i class="fas fa-cog"></i>Student Information</h1>
            <ol class="breadcrumb float-sm-left">
                <li class="breadcrumb-item"><a href="/home">Home</a></li>
                <li class="breadcrumb-item active">{{ isset($page) ? $page : 'Student Information' }}</li>
            </ol>
        </div>
    </section><br>
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12 text-left">
                            <button class="btn btn-success btn-sm" id="btn_addstudent" data-toggle="modal"
                                data-target="#addStudentModal"><i class="fas fa-plus"></i> Add
                                Student</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="scrollable-content">
                                <form style="font-size: 12px;" id="newStudForm">
                                    <div class="row mb-3">
                                        <div class="col-md-4">
...
@section('footerjavascript')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // added by clydev hehe 
            var studId = {!! json_encode($studid) !!};
            if (studId) {
                console.log('paramid...', studId);
                viewStudentInfo(studId)
            }
                        ...
                        tableData.push({
                            ...
                            <div class="row text-center">
                                <div class="col-md-6" style="border-right: 1px solid #ddd">
                                    <a href="#"><i class="text-info fas fa-pencil-alt edit_student" data-id="${student.id}"></i></a>
                                </div>
                                <div class="col-md-6">
    ...
    `;
            ...
            //     e.preventDefault();
            //     var studentId = $(this).data('id');
            //     var courseId = $('#input_specialization').val();
            //     var batchId = $('#batchs').val();

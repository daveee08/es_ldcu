...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <h1><i class="fas fa-cog"></i>Transcript of Records</h1>
            <ol class="breadcrumb float-sm-left">
                <li class="breadcrumb-item"><a href="/home">Home</a></li>
                <li class="breadcrumb-item active">{{ isset($page) ? $page : 'Transcript of Records' }}</li>
            </ol>
        </div>
    </section><br>
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12 text-right">
                            <button style="border-radius: 7px" class="btn btn-sm btn-primary float-right" id="btn_print_all_tor"><i class="fas fa-print"></i>
                                Print All
                                TOR</button>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="studentList"
                                    class="table table-bordered table-valign-middle table-hover w-100">
...
@section('footerjavascript')
                ...
                for (const gender in groupedData) {
                    ...
                    students.forEach(student => {
                        ...
                        tableData.push({
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#"><p class="text-primary mb-0 print-cor" data-id="${student.id}">Print TOR</p></a>
                                </div>
                            </div>`
                        });
                    });
    ...
    `;
            ...
            $(document).on('click', '#btn_print_all_tor', function(e) {
                e.preventDefault();
                let link = '/tesda/printTORall';
        ...
        `;
            ...
            $(document).on('click', '#printTOR', function(e) {
                e.preventDefault();
                let studentId = $(this).data('id');
                let link = '/tesda/printTOR/' + studentId;
                let a = document.createElement('a');
                a.href = link;
                a.target = '_blank';
                a.click();

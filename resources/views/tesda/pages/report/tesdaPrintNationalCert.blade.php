                ...
                <table width="100%">
                    <tr>
                        ...
                        <td style="width: 70%; text-align: center;">
                            ...
                            <br>
                            <span style="font-size: 16px; display: block; margin-top: 5px;">in</span>
                            <br>
                            <br>
                            ...
                            <br>
                            <br>
                            <span style="font-size: 18px; display: block; margin-top: 5px;">is awarded to</span>
                            <br>
                            <span style="font-size: 35px; display: block;">
                                <br>
                                {{-- {{ $student->firstname }}
                                {{ $student->middlename }}
                                {{ $student->lastname }} --}}
                                SERLY JANETTE Y. TEMPLO
                            </span>
                            <br>
                            <br>
                            <span style="font-size: 24px; display: block; margin-top: 5px; text-align: left;">
                                {{-- {{ $student->course_name }} --}}
                                for having completed the competency requirements under the Philippine TVET Competency
                                Assessment and Certifications System in the following units of competency:
                            </span>
                            <br>

...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <h1><i class="fas fa-cog"></i>Special Order Report</h1>
            <ol class="breadcrumb float-sm-left">
                <li class="breadcrumb-item"><a href="/home">Home</a></li>
                <li class="breadcrumb-item active">{{ isset($page) ? $page : 'Special Order Report' }}</li>
            </ol>
        </div>
    </section><br>
                ...
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12 text-right">
                            <div class="dropdown">
                                <button style="border-radius: 3px; font-size: 12px !important; min-width: 200px"
                                    class="btn btn-primary btn-sm" id="print_certifications" data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    Special Order Report&nbsp;&nbsp;&nbsp;<i style="font-size: 15px"
                                        class="fas fa-chevron-down"></i>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="print_certifications">
                                    <a class="dropdown-item" href="{{ url('tesda/printApplicationForGraduation') }}">Application
                                        for Graduation</a>
                                    <a class="dropdown-item" href="{{ url('tesda/printSpecialOrderReport') }}">Special Order Request</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    students.forEach(student => {
                        ...
                        // </div>`
                            ...
                            <div class="row text-center">
                                <div class="col-md-12">
                                    <div class="dropdown">
                                        <a href="#" class="text-primary print-certeficates mb-0" id="print-specific-certeficates" data-bs-toggle="dropdown" data-id="${student.id}" aria-haspopup="true" aria-expanded="false">View Details</a>
                                        <div class="dropdown-menu" aria-labelledby="print-specific-certeficates">
                                            <a class="dropdown-item" data-id="${student.id}" href="/tesda/printCertCompletion/${student.id}">Certificate of Completion</a>
                                            <a class="dropdown-item" data-id="${student.id}" href="#">National Certificate</a>
                                            <a class="dropdown-item" data-id="${student.id}" href="#">Certificate of Honorable Dismissal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>`

...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <h1><i class="fas fa-cog"></i>Attendance Summary</h1>
            <ol class="breadcrumb float-sm-left">
                <li class="breadcrumb-item"><a href="/home">Home</a></li>
                <li class="breadcrumb-item active">{{ isset($page) ? $page : 'Attendance Summary' }}</li>
            </ol>
        </div>
    </section><br>
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 d-flex justify-content-between">
                            <div class="attendance-summary">
                                ...
                                <span class="summary-text">TODAY</span>
                                <button class="button next">&gt;</button>
                            </div>

                            <button style="border-radius: 7px; padding: 8px; font-size: 12px; height: 40px;"
                                class="btn btn-primary btn-sm m-0" id="btn_print_attendanceSummary">
                                <i class="fas fa-print"></i> Attendance Summary
                            </button>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="studentList" class="table table-bordered table-valign-middle table-hover"
                                    width="100%">
    ...
    <div class="modal fade" id="attendanceSummaryModal" tabindex="-1" aria-labelledby="attendance_SummaryModal"
        aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-xl mw-100 mh-100" style="width: 90vw; height: 93vh;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="attendance_SummaryModal">Attendance Summary</h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div style="display: flex; justify-content: flex-end;" class="mb-4">
                                <div class="button-container">
                                    ...
                                    <div class="import-button">
                                        <i style="color: green" class="fas fa-file-excel"></i>
                                        Import Excel
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3  form-group  mb-0">
                                    <label for="" class="mb-1">Course/Specialization</label>
                                    <select class="form-control select2 form-control-sm" id="filterCourse"
                                        style="width:100%;">
                                        <option value="">All</option>
                                        @foreach (DB::table('tesda_courses')->get() as $item)
                                ...
                                {{-- <div class="col-md-3 form-group mb-0">
                                    ...
                                    <select name="" id="filterDateRange"
                                        class="form-control select2 form-control-sm" style="width: 100%;">
                                ...
                                <div class="col-md-3 form-group mb-0">
                                    <label for="filterDateRange" class="mb-1">Date Range</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control form-control-sm" id="filterDateRange"
                                            aria-label="Date Range" aria-describedby="basic-addon1" style="width: 100%;"
                                            value="02/01/2025 - 02/15/2025">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tor-signatories" class="mt-4 p-4" style="border: 1px solid #ccc; border-radius: 20px;">
                        <a href="#" style="font-size: 17px;color:black;" class="update-signatories"
                            role="button">
                            Signatories&nbsp; <i class="text-primary fas fa-pencil-alt"></i>
                        </a>
                        <div class="d-flex mt-3">
                            <div style="margin-left: 0px;">
                                {{-- font-weight-bold --}}
                                <p class="mb-1">Prepared By:</p>
                                <p class="mb-1 font-weight-bold">MARICEL L. SARARÑA</p>
                                <hr style="border-width: 2px;border-color: #000000;">
                                <p class="text-muted">Office Assistant</p>
                            </div>
                            <div style="margin-left: 14%;">
                                <p class="mb-1">Certified Correct:</p>
                                <p class="mb-1 font-weight-bold">NESSA LIE C. ELEGUEN</p>
                                {{-- <hr class="w-75 mx-auto"> --}}
                                <hr style="border-width: 2px;border-color: #000000;">
                                <p class="text-muted">Health Care Program Coordinator</p>
                            </div>
                            <div style="margin-left: 14%;">
                                <p class="mb-1">Checked By:</p>
                                <p class="mb-1 font-weight-bold">ARABELLA R. MEDIDA</p>
                                <hr style="border-width: 2px;border-color: #000000;">
                                <p class="text-muted">School Registrar</p>
                            </div>
                        </div>
                    </div>
...
@section('footerjavascript')
                ...
                for (const gender in groupedData) {
                    ...
                    students.forEach(student => {
                        ...
                        tableData.push({
                            ...
                            attendance_status: `<span style="color: green;">Present</span>`,
                            options: `
                            <div class="row text-center">
                                <div class="col-md-12">
                                    <a href="#"><p class="text-primary mb-0 print-cor" data-id="${student.id}">Attendance</p></a>
                                </div>
                            </div>`
                        });
                    });
                ...
                $('#studentList').DataTable({
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            searchable: false,
                            render: function(data, type, row) {
                                return row.genderRow ? '' : row.attendance_status;
                            }
                        },
                        {
                            data: null,
    ...
    `;
            ...
            $(document).on('click', '#btn_print_attendanceSummary', function(e) {
                e.preventDefault();
        ...
        `;
            ...
            $('#filterDateRange').daterangepicker({
                startDate: '02/01/' + new Date().getFullYear(),
                endDate: '02/15/' + new Date().getFullYear(),
            ...
            function updateDateText() {
                ...
                if (currentDate.toDateString() === today.toDateString()) {
                    $(".summary-text").text("TODAY");
                } else {
                    $(".summary-text").text(currentDate.toLocaleDateString('en-US', options));
                }
            }

      ...
      <div class="container-fluid">
        <div class="row mb-0 p-0">
          <div class="col-sm-8">
            ...
            <p style="font-size: 13px;" class="text-muted">Click the cards to navigate through <b>"Grade Status"</b> modules to manage student and enrollment.</p>
          </div>
          <div class="col-sm-4">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Student Menu</li>
            </ol>
          </div>
        </div>
      </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-box">
                                            <div class="card-body d-flex align-items-top" onclick="window.location.href='/tesda/enrollment'" style="cursor: pointer;">
                                    ...
                                    <div class="col-md-3">
                                        <div class="card card-box">
                                            <div class="card-body d-flex align-items-top" onclick="window.location.href='/tesda/studentInfo' " style="cursor: pointer;">

    ...
    <div class="row" style="width: 100%;">
        <div class="col-md-8 col-12" style="width: 100%;">
            <div class="d-flex justify-content-between align-items-center p-2">
                <div id="title-editor" contenteditable="true">
                    <h1 class="text-uppercase" id="template-name"
        ...
        <div class="col-md-4" style="width: 100%;">
            ...
            <div id="dataTable" class="hidden">
                <strong>
                    <p>Student's Specific labels. </p>
                </strong>
                <table class="table-hover table table-striped table-sm table-bordered" width="100%" style="width: 100%;">
                    <thead>
                        <tr>
                ...
                <strong>
                    <p>Staff/Teachers Specific labels.</p>
                </strong>
                <table class="table-hover table table-striped table-sm table-bordered" width="100%" style="width: 100%;">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>phonenumber</td>
                            <td>contact number of the staff</td>
                        </tr>
                        <tr>
                            <td>utype</td>
                            <td>usertype of the staff</td>
                        </tr>

                        <tr>
                            <td>acadtitle</td>
                            <td>title of the staff</td>
                        </tr>
                        <tr>
                            <td>datehired</td>
                            <td>date when the staff is hired</td>
                        </tr>
                        <tr>
                            <td>licno</td>
                            <td>license no.</td>
            ...
            <div class="row mt-3">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="text-md">Assets</h2>
                        <button class="btn btn-outline-primary upload_asset">Upload</button>
                    </div>
                    <div id="scrollable-container-assets">
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div id="text-controls" class="col-12" style="width: 100%;">
                    ...
                    <select id="labelid">
                        ...
                        <option value="acadtitle">acadtitle</option>
                        <option value="datehired">datehired</option>
                        <option value="licno">licno</option>
            ...
            <div id="preview-wrapper" style="width: 100%;">
                ...
                <div class="my-2">
                    <button type="button" class="btn btn-success btn-save" style="width: 100%;">Save Template</button>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.upload_img').on('click', function() {
                upload_purpose = 'bgtemplate';
                $('#addImageModal').modal();
            })

            $('.upload_asset').on('click', function() {
                upload_purpose = 'bgasset';
                $('#addImageModal').modal();
            })
        ...
        function upload() {
            ...
            // Append additional data (e.g., purpose)
        ...
        function load_images() {
            $.ajax({
                ...
                url: '{{ route('file.load') }}',
                success: function(data) {
                    var bg_template = data[0].data;
                    var assets = data[0].assets;
                    if (bg_template.length > 0) {
                        $('#scrollable-container').empty();
                        $.each(bg_template, function(index, item) {
                            var img =
                    ...
                    if (assets.length > 0) {
                        $('#scrollable-container-assets').empty();
                        $.each(assets, function(index, item) {
                            var img =
                                `<img src="${item}" class="scrollable-assets" alt="Image ${index}">`

                            $('#scrollable-container-assets').append(img);
                        });

                        // Event listener for image click
                        $('.scrollable-assets').on('click', function() {
                            var imageSrc = $(this).attr('src');
                            // load maryknoll logo in the canvas
                            fabric.Image.fromURL(imageSrc, function(
                                img1) {
                                const desiredWidth =
                                    100; // Adjust this value to your desired width
                                const scale = desiredWidth / img1.width;
                                var updatedWidth;
                                var updatedHeight
                                // Scale the image
        ...
        function saveTemplate() {
            ...
            var tempname = $("#template-name").text().toUpperCase();
            $.ajax({
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')

                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body p-0">
                            <table class="mb-0 table table-bordered table-sm font-sm college_grades" hidden
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="align-middle text-center term_holder" width="10%" data-term="1"
                                            hidden>Prelim</th>
                                        <th class="align-middle text-center term_holder" width="10%" data-term="2"
                                            hidden>Midterm</th>
                                        <th class="align-middle text-center term_holder" width="10%" data-term="3"
                                            hidden>PreFinal</th>
                                        <th class="align-middle text-center term_holder" width="10%" data-term="4"
                                            hidden>Final Term</th>
                                        <th class="align-middle text-center term_holder" width="10%" data-term="5">Final
                                            Grade</th>
                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-body p-1 pl-2">
                            <i class="text-danger">Contact your instructor for failed and INC grades.</i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row basic_ed" hidden>
                <div class="col-md-7">
                    <div class="card shadow">
                        ...
                        <div class="card-body p-0">
                            <table class="mb-0 table table-bordered table-sm font-sm nursery_grades" hidden
                                style="font-size:.7rem" width="100%">
                                <thead>
                                    <tr>
                            ...
                            <table class="mb-0 table table-bordered table-sm font-sm not_sh_grades" hidden
                                style="font-size:.8rem" width="100%">
                                <thead>
                                    <tr>
                                        <td class="p-1 align-middle text-center" rowspan="2" width="55%">
                                            <small>SUBJECTS</small></td>
                                        <td class="p-1 align-middle pr" align="center" colspan="4" width="20%"
                                            id="pr"><small>PERIODIC RATINGS</small></td>
                                        <td class="p-1 align-middle" align="center" rowspan="2" width="10%">
                                            <small>Final<br>Rating</small></td>
                                        <td class="p-1 align-middle" align="center" rowspan="2" width="15%">
                                            <small>Action<br>Taken</small></td>
                            ...
                            <table class="mb-0 table table-bordered table-sm font-sm sh_grades" hidden
                                style="font-size:.7rem" width="100%">
                                <thead>
                                    <tr>
                                        <td class="p-1 align-middle text-center" rowspan="1" width="55%">1st
                                            Semester</td>
                                        <td class="p-1 align-middle text-center" colspan="2" width="20%">Periodic
                                            Ratings</td>
                                        <td class="p-1 align-middle text-center" rowspan="2" width="10%">
                                            Final<br>Rating</td>
                                        <td class="p-1 align-middle text-center" rowspan="2" width="15%">
                                            Action<br>Taken</td>
                            ...
                            <table class="mb-0 table table-bordered table-sm font-sm sh_grades mt-3"
                                style="font-size:.7rem" width="100%">
                                <thead>
                                    <tr>
                                        <td class="p-1 align-middle text-center" rowspan="1" width="55%">2nd
                                            Semester</td>
                                        <td class="p-1 align-middle text-center" colspan="2" width="20%">Periodic
                                            Ratings</td>
                                        <td class="p-1 align-middle text-center" rowspan="2" width="10%">
                    ...
                    <div class="row">
                        <div class="col-md-12 nursery_side" hidden>
                            <div class="card shadow">
                                ...
                                <div class="card-body p-0">
                                    <table class="table table-sm table-bordered display p-0" width="100%"
                        ...
                        <div class="col-md-12 nursery_side" hidden>
                            <div class="card shadow">
                                <div class="card-header  bg-primary">
                                    <h3 class="card-title"><i class="fas fa-clipboard-list"></i> CHRISTIAN LIVING
                                        EDUCATION</h3>
                                </div>
                                <div class="card-body p-0">
                                    <table class="table table-sm table-bordered display p-0" width="100%"
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body p-0">
                                    <table class="table  table-bordered table-sm " width="100%"
                                        ...
                                        <tr>
                                            <td class="p-1">Rarely participates in class activities and /or initiates
                                                independent works</td>
                                        </tr>
                                        <tr>
                                            <td class="p-1">Shows interest in doing tasks but needs close supervision
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="p-1">Always participates in the different activities, works
                                                independently</td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="col-md-12 kinder_side" hidden>
                            <div class="card shadow">
                                <div class="card-header  bg-primary">
                                    <h3 class="card-title"><i class="fas fa-clipboard-list"></i> TEACHER’S
                                        COMMENTS/REMARKS</h3>
                                </div>
                                <div class="card-body p-0">
                                    <table class="table table-sm table-bordered display p-0" width="100%"
                        ...
                        <div class="col-md-12 basic_ed" hidden>
                            <div class="card shadow">
                                ...
                                <div class="card-body p-0 table-responsive">
                                    <table
                                        class="table table-striped table-sm table-bordered table-head-fixed nowrap display p-0"
                                        width="100%" style="font-size:.8rem; min-width:400px !important;">
                                        <tbody id="data_2">
                        ...
                        <div class="col-md-12 basic_ed" hidden>
                            <div class="card shadow">
                                ...
                                <div class="card-body p-0">
                                    <table
                                        class="table table-striped table-sm table-bordered table-head-fixed nowrap display p-0"
                                        width="100%" style="font-size:.8rem">
                                        <thead>
                                            <tr>
    ...
    <script>
        ...
        function plot_setup() {
            ...
            $.each(ob_setup_data[0].ob_setup, function(a, b) {
                $('#data').append('<tr><td class="p-2">' + b.description + '</td><td  data-id="' + b.id +
                    '" quarter="1" class="student_ob"></td><td  data-id="' + b.id +
                    '" quarter="2" class="student_ob"></td><td  data-id="' + b.id +
                    '" quarter="3" class="student_ob"></td><td class="pr-2 student_ob"  data-id="' + b.id +
                    '" quarter="4"></td></tr>')
            })
                ...
                success: function(data) {
                    ...
                    if (data[0].att_setup.length == 0) {
                        ...
                        $.each(attendance_data[0].att_setup, function(a, b) {
                            days_string += '<td class="text-center align-middle" width="' + width +
                                '">' + b.monthdesc.slice(0, 3) + '</td>'
                            numberofdays_string += '<td class="text-center align-middle" width="' +
                                width + '">' + b.days + '</td>'
                            numberofpresent_string += '<td class="text-center align-middle">' + b
                                .present + '</td>'
                            numberofabsent_string += '<td class="text-center align-middle">' + b
                                .absent + '</td>'
                        ...
                        $('#data_2').append('<tr><td class="pl-2" width="15%"</td>' + days_string +
                            '<td width="10%" class="text-center align-middle  pr-2">TOTAL</td></tr>')
                        $('#data_2').append('<tr><td class="pl-2"  width="15%">No. of School Days</td>' +
                            numberofdays_string + '<td class="text-center align-middle pr-2">' +
                            tolal_schooldays + '</td></tr>')
                        $('#data_2').append('<tr><td class="pl-2"  width="15%">No. of Days Present</td>' +
                            numberofpresent_string + '<td class="text-center align-middle pr-2">' +
                            tolal_present + '</td></tr>')
                        $('#data_2').append('<tr><td class="pl-2"  width="15%">No. of Days Absent</td>' +
                            numberofabsent_string + '<td class="text-center align-middle pr-2">' +
                            tolal_absent + '</td></tr>')
                    }
                }
            })
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('change', '#filter_sy', function() {
                ...
                if (check_enrollment[0].acadprogid == 6 || check_enrollment[0].acadprogid == 8) {
            ...
            function get_grades() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(data[0].levelid,'wewewe')
                        ...
                        if (levelid == 14 || levelid == 15) {
                            ...
                            for (var sem = 1; sem <= 2; sem++) {
                                var subjgrades = data[0].grades.filter(x => x.id != 'G1' && x.semid ==
                                    sem)
                                $.each(subjgrades, function(a, b) {
                                    ...
                                    if (sem == 1) {
                                        $('#enrollment_history_grade_sem1').append(
                                            '<tr><td class="p-1 ' + padding + '" >' + b
                                            .subjdesc +
                                            '</td><td class="text-center align-middle">' +
                                            quarter1_grade +
                                            '</td><td class="text-center align-middle">' +
                                            quarter2_grade +
                                            '</td></td><td class="text-center align-middle">' +
                                            finalrating +
                                            '</td><td class="text-center align-middle p-1">' +
                                            actiontaken + '</td></tr>')
                                    } else {
                                        $('#enrollment_history_grade_sem2').append(
                                            '<tr><td class=" p-1 ' + padding + '" >' + b
                                            .subjdesc +
                                            '</td><td class="text-center align-middle">' +
                                            quarter3_grade +
                                ...
                                var finalgrade = data[0].grades.filter(x => x.id == 'G1' && x.semid ==
                                    sem)
                                var colspan = 5;
                                $.each(finalgrade, function(a, b) {
                                    ...
                                    if (sem == 1) {
                                        $('#enrollment_history_grade_sem1').append(
                                            '<tr><td  colspan="3" class="text-right p-1">' +
                                            b.subjdesc +
                                            '</td><td class="text-center align-middle">' +
                                            finalrating +
                                            '</td><td class="text-center align-middle">' +
                            ...
                            $.each(subjgrades, function(a, b) {
                                console.log( b.prelim_transmuted,'asdasd');

                                b.prelim_transmuted = b.prelim_transmuted != null && withPrelem ? b
                                    .prelim_transmuted : ''
                                b.midterm_transmuted = b.midterm_transmuted != null && withMidterm ? b
                                    .midterm_transmuted : ''
                                b.prefinal_transmuted = b.prefinal_transmuted != null && withpreFinal ? b
                                    .prefinal_transmuted : ''
                                b.final_transmuted = b.final_transmuted != null && withFinalterm ? b
                                    .final_transmuted : ''
                                b.final_grade_transmuted = b.final_grade_transmuted != null && withFinalGrade ? b.final_grade_transmuted : ''
                                b.final_remarks = b.final_remarks != null && withFinalGrade ? b
                                    .final_remarks : ''

                                var bgrow = b.final_remarks != '' && withFinalterm ? b.fgremarks ==
                                    'PASSED' ? 'bg-danger' : 'bg-success' : ''

                                
                                $('#college_grade_table').append('<tr class="' + bgrow +
                                    '"><td>' + b.subjCode + '</td><td>' + b.subjDesc +
                                    '</td><td class="text-center align-middle term_holder" data-term="1" ' +
                                    prelemDisplay + '  data-id="' + b.id + '">' + b
                                    .prelim_transmuted +
                                    '</td><td class="text-center align-middle term_holder" data-term="2"  ' +
                                    midTermDisplay + '  data-id="' + b.id + '">' + b
                                    .midterm_transmuted +
                                    '</td><td class="text-center align-middle term_holder" data-term="3"  ' +
                                    preFiTermDisplay + '  data-id="' + b.id + '">' + b
                                    .prefinal_transmuted +
                                    '</td><td class="text-center align-middle term_holder" data-term="4" ' +
                                    finalTermDisplay + '  data-id="' + b.id + '">' + b
                                    .final_transmuted +
                                    '</td><td class="term_holder text-center align-middle">' +
                                    b.final_grade_transmuted +
                                    '</td><td  class="term_holder  text-center align-middle" data-term="remarks"  data-id="' +
                                    b.id + '">' + b.final_remarks + '</td></tr>')
                            ...
                            $.each(data[0].setup, function(a, b) {
                                ...
                                if (b.value == 0) {
                                    ...
                                    var q1total = data[0].setup.filter(x => x.group == group)
                                        .reduce(function(sum, current) {
                                            return sum + parseInt(current.q1grade);
                                        }, 0);
                                    var q2total = data[0].setup.filter(x => x.group == group)
                                        .reduce(function(sum, current) {
                                            return sum + parseInt(current.q2grade);
                                        }, 0);
                                    var q3total = data[0].setup.filter(x => x.group == group)
                                        .reduce(function(sum, current) {
                                            return sum + parseInt(current.q3grade);
                                        }, 0);
                                    ...
                                    if (next_group) {
                                        $('#nursery_setup').append(
                                            '<tr><td class="align-middle text-right pr-4"><b>TOTAL</b></td><i class="fas fa-edit text-primary"></i></a></td><td class="align-middle text-center">' +
                                            q1total + '</td><td class="text-center">' +
                                            q2total + '</td><td class="text-center">' +
                                            q3total + '</td><tr>')
                                    }
                                ...
                                if (b.value == 0) {
                                    ...
                                    $('#nursery_setup').append('<tr class="' + header +
                                        ' "><td class="align-middle bg-secondary" style="padding-left:' +
                                        padding + '" colspan="4">' + b.description +
                                        '</td></tr>')
                                    ...
                                    var q1grade = b.q1grade == 1 ?
                                        '<i class="fas fa-check"></i>' : ''
                                    var q2grade = b.q2grade == 1 ?
                                        '<i class="fas fa-check"></i>' : ''
                                    var q3grade = b.q3grade == 1 ?
                                        '<i class="fas fa-check"></i>' : ''

                                    padding = (b.group.length * 2) + "rem;"
                                    $('#nursery_setup').append('<tr class="' + header +
                                        ' "><td class="align-middle" style="padding-left:' +
                                        padding + '">' + b.description +
                                        '</td><i class="fas fa-edit text-primary"></i></a></td><td class="align-middle text-center">' +
                                        q1grade +
                                        '</td><td class="text-center aling-middle">' +
                                        q2grade +
                                        '</td><td class="text-center align-middle">' +
                                        q3grade + '</td></tr><')
                            ...
                            var q1total = data[0].setup.filter(x => x.group == group).reduce(function(
                                sum, current) {
                                return sum + parseInt(current.q1grade);
                            }, 0);
                            var q2total = data[0].setup.filter(x => x.group == group).reduce(function(
                                sum, current) {
                                return sum + parseInt(current.q2grade);
                            }, 0);
                            var q3total = data[0].setup.filter(x => x.group == group).reduce(function(
                                sum, current) {
                                return sum + parseInt(current.q3grade);
                            }, 0);
                            ...
                            $('#nursery_setup').append(
                                '<tr><td class="align-middle text-right pr-4"><b>TOTAL</b></td><i class="fas fa-edit text-primary"></i></a></td><td class="align-middle text-center">' +
                                q1total + '</td><td class="text-center">' + q2total +
                                '</td><td class="text-center">' + q3total + '</td><tr>')

                            $.each(data[0].sumsetup, function(a, b) {
                                var group = b.group
                                var qtotal = data[0].setup.filter(x => x.group == group).reduce(
                                    function(sum, current) {
                                        return sum + parseInt(current.q1grade);
                                    }, 0) == 0 ? '' : data[0].setup.filter(x => x.group ==
                                    group).reduce(function(sum, current) {
                                    return sum + parseInt(current.q1grade);
                                }, 0);
                                $('#admin_1').append(
                                    '<tr><td class="align-middle text-center pr-4">' + b
                                    .description +
                                    '</td><td class="align-middle text-center">' + qtotal +
                                    '</td><td class="text-center">' + b.q1grade +
                                    '</td><tr>')
                            })
                            ...
                            $.each(data[0].agevaldate, function(a, b) {
                                ...
                                $('#admin_1').append(
                                    '<tr><td class="align-middle text-center pr-4">' + b
                                    .description +
                                    '</td><td class="align-middle text-center" colspan="2">' +
                                    temp_grade + '</td><tr>')
                            })
                            ...
                            $.each(data[0].sumsetup, function(a, b) {
                                ...
                                $('#admin_2').append(
                                    ...
                                    .description +
                                    '</td><td class="align-middle text-center">' + qtotal +
                                    '</td><td class="text-center">' + temp_grade +
                                    '</td><tr>')
                            })
                            $.each(data[0].agevaldate, function(a, b) {
                            ...
                            $.each(data[0].clsetup, function(a, b) {
                                ...
                                $('#cl_educ').append('<tr><td class="align-middle">' + b
                                    .description +
                                    '</td><td class="align-middle text-center">' + q1grade +
                                    '</td><td class="text-center align-middle">' + q2grade +
                                    '</td><td class="text-center  align-middle">' +
                                    q3grade + '</td><tr>')
                            })
                            ...
                            $.each(data[0].setup, function(a, b) {
                                ...
                                if (b.value == 0) {
                                    ...
                                    $('#nursery_setup').append('<tr class="' + header +
                                        ' "><td class="align-middle" style="padding-left:' +
                                        padding + '">' + b.description +
                                        '</td><i class="fas fa-edit text-primary"></i></a></td><td class="align-middle text-center"></td><td class="text-center"></td><td class="text-center"></td><td class="text-center"></td></tr><'
                                        )
                                } else {
                                    padding = (b.group.length * 2) + "rem;"
                                    $('#nursery_setup').append('<tr class="' + header +
                                        ' "><td class="align-middle" style="padding-left:' +
                                        padding + '">' + b.description +
                                        '</td><td class="align-middle text-center">' + b
                                        .q1grade +
                                        '</td><td class="text-center align-middle">' + b
                                        .q2grade +
                                        '</td><td class="text-center align-middle">' + b
                                        .q3grade +
                                        '</td><td class="text-center align-middle">' + b
                            ...
                            $.each(data[0].remarks_setup, function(a, b) {
                                $('#kinder_comments').append(
                                    '<tr class="bg-secondary"><th>First Quarter (Weeks 1-10)</th></tr>'
                                    )
                                $('#kinder_comments').append('<tr><td><i>' + b.q1grade +
                                    '</i></td></tr>')
                                $('#kinder_comments').append(
                                    '<tr class="bg-secondary"><th>Second Quarter (Weeks 11-20)</th></tr>'
                                    )
                                $('#kinder_comments').append('<tr><td><i>' + b.q2grade +
                                    '</i></td></tr>')
                                $('#kinder_comments').append(
                                    '<tr class="bg-secondary"><th>Second Quarter (Weeks 11-20)</th></tr>'
                                    )
                                $('#kinder_comments').append('<tr><td><i>' + b.q3grade +
                                    '</i></td></tr>')
                                $('#kinder_comments').append(
                                    '<tr class="bg-secondary"><th>Fourth Quarter (Weeks 31-40)</th></tr>'
                                    )
                                $('#kinder_comments').append('<tr><td><i>' + b.q4grade +
                                    '</i></td></tr>')
                            })

                        } else if ((school == 'BCT' && levelid == 2) || (school == 'BCT' && levelid ==
                                3) || (school == 'BCT' && levelid == 4)) {
                            $('.nursery_grades').removeAttr('hidden')
                            ...
                            $.each(subjgrades, function(a, b) {
                                ...
                                var finalrating = b.finalrating != null ? b.finalrating : ''
                                var actiontaken = b.actiontaken != null ? b.actiontaken : ''
                                $('#enrollment_history_grade').append('<tr><td class="p-1 ' +
                                    padding + '" >' + b.subjdesc +
                                    '</td><td class="text-center align-middle">' +
                                    quarter1_grade +
                                    '</td><td class="text-center align-middle">' +
                            ...
                            $.each(finalgrade, function(a, b) {
                                var finalrating = b.finalrating != null ? b.finalrating : ''
                                var actiontaken = b.actiontaken != null ? b.actiontaken : ''
                                $('#enrollment_history_grade').append('<tr><td  colspan="' +
                                    colspan + '" class="text-right p-1">' + b.subjdesc +
                                    '</td><td class="text-center align-middle">' +
                                    finalrating +
                                    '</td><td class="text-center align-middle p-1">' +
                                    actiontaken + '</td></tr>')

...
@section('content')
    @php
        ...
        $student = DB::table('studinfo')
            ...
            ->select('id', 'sid', 'levelid', 'contactno', 'fcontactno', 'gcontactno', 'mcontactno')
            ->first();
        $studid = $student->id;
        $studsid = $student->sid;
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-10" hidden>
                                    <button class="btn btn-primary btn-sm float-right" id="view_fees_modal">View
                                        Fees</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row without_enrollment" hidden>
                <div class="col-md-12">
                    <div class="callout callout-danger">
                        <h5 id="without_enrollment_text">No enrollment record was found for School Year this school year!
                        </h5>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="card shadow">
                                ...
                                <div class="card-footer">
                                    <h6 class="text-danger"><i>Please contact the school registrar for more
                                            information.</i></h6>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card shadow">
                            <div class="card-body">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <h6 class="text-danger"><i>Note: Please be reminded that you should submit a hard
                                                copy to the registrars office.</i></h6>
                                    </div>
                                </div>
                                <form action="/student/preenrollment/submit" id="submit_enrollmentsetup" method="POST"
                        ...
                        <div class="card shadow">
                            <div class="card-body">
                                <div class="row" hidden>
                                    <div class="col-md-12">
                                        <h5>To complete the enrollment process, you may pay the minimum upon enrollment fee
                                            :</h5>
                                    </div>
                                    <div class="col-md-12">
                                        <h5 class="p-0 mb-2">Upon enrollment: <span style="font-size:25px !important"
                                                class="text-success">&#8369; </span><span id="dp_amount"
                                                style="font-size:25px !important" class="text-success">00.00</span>
                                            <h5>
                                    </div>
                                    <div class="col-md-12">
                                        <h5 class="p-0 mb-2">Balance forwarded from previous school year: <span
                                                style="font-size:25px !important" class="text-success">&#8369;
                                            </span><span id="bal_forward" style="font-size:25px !important"
                                                class="text-success">00.00</span>
                                            <h5>
                                    </div>
                                    <div class="col-md-12">
                                        <h5 class="p-0 mb-2 text-danger"><i>Note: you may pay higher than the required
                                                amount.</i>
                                            <h5>
                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                name="recieptImage" id="recieptImage"
                                                                accept=".png, .jpg, .jpeg">
                                                            <span class="invalid-feedback" role="alert"
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <i>
                                        <h4>Please update information for school year <span
                                                class="enrollment_schoolyear text-primary"></span></h4>
                                    </i>
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input disabled onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                        placeholder="First name" name="grade_level" required>
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group col-md-4">
                                    <label><b>LRN</b></label>
                                    <input disabled onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                        placeholder="LRN" name="lrn" required>
                                    <span class="invalid-feedback" role="alert">
                                        <strong>LRN</strong>
                                    </span>
                                </div>
                                <div class="form-group col-md-4" hidden id="strand_holder">
                                    ...
                                    <select name="input_strand" id="input_strand" class="form-control select2" required>
                                        ...
                                        @foreach (DB::table('sh_strand')->where('deleted', 0)->get() as $item)
                                            <option value="{{ $item->id }}">{{ $item->strandcode }} -
                            ...
                            <div class="row">
                                <div class="form-group col-md-12" hidden id="course_holder">
                                    ...
                                    <select name="input_course" id="input_course" class="form-control select2" required
                                        disabled>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <input disabled onkeyup="this.value = this.value.toUpperCase();"
                                        class="form-control p-2" placeholder="SU" id="suffix" name="suffix">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input disabled type="date" class="form-control" placeholder="First name..."
                                        name="dob" required>
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="barangay" id="barangay" autocomplete="off"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="city" id="city" autocomplete="off"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" name="province" id="province" autocomplete="off"
                                        onkeyup="this.value = this.value.toUpperCase();">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                        placeholder="Father's Full Name" name="father_name" id="father_name">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control " id="father_contact_number" name="father_contact_number"
                                        placeholder="09XX-XXXX-XXXX " minlength="13" maxlength="13">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control " onkeyup="this.value = this.value.toUpperCase();"
                                        placeholder="Mother's Full Maiden Name" name="mother_name" id="mother_name">
                                    <div class="text-center">
                                        ( surname, full name, middle name )
                                    </div>
                                    <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control " id="mother_contact_number" name="mother_contact_number"
                                        placeholder="09XX-XXXX-XXXX " minlength="13" maxlength="13">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                        placeholder="(surname, full name, middle name)" name="guardian_name"
                                        id="guardian_name">
                                    <div class="text-center">
                                        ( surname, full name, middle name )
                                    </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input onkeyup="this.value = this.value.toUpperCase();" class="form-control "
                                        placeholder="Guardian's Relationship" name="guardian_relation"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" id="guardian_contact_number"
                                        name="guardian_contact_number" placeholder="09XX-XXXX-XXXX " minlength="13"
                                        maxlength="13">
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="row" id="incaseholder">
                                <div class="col-md-12 ">
                                    <label><b>In case of emergency ( Recipient for News, Announcement and School
                                            Info)</b></label>
                            ...
                            <div class="timeline">
                                ...
                                <div class="step1_com" hidden>
                                    ...
                                    <div class="timeline-item">
                                        <h3 class="timeline-header no-border"><a href="#" id="step1">Personal
                                                Information</a> was updated</h3>
                                ...
                                <div class="step1_ncom">
                                    <i class="fas fa-users bg-blue"></i>
                                    <div class="timeline-item">
                                        <h3 class="timeline-header no-border"><a href="#" id="step1">Update
                                ...
                                <div class="step2_com" hidden>
                                    ...
                                    <div class="timeline-item">
                                        <h3 class="timeline-header"><a href="#" id="step2">Enrollment</a> was
                                            submitted</h3>
                                        <div class="timeline-body">
                                ...
                                <div class="step2_ncom">
                                    <i class="fas fa-envelope bg-blue"></i>
                                    <div class="timeline-item">
                                        <h3 class="timeline-header"><a href="#" id="step2">Submit
                                                Enrollment</a></h3>
                                    </div>
                                </div>
                                <div class="time-label">
                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        <h3 class="timeline-header"><a href="#" id="step3">Upload Payment</a>
                                        </h3>
                                        <div class="timeline-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#step1', function() {
                ...
                // Optional: remove this check if you want to skip filtering
                ...
                $.each(all_mol, function(a, b) {
                    ...
                    if (b.all) {
                        ...
                        let check = b.gradelevel.filter(x => x.levelid == temp_levelid).length;
                        if (check > 0) {
                            included = true;
                        }
                    }
                    ...
                    if (included) {
                        checkbox += '<div class="icheck-primary d-inline" dusk="withMOL' + b.id +
                            '">' +
                            '<input type="radio" name="withMOL" id="withMOL' + b.id + '" value="' +
                            b.id + '" disabled="disabled">' +
                            '<label class="mr-5" for="withMOL' + b.id + '">' + b.description +
                            '</label>' +
                            '</div>';
                    }
                });
                ...
                if (schoolinfo.withMOL == 1) {
                    $('#mol_holder').empty().html(checkbox);
                }
            ...
            $(document).on('click', '#step2', function() {
                ...
                // Commented out to allow access even if enrollment setup isn't present
                ...
                // Commented out to allow students to proceed without updated info
                // if (update_info.length == 0) {
                //     valid_step2 = false
                //     Toast.fire({
                //         type: 'info',
            ...
            function get_studentinfo() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (studinfo[0].levelid == 18 || studinfo[0].levelid == 19 || studinfo[0]
                            .levelid == 20) {
                        ...
                        data[0].fcontactno = data[0].fcontactno.length > 11 ? data[0].fcontactno
                            .substring(0, 12) : data[0].fcontactno;
                        data[0].mcontactno = data[0].mcontactno.length > 11 ? data[0].mcontactno
                            .substring(0, 12) : data[0].mcontactno;
                        data[0].gcontactno = data[0].gcontactno.length > 11 ? data[0].gcontactno
                            .substring(0, 12) : data[0].gcontactno;
                        data[0].contactno = data[0].contactno.length > 11 ? data[0].contactno.substring(
                            0, 12) : data[0].contactno;
            ...
            var gradelevel_to_enroll = gradelevel.filter(x => x.sortid == parseInt(current_gradelevel_detail[0]
                .sortid))
                    ...
                    success: function(data) {
                        ...
                        // 1d
                            ...
                            if (activesy_index > current_index) {
                                $('#without_enrollment_text').text(
                                    'No enrollment record was found for S.Y. ' + $(
                                        "#filter_sy option:selected").text() + '!')
            ...
            function display_enrollmentrecord() {
                ...
                if (temp_enrollment.length == 0) {
                    $('#without_enrollment_text').text('No enrollment record was found for S.Y. ' + $(
                        "#filter_sy option:selected").text() + '!')
                    return false;
                } else {
                    $('#preregistration_flow').attr('hidden', 'hidden')
                ...
                if (temp_enrollment[0].acadprogid == 6 || temp_enrollment[0].acadprogid == 5) {
                    ...
                    var temp_enrollment = enrollmentrecord.filter(x => x.syid == $('#filter_sy').val() && x.semid ==
                        $('#filter_sem').val())
                    if (temp_enrollment.length == 0) {
                        $('#without_enrollment_text').text('No enrollment record was found for S.Y. ' + $(
                                "#filter_sy option:selected").text() + ' - ' + $("#filter_sem option:selected")
                            .text() + '!')
                        $('.with_enrollment').attr('hidden', 'hidden')
                        $('.without_enrollment').removeAttr('hidden')
                        get_enrollment_setup()
            ...
            function get_balforward() {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            $('#bal_forward').text((data[0].amount).toString().replace(
                                /(\d)(?=(\d{3})+(?!\d))/g, "$1,"))
                        }
                    }
                })
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data[0].status == 'Ended') {
                            ...
                            $('#available_enrollment').append(
                                '<tr><td colspan="4">Enrollment Period Ended last ' + data[0]
                                .enrollmentend + '</td></tr>')
                            ...
                            $('#available_enrollment').empty()
                            $('#available_enrollment').append(
                                '<tr><td colspan="4">Enrollment Period will start on ' + data[0]
                                .enrollmentstart + '</td></tr>')
                            $('#preregistration_flow').removeAttr('hidden')
                            return false
                        }
                        ...
                        if (enrollment_setup.length > 0) {
                            if (enrollmentrecord.length > 0) {
                                if (studinfo[0].acadprogid == 5 || enrollment_setup[0].acadprogid ==
                                    6) {
                                    if (enrollment_setup[0].syid == enrollmentrecord[0].syid &&
                                        enrollment_setup[0].semid == enrollmentrecord[0].semid) {
                                        can_submit = false;
                                    }
                                } else {
                                    if (enrollment_setup[0].syid == enrollmentrecord[0].syid) {
                            ...
                            if (can_submit) {
                                ...
                                $('#available_enrollment').empty()
                                $.each(data, function(a, b) {
                                    $('#available_enrollment').append('<tr><td>' + b
                                        .description + '</td><td> ' + b.progname +
                                        ' </td><td>' + b.enrollmentstart + '</td><td>' + b
                                        .enrollmentend + '</td></tr>')
                                })
                                $('#preregistration_flow').removeAttr('hidden')
                            }
                    ...
                    success: function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            $.each(data, function(a, b) {
                                ...
                                // }
                                var src = '{{ asset('') }}' + b.picUrl + "?random=" +
                                    new Date().getTime()
                                var html =
                                    '<tr><td class="text-center"><img style="width:50px" src="' +
                                    src + '"></td><td class="align-middle">&#8369; ' + b
                                    .amount + '</td><td class="align-middle">' + stat +
                                    '</td><td class="align-middle">' + b.paymentDate +
                                    '</td></tr>'
                                $('#uploaded_onlinepayments_holder').append(html)
                            })
                        } else {
                            var html =
                                '<tr><td colspan="4" class="text-center">Payment reciept was uploaded.</td></tr>'
                            $('#uploaded_onlinepayments_holder').append(html)
                        }
                    }
                })
                        ...
                        $.each(data, function(a, b) {
                            ...
                            if (b.doc_studtype != null) {
                                if (studinfo[0].studtype == 'new' && b.doc_studtype != 'New') {
                                    add = false
                                } else if (studinfo[0].studtype == ' transferee' && b
                            ...
                            if (add) {
                                $('#preregrequirements_holder').append(
                                    '<tr data-status="0"><td class="align-middle" width="30%">' +
                                    b.description + require_label +
                                    '</td><td class="align-middle" width="70%"><input class="form-control form-controm-sm" type="file" name="req' +
                                    b.id + '" ' + required + '></td></tr>')
                            }
                        })
                    }
                    ...
                    success: function(data) {
                        if (data.length > 0) {
                            $.each(data, function(a, b) {
                                ...
                                if (b.doc_studtype != null) {
                                    if (studinfo[0].studtype == 'new' && b.doc_studtype !=
                                        'New') {
                                        add = false
                                    } else if (studinfo[0].studtype == ' transferee' && b
                                        .doc_studtype != 'Transferee') {
                                ...
                                if (add) {
                                    var html = '<tr><td class="align-middle">' + b.description +
                                        '</td><td>' + td_input + '</td><td>' + image +
                                        '</td></tr>'
            ...
            $('#submit_enrollmentsetup')
                .submit(function(e) {
                    ...
                    $.each(all_preregrequirements, function(a, b) {
                        if (b.isRequired == 1) {
                            if ($('input[name="req' + b.id + '"]').val() == null || $(
                                    'input[name="req' + b.id + '"]').val() == '' || $(
                                    'input[name="req' + b.id + '"]').val() == undefined) {
            ...
            $('#paymentInfo')
                .submit(function(e) {
                    ...
                    if ($('#input_number').val() == "" || ($('#input_number').val()).toString().replace(/-|_/g,
                            '').length != 11) {

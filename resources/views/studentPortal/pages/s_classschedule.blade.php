        ...
        function byday_sched(){
            ...
            if(day_sched.length > 0){
                $.each(day_sched,function(c,d){
                    $('#today_sched').append('<tr><td class="align-middle">'+d.start+'<br>'+d.end+'</td><td><a class="mb-0" style="font-size:.8rem">'+d.subjdesc+'</a><p class="text-muted mb-0" style="font-size:.7rem">'+(d.teacher ? d.teacher : 'No Instructor Assigned')+'</p></td></tr>')
                })
            }else{

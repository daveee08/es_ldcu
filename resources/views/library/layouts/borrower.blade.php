                ...
                <div class="content-side">
                    <ul class="nav-main">
                        <div class="content content-full text-center">
                            ...
                            <span
                                class="text-primary font-w600">{{ DB::table('usertype')->where('id', auth()->user()->type)->value('utype') }}</span>
                        </div>

                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('home') ? ' active' : '' }} || {{ request()->is('/') ? ' active' : '' }}"
                                href="/home">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right p-0 border-0"
                            ...
                            <div class="p-3 text-center bg-primary-dark rounded-top">
                                ...
                                <p class="mb-0 text-white-50 font-size-sm">
                                    {{ DB::table('usertype')->where('id', auth()->user()->type)->value('utype') }}</p>
                            </div>
                            <div class="p-2">
                                {{-- Profile --}}
                                ...
                                <li>
                                    <a class="text-dark media py-2" href="javascript:void(0)">
                                        ...
                                        <div class="media-body pr-2">
                                            <div class="font-w600">Sample Notifications</div>

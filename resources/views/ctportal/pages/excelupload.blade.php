        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="container-fluid headerText pl-0" style="font-size: .8rem">
                        <div class="row py-3">
                            ...
                            <div class="col-md-3" style="display: none;">
                                <div class="d-flex flex-column">
                                    <span class="font-weight-bold"><i class="fas fa-building"></i> Course</span>
                                    <span id="course"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label for="">Upload Final Grading</label>
                            <div class="d-flex align-items-center">
                                <span class="mr-2" style="font-size: .8rem; width: 200px; display: inline-block">Select
                                    Term to Upload</span>
                                <select name="" id="excel_termid" class="form-control form-control-sm select2">
                                    <option value="">Select Term</option>
                                    <option value="PRELIM" data-term="1">PRELIM</option>
                                    <option value="MIDTERM" data-term="2">MIDTERM</option>
                                    <option value="SEMI-FINAL" data-term="3">SEMI-FINAL</option>
                                    <option value="FINAL" data-term="4">FINAL</option>
                                </select>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="d-flex align-items-center mt-2">
                                <span class="mr-2" style="font-size: .8rem; width: 200px; display: inline-block">Input
                                    Cell Coordinates</span>
                                <input type="text" class="form-control form-control-sm" id="excel_cell_coordinates"
                                    placeholder="AI16" value="AI16">
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-left: 2rem;">
                            <div class="d-flex align-items-center mt-2">
                                <form action="/ecr/upload" id="upload_ecr" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="input-group input-group-sm">
                                            <input type="file" class="form-control" name="input_ecr" id="input_ecr">

                                            <button class="btn btn-success btn-sm ml-2 mr-2" style="font-size: 0.7rem"
                                                data-schedid2="0" id="upload_ecr_button">
                                                Upload ECR (Excel)
                                            </button>
                                ...
                                <button class="btn btn-primary ml-2" style="font-size: 0.7rem" data-strand="0"
                                    id="download_ecr">
                                    Download ECR (Excel)
                                </button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs" role="tablist">
                            ...
                            <li class="nav-item col-md-2 ">
                                <a class="nav-link active" href="{{ url('college/teacher/student/excelupload') }}">
                                    Excel Upload
                                </a>
                            </li>
                            <li class="nav-item col-md-2 ">
...
@section('footerscript')
    ...
    <script>
        ...
        if (gradessetup.length != 0) {
            if (gradessetup.prelim == 0) {
                ...
                $('#excel_termid option[value="PRELIM"]').remove();
            }
            if (gradessetup.midterm == 0) {
                displaycolspan -= 1;
                $('.term_holder[data-term="2"]').remove();
                $('#excel_termid option[value="MIDTERM"]').remove();
            }
            if (gradessetup.prefi == 0) {
                displaycolspan -= 1;
                $('.term_holder[data-term="3"]').remove();
                $('#excel_termid option[value="SEMI-FINAL"]').remove();
            }
            if (gradessetup.final == 0) {
                displaycolspan -= 1;
                $('.term_holder[data-term="4"]').remove();
                $('#excel_termid option[value="FINAL"]').remove();
            }
            ...
            $('.term_holder[data-term="4"]').remove();
            $('#excel_termid').empty();
            $('#excel_termid').append('<option value="">Select Term</option>');
    ...
    <script>
        $(document).ready(function() {
            ...
            //         }
            //     }
            //     console.log(checkDateSetup, 'checkDateSetup DAW NA');
            //     // console.log(term, 'term DAW NA');
            //     console.log(inputperiod, 'inputperiod DAW NA');
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.view_grades', function() {
                ...
                $('#course').text(selected_students[0].students[0].courseabrv);
                ...
                // selected_students[0].students.sort((a, b) => a.student_name.localeCompare(b.student_name));
                ...
                // function excelgradeStatus() {


                //     $('#student_list_grades tr').each(function() {
                //         const remarkElement = $(this).find('th[data-term="1"]');
                ...
                // setTimeout(excelgradeStatus, 500); // Call the function once after 500ms
                ...
                $('#upload_ecr').submit(function(e) {
                    ...
                    var term = $('#excel_termid').find(':selected').data('term');
                    // var term = $(this).attr('data-term')
                    // var term = $(sibling).attr('data-term')
                    var checkDateSetup = [];
                    ...
                    if (checkDateSetup.length > 0 && !checkDateSetup[0].isended) {
                        Toast.fire({
                            type: 'warning',
                            title: 'Deadline for this term has ended.'
                        });
                        return false;
                    }
                    ...
                    console.log(term, 'term DAW NA');
                    console.log(inputperiod, 'inputperiod DAW NA');
                    // console.log(checkDateSetup[0].isended, 'checkDateSetup[0].isended DAW NA');
                    // console.log(!checkDateSetup[0].isended, '!checkDateSetup[0].isended DAW NA');
                    // console.log(checkDateSetup.length > 0, 'checkDateSetup.length > 0 DAW NA');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (data[0].status == 0) {
                                ...
                                // $(this).find('th[data-term="1"]').prop('disabled',
                                //     true);
                                // load_ecr()
                                // get_grades(temp_id, true, students);
                ...
                //     //     checkDateSetup = inputperiod.filter(x => x.term == 'MIDTERM');
                //     // } else if (term == 3) {
                //     //     checkDateSetup = inputperiod.filter(x => x.term == 'PREFINAL');
                //     // } else if (term == 4) {
                //     //     checkDateSetup = inputperiod.filter(x => x.term == 'FINALTERM');
                //     // }
                ...
                $('#input_ecr').on('change', function() {
                    ...
                    var school = @json($schoolinfo).replace(/\s+/g,
                        ''); // Remove spaces
                    var courseValue = $('#course').text().replace(/\s+/g, ''); // Remove spaces
                    var collegeLevelValue = $('#collegeLevel').text().trim();
                    var sectionValue = $('#section').text().trim();
                    var subjValue = $('#subjectDesc').text().trim();

                    // Check if a file is selected
                    if (file) {
                        var fileName = file.name; // Get the file name
                        var validExtensions = ['xlsx', 'xls']; // Valid Excel extensions
                        var expectedFileName = school + '_' + courseValue + '_' +
                            collegeLevelValue + '_' + sectionValue + '_' + subjValue.replace(
                                /\s+/g,
                                ' ') + ' ' +
                            'ECR.xlsx'; // Expected file name for upload

                        console.log(expectedFileName, 'expectedFileName DAW NA');
                        // Get the file extension and check if it's valid
                        var fileExtension = fileName.split('.').pop().toLowerCase();

                        // Check if the file name matches the expected file name and if the extension is valid
                        if (fileName === expectedFileName && $.inArray(fileExtension,
                                validExtensions) !== -1) {
                            uploadButton.prop('disabled', false); // Enable button
                        } else {
                            uploadButton.prop('disabled', true); // Disable button
                            Swal.fire({
                                icon: 'error',
                                title: 'Invalid File',
                                text: 'Please select the specific Excel file named "' +
                                    expectedFileName + '".'
                            });
            ...
            function print_grades() {
                ...
                window.open('/college/teacher/student/grades/print?&syid=' + syid + '&semid=' + semid +
                    '&pid=' +
            ...
            //             if (data.some(x => x.excel_status === 1)) {
            //                 Toast.fire({
            //                     type: 'success',
            //                     title: 'Excel grades!'
            //                 });

            //                 // $('.grade_td').removeClass('input_grades').addClass('grade_td');
            //                 // $('.grade_td').removeClass('input_grades');

            //                 // var temp_studid = $(currentIndex).attr('data-studid')


            //                 // var prelim = parseFloat($('.grade_td[data-studid="' + temp_studid +
            //                 //         '"][data-term="1"]')
            //                 //     .text());
            //                 // var midterm = parseFloat($('.grade_td[data-studid="' + temp_studid +
            //                 //         '"][data-term="2"]')
            //                 //     .text());
            //                 // var prefi = parseFloat($('.grade_td[data-studid="' + temp_studid +
            //                 //     '"][data-term="3"]').text());
            //                 // var final = parseFloat($('.grade_td[data-studid="' + temp_studid +
            //                 //     '"][data-term="4"]').text());

            //                 data.forEach(b => {
            //                     var prelim = parseFloat($('.grade_td[data-studid="' + b.id +
            //                             '"][data-term="1"]')
            //                         .text());
            //                     var midterm = parseFloat($('.grade_td[data-studid="' + b.id +
            //                             '"][data-term="2"]')
            //                         .text());
            //                     var prefi = parseFloat($('.grade_td[data-studid="' + b.id +
            //                         '"][data-term="3"]').text());
            //                     var final = parseFloat($('.grade_td[data-studid="' + b.id +
            //                         '"][data-term="4"]').text());
            //                 });
            ...
            //                 // var term = 1;
            //                 // console.log(term, 'term sa kuha grades');

            //                 // data.forEach(b => {
            //                 //     var inputSelector = '.grade_td[data-id="' + b.id +
            //                 //         '"][data-term="' + term + '"]';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.length == 0) {
                            ...
                            $('.drop_count[data-stat="1"]').text(data.filter(x => x
                                    .prelemstatus == 9)
                                .length)
                            $('.drop_count[data-stat="2"]').text(data.filter(x => x
                                    .midtermstatus == 9)
                                .length)
                            $('.drop_count[data-stat="3"]').text(data.filter(x => x
                                    .prefistatus == 9)
                                .length)
                            $('.drop_count[data-stat="4"]').text(data.filter(x => x
                                    .finalstatus == 9)
                                .length)

                            $('.inc_count[data-stat="1"]').text(data.filter(x => x
                                    .prelemstatus == 8)
                                .length)
                            $('.inc_count[data-stat="2"]').text(data.filter(x => x
                                    .midtermstatus == 8)
                                .length)
                            $('.inc_count[data-stat="3"]').text(data.filter(x => x
                                    .prefistatus == 8)
                                .length)
                            $('.inc_count[data-stat="4"]').text(data.filter(x => x
                                    .finalstatus == 8)
                                .length)

                            $('.pen_count[data-stat="1"]').text(data.filter(x => x
                                    .prelemstatus == 3)
                                .length)
                            $('.pen_count[data-stat="2"]').text(data.filter(x => x
                                    .midtermstatus == 3)
                                .length)
                            $('.pen_count[data-stat="3"]').text(data.filter(x => x
                                    .prefistatus == 3)
                                .length)
                            $('.pen_count[data-stat="4"]').text(data.filter(x => x
                                    .finalstatus == 3)
                                .length)

                            $('.sub_count[data-stat="1"]').text(data.filter(x => x
                                    .prelemstatus == 1)
                                .length)
                            $('.sub_count[data-stat="2"]').text(data.filter(x => x
                                    .midtermstatus == 1)
                                .length)
                            $('.sub_count[data-stat="3"]').text(data.filter(x => x
                                    .prefistatus == 1)
                                .length)
                            $('.sub_count[data-stat="4"]').text(data.filter(x => x
                                    .finalstatus == 1)
                                .length)

                            $('.app_count[data-stat="1"]').text(data.filter(x => x
                                .prelemstatus == 2 ||
                                x.prelemstatus == 7).length)
                            $('.app_count[data-stat="2"]').text(data.filter(x => x
                                .midtermstatus == 2 ||
                                x.midtermstatus == 7).length)
                            $('.app_count[data-stat="3"]').text(data.filter(x => x
                                .prefistatus == 2 || x
                                .prefistatus == 7).length)
                            $('.app_count[data-stat="4"]').text(data.filter(x => x
                                .finalstatus == 2 || x
                                .finalstatus == 7).length)


                            $('.p_count[data-stat="1"]').text(data.filter(x => x.prelemgrade !=
                                null &&
                                x.prelemgrade >= 75).length)
                            $('.p_count[data-stat="2"]').text(data.filter(x => x.midtermgrade !=
                                null &&
                                x.midtermgrade >= 75).length)
                            $('.p_count[data-stat="3"]').text(data.filter(x => x.prefigrade !=
                                null && x
                                .prefigrade >= 75).length)
                            $('.p_count[data-stat="4"]').text(data.filter(x => x.finalgrade !=
                                null && x
                                .finalgrade >= 75).length)

                            $('.f_count[data-stat="1"]').text(data.filter(x => x.prelemgrade !=
                                null &&
                                x.prelemgrade < 75).length)
                            $('.f_count[data-stat="2"]').text(data.filter(x => x.midtermgrade !=
                                null &&
                                x.midtermgrade < 75).length)
                            $('.f_count[data-stat="3"]').text(data.filter(x => x.prefigrade !=
                                null && x
                                .prefigrade < 75).length)
                            $('.f_count[data-stat="4"]').text(data.filter(x => x.finalgrade !=
                                null && x
                                .finalgrade < 75).length)

                            if (school == 'spct'.toUpperCase()) {
                                $('.ng_count[data-stat="2"]').text(parseInt($(
                                    '.student_count[data-stat="2"]').text()) - (
                                    parseInt($(
                                ...
                                $('.ng_count[data-stat="1"]').text(parseInt($(
                                    '.student_count[data-stat="1"]').text()) - (
                                    parseInt($(
            ...
            //         ['prelemgrade', 'midtermgrade', 'prefigrade', 'finalgrade'].forEach((term,
            //             idx) => {
            //             const termIndex = idx + 1;
            //             const grade = record[term];
            //             const status = record[term.replace('grade', 'status')];
            ...
            //             if (grade && grade.trim() !== '') {
            //                 const gradeElement = $('.input_grades[data-studid="' + record
            //                     .studid +
            //                     '"][data-term="' + termIndex + '"]');
            //                 gradeElement.text(grade);
            //                 $('th[data-studid="' + record.studid + '"][data-term="5"]')
            //                     .addClass(
            //                         'bg-success');
            //                 $('th[data-studid="' + record.studid + '"][data-term="5"]')
            //                     .text('---');
            //                 updateStatus(termIndex.toString(), status, grade);
            //             } else if (status === 8) {
            //                 const incElement = $('.input_grades[data-studid="' + record
            //                     .studid +
            //                     '"][data-term="' + termIndex + '"]');
            //                 incElement.addClass('bg-warning');
            //                 updateStatus(termIndex.toString(), 8, 'INC');
            ...
            //         function updateStatus(term, status, grade) {
            //             const element = $('.input_grades[data-studid="' + record.studid +
            //                 '"][data-term="' +
            //                 term + '"]');
            ...
            //         ['prelemstatus', 'midtermstatus', 'prefistatus', 'finalstatus'].forEach(
            //             status => {
            ...
            //         const finalStatusText = record.fgremarks || '';
            //         const finalStatusElement = $('th[data-studid="' + record.studid +
            //             '"][data-term="6"]');
            ...
            //             if (finalStatusText === 'PASSED' || finalStatusText === 'Passed') {
            //                 finalStatusElement.removeClass('bg-danger bg-warning').addClass(
            //                     'bg-success');
            //                 passedCount++;
            //             } else if (finalStatusText === 'INC' || finalStatusText === 'Inc') {
            //                 finalStatusElement.removeClass('bg-success bg-danger').addClass(
            //                     'bg-warning');
            //             } else if (finalStatusText === 'FAILED' || finalStatusText === 'Failed') {
            //                 finalStatusElement.removeClass('bg-success bg-warning').addClass(
            //                     'bg-danger');
            //                 failedCount++;
            //             } else {
            //                 finalStatusElement.removeClass('bg-success bg-danger bg-warning');
                ...
                $("#datatable_1").DataTable({
                    ...
                    columnDefs: [{
                            ...
                            'createdCell': function(td, cellData, rowData) {
                                ...
                                var text =
                                    '<a class="badge badge-primary text-white mb-0">' +
                            ...
                            'createdCell': function(td, cellData, rowData) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(conflictData) {
                                        var hasConflict = conflictData.length >
                                            0;
                                        var conflictIcon =
                                            '<i class="fa fa-exclamation-triangle text-warning" data-toggle="tooltip" title="Conflict Schedule"></i>';
                                        ...
                                        $(td).html(text).addClass(
                                            'align-middle');
                                        $(td).find('[data-toggle="tooltip"]')
                                            .tooltip();
                                    }
                                });

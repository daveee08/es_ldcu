<aside class="main-sidebar sidebar-dark-primary elevation-4 asidebar">
    <a href="#" class="brand-link nav-bg">
        ...
        <span class="brand-text font-weight-light"
            style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>ACADEMIC COOR...</b></span>
    </a>
    <div class="sidebar">
        @php
            $randomnum = rand(1, 4);
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column side" data-widget="treeview" role="menu"
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ Request::url() == url('/posting/grade/deportment-status') ? 'active' : '' }}"
                        href="/posting/grade/deportment-status">
                        <i class="fas fa-window-restore nav-icon"></i>
                        <p>
                            Deportment Status
                        </p>
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ Request::url() == url('/posting/grade') ? 'active' : '' }}"
                        href="/posting/grade">
                        <i class="fas fa-window-restore nav-icon"></i>
                        <p>
                            Grades Summary
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::url() == url('/setup/sections') ? 'active' : '' }}"
                        href="/setup/sections">
                ...
                <li class="nav-item">
                    <a href="/setup/observed/values"
                        class="nav-link {{ Request::url() == url('/setup/observed/values') ? 'active' : '' }}">
                ...
                <li class="nav-item">
                    <a href="/setup/deportment-setup"
                        class="nav-link {{ Request::url() == url('/setup/deportment-setup"') ? 'active' : '' }}">
                        <i class="fas fa-layer-group nav-icon"></i>

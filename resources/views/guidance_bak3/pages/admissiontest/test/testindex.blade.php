                                ...
                                <div class="row p-4 dragrow">
                                    <div class="col-lg-1 col-2 rowhidden d-flex align-items-center">
                                        <div class="btn-group-verticals">
                                            <a class="btn btn-sm text-white gfg_tooltip newrow" style="background-color: #3175c2; border: 3px solid #1d62b7; z-index: 10">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="row justify-content-end p-3 mt-2">
                                                                                    <button class="btn btn-success addoption" data-id="{{$question->id}}" id="{{$question->id}}">Add option</button>
                                                                            </div>
                                                ...
                                                <div id="{{$question->id}}" class="col-lg-11 col-10 editcontent col-content identifier{{$question->id}}">
                                                    <div class="card mt-5 shadow-none border-0">
                                                        <div class="card-header">
                                                            <div class="row justify-content-end">
                                                                <div class="col-sm-6 col-md-6 col-lg-6 mr-1" id="categorylist{{$question->id}}">
                                                                    <input type="text" class="form-control categorylist" data-id= "{{$question->id}}" placeholder="Category">    
                                                                </div>
                                                                <div class="col-sm-6 col-md-10 col-lg-6 mr-1 quizarea">
                                                                    <select class="form-control quiztype" data-id="{{$question->id}}" id="quiztype{{$question->id}}">
                                                                    <option value="short_answer">Short Answer</option>
                    ...
                    $(document).on('click', '.newrow', function(){
                        ...
                        $.ajax({
                                    ...
                                    success: function(response) {
                                        ...
                                        var html = `<div id="${addrow}" class="row p-4 dragrow${addrow}">
                                                    ...
                                                    <div class="card-header">
                                                        <div class="row ml-2 justify-content-end">
                                                            <div class="col-sm-6 col-md-6 col-lg-6 mr-1" id="categorylist${addrow}">
                                                                <input type="text" class="form-control categorylist" data-id= ${addrow} value="${response.category}" placeholder="Category">    
                                                            </div>
                                                            <div class="col-sm-6 col-md-10 col-lg-6 mr-1 mt-2+ quizarea">
                                                            ...
                                                            <div class="col-12">
                                                                <div id="quiztioncontent${addrow}">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="row justify-content-end p-3 mt-2">
                                                                            <button class="btn btn-success addoption" data-id=${addrow} id="${addrow}">Add option</button>
                                                                        </div>
                        ...
                        switch (select_quiz_type) {
                            case 'multiple_choice':
                                ...
                                $('#quiztioncontent' + parentId).empty().append(
                                    ...
                                    '<div class="col-12">' +
                                    '<div class="row justify-content-end p-3 mt-2">' +
                                    '<button class="btn btn-success addoption" id="' + parentId + '" data-id="' + parentId + '" >Add option</button>' +
                                    '</div>' +
                    ...
                    $.ajax({
                            ...
                            success: function(response) {
                                    ...
                                    html += `</div>
                                            <div class="col-12">
                                                <div class="row justify-content-end p-3 mt-2">
                                                    <button class="btn btn-success addoption" id="${response.id}" data-id="${response.id}" >Add option</button>
                                                </div>

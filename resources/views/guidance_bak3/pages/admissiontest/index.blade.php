                ...
                <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                                ...
                                <div class="modal-body">
                                        ...
                                        <hr>
                                        <h4 id="addsetup">General Setup <i class="fas fa-plus" style="color: #00fa53;"></i></h4> 
                                        <div id="setupDiv"> 
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <input type="number" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control indiPercentage">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label class="setupLabel" data-fix="1">JHS GWA</label>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label>Passing %</label>
                                                            <input type="number" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control passingPercentage"onkeyup="if (this.value < 0) this.value = ''; if (this.value > 100) this.value = '100'; if (this.value.length > 2) this.value = this.value.slice(0, 2);">
                                                        </div>
                                                        <div class="col-6">
                                                            <label>Overall Percentage</label>
                                                            <input type="number" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control indiPercentage">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    <label class="setupLabel" data-fix="1">SHS GWA</label>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <label>Passing %</label>
                                                        ...
                                                        <div class="col-6">
                                                            <label>Overall Percentage</label>
                                                            <input type="number" min="0" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control indiPercentage" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row justify-content-end">
                                                    <div class="col-6 text-right">
                                                        <hr class="bg-dark">
                                                        <h4> <b>Total: </b> <span id="totalvaluepercentage"> 0 </span></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
$(document).ready(function(){
                ...
                return `<div class="form-group">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <label>Overall Percentage</label>
                                            <input id="passingPercentage" type="number" max="100"  value="${data.overalpercentage}" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control indiPercentage">
                                        </div>
                                    </div>
                                </div>
                        </div>`
    ...
    function rendersubDefaultHtml(entry) {
            ...
            <input id="inputSubject" type="number" max="100" placeholder="Enter Passing Percentage.." name="subject" class="form-control form-control mb-1 inputSubject" value="${entry.passing}" data-id="${entry.id}">`;
    }
    ...
    $(document).on('click','.edit-button',function(){
                ...
                $('.testdiv').empty().append(`
                    <label>Test</label>
                    <input type="text" class="form-control form-control" value="${data[0].test}" disabled>`
                );
    ...
    $(document).on('click','#addsetup',function(){
        ...
        var inputHTML = `    <div class="form-group">
                                <div class="form-group">
                                    <label class="setupLabel" data-fix="0" contenteditable="true">  Edit here <i class="fas fa-pencil-alt ml-1" id="pencil"></i></label>
                                    <div class="row">
                                        <div class="col-6">
                                            <label>Passing %</label>
                                            <input id="passingPercentage" type="number" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control passingPercentage"onkeyup="if (this.value < 0) this.value = ''; if (this.value > 100) this.value = '100'; if (this.value.length > 2) this.value = this.value.slice(0, 2);">
                                        ...
                                        <div class="col-6">
                                            <label>Overall Percentage</label>
                                            <input id="passingPercentage" type="number" max="100" placeholder="Enter a value between 0 and 100" name="passingPercentage" class="form-control form-control indiPercentage">
                                        </div>
                                    </div>
                                </div>
                            </div>`;

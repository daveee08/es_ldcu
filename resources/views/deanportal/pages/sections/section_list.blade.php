...
<body class="p-5">
    ...
    <table width="100%" class="table table-bordered smaller-font pr-3" style="border: 1px solid black; color: black;">
        <tr class=" p-0">
            ...
            <th width="25%" class="text-start bold">COURSE</th>
            <th width="20%" class="text-start bold">LEVEL</th>
            <th width="20%" class="text-start bold">SECTION</th>
            <th width="15%" class="text-center bold">MAXIMUM</th>
        ...
        @foreach ($sections as $section)
            ...
            <tr class="align-start p-0">
                ...
                <td class="text-start pl-1" style="font-size: 11px;">{{$section->courseabrv}}</td>
                <td class="text-start pl-1" style="font-size: 11px;">{{$section->yearDesc}} </td>
                <td class="text-start pl-1" style="font-size: 11px;">{{$section->sectionDesc}}</td>
                <td class="text-center" style="font-size: 11px;">{{$section->capacity}} </td>
                <td class="text-center bold" style="font-size: 11px;">{{$section->enrolledcount}}</td>
            </tr>
            @php
                $counter++;
            @endphp

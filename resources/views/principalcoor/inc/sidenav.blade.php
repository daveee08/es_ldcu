<asid e class="main-sidebar sidebar-dark-primary elevation-4 asidebar">
    ...
    <a href="#" class="brand-link nav-bg">
        ...
        <span class="brand-text font-weight-light"
            style="position: absolute;top: 50%;font-size: 16px!important;color:#ffc107"><b>SUBJECT COOR...</b></span>
    </a>
    <div class="sidebar">
        @php
            $randomnum = rand(1, 4);

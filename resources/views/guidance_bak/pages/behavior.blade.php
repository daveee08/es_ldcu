...
$(document).ready(function(){
                ...
                for (var i = 0; i < ABSENT_TABLE.length; i++) {
                    ...
                    html +=`<div class="card shadow rounded" id="absenttable" data-studid="${ABSENT_TABLE[i].studid}">
                                <div class="card-body position-relative">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <img src="{{ asset('${ABSENT_TABLE[i].picurl}') }}" alt="profile"  style="height: 50px; width: 50px; border-radius: 50%; overflow: hidden;" class="h-100 w-100">
                                        </div>
                                        <div class="col-md-8">
    ...
    $(document).on('click','#btn-summon',function(){
				...
				console.log("Hello headset",STUDENT_ID);

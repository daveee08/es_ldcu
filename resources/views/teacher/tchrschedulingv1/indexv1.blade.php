    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-footer border-0">
                <div class="col-md-6">
                      <button class="btn btn-sm" id="create_component_percentage"> Create</button>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 mt-10" style="margin-top: 15px!important;">
                        <table width="100%" class="table table-sm table-bordered table-head-fixed " id="schedule-list-datatable"  style="font-size:.7rem">
                            <thead>
                                <tr>
                                    ...
                                    <th width="8%" class="text-center p-0 align-middle">Enrolled</th>
                                    <th width="8%" class="text-center p-0 align-middle">Percentage</th>
                                    <th width="9%" class="text-center p-0 align-middle">Edit Sched</th>
                                </tr>
                            </thead>
    ...
    <div class="col-md-5">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12 mt-10" style="margin-top: 15px!important;">
                        <table width="100%" class="table table-bordered table-head-fixed " id="section-list-datatable" style="font-size: 13px;">
                            <thead>
                                <tr>
    ...
    $(document).ready(function(){
                ...
                columnDefs : [
                        ...
                        'createdCell':  function (td, cellData, rowData, row, col) {
                            ...
                            if (subcomponent == null) {
                                ...
                                if (principalgradessetup == null) {
                                    var text = '<a class="mb-0">'+rowData.subjdesc+' '+comp+' '+pending+' </a><p class="text-muted mb-0" style="font-size:.7rem;">'+rowData.subjcode+' '+type+'</p><p class="text-muted mb-0" style="font-size:.7rem;">No Subject Component</p>';
                                } else {
                                    ...
                                    var text = '<a class="mb-0">'+rowData.subjdesc+' '+comp+' '+pending+' </a><p class="text-muted mb-0" style="font-size:.7rem;">'+rowData.subjcode+' '+type+'</p><p class="text-muted mb-0" style="font-size:.9rem;"><span class="badge badge-dark">SP</span> <span class="badge badge-info mr-2">WW : '+subcomponent.ww+'</span><span class="badge badge-success mr-2">PT : '+subcomponent.pt+'</span><span class="badge badge-warning mr-2">QA : '+subcomponent.qa+'</span><a href="javascript:void(0)" id="btn-removesubjcom"></a></p>';
                                    
                                }
                                
                            } else {
                                var text = '<a class="mb-0">'+rowData.subjdesc+' '+comp+' '+pending+' </a><p class="text-muted mb-0" style="font-size:.7rem;">'+rowData.subjcode+' '+type+'</p><p class="text-muted mb-0" style="font-size:.9rem;"><span class="badge badge-dark">T</span> <span class="badge badge-info mr-2">WW : '+subcomponent.ww+'</span><span class="badge badge-success mr-2">PT : '+subcomponent.pt+'</span><span class="badge badge-warning mr-2">QA : '+subcomponent.qa+'</span><a href="javascript:void(0)" id="btn-removesubjcom" subjcomid="'+subcomponent.subjcomid+'" componentid="'+subcomponent.id+'"><i class="fas fa-trash text-danger"></i></a></p>';
                            }
                    ...
                    },
                    {
                        ...
                        'createdCell':  function (td, cellData, rowData, row, col) {
                            ...
                            if (subcomponent == null) {
                                $(td)[0].innerHTML = '<div><a href="javascript:void(0)" data-acadprogid="'+rowData.acadprogid+'" data-detailed="'+rowData.schedule[0].detailid+'" data-levelid="'+rowData.levelid+'" data-sectionid="'+rowData.sectionid+'" data-subjid="'+rowData.subjid+'" id="addsubjectcomponent" class="pl-2"><i class="fas fa-percentage"></i></div>'
                            } else {
                                $(td)[0].innerHTML = '<div><a href="javascript:void(0)" data-acadprogid="'+rowData.acadprogid+'" data-detailed="'+rowData.schedule[0].detailid+'" data-levelid="'+rowData.levelid+'" data-sectionid="'+rowData.sectionid+'" data-subjid="'+rowData.subjid+'" subjcomid="'+subcomponent.subjcomid+'" headerid="'+subcomponent.headerid+'" teachersubjcomid="'+subcomponent.id+'" id="editsubjectcomponent" class="pl-2"><i class="fas fa-percentage"></i></div>'
                            }
                    ...
                    },
                    {
                        ...
                        'createdCell':  function (td, cellData, rowData, row, col) {
                            ...
                            $(td).addClass('align-middle')
                            $(td)[0].innerHTML =  
                            '<div><a href="javascript:void(0)" data-acadprogid="'+rowData.acadprogid+'" data-detailed="'+rowData.schedule[0].detailid+'" data-levelid="'+rowData.levelid+'" data-sectionid="'+rowData.sectionid+'" data-subjid="'+rowData.subjid+'" id="editteachersched" class="pl-2"><i class="text-primary far fa-edit"></i></a></div>'
        ...
        $(document).on('click', '#btn_addsched', function(){
            ...
            if (roomid == null){
                ...
                console.log("mao ning roomid" + " " + room_id);
        ...
        $(document).on('click', '#btn-addsubjcom', function (){
            var headerid = $('#select-subjcom').select2('data')[0].id;
            ...
            var subjcomid = $('#select-subjcom').val();
        ...
        $(document).on('click', '#editsubjectcomponent', function (){
            ...
            $('#select-subjcom').val(subjcomid).change();
            $('#modal-subjectcomponent').modal('show')
        });

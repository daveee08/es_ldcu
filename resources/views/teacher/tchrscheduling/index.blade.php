                        ...
                        <div class="card-body shadow-none" style="padding-bottom: 0px !important;">
                            ...
                            <div class="row">
                                <div class="col-md-12" style="margin-top: 15px!important;">
                                    <table width="100%" class="table table-sm table-bordered table-head-fixed"
                                        id="section-list-datatable" style="font-size: 13px;">
                                        <thead>
                                            <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header shssched">
                    <div class="col-md-6">
                        <h5 class="modal-title" id="exportmodalLabel">Schedules in Section <span class="text-primary"
                                id="as_section" style="font-weight: bold; text-decoration: underline;"></span><input
                                type="hidden" id="as_glevel_id"></h5>
                    </div>
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-sm-4">
                ...
                <div class="modal-header jhssched">
                    <h5 class="modal-title" id="exportmodalLabel">Schedules in Section <span class="text-primary"
                            id="jhs_section" style="font-weight: bold; text-decoration: underline;"></span></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span>×</span>
                    </button>
                </div>
                <div class="modal-body p-0">
                    ...
                    <div class="card shadow-none" style="border: none;">
                        <div class="card-body shadow-none">
                            <div class="row">
                                <div class="col-md-12">
                                    <table width="100%" class="table table-bordered" id="view-sched-datatable"
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="input" class="form-control form-control-sm" id="as_gradelevel" readonly
                        ...
                        <div class="col-md-7">
                            <div class="form-group p-0">
                                ...
                                <input type="text" class="form-control form-control-sm" id="input_as_section"
                                    readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control  form-control-sm reservationtime"
                                    name="time" id="time">
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-sm table-bordered" id="subjectcomponent_table" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="12%" style="padding-right: 0!important;">WW
                                        </th>
                                        <th class="text-center" width="12%" style="padding-right: 0!important;">PT
                                        </th>
                                        <th class="text-center" width="12%" style="padding-right: 0!important;">QA
                                        </th>
                                        <th class="text-center" width="12%" style="padding-right: 0!important;">CG
                                        </th>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <button type="button" class="btn btn-primary" id="btn_modalviewallsched"
                                style="font-size:.8em">View All Schedules</button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 mt-10" style="margin-top: 15px!important;">
                            <table width="100%" class="table table-bordered table-sm table-head-fixed "
                                id="schedule-list-datatable" style="font-size:.8rem">
                                <thead>
                                    <tr>
        ...
        $(document).ready(function() {
            ...
            function teachersched() {
                ...
                $('#schedule-list-datatable').dataTable({
                    ...
                    columnDefs: [{
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                var text = '<a class="mb-0">' + rowData.sectionname +
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                if ($('#filter_gradelevel').val() != 14 && $('#filter_gradelevel')
                                    .val() != 15) {
                                    if (rowData.isCon == 1) {}
                                    ...
                                    if (rowData.subj_per != 0) {
                                        percentage = '-  <i class="text-danger">' + rowData
                                            .subj_per + '%</i>'
                                    }
                                    ...
                                    if (rowData.isVisible == 0) {
                                        visDis =
                                            '<span class="badge badge-danger badge-danger">V</span>'
                                    }
                                ...
                                if (rowData.with_pending) {
                                    pending =
                                        '<span class="badge badge-warning">With Pending</span>'
                                }


                                var teacherdeletedsubjcom = deletedsubjcom.filter(x => x.levelid ==
                                    rowData.levelid && x.subjid == rowData.subjid)[0];
                                var teachersubjectplotted = tchersubjectplot.filter(x => x
                                    .levelid == rowData.levelid && x.subjid == rowData.subjid)[
                                    0];
                                ...
                                //     }
                                // }
                                var subcomponent = teachersubjcom.filter(x => x.levelid == rowData
                                    .levelid && x.sectionid == rowData.sectionid && x.subjid ==
                                    rowData.subjid)[0];
                                ...
                                if (subcomponent == null) {
                                    ...
                                    if (principalgradessetup == null) {
                                        var text = '<a class="mb-0">' + rowData.subjdesc + ' ' +
                                            comp + ' ' + pending +
                                            ' </a><p class="text-muted mb-0" style="font-size:.7rem;">No Subject Component</p>';
                                    } else {
                                        ...
                                        if (subcomponent.comp4 == null) {
                                            var text =
                                                '&nbsp;<a class="mb-0" style="font-weight: 400">' +
                                                rowData.subjdesc + ' ' + comp + ' ' + pending +
                                                ' </a><p class="text-muted mb-0" style="font-size:.9rem; padding-top: 3px;"><span class="badge badge-dark">SP</span> <span class="badge badge-info mr-2">WW : ' +
                                                subcomponent.ww +
                                                '</span><span class="badge badge-success mr-2">PT : ' +
                                                subcomponent.pt +
                                                '</span><span class="badge badge-warning mr-2">QA : ' +
                                                subcomponent.qa +
                                                '</span><a href="javascript:void(0)" id="btn-removesubjcom"></a></p>';
                                        } else {
                                            if (subcomponent.ww == null || subcomponent.ww == 0) {
                                                var text =
                                                    '&nbsp;<a class="mb-0" style="font-weight: 400">' +
                                                    rowData.subjdesc + ' ' + comp + ' ' + pending +
                                                    ' </a><p class="text-muted mb-0" style="font-size:.9rem; padding-top: 3px;"><span class="badge badge-dark">T</span><span class="badge badge-success mr-2">PT : ' +
                                                    subcomponent.pt +
                                                    '</span><span class="badge badge-warning mr-2">QA : ' +
                                                    subcomponent.qa +
                                                    '</span><span class="badge badge-secondary mr-2">CG : ' +
                                                    subcomponent.comp4 +
                                                    '</span> <a href="javascript:void(0)" id="btn-removesubjcom" subjcomid="' +
                                                    subcomponent.subjcomid + '" componentid="' +
                                                    subcomponent.id +
                                                    '"><i class="fas fa-trash text-danger"></i></a></p>';
                                            } else if (subcomponent.comp4 == null || subcomponent
                                                .comp4 == 0) {
                                                var text =
                                                    '&nbsp;<a class="mb-0" style="font-weight: 400">' +
                                                    rowData.subjdesc + ' ' + comp + ' ' + pending +
                                                    ' </a><p class="text-muted mb-0" style="font-size:.9rem; padding-top: 3px;"><span class="badge badge-dark">T</span> <span class="badge badge-info mr-2">WW : ' +
                                                    subcomponent.ww +
                                                    '</span><span class="badge badge-success mr-2">PT : ' +
                                                    subcomponent.pt +
                                                    '</span><a href="javascript:void(0)" id="btn-removesubjcom" subjcomid="' +
                                                    ...
                                                    subcomponent.id +
                                                    '"><i class="fas fa-trash text-danger"></i></a></p>';
                                            } else if (subcomponent.pt == null || subcomponent.pt ==
                                                0) {
                                                var text =
                                                    '&nbsp;<a class="mb-0" style="font-weight: 400">' +
                                                    rowData.subjdesc + ' ' + comp + ' ' + pending +
                                                    ...
                                                    subcomponent.id +
                                                    '"><i class="fas fa-trash text-danger"></i></a></p>';
                                            } else if (subcomponent.qa == null || subcomponent.qa ==
                                                0) {
                                                var text =
                                                    '&nbsp;<a class="mb-0" style="font-weight: 400">' +
                                                    rowData.subjdesc + ' ' + comp + ' ' + pending +
                                    ...
                                    if (subcomponent.comp4 == null) {
                                        var text =
                                            '&nbsp;<a class="mb-0" style="font-weight: 400; font-size: .8rem;">' +
                                            rowData.subjdesc + ' ' + comp + ' ' + pending +
                                            ' </a><p class="text-muted mb-0" style="font-size:.9rem; padding-top: 3px;"><span class="badge badge-dark">T</span> <span class="badge badge-info mr-2">WW : ' +
                                            subcomponent.ww +
                                            '</span><span class="badge badge-success mr-2">PT : ' +
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var text = '<table class="p-0 table table-sm mb-0 ' + table + '">'
                                $.each(rowData.schedule, function(a, b) {
                                    text +=
                                        '<tr style="background-color:transparent !important"><td width="50%" class="' +
                                        multiple + '" style="font-size:.7rem">' + b.start +
                                        ' - ' + b.end +
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                if (rowData.schedule.length > 0) {
                                    if (rowData.schedule[0].roomname == null) {
                                        rowData.schedule[0].roomname = ''
                                    }
                                    var text = '<span>' + rowData.schedule[0].roomname +
                                        '</span><span hidden>' + rowData.levelname + '</span>'
                                } else {
                                    var text = ''
                                }
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                if (rowData.schedule.length > 0) {
                                    if (subcomponent == null) {
                                        $(td)[0].innerHTML =
                                            '<div><a href="javascript:void(0)" data-acadprogid="' +
                                            rowData.acadprogid + '" data-detailed="' + rowData
                                            .schedule[0].detailid + '" data-levelid="' + rowData
                                            .levelid + '" data-sectionid="' + rowData.sectionid +
                                            '" data-subjid="' + rowData.subjid +
                                            '" id="addsubjectcomponent" class="pl-2"><i class="fas fa-percentage" data-toggle="tooltip" data-placement="top" title="Add/Edit Subject Component"></i></div>'
                                    } else {
                                        $(td)[0].innerHTML =
                                            '<div><a href="javascript:void(0)" data-acadprogid="' +
                                            rowData.acadprogid + '" data-detailed="' + rowData
                                            .schedule[0].detailid + '" data-levelid="' + rowData
                                            .levelid + '" data-sectionid="' + rowData.sectionid +
                                            '" data-subjid="' + rowData.subjid + '" subjcomid="' +
                                            subcomponent.subjcomid + '" headerid="' + subcomponent
                                            .headerid + '" teachersubjcomid="' + subcomponent.id +
                                            '" id="editsubjectcomponent" class="pl-2"><i class="fas fa-percentage" data-toggle="tooltip" data-placement="top" title="Add/Edit Subject Component"></i></div>'
                                    }
                                } else {
                                    $(td)[0].innerHTML = ''
                                }
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                $.each(rowData.schedule, function(a, b) {
                                    text +=
                                        '<tr style="background-color:transparent !important"><td width="50%" class="' +
                                        multiple +
                                        '" style="font-size:1rem; padding: 9.5px!important;"><a href="javascript:void(0)"  data-acadprogid="' +
                                        rowData.acadprogid + '" data-detailed="' + b
                                ...
                                text += '</table>'
                                // $.each(rowData.schedule,function(a,b){
                                //         text += '<a href="javascript:void(0)"  data-acadprogid="'+rowData.acadprogid+'" data-detailed="'+b.detailid+'" data-levelid="'+rowData.levelid+'" data-sectionid="'+rowData.sectionid+'" data-subjid="'+rowData.subjid+'" id="editteachersched" class="pl-2" style="oadding-top: 10px;"><i class="text-primary far fa-edit"  data-toggle="tooltip" data-placement="top" title="Edit Schedule"></i></a><br>'
                                // })
                                // var text = '';
                                $(td).addClass('text-center')
                                $(td).addClass('align-middle')
                ...
                $(label_text)[0].innerHTML = '<div class="float-sm-left p-0" style="font-size: .9rem"> ' +
                    ' <ul> ' +
                    '<li><span class="p-0 text-dark"><span class="badge badge-dark">SP</span> - Subject Component Created by Principal/Registrar</span></li> ' +
                    '<li><span class="p-0 text-dark"><span class="badge badge-dark">T</span> - Subject Component Created by Teacher</span> </li> ' +
                    '</ul> ' +
                    '</div>'
            ...
            $(document).on('click', '#editteachersched', function() {
                ...
                var detailedid = $(this).attr('data-detailed');
                var levelid = $(this).attr('data-levelid');
                var sectionid = $(this).attr('data-sectionid');
                var subjid = $(this).attr('data-subjid');
                var acadprog = $(this).attr('data-acadprogid');

                var scheddata = update_teacherschedule.filter(x => x.levelid == levelid && x.sectionid ==
                    sectionid && x.subjid == subjid)[0];
                // var data_detailid = scheddata.schedule[0].detailid; 
                var data_detailid = detailedid;

                schedule = scheddata.schedule
                for (let i = 0; i < schedule.length; i++) {
                    const scheduleItem = schedule[i];

                    if (scheduleItem.detailid == data_detailid) {

                        $('.reservationtime').daterangepicker({
                            timePicker: true,
                            startDate: scheduleItem.start,
                            endDate: scheduleItem.end,
                        ...
                        $.each(scheduleItem.days, function(a, b) {
                ...
                scheddatadays = update_teacherschedule.filter(x => x.levelid == levelid && x.sectionid ==
                    sectionid && x.subjid == subjid)[0].schedule[0].days;
                ...
                var schedclassval = schedclass.filter(x => x.text == scheddata.schedule[0].classification)[
                    0].id;
            ...
            $(document).on('click', '#btn_updatesched', function() {
                ...
                if (levelid == 14 || levelid == 15) {
                    semid = sh_subjects.filter(x => x.subjid == subjid && x.levelid == levelid && x
                        .strandid == strandid)[0].semid;
                } else {
                    semid = null;
                }

                var scheddata = teacherschedule.filter(x => x.levelid == levelid && x.sectionid ==
                    sectionid && x.subjid == subjid)[0];
                ...
                if (valid_data) {
                    var temp_url = acadprogid == 5 ? '/principal/setup/schedule/sh/add' :
                ...
                $('#section-list-datatable').dataTable({
                    ...
                    columnDefs: [{
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var text =
                                    '<a class="mb-0" style="padding: 0px 5px 0px 5px !important">' +
                                    rowData.sectionname + '</a>';
                                $(td)[0].innerHTML = text
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                $(td).addClass('align-middle')
                                $(td)[0].innerHTML =
                                    '<a class="btn btn-primary text-light" id="btn_viewschedules_id" data-roomid="' +
                                    rowData.roomid + '" data-roomname="' + rowData.roomname +
                                    '" data-levelid="' + rowData.levelid + '" data-section="' +
                                    rowData.sectionname + '" data-id="' + rowData.sectionid +
                                    '" style="font-size:.8rem; href="javascript:void(0)" style="padding: 2px 0px 2px 0px !important">view sched</a>'
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                if (rowData.teacher == "no teacher assign") {
                                    if (rowData.isCon == 1) {
                                        ...
                                        $(td)[0].innerHTML = '<span>Not Assign</span>'
                                    ...
                                    if (rowData.isCon == 1) {
                                        ...
                                        $(td)[0].innerHTML = '<span>Assigned</span>'
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                if (rowData.teacher == "no teacher assign") {
                                    if (rowData.isCon == 1) {
                                        ...
                                        $(td)[0].innerHTML =
                                            '<a class="add_sched" id="btn_addsched" data-acadid="' +
                                            rowData.acadprogid + '" data-gradelevelid="' + rowData
                                            .levelid + '" data-subjid="' + rowData.subjid +
                                            '" data-gradelevel="' + rowData.levelname +
                                            '" data-subject="' + rowData.subjdesc +
                                            '" data-semid="' + rowData.semid +
                                            '" style="font-size:.8rem; padding: 2px 0px 2px 0px !important; cursor: pointer" data-toggle="tooltip" data-placement="top" title="Add Subject"><i class="fas fa-plus text-primary"></i></a>'
                                    }
                                } else {
                                    if (rowData.tid == teacherid) {
                                        if (rowData.isCon == 1) {
                                            $(td)[0].innerHTML = text
                                        } else {
                                            $(td)[0].innerHTML =
                                                '<a class="add_sched" id="btn_addsched" data-acadid="' +
                                                rowData.acadprogid + '" data-gradelevelid="' +
                                                rowData.levelid + '" data-subjid="' + rowData
                                                .subjid + '" data-gradelevel="' + rowData
                                                .levelname + '" data-subject="' + rowData.subjdesc +
                                                '" data-semid="' + rowData.semid +
                                                '" style="font-size:.8rem; padding: 2px 0px 2px 0px !important; cursor: pointer"  data-toggle="tooltip" data-placement="top" title="Add Subject"><i class="fas fa-plus text-primary"></i></a>'
                                        }
                                    } else {
                                        if (rowData.isCon == 1) {
                                            ...
                                            $(td)[0].innerHTML =
                                                '<a class="add_sched" id="" data-acadid="' + rowData
                                                .acadprogid + '" data-gradelevelid="' + rowData
                                                .levelid + '" data-subjid="' + rowData.subjid +
                                                '" data-gradelevel="' + rowData.levelname +
                                                '" data-subject="' + rowData.subjdesc +
                                                '" data-semid="' + rowData.semid +
                                                '" style="font-size:.8rem; padding: 2px 0px 2px 0px !important; cursor: pointer"></a>'
                                        }
                                    }
            ...
            $(document).on('click', '#btn_addsched', function() {
                $('.day').prop('checked', false);
                $('#select-schedclass').val(1).change();
                $('#headaddsched').show();
                $('#headupdatesched').hide();
                $('#btn_proceed').show();
                $('#btn_updatesched').hide();
                ...
                var roomid = availableschedules.filter(x => x.levelid == gradelevelid && x.subjid ==
                    subjid)[0].roomid;
                ...
                if (gradelevelid == 14 || gradelevelid == 15) {
                    var semid = availableschedules.filter(x => x.levelid == gradelevelid && x.subjid ==
                        subjid)[0].semid;
                } else {
                    var semid = null;
                }
            ...
            $('#modal-addschedule').on('hide.bs.modal', function(e) {
                ...
                $('#conflict_holder').attr('hidden', 'hidden');
                $('#select-schedclass').val(0).change()
            })
                        ...
                        },
                        {
                            ...
                            'createdCell': function(td, cellData, rowData, row, col) {
                                ...
                                var buttons = '<a href="javascript:void(0)" ' + disabled +
                                    ' class="delete_comp" data-teacherid="' + rowData.teacherid +
                                    '" data-id="' + rowData.id +
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    if (data) {
                                        ...
                                        getallteachersched();
                                        lodteachersubjcom();
                                        $("#tchrschedss").load(location.href +
                                            " #tchrschedss");
                                        // $('#modal-subjectcomponent').modal('hide')
            ...
            $('#modal-viewallschedules').on('hidden.bs.modal', function() {
                $('#select-gradelevel').val(0).change()
            })

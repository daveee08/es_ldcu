            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <button type="button" class="btn btn-primary" id="btn_modalviewallsched" style="font-size:.8em"><i class="fas fa-plus"></i> View All Schedules</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 mt-10" style="margin-top: 15px!important;">
                        <table width="100%" class="table table-sm table-bordered table-head-fixed " id="schedule-list-datatable"  style="font-size:.8rem">
                            <thead>
                                <tr>

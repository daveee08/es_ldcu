        ...
        $('.select2').select2()
            ...
            function get_student_credentials(){
                ...
                if($('#input_section').val() != "" && $('#input_section').val() != null){
                    ...
                    $(label_text)[0].innerHTML = ' <button class="btn btn-primary btn-sm" id="reset_all_student_pass"><i class="fas fa-sync"></i> Reset All Students Password</button><button class="btn btn-primary btn-sm ml-2" id="reset_all_parents_pass" ><i class="fas fa-sync" ></i> Reset All Parents Password</button>'
                }

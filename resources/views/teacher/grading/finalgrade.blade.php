...
@section('content')
    ...
    <div class="modal fade" id="modal_1" style="display: none;" aria-hidden="true" data-backdrop="static"
        data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="card-body table-responsive p-0" style="height: 500px;">
                                <table class="table table-sm table-bordered table-head-fixed">
                                    <thead>
                                        <tr>
                                            <th width="5%" class="text-center align-middle p-0"><input type="checkbox"
                                                    checked="checked" class="exclude select_all"></th>
                                            <th width="15%">SID</th>
                    ...
                    <div class="row mt-2">
                        <div class="col-md-6">
                            <button class="btn btn-sm btn-success" id="btnSubmit" style=" font-size:11px !important"> Submit
                                Grades</button>
                        </div>
                        <div class="col-md-6">
                            <button class="btn btn-danger btn-sm float-right" data-dismiss="modal"
                                style=" font-size:11px !important"><i class="fas fa-times"></i> Close</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Grades /Final Grade</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow">
                                <div class="card-body p-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn btn-warning btn-sm btn-block submit_pending_grades"
                                                data-quarter="1" hidden>Submit Pending Grade</button>
                                        </div>
                                        <div class="col-md-12">
                                            <button class="btn btn-primary btn-sm btn-block submit_grades"
                                                data-quarter="1" hidden>Submit 1st Quarter Grades</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card shadow">
                                <div class="card-body p-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn btn-warning btn-sm btn-block submit_pending_grades"
                                                data-quarter="2" hidden>Submit Pending Grade</button>
                                        </div>
                                        <div class="col-md-12">
                                            <button class="btn btn-primary btn-sm btn-block submit_grades"
                                                data-quarter="2" hidden>Submit 2nd Quarter Grades</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card shadow">
                                <div class="card-body p-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn btn-warning btn-sm btn-block submit_pending_grades"
                                                data-quarter="3" hidden>Submit Pending Grades</button>
                                        </div>
                                        <div class="col-md-12">
                                            <button class="btn btn-primary btn-sm btn-block submit_grades"
                                                data-quarter="3" hidden>Submit 3rd Quarter Grades</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card shadow">
                                <div class="card-body p-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="btn btn-warning btn-sm btn-block submit_pending_grades"
                                                data-quarter="4" hidden>Submit Pending Grades</button>
                                        </div>
                                        <div class="col-md-12">
                                            <button class="btn btn-primary btn-sm btn-block submit_grades"
                                                data-quarter="4" hidden>Submit 4th Quarter Grades</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-9">
                    <div class="card shadow">
                        <div class="card-body  p-2">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button class="btn btn-primary btn-sm" id="save_button_1" disabled><i
                                            class="fas fa-save"></i> Save Grades</button>
                                    <button class="btn btn-primary btn-sm" id="download_final_grade" disabled><i
                                            class="fas fa-save"></i> Download Grades</button>
                                </div>
...
@section('footerjavascript')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#download_final_grade', function() {
                ...
                window.open('/teacher/finalgrades/extract?syid=' + syid + '&levelid=' + levelid +
                    '&sectionid=' + sectionid + '&subjid=' + subjid + '&semid=' + semid, '_blank');
            })
            ...
            function load_subject_select(subjid = null) {
                ...
                $.each(all_sched, function(a, b) {
                    ...
                    var count = grade_subjects.filter(x => x.subjcode == b.subjcode && x.id == b.subjid)
                        .length
                    var pending = '';

                    $.each(all_sched.filter(x => x.subjcode == b.subjcode && x.subjid == b.subjid),
                        function(c, d) {
                            if (d.with_pending) {
            ...
            function load_section_select(sectionid = null) {
                ...
                var sections = []
                var subjid = $('#filter_subjects').val()
                var subjdesc = $("#filter_subjects option:selected").text().replace(
            ...
            $(document).on('click', '#btnSubmit[type="perst"]', function() {
                ...
                $('.exclude').each(function() {
                    if ($(this).prop('checked') == false && $(this).attr('data-studid') !=
                        undefined) {
                            ...
                            success: function(data) {
                                if (data[0].status == 1) {
                                    ...
                                    $('.exclude').each(function(a, b) {
                                        var temp_studid = $(this).attr(
                                            'data-studid')
                                        if ($(this).prop('checked') == true &&
                                            $(this).attr('data-studid') !=
                                            undefined) {
                                            $('.pending_list[data-studid="' +
                                                temp_studid + '"]').remove()
                                        }
                                    })
                                    ...
                                    if (excluded.length == 0) {
                                        ...
                                        $('#btnSubmit').attr('disabled', 'disabled')
                                        $('.exclude').attr('disabled', 'disabled')
                                        $('.submit_pending_grades[data-quarter="' +
                                            quarter + '"]').attr('hidden', 'hidden')

                                        var temp_index = all_sched.findIndex(x => x
                                            .subjid == subjid && x.sectionid ==
                                            sectionid)
                                        all_sched[temp_index].quarter_pending_perst =
                                            all_sched[temp_index].quarter_pending_perst
                                            .filter(x => x != selected_quarter)
            ...
            $(document).on('click', '.submit_pending_grades, .submit_grades', function() {
                ...
                $.each(all_students, function(a, b) {
                    ...
                    var include_to_list = true

                    if (temp_quarter == 1 && b.q1 == 0) {
                        include_to_list = false
                    } else if (temp_quarter == 2 && b.q2 == 0) {
                        include_to_list = false
                    } else if (temp_quarter == 3 && b.q3 == 0) {
                        include_to_list = false
                    } else if (temp_quarter == 4 && b.q4 == 0) {
                        include_to_list = false
                    }
                    ...
                    if (include_to_list) {
                        ...
                        if (is_pending) {
                            ...
                            if (male == 0 && b.gender == 'MALE') {
                                $('#students_from_pending').append(
                                    '<tr class="bg-secondary"><th colspan="8">MALE</th></tr>')
                                male = 1
                            } else if (female == 0 && b.gender == 'FEMALE') {
                                $('#students_from_pending').append(
                                    '<tr class="bg-secondary"><th colspan="8">FEMALE</th></tr>')
                                female = 1
                            }
                            ...
                            qgrade = $('.studgrades[data-studid="' + b.studid + '"][data-id="' +
                                qid + '"]').text()
                            ...
                            $('#students_from_pending').append('<tr data-studid="' + b.studid +
                                '" class="pending_list"><td class="text-center p-0 align-middle"><input type="checkbox"  class="exclude" checked="checked" data-studid="' +
                                b.studid + '"></td><td>' + b.sid + '</td><td>' + b.student +
                                '</td><td class="text-center">' + qgrade +
                                '</td><td class="text-center">' + remarks + '</td></tr>')
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(a, b) {
                            ...
                            var qgrade1 = b.qgrade1 != null ? parseInt(b.qgrade1) : '';
                            var qgrade2 = b.qgrade2 != null ? parseInt(b.qgrade2) : '';
                            var qgrade3 = b.qgrade3 != null ? parseInt(b.qgrade3) : '';
                            var qgrade4 = b.qgrade4 != null ? parseInt(b.qgrade4) : '';
                            ...
                            var gstatus1 = b.gstatus1 == 0 || b.gstatus1 == 3 ?
                                'input_grades studgrades align-middle' :
                                'studgrades align-middle';
                            var gstatus2 = b.gstatus2 == 0 || b.gstatus2 == 3 ?
                                'input_grades studgrades align-middle' :
                                'studgrades align-middle';
                            var gstatus3 = b.gstatus3 == 0 || b.gstatus3 == 3 ?
                                'input_grades studgrades align-middle' :
                                'studgrades align-middle';
                            var gstatus4 = b.gstatus4 == 0 || b.gstatus4 == 3 ?
                                'input_grades studgrades align-middle' :
                                'studgrades align-middle';
                            ...
                            if (levelid == 14 || levelid == 15) {
                                ...
                                if (qgrade1 != '' && qgrade2 != '' && qgrade3 != '' &&
                                    qgrade4 != '') {
                                    nums = [qgrade1, qgrade2, qgrade3, qgrade4]
                                    fg = parseFloat((qgrade1 + qgrade2 + qgrade3 + qgrade4) / 4)
                                        .toFixed();
                                    remarks = fg >= 75 ? 'PASSED' : 'FAILED'
                                    bg = fg >= 75 ? 'bg-success' : 'bg-danger'
                                }
                            ...
                            $('#students').append('<tr><td class="align-middle">' + b.sid +
                                '</td><td class="align-middle">' + b.student +
                                '</td><td class="text-center ' + gstatus1 + ' ' + b
                                .gdcolor1 + '" ' + s1hidden +
                                ' data-quarter="1" data-id="' + qid1 + '" data-header="' + b
                                .qheader1 + '" data-studid="' + b.studid + '">' + qgrade1 +
                                '</td><td class="text-center ' + gstatus2 + ' ' + b
                                .gdcolor2 + '" ' + s1hidden +
                                ' data-quarter="2" data-id="' + qid2 + '" data-header="' + b
                                .qheader2 + '"  data-studid="' + b.studid + '">' + qgrade2 +
                                '</td><td class="text-center  ' + gstatus3 + ' ' + b
                                .gdcolor3 + '" ' + s2hidden +
                                ' data-quarter="3" data-id="' + qid3 + '" data-header="' + b
                                .qheader3 + '"  data-studid="' + b.studid + '">' + qgrade3 +
                                '</td><td class="text-center  ' + gstatus4 + ' ' + b
                                .gdcolor4 + '" ' + s2hidden +
                                ' data-quarter="4" data-header="' + b.qheader4 +
                                '" data-id="' + qid4 + '"  data-studid="' + b.studid +
                                '">' + qgrade4 + '</td><td class="text-center fg ' + bg +
                                '" data-studid="' + b.studid + '" >' + fg +
                                '</td><td class="text-center actiontaken ' + bg +
                                '" data-studid="' + b.studid + '">' + remarks + '</td></tr>'
                            )

                            $('.studgrades[data-studid="' + b.studid + '"]').attr('is_sp',
                                false)


                            if (levelid == 14 || levelid == 15) {} else {
                                var cell = null
                                if (b.q1 == 0) {
                                    cell = $('.studgrades[data-studid="' + b.studid +
                                        '"][data-quarter="1"]')
                                    cell.removeAttr('class')
                                    if (b.studstatus == 3 || b.studstatus == 5 || b
                                        .studstatus == 6) {
                                        cell.text(b.description)
            ...
            $(document).on('change', '#filter_section', function() {
                ...
                if ($(this).val() == "") {
                    $('#download_final_grade').attr('disabled', 'disabled')
                } else {
                    $('#download_final_grade').removeAttr('disabled')
                }
            ...
            $(document).on('click', '#btnSubmit[type="all"]', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $('.exclude').each(function() {
                            if ($(this).prop('checked') == false && $(this).attr(
                                    'data-studid') != undefined) {
                                excluded.push($(this).attr('data-studid'))
                            }
                        })
                        ...
                        var filter_data = all_sched.filter(x => x.subjid == subjid && x.sectionid ==
                            sectionid)
                        var levelid = filter_data[0].levelid
                        var semid = 1
        ...
        $(document).ready(function() {
            ...
            function calcfg(studid) {
                ...
                if (levelid == 14 || levelid == 15) {
                    if (semid == 1) {
                        for (var x = 1; x <= 2; x++) {
                            $('.studgrades[data-studid="' + studid + '"][data-quarter="' + x + '"]').each(function(
                                a, b) {
                                if ($(this).text() == "") {
                                    with_fg = false
                                }
                    ...
                    var is_sp = $('.studgrades[data-studid="' + studid + '"][is_sp="true"]').length > 0 ? true :
                        false;

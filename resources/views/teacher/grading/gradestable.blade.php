      ...
      <table  class="table table-bordered mb-0 table-sm table-hover" disabled>
            <thead>
                  <tr style="font-size:11px">
                        ...
                        @if($gradesetup->comp4 == 0 || $gradesetup->comp4 == null)
                              <th colspan="4" class="text-center" hidden></th>
                        @else
                              <th colspan="4" class="text-center">Character Grade <span class="text-danger">( {{$gradesetup->comp4}}% )</span></th>
                        @endif
                        <th></th>
                  ...
                  <tr style="font-size:11px">
                        ...
                        @if($gradesetup->comp4 == 0 || $gradesetup->comp4 == null)
                              <th hidden style="top: 28px; min-width:30px" class="text-center align-middle">1</th>
                              <th hidden style="top: 28px; min-width:30px" class="text-center align-middle">2</th>
                              <th hidden style="top: 28px; min-width:30px" class="text-center align-middle">3</th>
                              <th hidden style="top: 28px;  min-width:30px" class="text-center align-middle">TOTAL</th>
                              <th hidden style="top: 28px;  min-width:30px" class="text-center align-middle">PS</th>
                              <th hidden style="top: 28px;  min-width:30px" class="text-center align-middle">WS</th>
                        @else
            ...
            <tbody>
                  ...
                  @foreach($hps as $hp)
                        ...
                        <tr  data-value="{{$hp->id}}" id="hps" class="hps" style="font-size:11px">
                              ...
                              @endif
                              @if($gradesetup->comp4 == 0 || $gradesetup->comp4 == null)
                                    <td hidden class="qahr1 isHPS qa" data-id="hps"  data-field="cg1">0</td>
                                    <td hidden class="qahr1 isHPS qa" data-id="hps"  data-field="cg2">0</td>
                                    <td hidden class="qahr1 isHPS qa" data-id="hps"  data-field="cg3">0</td>
                                    <th hidden class="text-center align-middle isHPS"  data-id="hps" id="hpstotalcg"  data-field="cghrtotal">0</th>
                                    <th hidden class="text-center align-middle isHPS" style="background-color: #b4c6e7;">100.00</th>
                                    <th hidden class="text-center align-middle isHPS" data-field="cgws">0</th>
                              @else
                                    <td class="qahr1 isHPS cg" data-id="hps"  data-field="cghr1">{{$hp->cghr1 != null ? $hp->cghr1 : 0}}</td>
                                    <td class="qahr1 isHPS cg" data-id="hps"  data-field="cghr2">{{$hp->cghr2 != null ? $hp->cghr2 : 0}}</td>
                                    <td class="qahr1 isHPS cg" data-id="hps"  data-field="cghr3">{{$hp->cghr3 != null ? $hp->cghr3 : 0}}</td>
                                    <th class="text-center align-middle isHPS"  data-id="hps" id="hpstotalcg"  data-field="cghrtotal">{{$hp->cghrtotal != null ? $hp->cghrtotal : 0}}</th>
                                    <th class="text-center align-middle isHPS" style="background-color: #b4c6e7;">100.00</th>
                                    <th class="text-center align-middle isHPS" data-field="cgws" style="background-color: #f8cbad;">{{$gradesetup->comp4}}</th>
                              @endif
                  ...
                  @foreach($grades as $grade)
                        ...
                        <tr data-value="{{$grade->id}}" class="gradedetail" style="font-size:11px">
                              ...
                              @if($gradesetup->comp4 == 0 || $gradesetup->comp4 == null)
                                    <td hidden class="cg1 cg" data-id="{{$grade->id}}" data-field="cg1" data-studid="{{$grade->studid}}">0</td>
                                    <td hidden class="cg2 cg" data-id="{{$grade->id}}" data-field="cg2" data-studid="{{$grade->studid}}">0</td>
                                    <td hidden class="cg3 cg" data-id="{{$grade->id}}" data-field="cg3" data-studid="{{$grade->studid}}">0</td>
                                    <th hidden class="text-center align-middle input_cell" data-field="cgtotal"  data-id="{{$grade->id}}" data-studid="{{$grade->studid}}">0</th>
                                    <th hidden class="text-center align-middle input_cell" data-field="cgps"  data-id="{{$grade->id}}" data-studid="{{$grade->studid}}"  style="background-color: #b4c6e7;">0</th>
                                    <th hidden class="text-center align-middle ws input_cell" data-field="cgws" data-id="{{$grade->id}}" data-studid="{{$grade->studid}}">0</th>
                              @else
                                    <td class="cg1 cg" data-id="{{$grade->id}}" data-field="cg1" data-studid="{{$grade->studid}}">{{$grade->cg1 != null ?$grade->cg1 : 0}}</td>
                                    <td class="cg2 cg" data-id="{{$grade->id}}" data-field="cg2" data-studid="{{$grade->studid}}">{{$grade->cg2 != null ?$grade->cg2 : 0 }}</td>
                                    <td class="cg3 cg" data-id="{{$grade->id}}" data-field="cg3" data-studid="{{$grade->studid}}">{{$grade->cg3 != null ?$grade->cg3 : 0 }}</td>
                                    <th class="text-center align-middle input_cell" data-field="cgtotal"  data-id="{{$grade->id}}" data-studid="{{$grade->studid}}" >{{$grade->cgtotal}}</th>
                                    <th class="text-center align-middle input_cell" data-field="cgps"  data-id="{{$grade->id}}" data-studid="{{$grade->studid}}"  style="background-color: #b4c6e7;">{{number_format($grade->cgps,2)}}</th>
                                    <th class="text-center align-middle ws input_cell" data-field="cgws" data-id="{{$grade->id}}" data-studid="{{$grade->studid}}" style="background-color: #f8cbad;">{{number_format($grade->cgws,2)}}</th>
                              @endif
...
<script id="gradescript">
      ...
      $(document).ready(function(){
            ...
            var newcghpstotal = parseInt($('#hpstotalcg')[0].innerText)
            var iswww = false;
            var ispt = false;
            var isqa = false;
            var iscg = false;
            ...
            function updateTotal(){
                  ...
                  iscg = $(currentIndex).hasClass('cg') ? true : false;
                  ...
                  newcghpstotal = parseInt($('#hpstotalcg')[0].innerText)
            ...
            function updatehrs(){
                  ...
                  if(iscg){
                        var totalcg = 0;
                        for(var x =32; x <= 34; x++){
                              totalcg += parseInt($(currentIndex).parent()[0].cells[x].innerText);
                        }
                        $(currentIndex).parent()[0].cells[$('#hpstotalcg')[0].cellIndex].innerText = totalcg
                        $($(currentIndex).parent()[0].cells[$('#hpstotalcg')[0].cellIndex]).addClass('edited')
                  }
            ...
            function calc_grade(curcell){
                  ...
                  if(iscg){
                        var cgtotal = 0
                        $('.cg[data-id="'+id+'"]').each(function(a,b){
                              cgtotal += parseInt($(b).text())
                              $('.input_cell[data-id="'+id+'"][data-field="cgtotal"]')[0].innerText = cgtotal
                              $('.input_cell[data-id="'+id+'"][data-field="cgtotal"]').addClass('edited')
                        })
                        
                        var hps_cg_ws = parseInt (parseInt($('.isHPS[data-field="cgws"]').text()) ) / 100
                        var cgtotal = parseInt( $('.input_cell[data-id="'+id+'"][data-field="cgtotal"]').text() )
                        var cgps = parseFloat( ( cgtotal / newcghpstotal ) * 100).toFixed(3);
                        var cgws = parseFloat( cgps * hps_cg_ws);
                        console.log(qaps, hps_cg_ws)
                        var cgws = round( parseFloat( cgps * hps_cg_ws).toFixed(3) , 2 );

                        $('.input_cell[data-id="'+id+'"][data-field="cgps"]')[0].innerText = cgps != 'NaN' ? parseFloat(cgps).toFixed(2) : parseFloat(0).toFixed(2)
                        $('.input_cell[data-id="'+id+'"][data-field="cgws"]')[0].innerText = cgws != 'NaN' ? cgws : parseFloat(0).toFixed(2)
                        $('.input_cell[data-id="'+id+'"][data-field="cgps"]').addClass('edited')
                        $('.input_cell[data-id="'+id+'"][data-field="cgws"]').addClass('edited')
                  }
                  var totalig = 0 ;

...
<div class="row">
    <div class="col-md-6">        
        ...
        @foreach (collect($students)->values() as $student)
            ...
            <div class="card card-primary card-student card-shadow" style="border: none; box-shadow: 0 .125rem .25rem rgba(0,0,0,.075)!important;}"  data-string="{{$student->lastname}}, {{$student->firstname}}<">
                      ...
                      <div class="row">
                          <div class="col-12" style="font-size: 13px;">
                            ...
                            <div class="card-tools mt-2">
                                <form action="/prinsf9print/{{$student->id}}" method="get" class="m-0 p-0" target="_blank" style="display: inline;">
                                {{-- <form action="/forms/form9" method="get"> --}}
                                    ...
                                    <button type="submit"  class="btn btn-sm btn-primary toModal" id="{{$student->id}}">View Report card</button>
                                </form>
                                <form action="/reports/student/copyofGrades?studentid={{$student->id}}" method="get" target="_blank" class="m-0 p-0" style="display: inline;">
                                    <input type="hidden" name="action" value="preview"/>
                                    <input type="hidden" name="studentid" value="{{$student->id}}"/>
                                    <input type="hidden" name="sectionid" value="{{$student->sectionid}}"/>
                                    <input type="hidden" name="syid" value="{{$syid}}"/>
                                    <button type="submit"  class="btn btn-sm btn-secondary" id="{{$student->id}}">View Copy  of Grades</button>
                                </form>

...
<body>
    <div id="watermark">
        <img src="<?php echo e(base_path()); ?>/public/<?php echo e($schoolinfo->picurl); ?>" width="700px" />
    </div>
    <?php
    // $registrarname = '';
  ...
  <header>
      ...
      <table style="width: 100%; table-layout: fixed;">
        <tr>
            <td style="width: 20%; text-align: right;"><img src="<?php echo e(base_path()); ?>/public/<?php echo e($schoolinfo->picurl); ?>" alt="school" width="80px"/></td>
            <td colspan="3"><img src="<?php echo e(base_path()); ?>/public/assets/images/gbbc/tor-header.png" alt="school" width="520px"/></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
  ...
  <footer>
    <table style="width: 100%; font-size: 12px; font-weight: bold; text-align: left !important;">
        <thead>
            <tr>
                ...
                <th style="border-bottom: 1px solid black;"><?php echo e($details->remarks); ?></th>
    ...
    <table style="width: 100%; font-size: 12px;">
        <tr>
            ...
            <th style="width: 40%; text-align: center;"><?php echo e($assistantreg ?? ''); ?></th>
            <th style="width: 30%;">&nbsp;</th>
        </tr>
    </table>
    <table style="width: 100%; font-size: 12px;">
        <tr>
            ...
            <th style="width: 30%; text-align: center;"><?php echo e($registrar); ?></th>
        </tr>
        <tr>
            <td style="width: 30%; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O.R #: <span style="font-weight: bold;"><?php echo e($or); ?></span></td>
            <td style="width: 40%; font-size: 12px; text-align: center;"></td>
            <td style="width: 30%; text-align: center; font-size: 12px;">Registrar</td>
        </tr>
        <tr>
            <td style="width: 30%; font-size: 12px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date Issued: <?php if($dateissued != null): ?> <span style="font-weight: bold;"><?php echo e(date('m/d/Y', strtotime($dateissued))); ?></span> <?php endif; ?></td>
            <td style="width: 40%; font-size: 12px; text-align: center;"></td>
  ...
  <tr>
      ...
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($studentinfo->lastname); ?>, <?php echo e($studentinfo->firstname); ?> <?php echo e($studentinfo->suffix); ?> <?php echo e($studentinfo->middlename); ?></td>
      <td style="width: 15%;">Address:</td>
      <td style="width: 35%;border-bottom: 1px solid black;" colspan="3"><?php echo e($address); ?></td>
  </tr>
  <tr>
      <td style="width: 18%;">Date of Birth:</td>
      <td style="width: 17%;border-bottom: 1px solid black;"><?php echo e($studentinfo->dob); ?></td>
      <td style="width: 5%;">Sex</td>
      <td style="width: 10%;border-bottom: 1px solid black;"><?php echo e($studentinfo->gender); ?></td>
  ...
  <tr>
      ...
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->parentguardian); ?></td>
      <td style="">Address:</td>
      <td style="border-bottom: 1px solid black;" colspan="3"><?php echo e($details->address); ?></td>
  </tr>
  <tr>
      <td>Elementary Course:</td>
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->elemcourse); ?></td>
      <td style="">Date Complete:</td>
      <td style="border-bottom: 1px solid black;" colspan="3"><?php echo e($details->elemdatecomp); ?></td>
  </tr>
  <tr>
      <td>Secondary Course:</td>
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->secondcourse); ?></td>
      <td style="">Date Complete:</td>
      <td style="border-bottom: 1px solid black;" colspan="3"><?php echo e($details->seconddatecomp); ?></td>
  </tr>
  <tr>
      <td>Admission Date:</td>
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->admissiondate); ?></td>
      <td style="">Degree:</td>
      <td style="border-bottom: 1px solid black;" colspan="3"><?php echo e($details->degree); ?></td>
  </tr>
  <tr>
      <td>Basis of Admission:</td>
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->basisofadmission); ?></td>
      <td style="width: 15%;">Major:</td>
      <td style="width: 14%;border-bottom: 1px solid black;"><?php echo e($details->major); ?></td>
  ...
  <tr>
      ...
      <td style="width: 32%;border-bottom: 1px solid black;" colspan="3"><?php echo e($details->specialorder); ?></td>
      <td style="border-bottom: 1px solid black;">Graduation Date:</td>
      <td style="border-bottom: 1px solid black;"><?php echo e($details->graduationdate); ?></td>
...
?>
  <main>
        ...
        <table style="width: 100%; margin: 0px; table-layout: fixed;" class="font-two">
            ...
            <?php if(count($records)>0): ?>
                <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($initialschool == strtolower($record->schoolname)): ?>
                    <?php else: ?>
                    <?php
                    ...
                    ?>
                    <tr>
                        <td colspan="6" style="text-align: center"><u style="text-transform: uppercase; font-weight: bold; font-size: 12px;"><?php echo e($record->schoolname); ?></u><br/><span style="font-weight: bold; text-transform: uppercase; font-size: 12px;"><?php echo e($initialcourse); ?></span></td>
                    </tr>
                    <?php endif; ?>
                    <tr style="font-size: 12px;">
                        <td style="width: 15%; font-weight: bold;"><u><?php if($record->semid == 1): ?>First Semester <?php elseif($record->semid == 2): ?>Second Semester <?php else: ?> Summer <?php endif; ?></u></td>
                        <td style="width: 5%; "></td>
                        <td style="width: 10%; text-align: right;"><u><?php echo e($record->sydesc); ?></u>&nbsp;&nbsp;</td>
                    ...
                    <?php if(count($record->subjdata)>0): ?>
                        <?php $__currentLoopData = $record->subjdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="font-size: 12px;">
                                <td style=""><?php echo e($subj->subjcode); ?></td>
                                <td style=""><?php echo e($subj->subjunit); ?></td>
                                <td style="">&nbsp;</td>
                                <td style=""><?php echo e($subj->subjdesc); ?></td>
                                <td style=" text-align: right; font-weight: bold;"><?php echo e($subj->subjgrade); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                <td style="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($subj->subjcredit); ?></td>
                            </tr>
        ...
        <?php if(collect($records)->where('display','0')->count()>0): ?>
            ...
            <table style="width: 100%; margin: 0px; margin-top: 180px; page-break-before: always;" class="font-two">
                <?php if(count($records)>0): ?>
                    <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <tr>
                            <td colspan="6" style="text-align: center; width: 100%;"><u style="text-transform: uppercase; font-weight: bold; font-size: 13px;"><?php echo e($record->schoolname); ?></u><br/><span style="font-weight: bold; text-transform: uppercase; font-size: 13px;"><?php echo e($initialcourse); ?></span></td>
                        </tr>
                        <?php endif; ?>
                        <tr style="font-size: 12px;">
                            <td style="width: 14%; font-weight: bold;"><u><?php if($record->semid == 1): ?>First Semester <?php elseif($record->semid == 2): ?>Second Semester <?php else: ?> Summer  <?php endif; ?></u></td>
                            <td style="width: 5%;"></td>
                            <td style="width: 11%; text-align: right;"><u><?php echo e($record->sydesc); ?></u>&nbsp;&nbsp;</td>
                        ...
                        <?php if(count($record->subjdata)>0): ?>
                            <?php $__currentLoopData = $record->subjdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr style="font-size: 12px;">
                                    <td style="width: 14%;"><?php echo e($subj->subjcode); ?></td>
                                    <td style="width: 5%;"><?php echo e($subj->subjunit); ?></td>
                                    <td style="width: 11%;">&nbsp;</td>
                                    <td style="width: 45%;"><?php echo e($subj->subjdesc); ?></td>
                                    <td style="width: 12%; text-align: right; font-weight: bold;"><?php echo e($subj->subjgrade); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td style="width: 13%;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($subj->subjcredit); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                        <?php    
            ...
            <div style="width: 100%; font-size: 12px; text-align: center;">***** Continued on next page *****</div>
                ...
                <table style="width: 100%; margin: 0px; margin-top: 180px; page-break-before: always;" class="font-two">
                    <?php if(count($records)>0): ?>
                        <?php $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td colspan="6" style="text-align: center; width: 100%;"><u style="text-transform: uppercase; font-weight: bold; font-size: 13px;"><?php echo e($record->schoolname); ?></u></td>
                            </tr>
                            <tr style="font-size: 12px;">
                                <td style="width: 14%; font-weight: bold;"><u><?php if($record->semid == 1): ?>First Semester <?php elseif($record->semid == 2): ?>Second Semester  <?php else: ?> Summer <?php endif; ?></u></td>
                                <td style="width: 5%;"></td>
...
</html><?php /**PATH C:\laragon\www\es_ldcu2\resources\views/registrar/forms/tor/pdf/pdf_tor_gbbc_dompdf.blade.php ENDPATH**/ ?>
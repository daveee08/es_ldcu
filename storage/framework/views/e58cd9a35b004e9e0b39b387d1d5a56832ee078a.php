                      ...
                      <div class="card shadow">
                          <div class="card-header">
                              ...
                              <div class="row">
                                      ...
                                      <div class="col-md-7">
                                          <h5 class="float-right">Active S.Y.: <?php echo e(collect($schoolyears)->where('isactive',1)->first()->sydesc); ?></h5>
                                      </div>
                              </div>
                              <div class="row">
                                    <?php if(Session::get('currentPortal') != 7 && Session::get('currentPortal') != 9): ?>
                                          <div class="col-2">
                                                      <label>School Year</label>
                                                      <select class="form-control select2 form-control-sm" id="filter_sy">
                                                            <?php $__currentLoopData = $schoolyears; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->startSection('footerjavascript'); ?>
      ...
      <script>
            ...
            var type = <?php echo json_encode(Session::get('currentPortal'), 15, 512) ?>
...
<?php echo $__env->make($extend, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\es_ldcu\resources\views/superadmin/pages/student/sadtr.blade.php ENDPATH**/ ?>
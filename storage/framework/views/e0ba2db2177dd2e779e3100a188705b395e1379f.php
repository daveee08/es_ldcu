...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <label for="">Emailer</label>
                                    <br>
                                    <input type="checkbox" name="withEmailer" class="update_module"
                                        data-bootstrap-switch>
                                </div>
                            </div>
                            <div class="row form-group mt-2">
                                ...
                                <div class=" col-md-2">
                                    ...
                                    <br>
                                    <input type="checkbox" name="bookkeeperv2" class="update_module"
                                        data-bootstrap-switch>
                                </div>
...
<?php $__env->startSection('footerjavascript'); ?>
    ...
    <script>
        ...
        if (schoolinfo.emailer == 1) {
            $('.update_module[name="withEmailer"]').attr('checked', 'checked')
        }

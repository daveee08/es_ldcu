...
<link rel="stylesheet" href="<?php echo e(asset('dist/css/floating-button.css')); ?>">
...
<?php $__env->startSection('qab_sript'); ?>
    <script>
            ...
            // FLOATING BUYTTON FUNCTION
                ...
                $(document).on('click', '.annouce', function () {
                    ...
                    if(assignedwindow == 0){
                        ...
                        $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("annouce.next.que")); ?>',
                        data: {
                ...
                $(document).on('click', '.window_asign', function () {
                    ...
                    $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("assign.window")); ?>',
                        data: {
                ...
                $(document).on('click', '.waitlist', function () {
                    ...
                    $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("get.waitlist")); ?>',
                        data: {
                ...
                $(document).on('click', '.mark_done', function () {
                    ...
                    $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("waitlist.markdone")); ?>',
                        data: {
                ...
                function get_current_serving(){
                    ...
                    $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("get.current.serving")); ?>',
                        data:{
                            window_number: assignedwindow,
                        },
                        success:function(data) {
                ...
                function next_que_done(status){
                    ...
                    $.ajax({
                        type:'GET',
                        url: '<?php echo e(route("get.next.que")); ?>',
                        data: {
                            window_number: assignedwindow,
...
<?php $__env->stopSection(); ?><?php /**PATH C:\laragon\www\es_ldcu2\resources\views/general/queuingactionbutton/qab.blade.php ENDPATH**/ ?>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed accent-info pace-primary">
    <div class="wrapper">
        <?php echo $__env->make('general.defaultportal.inc.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('general.defaultportal.inc.sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\laragon\www\es_ldcu\resources\views/general/defaultportal/layouts/app.blade.php ENDPATH**/ ?>
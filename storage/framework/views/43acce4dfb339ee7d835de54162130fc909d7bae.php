<html>
    ...
    <body style="padding-top: 170px; padding-bottom: 100px;">
        ...
        <footer style=" font-family: Arial, Helvetica, sans-serif !important;">
            <table style="width: 100%; font-size: 11px;margin-bottom: 2px;">
                <tr>
                    ...
                    <td width="20%" style="text-align: center; border-bottom: 1px solid black;">
            ...
            <table style="width: 100%; table-layout: fixed;">
                <tr>
                    <td rowspan="3" style="width: 25%; vertical-align: top;">
                        ...
                        <img src="<?php echo e(base_path()); ?>/public/<?php echo e($schoolinfo->picurl); ?>" alt="school" width="100px" />
                    </td>
                    ...
                    <td rowspan="5" style="width: 15%;">
                        ...
                        <?php else: ?>
                            <?php
                                ...
                                $picExists =
                                    !empty($studentinfo->picurl) && file_exists(public_path($studentinfo->picurl));
                            ?>
                    ...
                    <td style="text-align: center; font-size: 10.5px;">
                        <?php if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'sait'): ?>
                            <?php echo e(DB::table('schoolinfo')->first()->address); ?><br />Tel. no. 828-6058 Email Add: <u
                                style="color:blue;">saitvalencia1960@gmail.com</u> <br />Website:
                            https://www.sait.edu.ph
                        <?php else: ?>
        ...
        <table
            ...
            <tr>
                <td colspan="5" style="padding-left: 5px; padding-top: 10px"><b>Date / Term and School Year
                        Admitted:</b>
                    <?php if($enrollment_his ?? '' != null && $enrollment_his->created_at != null): ?>
            ...
            <tr>
                <td colspan="5" style="padding-left: 5px;"><b>Junior High School Completed at:</b>
                    <?php echo e($details->juniorschoolname ?? ''); ?></td>
            </tr>
            <tr>
                <td colspan="5" style="padding-left: 5px;"><b>Senior High School Completed at:</b>
                    <?php echo e($details->seniorschoolname ?? ''); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5" style="padding-left: 5px;padding-bottom: 5px"><b>Date Graduated / Last Term and
                        School
        ...
        <table
            style="width: 100%; font-size: 12px; margin-top: 5px; page-break-inside: always; page-break-before: avoid;"
            border="1">
            <thead>
                <tr>
                        ...
                        <?php $__currentLoopData = $record->subjdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="font-size: 12px;">
                                ...
                                <td style="border-top: hidden; border-bottom: hidden; text-align: center;">
                                    <?php echo e($record->type != 'manual' && isset($subj->subjgrade) ? number_format($subj->subjgrade, 1) : $subj->subjgrade ?? ''); ?>
        ...
        <table style="width: 100%; font-size: 12px; margin-bottom: 2px; margin-top: 10px;">
            <tr>
                ...
                <td>
                    ...
                    100 - 1.0, 99 - 1.1, 98 - 1.2, 97 - 1.3, 96 - 1.4, 95 - 1.5, 94 - 1.6, 93 - 1.7, 92 - 1.8, 91 - 1.9
                    <br>
                    90 - 2.0, 89 - 2.1, 88 - 2.2, 87 - 2.3, 86 - 2.4, 85 - 2.5, 84 - 2.6, 83 - 2.7, 82 - 2.8, 81 - 2.9
                    <br>
            ...
            <tr>
                <td colspan="2">
                    ...
                    has been verified by me and that true copies of the official records substantiating the same are
                    kept in
        ...
        <table style="width: 100%; font-size: 12px; margin-bottom: 2px; margin-top: 5px;">
            <tr>
                ...
                <?php if(strtolower(DB::table('schoolinfo')->first()->abbreviation) == 'stii'): ?>
                    <td style="width: 30%; text-align: center; border-bottom: 1px solid black; font-weight: bold;">
                        ERWIN B. CENAS</td>
                <?php else: ?>
                    <td style="width: 30%; text-align: center; border-bottom: 1px solid black; font-weight: bold;">
                        <?php echo e($registrar); ?></td>
                <?php endif; ?>
            </tr>
            <tr>
                <td></td>
...
<?php /**PATH C:\laragon\www\es_ldcu2\resources\views/registrar/forms/tor/pdf/pdf_tor_sait.blade.php ENDPATH**/ ?>
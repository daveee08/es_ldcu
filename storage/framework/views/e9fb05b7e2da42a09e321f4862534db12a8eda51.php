            ...
            <tr>
                <td width="50%" class="p-0"
                    ...
                    <table width="100%" style="font-size: 14px; margin-top: 15px;">
                        <tr>
                            ...
                            <td width="20%" class="p-0 text-left">1<sup style="font-size: 11px;">st</sup> Quarter
                            </td>
                    ...
                    <table width="100%" style="font-size: 14px; margin-top: 15px;">
                        <tr>
                            <td width="24%"class="p-0"></td>
                            <td width="20%" class="p-0 text-left">2<sup style="font-size: 11px;">nd</sup> Quarter
                            </td>
                            <td width="30%" class="p-0 text-center" style="border-bottom: 1px solid #000"></td>
                            <td width="26%" class="p-0"></td>
                        </tr>
                    ...
                    <table width="100%" style="font-size: 14px; margin-top: 15px;">
                        <tr>
                            <td width="24%"class="p-0"></td>
                            <td width="20%" class="p-0 text-left">3<sup style="font-size: 11px;">rd</sup> Quarter
                            </td>
                            <td width="30%" class="p-0 text-center" style="border-bottom: 1px solid #000"></td>
                            <td width="26%" class="p-0"></td>
                        </tr>
                    ...
                    <table width="100%" style="font-size: 14px; margin-top: 15px;">
                        <tr>
                            <td width="24%"class="p-0"></td>
                            <td width="20%" class="p-0 text-left">4<sup style="font-size: 11px;">th</sup> Quarter
                            </td>
                            <td width="30%" class="p-0 text-center" style="border-bottom: 1px solid #000"></td>
                            <td width="26%" class="p-0"></td>
                        </tr>
                    ...
                    <table width="100%" style="margin-top: 15px;">
                        ...
                        <tr>
                            ...
                            <td class="p-0" width="10%" style=""> </td>
                            <td class="p-0" width="45%" style="text-align: center; font-size: 13px;">Teacher
                            </td>
                        </tr>
                    </table>
                ...
                <td width="50%" class="p-0" style="vertical-align: top; padding-left: .40in!important;">
                    <table class="table mb-0 mt-0" style="width: 100%; table-layout: fixed;">
                        <tr>
                            <td width="25%" class="p-0 text-center" style="font-size: 10px;"><b>REPORT CARD
                                    (SF9)</b>
                            </td>
                    ...
                    <table style="font-size: 13px; margin-top: 20px;">
                        <tr>
                            <td width="100%" class="p-0" style="text-indent: 50px;">The school welcomes you
                                should
                    ...
                    <table style="width: 100%; padding-top: 45px; text-align: center;">
                        ...
                        <tr>
                            ...
                            <td class="p-0" width="10%" style=""></td>
                            <td class="p-0" width="45%" style="text-align: center; font-size: 12px;">Adviser
                            </td>
                        </tr>
                    </table>
                </td>
                                ...
                                <table class="table-sm" width="100%">
                                    <tr>
                                        <td colspan="6" class="align-middle text-center"
                                            style="font-size: 13px!important;"><b>REPORTS ON LEARNER'S OBSERVED
                                                VALUES</b>
                                        </td>
                                    </tr>
                                </table>

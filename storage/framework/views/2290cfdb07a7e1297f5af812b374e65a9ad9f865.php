                    ...
                    <table width="600" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            <td align="center" style="font-size: 48px; padding-bottom: 20px;">
                                <img src="<?php echo e(asset('schoollistlogo/bct.png')); ?>" alt="logo" width="72"
                        ...
                        <tr>
                            <td style="font-size: 16px; color: #333333;">
                                <p style="text-align: center;">
                                    Hi <strong><?php echo e($data['fullname']); ?></strong>,
                                </p>
                                <p style="text-align: center;">
                                    Here is your credentials for your account
                                </p>
                                <p>
                                    <strong>Username:</strong> <?php echo e($data['username']); ?><br />
                                    <strong>Password:</strong> <?php echo e($data['password']); ?>
...
<?php /**PATH C:\laragon\www\es_ldcu\resources\views/emails/template.blade.php ENDPATH**/ ?>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark pace-primary nav-bg">
      ...
      <ul class="navbar-nav ml-auto">
        <?php echo $__env->make('components.headerprofile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </ul>
    </nav>
<?php /**PATH C:\laragon\www\es_ldcu\resources\views/teacher/inc/header.blade.php ENDPATH**/ ?>
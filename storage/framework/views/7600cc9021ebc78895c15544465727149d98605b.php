        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 mb-2">
            <div class="btn-group btn-block shadow-lg">
                ...
                <div class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = collect($academicprograms)->where('id', '!=', '6')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacadprog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item"
                            href="/registar/schoolforms/index?sf=0&acadprogid=<?php echo e($eachacadprog->id); ?>"><?php echo e($eachacadprog->acadprogcode); ?></a>
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 mb-2">
            <div class="btn-group btn-block shadow-lg">
                ...
                <div class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = collect($academicprograms)->where('id', '!=', '6')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacadprog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item"
                            href="/registar/schoolforms/index?sf=1&acadprogid=<?php echo e($eachacadprog->id); ?>"><?php echo e($eachacadprog->acadprogcode); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 mb-2">
            <div class="btn-group btn-block shadow-lg">
                ...
                <div class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = collect($academicprograms)->where('id', '!=', '6')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacadprog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item"
                            href="/registar/schoolforms/index?sf=2&acadprogid=<?php echo e($eachacadprog->id); ?>"><?php echo e($eachacadprog->acadprogcode); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 mb-2">
            <div class="btn-group btn-block shadow-lg">
                ...
                <div class="dropdown-menu float-left" role="menu">
                    <?php $__currentLoopData = collect($academicprograms)->where('id', '!=', '6')->where('id', '!=', '5')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacadprog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item"
                            href="/registar/schoolforms/index?sf=5&acadprogid=<?php echo e($eachacadprog->id); ?>"><?php echo e($eachacadprog->acadprogcode); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-4 col-lg-3 col-xl-2 mb-2">
            <div class="btn-group btn-block shadow-lg">
                ...
                <div class="dropdown-menu" role="menu">
                    <?php $__currentLoopData = collect($academicprograms)->where('id', '!=', '6')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacadprog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="dropdown-item"
                            href="/registar/schoolforms/index?sf=9&acadprogid=<?php echo e($eachacadprog->id); ?>"><?php echo e($eachacadprog->acadprogcode); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="small-box bg-success" style="height: 15%; box-shadow: 0 1rem 3rem rgba(0,0,0,.175)!important;">
                <div class="inner">
                    <h3 class="m-0">S.Y. <?php echo e(DB::table('sy')->where('isactive', '1')->first()->sydesc); ?></h3>
                    <h3 class="m-0"><?php echo e(DB::table('semester')->where('isactive', '1')->first()->semester); ?></h3>
                </div>
            </div>
            <div class="small-box bg-warning" style="height: 21%; box-shadow: 0 1rem 3rem rgba(0,0,0,.175)!important;">
                <div class="inner pt-1" style="font-size: 10px !important; width: 60%;">
                    <p class="m-0">Enrolled: <span class="float-right text-bold"><?php echo e($numenrolled); ?></span></p>
                    <p class="m-0">Late Enrolled: <span class="float-right text-bold"><?php echo e($numlateenrolled); ?></span>
                    </p>
                    <p class="m-0">Transferred In: <span class="float-right text-bold"><?php echo e($numtransferredin); ?></span>
                    </p>
                    <p class="m-0">Transferred Out: <span
                            class="float-right text-bold"><?php echo e($numtransferredout); ?></span></p>
                    <p class="m-0">Dropped Out: <span class="float-right text-bold"><?php echo e($numdroppedout); ?></span></p>
                    <p class="m-0">Withdrawn: <span class="float-right text-bold"><?php echo e($numwithdrawn); ?></span></p>
                </div>
            </div>
            <div class="card" style="height: 60%; box-shadow: 0 1rem 3rem rgba(0,0,0,.175)!important;">
                ...
                <div class="card-body pr-1 pl-1 pt-0 pb-1" style="font-size: 15px;">
                    <?php $__currentLoopData = $academicprograms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eachacad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <label class="mt-1 mb-1"><?php echo e($eachacad->progname); ?> </label><span
                                    class="float-right badge badge-warning mt-2"
                                    style="font-size: 12px;"><?php echo e($eachacad->count); ?></span>
                            </div>
...
<?php $__env->startSection('footerjavascript'); ?>
    ...
    <script>
        ...
        //   labels: [
        //       '<?php echo e($preschoolTeachers); ?> Pre ',
        //       '<?php echo e($elemTeachers); ?> Elem', 
        //       '<?php echo e($juniorHighTeachers); ?> Junior', 
        //       '<?php echo e($seniorHighTeachers); ?> Senior'
        //   ],
        //   datasets: [
        //     {
        //       data: ['<?php echo e($preschoolTeachers); ?>','<?php echo e($elemTeachers); ?>','<?php echo e($juniorHighTeachers); ?>','<?php echo e($seniorHighTeachers); ?>'],
        ...
        var acadprogcodes = '<?php echo e(collect($academicprograms)->pluck('acadprogcode')); ?>'
        acadprogcodes = acadprogcodes.replace(/&quot;/gi, "");
        acadprogcodes = acadprogcodes.replace(/\[/gi, "");
        acadprogcodes = acadprogcodes.replace(/\]/gi, "");
        acadprogcodes = acadprogcodes.split(',');
        var acadcounts = '<?php echo e(collect($academicprograms)->pluck('count')); ?>'
        acadcounts = acadcounts.replace(/&quot;/gi, "\"");
        acadcounts = acadcounts.replace(/\[/gi, "");
        acadcounts = acadcounts.replace(/\]/gi, "");
        acadcounts = acadcounts.split(',');
        var acadcolors = '<?php echo e(collect($academicprograms)->pluck('color')); ?>'
        ...
        $(document).ready(function() {
            ...
            var currentportal = <?php echo json_encode(Session::get('currentPortal'), 15, 512) ?>;
            ...
            $('#stud-manage-enrolled-online').on('click', function() {
                window.open(
                    '/registrar/oe?syid=<?php echo e(DB::table('sy')->where('isactive', '1')->first()->id); ?>&semid=<?php echo e(DB::table('semester')->where('isactive', '1')->first()->id); ?>',
                    "_blank")
            })
        });
    </script>
...
<?php echo $__env->make('registrar.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\es_ldcu2\resources\views/registrar/home.blade.php ENDPATH**/ ?>
...
<script src="<?php echo e(asset('plugins/datatables-fixedcolumns/js/dataTables.fixedColumns.js')); ?>"></script>
      ...
      <script>
            ...
            $(document).ready(function(){
                  ...
                  var usertype = <?php echo json_encode($usertype, 15, 512) ?>;
                  var usertypev2 = [];
                  var topdesc = [];
                  ...
                  $(document).on('click', '.edit_topdesc', function(){
                        ...
                        var publicPath = '<?php echo e(asset('')); ?>';
...
<?php echo $__env->make($extend, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\es_ldcu\resources\views/superadmin/pages/setup/FAQs/faqs.blade.php ENDPATH**/ ?>
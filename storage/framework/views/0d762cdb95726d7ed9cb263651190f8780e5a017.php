      ...
      <div class="container-fluid">
            <div class="row mb-2">
                  ...
                  <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/home">Home <?php echo e(auth()->user()->type); ?> <?php echo e(Session::get('currentPortal')); ?></a></li>
                          ...
                          <div class="info-box-content">
                              <div class="row">
                                          ...
                                          <select class="form-control select2 form-control-sm" id="filter_sy">
                                                <?php $__currentLoopData = $sy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                      <?php if($item->isactive == 1): ?>
                                                            <option value="<?php echo e($item->id); ?>" selected="selected"><?php echo e($item->sydesc); ?></option>
                                                      <?php else: ?>
                                    ...
                                    <div class="col-md-6">
                                          ...
                                          <span class="text-danger" id="filter_student_error" hidden><small>Select a Student first to display the Student Information</small></span>
                                    </div>
                              </div>
                          </div>
                        </div>
                                      ...
                                      <div class="tab-content" id="custom-tabs-two-tabContent">
                                          ...
                                          <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                                ...
                                                <div class="row">
                                                      ...
                                                      <div class="col-md-6">
                                                      <strong><i class="fas fa-book mr-1"></i>Province</strong>
...
<?php $__env->startSection('footerjavascript'); ?>
      ...
      <script>
            ...
            var studentid = $('#filter_student').val()
            
            if (studentid === '') {
                  $('#filter_student_error').prop('hidden', false);
                  Toast.fire({
                        type: 'error',
                        title: 'No filters have been applied yet',
                  });
            }
      </script>
      ...
      <script>
            $(document).ready(function(){
                  ...
                  $(document).on('change','#filter_student',function(){
                        $('#filter_student_error').prop('hidden', true);
                        ...
                        $.ajax({
                              ...
                              success:function(data) {
                                    ...
                                    if(data[0].picurl != null){
                                          ...
                                          var image = '<img width="100%" src="'+onerror_url+'" onerror="this.src=\''+onerror_url+'\'" alt="" class="img-circle img-fluid" >'
                                    }
...
<?php echo $__env->make($extend, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\es_ldcu\resources\views/superadmin/pages/student/studentinformation.blade.php ENDPATH**/ ?>
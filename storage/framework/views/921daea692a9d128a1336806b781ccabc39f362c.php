...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(isset($msteamsaccount->username)): ?>
        <div class="row mt-5">
            <div class="col-12">
                <div class="card collapsed-card shadow">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <?php if($msteamsaccount): ?>
                                    <em><?php echo e($msteamsaccount->username); ?></em>
                                <?php endif; ?>
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-4">
                                <div class="input-group" data-target-input="nearest">
                                    <?php if($msteamsaccount): ?>
                                        <input type="password" value="<?php echo e($msteamsaccount->password); ?>" id="msteamspassword"
                                            class="form-control form-control-sm" readonly />
                                        <div class="input-group-append" data-target="#reservationdate"
                                            data-toggle="datetimepicker">
                                            <div class="input-group-text" id="msteamsvisible"><i class="fa fa-eye"></i>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="card-body pt-0 h-100" style="min-height:574px">
                            <div class="row">
                                <div class="col-md-12" style="font-size:.7rem">
                                    <table class="table table-sm table-bordered" id="teachersched_table" width="100%"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="10%" class="text-center p-0 align-middle">Enrolled Student
                                                </th>
                                            </tr>
                                        </thead>
                                    </table>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="small-box bg-success shadow">
                        <div class="inner">
                            <h3 class="mb-0">SY: <?php echo e($syinfo->sydesc); ?></h3>
                            <p class="mb-0"><?php echo e($seminfo->semester); ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="row">
                <div class="col-md-12">
                    <div class="card shadow">
                        <div class="card-header p-2 border-0">
                            <h3 class="card-title"><i class="nav-icon fas fa-layer-group text-warning"></i> Student
                                Information</h3>
                        </div>
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-md-12">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/students/advisory">Advisory</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm" href="/students/bysubject">By
                                        Subject</a>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/teacher/teachingload">Teaching Load</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <a class="btn btn-primary text-white btn-block btn-sm" href="/grades/index">System
                                        Grading</a>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-primary text-white btn-block btn-sm" href="/grades/index">Upload
                                        Excel</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6  mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm" href="/grades/index">Final
                                        Grading</a>
                                </div>
                                <div class="col-md-6  mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/grade/observedvalues">Observed Values</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12  mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/teacher/pending/grades/view">Pending Grades <span
                                            class="badge badge-warning pending_status_holder right" hidden>WP</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card shadow">
                        ...
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/forms/index/form1">SF1</a>
                                </div>
                                <div class="col-md-6">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/forms/index/form2">SF2</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/forms/index/form5a">SF5A</a>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/forms/index/form5b">SF5B</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/forms/index/form9">Report Card</a>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/teacher/grade/summary">Grade Summary</a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/teacher/grade/summary/quarter">Quarter Grades</a>
                                </div>
                                <div class="col-md-6 mt-2">
                                    <a class="btn btn-primary text-white btn-block btn-sm"
                                        href="/teacher/student/ranking">Student Awards</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var teacherid = <?php echo json_encode($teacherid, 15, 512) ?>;
            var syid = <?php echo json_encode($syid, 15, 512) ?>;
            var semid = <?php echo json_encode($semid, 15, 512) ?>;
    ...
    <script>
        $(document).ready(function() {
            ...
            var datefrom = new Date().toLocaleString("en-US", {
                timeZone: "Asia/Manila"
            })
                ...
                eventClick: function(info) {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (moment(datefrom).format('MMM DD, YYYY') != moment(dateto)
                                .format('MMM DD, YYYY')) {
                                $('#date').append(' - ' + moment(dateto).format(
                                    'MMM DD, YYYY'))
                            }
...
<?php echo $__env->make('teacher.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\es_ldcu\resources\views/teacher/home.blade.php ENDPATH**/ ?>
...
<body class="sidebar-mini layout-fixed layout-navbar-fixed accent-info" style="height: auto;">
    <div class="wrapper">
        <?php echo $__env->make('registrar.inc.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->make('registrar.inc.sidenav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\laragon\www\es_ldcu2\resources\views/registrar/layouts/app.blade.php ENDPATH**/ ?>